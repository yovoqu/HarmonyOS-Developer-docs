...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-custom-auth-plugin-template
...
export class CustomAuth implements AuthPlugin {
   ...
   */
  async auth(accessToken: string): Promise;     // 用户所在的组织，具有发布指定组织包的权限
    groupAdminList: Array;      // 用户所管理的组织，具有删除指定组织内包的权限
  }> {
    let id: string, name: string, belongGroupList: Array, groupAdminList: Array;
   ...
   */
  async authWithReadOnly(accessToken: string): Promise;     // 用户所在的组织，具有发指定组织包的权限
    groupAdminList: Array;      // 用户所管理的组织，具有删除指定组织内包的权限
  }> {
    let id: string, name: string, belongGroupList: Array, groupAdminList: Array;
    return {id, name, belongGroupList, groupAdminList};
