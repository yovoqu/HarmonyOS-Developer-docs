...
> [!NOTE]
> ohpm-repo成功启动后修改配置文件方法 ： 首次启动ohpm-repo时执行 install 命令时已指定配置文件：找到指定的配置文件进行文件内容修改，然后重新执行install指定修改后的配置文件，再执行start启动ohpm-repo。 首次启动ohpm-repo时执行 install 命令未指定配置文件：默认使用ohpm-repo压缩包解压路径下conf目录中的配置文件，修改该文件内容，然后重新执行install和start操作。
...
#store:
#  type: custom                                            # custom是自定义存储插件类型，自定义存储插件开发流程见<a href="https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-ohpm-repo-storageplugin">指导文档</a>
#  config:
...
<span id="ZH-CN_TOPIC_0000002594631988__ph1741761692614"><span style="color: rgb(95,130,107);">##### content check plugin #####</span></span>
<span id="ZH-CN_TOPIC_0000002594631988__ph19417016142618"><span style="color: rgb(95,130,107);"># </span><span style="color: rgb(95,130,107);">可选项，包内容规则检测插件配置</span></span>
<span id="ZH-CN_TOPIC_0000002594631988__ph1941712165263"><span style="color: rgb(95,130,107);">#content_check_plugin:</span></span>
<span id="ZH-CN_TOPIC_0000002594631988__ph64171816192617"><span style="color: rgb(95,130,107);">  # </span><span style="color: rgb(95,130,107);">该校验要求环境变量中有</span><span style="color: rgb(95,130,107);">ark_disasm</span><span style="color: rgb(95,130,107);">可执行文件</span><span style="color: rgb(95,130,107);">、tar</span><span style="color: rgb(95,130,107);">命令行工具</span></span>
<span id="ZH-CN_TOPIC_0000002594631988__ph1941716164264">  <span style="color: rgb(95,130,107);"># </span><span style="color: rgb(95,130,107);">检查范围：上架的字节码</span><span style="color: rgb(95,130,107);">har</span><span style="color: rgb(95,130,107);">、</span><span style="color: rgb(95,130,107);">hsp</span></span>
<span id="ZH-CN_TOPIC_0000002594631988__ph24171169262"><span style="color: rgb(95,130,107);">#  name: 'OHMUrlCheck'</span></span>
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d9/v3/pt8wXqpST2WN7BFm4ageOw/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260624T020657Z&HW-CC-Expire=86400&HW-CC-Sign=78CBEFF9F71F3DDA92E5AE7D6A3ED5285793DD90AC14860B8C1034BD4B7F6732)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/FycrhybVT6KvuK0D6t6Z9w/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260624T020657Z&HW-CC-Expire=86400&HW-CC-Sign=8E675A70C66D7FEC726D6A6990E37DF5B00BF877C5AD53FA95D63A95951EE6F1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a5/v3/XP-lHm8sRY-JoIwHVa2gxw/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260624T020657Z&HW-CC-Expire=86400&HW-CC-Sign=2F684A0838747ECAFFE88A6DE672D01F73644B1AD5232F2955DC823A7AF878C6)
