...
在当前的工作目录导出记录了DB数据的export_userInfo_xxx.zip文件，其中包含加密组件和下面的10张数据表。 usergroup_memberpublic_keyaccess_tokenuplinkuplink_proxyreporepo_permissionvalidation_configsystem_security
