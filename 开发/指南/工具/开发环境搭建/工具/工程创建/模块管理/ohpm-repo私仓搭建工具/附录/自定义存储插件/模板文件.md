...
export class CustomStorage implements StoragePlugin {
   ...
   */
  async save(srcPath: string, packageInfo: any): Promise{
   ...
   */
  async delete(savedResponse: string): Promise{
   ...
   */
  async download(savedResponse: string): Promise{
 ...
 /**
   ...
   */
  async getDownloadUrl(savedResponse: string): Promise{
