...
对于C/C++代码，可通过内置的Clang-Tidy或自定义的Clang-Tidy对代码进行实时检查，实时检查前需完成选项配置，配置操作请参考[Clang-Tidy代码检查](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-clang-tidy)。
