...
3. 点击**Enable open capabilities** **+**，在DevEco Studio上开通[开放能力](https://developer.huawei.com/consumer/cn/doc/app/agc-help-create-app-0000002247955506#section1817619495251)，开放能力接入方式包括默认开启、直接开启、申请开启。当前支持的开放能力请参考[自动签名支持的开放能力](#section179851045217)。
...
6. （可选）添加ACL权限信息，ACL权限清单请参考[自动签名支持的ACL权限](#section5301916183411)。
...
7. 检验和申请ACL权限。**26.0.0 Beta1及以上版本**

  Enable ACL Permissions +下会显示配置文件中添加的ACL权限，点击**Enable ACL Permissions**** +**，在ACL Permission Configuration窗口会显示未申请的ACL权限，填写申请理由（Request reason）和附件（Attachment）等，点击**OK。**在AGC中查看权限申请进度，具体请参考[申请ACL权限](https://developer.huawei.com/consumer/cn/doc/app/agc-help-apply-acl-0000002394212138#section156171230179)。
...
![](assets/配置调试签名/file-20260514132937195-15.png)
  ...
  **26.0.0 Beta1以下版本**
  ...
  修改配置文件后，在签名界面点击**OK**，若应用已在AGC申请该权限则签名成功；若应用未申请该权限，会导致签名失败，点击Notice弹窗中"**submit a permission request in AppGallery Connect**"或"**Submit**"，跳转至AGC申请权限，然后再返回DevEco Studio界面重新签名。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/mTbVEyhcQBiFPTEd6ae-HQ/zh-cn_image_0000002625074099.png?HW-CC-KV=V1&HW-CC-Date=20260723T012118Z&HW-CC-Expire=86400&HW-CC-Sign=5AF2DC0131949CA4CE98FFEFAC64732501D5CA3915D38FC3DE975F59B5036CF5)


16. 单击**Finish**，创建CSR文件成功，可以在存储路径下获取生成的密钥库文件（.p12）、证书请求文件（.csr）和material文件夹（存放密码加密材料等）。

  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/3SphJ7atRoaj3z77rUh7vw/zh-cn_image_0000002594474598.png?HW-CC-KV=V1&HW-CC-Date=20260723T012118Z&HW-CC-Expire=86400&HW-CC-Sign=9295282DDB0B38F03FF869903F70D55C5EA6C07AC612683DA27C0451D3375D1F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/52/v3/oet197B-RMqGJo1zkgvIiQ/zh-cn_image_0000002625074093.png?HW-CC-KV=V1&HW-CC-Date=20260723T012118Z&HW-CC-Expire=86400&HW-CC-Sign=6DFE13CE5756C958EF0B902F3B7ABC341F4DE3C498CBC994BE7E05C576E38900)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3a/v3/2Q-GnmV-TVC__sdh8RwxGA/zh-cn_image_0000002624993945.png?HW-CC-KV=V1&HW-CC-Date=20260723T012118Z&HW-CC-Expire=86400&HW-CC-Sign=054280AF84854142270011240DB68A93EB94B3A442FA3E92A80FF0B79A630BC0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/Oye-0mpISFCAMalMnt6R2w/zh-cn_image_0000002594474592.png?HW-CC-KV=V1&HW-CC-Date=20260723T012118Z&HW-CC-Expire=86400&HW-CC-Sign=15C306238144267F7A54AE9A151D8770F84103F3A3AF95D7108D32184C4F88DD)
