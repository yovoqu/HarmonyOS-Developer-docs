...
3. 如果没有配置debug字段，则根据build-profile.json5的debuggable字段判断应用是否支持调试。       
...
4. false：应用不支持调试。当编译模式为release时，debuggable的缺省值是false，即不支持调试。
...
DebugLine Support：勾选Enable DebugLine表示在构建产物中系统组件增加debugline属性，用于开启[ArkUI Inspector源码跳转](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-arkui-inspector#section1226015494335)功能。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/MKlmBadaRWKrQ6LH7TsndQ/zh-cn_image_0000002624994323.png?HW-CC-KV=V1&HW-CC-Date=20260624T020710Z&HW-CC-Expire=86400&HW-CC-Sign=85E89E87707C976B0B2D5425240A3DF59BA6AF20435006F014A4ACFF999285DC)
