...
7. **Sampling Stack**：从DevEco Studio 6.1.1 Beta1版本开始，新增Sampling Stack页签，对应[AppFreeze增强日志中的堆栈信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/appfreeze-guidelines#appfreeze应用冻屏增强日志信息采样栈)，用于查看采样栈数据，标记可疑问题栈，具体请参考[查看采样栈数据信息](#section1731022185212)。
...
![](assets/查看AppFreeze（应用冻屏）日志/file-202607081041059c12d290.png)
...
![](assets/查看AppFreeze（应用冻屏）日志/file-20260708104105ead2946e.png)
