...
| 规则体检下的UX测试 | API 20及以上的双折叠、三折叠手机和模拟器API 20及以上的Pura X Max手机和模拟器 | 从DevEco Studio 6.0.2 Beta1版本开始，支持三折叠模拟器。 从DevEco Studio 6.1.0 Release版本开始，支持双折叠模拟器。 |
| 场景化体检下的多设备测试 | API 20及以上的双折叠、三折叠手机和模拟器API 20及以上的Pura X Max手机和模拟器 | 从DevEco Studio 6.0.2 Beta1版本开始，支持三折叠模拟器。 从DevEco Studio 6.1.0 Release版本开始，支持双折叠模拟器。 |
