...
> [!NOTE] 说明
> include的优先级比exclude高。

| 字段名称 | 可选/必选 | 类型 | 适用的覆盖率测试 | 含义 |
| --- | --- | --- | --- | --- |
| include | 可选 | 字符串数组 | 黑盒覆盖率测试 仪器覆盖率测试 本地覆盖率测试 | 配置参与覆盖率测试的文件或文件夹路径。 26.0.0 Beta2及以上版本：字段可选，路径配置支持以下通配符。*：匹配文件名中的任意数量字符。**：匹配任意文件夹。?：匹配文件名的单个字符。 26.0.0 Beta2以下版本：字段必选，仅支持模块名开头的路径，不支持通配符。 |
...
3. reportPath：指定的覆盖率报告文件生成路径。

4. bjc_cov_yyyyMMdd_HHmmss_SSS.json：指定上一个步骤LocalPath目录下的一份最新的json文件，格式以bjc_cov开头，yyyyMMdd_HHmmss_SSS表示年月日_时分秒_毫秒。

5. 在本地找到报告文件路径并在浏览器中打开，查看代码覆盖率详情，关于覆盖率的计算方式请参考[查看覆盖率报告](#section10394362109)。
...
- 绿色：语句/函数覆盖。
- Nx：表示当前可执行代码行被执行了N次。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/df/v3/j-ZTLwNvQB2ph8L4vzrSDg/zh-cn_image_0000002677996485.png?HW-CC-KV=V1&HW-CC-Date=20260730T071819Z&HW-CC-Expire=86400&HW-CC-Sign=13A10CC02190B3A66982913E53AD1C0AE7AA26D4C71E06C93A676576A9FEAACF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/l7Usb7VGSSWk6cPnX7GGGQ/zh-cn_image_0000002647916724.png?HW-CC-KV=V1&HW-CC-Date=20260730T071819Z&HW-CC-Expire=86400&HW-CC-Sign=B8C181BE2AC773B936F62B048A8B470991604743A3987E0C9D7A832AF6F76FE4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d2/v3/rBTF2i66TiON4y9CHjHLwg/zh-cn_image_0000002648076620.png?HW-CC-KV=V1&HW-CC-Date=20260730T071819Z&HW-CC-Expire=86400&HW-CC-Sign=63E81F330886ECA804E4D25DE0769EF2BDEFE9FC0CEFB02DA8A1A382D3990382)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bd/v3/BsPfGYxmRXCLJsYmTicAAQ/zh-cn_image_0000002647916722.png?HW-CC-KV=V1&HW-CC-Date=20260730T071819Z&HW-CC-Expire=86400&HW-CC-Sign=A43793A58BD598EC5803F62967D19C3C2C61A25C7CB3C8FEB0EE1F7B1964A841)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/81/v3/P7cwV6YZRUKGJu9yc8OXJg/zh-cn_image_0000002678156333.png?HW-CC-KV=V1&HW-CC-Date=20260730T071819Z&HW-CC-Expire=86400&HW-CC-Sign=F0F361DC46473D1B7053D0A0E2B49658C5C7A875748E3FA26029B40DFD75DAC0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c7/v3/IhbTwV1CSvyeN4pxdgUCPg/zh-cn_image_0000002678156329.png?HW-CC-KV=V1&HW-CC-Date=20260730T071819Z&HW-CC-Expire=86400&HW-CC-Sign=DA055807D89C67FBDEF9CE036BFB9E15FAA100000AC65FDDCC47AD837B3E12FD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d1/v3/W-oMKIEDTg-T7aWcE2deUw/zh-cn_image_0000002648076622.png?HW-CC-KV=V1&HW-CC-Date=20260730T071819Z&HW-CC-Expire=86400&HW-CC-Sign=C06873079B3DACB6F859871AF6B96323DE7273019FE8D04CBFB78A2052353D85)
