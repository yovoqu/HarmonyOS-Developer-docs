...
```text
proxy=http://user:password<strong>@</strong>proxy.proxyserver.com:port
https-proxy=http://user:password<strong>@</strong>proxy.proxyserver.com:port
```
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/90/v3/TfnS7TqaTJSWpIgq5csVig/zh-cn_image_0000002594474452.png?HW-CC-KV=V1&HW-CC-Date=20260723T012122Z&HW-CC-Expire=86400&HW-CC-Sign=26BE1494E44682B29D5C93B066C91AFAC8737129E58AB40FD01BC3024CD598DB)
