...
- 在[hvigor-config.json5](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-hvigor-set-options)中配置daemon选项。
...
- 修改[hvigor-config.json5文件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-hvigor-set-options)中的maxOldSpaceSize配置。
- 执行命令修改守护进程内存，示例如下：
```bash
...
- 修改[hvigor-config.json5文件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-hvigor-set-options)中的maxSemiSpaceSize配置。
- 执行命令修改守护进程内存，示例如下：
```bash
...
- 修改[hvigor-config.json5文件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-hvigor-set-options)中的hvigor.daemon.idleTimeout配置。
