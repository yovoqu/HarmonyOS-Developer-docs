...
![](assets/构建任务说明/file-20260514133057863-0.png)

## HSP基础任务流程图

![](assets/构建任务说明/file-20260514133057863-1.png)

## HAR基础任务流程图

![](assets/构建任务说明/file-20260514133057863-2.png)
...
![](assets/构建任务说明/file-20260514133057863-3.png)
...
CompileArkTS/BuildArkTS   通过rollup调用loader编译ArkTS源码。PreviewArkTS   预览模式下，通过rollup调用loader编译ArkTS源码。HotReloadArkTS   热加载场景下，通过rollup调用loader编译ArkTS源码。OhosTestCompileArkTS/OhosTestBuildArkTS ohos测试场景下，通过rollup调用loader编译ArkTS源码。HarCompileArkTS/HarBuildArkTS   构建HAR包场景下，通过rollup调用loader编译ArkTS源码。UnitTestArkTS   单元测试场景下，通过rollup调用loader编译ArkTS源码。

## JS

CompileJS/BuildJS   调用loader编译js源码。OhosTestCompileJS/OhosTestBuildJS   ohos测试场景下，调用loader编译js源码。
