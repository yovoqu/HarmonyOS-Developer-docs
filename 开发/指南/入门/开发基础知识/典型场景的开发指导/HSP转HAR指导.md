...
> [!WARNING]
> 阅读本文前，请开发者完成 HSP 、 HAR 、 module.json5 、 hvigorfile.ts 、 oh-package.json5 、 build-profile.json5 学习。 部分组件和模块在HAP、HSP、HAR中集成使用时存在差异，例如 加载HAR中Worker线程文件相比HSP存在单独的使用约束 ，因此按照如下步骤完成HSP转HAR后，请关注对应组件和模块介绍并进行适配。
