...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/_Nd-vlK6TxS2_2pbAbEh1g/zh-cn_image_0000002685927707.png?HW-CC-KV=V1&HW-CC-Date=20260730T072032Z&HW-CC-Expire=86400&HW-CC-Sign=8799BC2FDBD1DD8AFFFD89E23634E3036DC5EE35FBAE52C66A5935678E8CA419)
...
3. 通过photoAccessHelper.PhotoViewPicker拉起图库选择图片，并且使用fileIo与image模块将URI转换为[PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap)，为后续超分接口准备输入数据。
...
4. 构造[Request](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/core-vision-image-super-resolution-api#imagesranalyzerprocess)对象并传入待处理图片的PixelMap，调用[ImageSRAnalyzer.process](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/core-vision-image-super-resolution-api#imagesranalyzerprocess)方法，获取超分处理结果并展示在界面上。
