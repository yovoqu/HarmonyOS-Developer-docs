...
2. 调用[clearUkeyPinAuthState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-huksexternalcrypto#huksexternalcryptoclearukeypinauthstate)清除PIN码认证状态。
