...
#### 开发步骤
1. 导入[@ohos.security.cert](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert)。
...
2. 基于已有的证书数据，创建待校验[X509Cert](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#x509cert)证书对象。
3. 调用[cert.createCertChainValidator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#certcreatecertchainvalidator)接口创建证书链校验器对象。
4. 创建[CertValidationParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#certvalidationparams)校验参数对象。
5. 调用[validateCert(cert: X509Cert, params: CertValidationParams): Promise&lt;CertValidationResult&gt;](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#validatecert)接口构建并校验证书链，返回校验成功的证书链[CertValidationResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#certvalidationresult)。
