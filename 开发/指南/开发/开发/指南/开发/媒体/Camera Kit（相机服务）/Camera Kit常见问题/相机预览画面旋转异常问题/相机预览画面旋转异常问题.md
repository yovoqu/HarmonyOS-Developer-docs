...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/camera-rotation-faq
...
1. 在会话配置过程中，未适配相机预览旋转接口：[getPreviewRotation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-camera-previewoutput#getpreviewrotation12)、[setPreviewRotation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-camera-previewoutput#setpreviewrotation12)。
2. 会话配置过程中的时序不正确，即调用相机预览旋转接口前未完成会话[commitConfig](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-camera-session#commitconfig11)。
...
参考文档：[适配相机旋转角度(ArkTS)](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/camera-rotation-angle-adaptation#预览)。
