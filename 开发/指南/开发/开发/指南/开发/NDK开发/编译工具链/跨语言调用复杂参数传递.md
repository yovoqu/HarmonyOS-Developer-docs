...
![](assets/跨语言调用复杂参数传递/file-202607081034427fd2d28b.png)
...
![](assets/跨语言调用复杂参数传递/file-202607081034428d48baaa.png)
...
3. 在DevEco Studio预生成的Init()函数中设置写好的数据传递函数。与[arrayBuffer类型数据交互](#arraybuffer类型数据交互)类同，此处不再赘述。

  **实现效果**

  
![](assets/跨语言调用复杂参数传递/file-202607081034436036aa67.png)
...
- 需在DevEco Studio预生成的Init()函数中设置写好的数据传递函数。与[arrayBuffer类型数据交互](#arraybuffer类型数据交互)类同，此处不再赘述。
...
![](assets/跨语言调用复杂参数传递/file-20260708103444edeb9cbe.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b3/v3/iqbJxTDhSOCHE1M7JBQYuA/zh-cn_image_0000002709646377.png?HW-CC-KV=V1&HW-CC-Date=20260818T063202Z&HW-CC-Expire=86400&HW-CC-Sign=E6A335EAC419CE9D468DEFA7A73DBEA00D9B6C3B94A25A2DD090FBCE86EAEBCE)
...
3. 需在DevEco Studio预生成的Init()函数中设置写好的数据传递函数。与[arrayBuffer类型数据交互](#arraybuffer类型数据交互)类同，此处不再赘述。
 
**实现效果**
 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/39/v3/d0rKENTgRdG2ghSVy1t0Tw/zh-cn_image_0000002679806702.png?HW-CC-KV=V1&HW-CC-Date=20260818T063202Z&HW-CC-Expire=86400&HW-CC-Sign=2084DDFC055A1970A69F7109095DB5111FD8D8E32D7775855D94CD781755BEF1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/df/v3/8PzMSii2QcSVc4Omp8whyQ/zh-cn_image_0000002709526519.png?HW-CC-KV=V1&HW-CC-Date=20260818T063202Z&HW-CC-Expire=86400&HW-CC-Sign=6C4EFF38FA88F97D4C014BD29CEE6EBD1ABA6D1D7861ADB3BAF09E8E3E401407)
