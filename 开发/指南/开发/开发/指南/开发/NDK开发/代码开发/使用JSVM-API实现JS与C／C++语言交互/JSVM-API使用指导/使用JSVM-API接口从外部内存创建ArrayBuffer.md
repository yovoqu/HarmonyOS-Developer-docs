...
![](assets/使用JSVM-API接口从外部内存创建ArrayBuffer/file-20260708103449e7f448b4.png)
...
| JSVM_FinalizeArrayBuffer finalizeCb | 可选参数。当ArrayBuffer被GC回收时调用的callback。回调签名含bool copied参数，指示是否发生了拷贝。byteLength==0时此参数应该传递NULL。 |
