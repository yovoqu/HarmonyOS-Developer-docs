...
![](assets/三方动态链接库集成/file-202607081034451d91bad9.png)


  
![](assets/三方动态链接库集成/file-2026070810344620840ac6.png)
...
![](assets/三方动态链接库集成/file-2026070810344694afc091.png)
...
![](assets/三方动态链接库集成/file-2026070810344778ad75a7.png)

2. 在ArkTS侧将so库的[应用沙箱目录](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-sandbox-directory)传递至Native侧。
...
![](assets/三方动态链接库集成/file-20260708103447d4a5cb77.png)
...
![](assets/三方动态链接库集成/file-20260708103448068aaef6.png)

2. 在src/main/cpp/types下新建目录并将so库模块src/main/cpp/types目录下的index.d.ts、oh-package.json5移动到该目录下。

  
![](assets/三方动态链接库集成/file-2026070810344849f4bd09.png)
...
![](assets/三方动态链接库集成/file-20260708103448f9d0f485.png)
...
![](assets/三方动态链接库集成/file-2026070810344979e73994.png)

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/BDRJ-EcARO-d0_9kIu39EA/zh-cn_image_0000002677667379.png?HW-CC-KV=V1&HW-CC-Date=20260723T012203Z&HW-CC-Expire=86400&HW-CC-Sign=506FC1E45C8FD611FF89A68F4FC64B20491964BE398E08F08F6882F1970B1AE7)
