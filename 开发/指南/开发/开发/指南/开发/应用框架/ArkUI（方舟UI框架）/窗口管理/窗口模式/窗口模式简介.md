...
> [!NOTE]
> 应用子窗口仅在 自由窗口 状态下支持FULL_SCREEN与MAXIMIZE模式，且需要在创建子窗时将maximizeSupported参数配置为true；或者通过 setSupportedWindowModes() 配置支持。 FULL_SCREEN与MAXIMIZE的主要差异： FULL_SCREEN：窗口铺满整个屏幕；在 自由窗口 状态下，无dock栏、状态栏和标题栏显示；在非 自由窗口 状态下，无dock栏和标题栏显示。 MAXIMIZE：窗口铺满整个屏幕，有dock栏、状态栏和标题栏显示。 MAXIMIZE模式仅在 自由窗口 状态下生效。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/VaJjhMZhQ4uprEYKx0GkGg/zh-cn_image_0000002686086191.png?HW-CC-KV=V1&HW-CC-Date=20260730T072027Z&HW-CC-Expire=86400&HW-CC-Sign=A7741360CBFECCD8FAE68B86DD8E22642C7140BC9A6F00103BAFD65223AF1AFB)
...
| --- | --- | --- | --- |
| 1 | 通过setSupportedWindowModes()接口配置 | 应用主窗口、应用子窗口 | 仅在自由窗口状态下生效 |
