...
![](assets/组件复用问题诊断分析/file-2026070810363976c07f23.png)

3. 点击工具“手动性能页面滑动体检”，按照提示进行检测操作。

  
![](assets/组件复用问题诊断分析/file-20260708103639aded06d8.png)

4. 通过分析检测结果，结合滑动过程中列表卡片的创建次数，可以分析出当前列表的组件未使用复用或者复用未生效。

  
![](assets/组件复用问题诊断分析/file-20260708103639bb0cf37a.png)
...
![](assets/组件复用问题诊断分析/file-2026070810364099f88843.png)
...
![](assets/组件复用问题诊断分析/file-20260708103640a9ab14c5.png)
...
![](assets/组件复用问题诊断分析/file-2026070810364199f88843.png)
...
![](assets/组件复用问题诊断分析/file-20260708103641a9ab14c5.png)
...
![](assets/组件复用问题诊断分析/file-202607081036424d427372.png)
...
![](assets/组件复用问题诊断分析/file-20260708103642ad6ace77.png)
...
![](assets/组件复用问题诊断分析/file-20260708103642c6dc2388.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/lihtKGn6QsK9m8-W-PClxQ/zh-cn_image_0000002656005798.png?HW-CC-KV=V1&HW-CC-Date=20260730T072026Z&HW-CC-Expire=86400&HW-CC-Sign=BA08866A68623F5993716515F5FE48590B47027DEB2847CCEFD616CA9946448C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/59/v3/EvMu1oRXTz-o2oZq66rUtQ/zh-cn_image_0000002655845878.png?HW-CC-KV=V1&HW-CC-Date=20260730T072026Z&HW-CC-Expire=86400&HW-CC-Sign=9008651AAD4F270FE8BA3C7AD42B0142E94A3D42580FC8868399C0BF41906623)

 
上述案例中，BuildRecycle是典型的复用成功回调，此处执行耗时过长造成了应用丢帧，虽然当前操作在帧间，但是长耗时仍然会影响下一帧的执行。通过耗时函数检测，可以定位到具体的耗时方法。
 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/j9wSipsNSpuEyCZd1IdpIQ/zh-cn_image_0000002686085307.png?HW-CC-KV=V1&HW-CC-Date=20260730T072026Z&HW-CC-Expire=86400&HW-CC-Sign=2989FFC90FC98D64072075F9B396C619ACA6E61861F70897A81B5B416AD121EF)
