...
![](assets/全局复用：集中化的组件回收与复用/file-20260708103637258842db.png)
...
![](assets/全局复用：集中化的组件回收与复用/file-20260708103637806f3ea5.png)
...
具体shared复用池示例代码，参考使用场景：[多个父组件间共享复用池](#多个父组件间共享复用池)。
...
![](assets/全局复用：集中化的组件回收与复用/file-2026070810363818c5ee1c.gif)


具体perInstance复用池示例代码，参考使用场景：[使用@Provider/@Consumer的独立复用池](#使用providerconsumer的独立复用池)。
...
![](assets/全局复用：集中化的组件回收与复用/file-202607081036382dcbc169.gif)
...
![](assets/全局复用：集中化的组件回收与复用/file-202607081036386c917f6e.gif)
...
![](assets/全局复用：集中化的组件回收与复用/file-20260708103638bdb6debd.gif)
...
![](assets/全局复用：集中化的组件回收与复用/file-20260708103638e0be59a8.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3f/v3/AwSDSnIaQ4aPlZLyYhO2kQ/zh-cn_image_0000002704271731.gif?HW-CC-KV=V1&HW-CC-Date=20260813T095859Z&HW-CC-Expire=86400&HW-CC-Sign=2EF0BECA45D84C7E318D0D7571A54CF92AE8D0182AD7D05B9DB0524645300953)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/E4ZJcK66RcCGtoJvo9ZHHQ/zh-cn_image_0000002674471930.gif?HW-CC-KV=V1&HW-CC-Date=20260813T095859Z&HW-CC-Expire=86400&HW-CC-Sign=0C0A39BF1F2594F87D08619B7858002E767F7142882443BA894F99CF1A67581F)
