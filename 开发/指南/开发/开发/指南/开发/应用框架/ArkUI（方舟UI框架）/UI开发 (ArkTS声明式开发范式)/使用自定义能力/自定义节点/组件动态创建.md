...
![](assets/组件动态创建/file-202607081036443af806c5.png)
...
![](assets/组件动态创建/file-202607081036444ca21d0c.png)
...
![](assets/组件动态创建/file-20260708103645a6b57d41.png)
...
![](assets/组件动态创建/file-20260708103645b926843f.png)
...
![](assets/组件动态创建/file-20260708103645cbdb4600.jpg)

2. 以上示例场景在FrameNode扩展模式下的完成时延为6.1ms（根据设备和场景不同，数据会有差异，本数据仅供参考），如下图所示。

  
![](assets/组件动态创建/file-20260708103645e95ddbad.png)
