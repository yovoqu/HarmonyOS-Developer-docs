...
![](assets/模块化调试工具/file-202607081036483980225f.png)
...
![](assets/模块化调试工具/file-20260708103648e7f448b4.png)
...
![](assets/模块化调试工具/file-202607081036498007a41a.png)

3. 打开trace文件并选择需要查看的应用

  
![](assets/模块化调试工具/file-20260708103649953c358d.png)
...
![](assets/模块化调试工具/file-202607081036499d85e460.png)

 
执行的文件以及so在SourceTextModule::Evaluate下。
 

![](assets/模块化调试工具/file-2026070810365088b50281.png)

 
选中需要分析的区域，会在下方生成表格。可以根据表格数据对耗时长的文件进行性能优化。
 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/4-PlwPEMQi29xD_mydimWw/zh-cn_image_0000002674471896.png?HW-CC-KV=V1&HW-CC-Date=20260813T095858Z&HW-CC-Expire=86400&HW-CC-Sign=3F2FAF67EA757A91E8B2C265DC2F06F7DBA1F8C8D5E97243988980E27A04CF42)
