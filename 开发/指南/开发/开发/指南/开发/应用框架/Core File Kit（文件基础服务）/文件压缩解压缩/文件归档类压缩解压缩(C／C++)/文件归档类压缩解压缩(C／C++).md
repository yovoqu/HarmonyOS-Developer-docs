...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/archive-file-compression-guidelines
...
#### 约束限制
 ...
 - 压缩解压缩接口的输入输出路径均为沙箱路径，具体请参考[应用沙箱目录](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-sandbox-directory)。
 - 当前仅支持ZIP格式的归档文件。
