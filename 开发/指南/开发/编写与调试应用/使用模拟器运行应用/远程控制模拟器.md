...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/e6JnzprHSgeMtXOeJVbErQ/zh-cn_image_0000002594471352.png?HW-CC-KV=V1&HW-CC-Date=20260701T041508Z&HW-CC-Expire=86400&HW-CC-Sign=144FA41FF91D54D85F2C703B9FB470A4A868338C8B053FD88806690C9654F257)

 
工作流程主要包括：
 1. 启动RPC服务器模式：在目标服务器上，启动模拟器RPC服务器模式，以便客户端连接使用。
2. 客户端创建会话：客户端通过指定服务端IP和端口号，以及安全认证命令，创建会话连接到服务端。
3. 执行命令：客户端和服务端成功连接后，客户端可查询会话信息和模拟器实例信息，执行模拟器启动停止、场景化等命令，操控服务端上已存在的模拟器。
