...
![](assets/动态轨迹/file-20260514132022419-0.gif)
...
| [addTraceOverlay](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapcomponentcontroller#addtraceoverlay)(params: [mapCommon.TraceOverlayParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#traceoverlayparams), markers?: Array): Promise | 绘制动态轨迹。 |
  ...
  aboutToAppear(): void {
    ...
    this.callback = async (err, mapController) => {
      ...
      if (!err) {
        ...
        let resourceArray: Array = new Array();
        ...
        let resourceArray2: Array = new Array();
        // 需要替换您自己的资源图片，存放在resources/base/media目录下
