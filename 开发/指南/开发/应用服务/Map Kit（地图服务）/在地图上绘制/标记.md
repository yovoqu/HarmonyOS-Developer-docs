...
本章节将向您介绍如何在地图的指定位置添加标记以标识位置、商家、建筑等。 点标记用来在地图上标记任何位置，例如用户位置、车辆位置、店铺位置等一切带有位置属性的事物。Map Kit提供的点标记功能（又称 Marker）封装了大量的触发事件，例如点击事件、长按事件、拖拽事件。 Marker有默认风格，同时也支持自定义。由于内容丰富，以下只能展示一些基础功能的使用。 5.1.1(19)开始，支持控制Marker文字显隐功能。 6.0.0(20)开始，支持自定义组件实现Marker图标功能。 6.1.1(24)开始，支持监听Marker长按事件。
![](assets/标记/file-20260514132013008-0.jpg)
...
| [addMarker](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapcomponentcontroller#addmarker)(options: [mapCommon.MarkerOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#markeroptions)): Promise | 在地图上添加标记。 |
...
![](assets/标记/file-20260514132013008-1.jpg)
在添加标记之后，修改已经设置的标记属性。
```text
// 设置标记可拖拽
...
![](assets/标记/file-20260514132013008-2.jpg)
...
**图1** 隐藏Marker文字之前
![](assets/标记/file-20260514132013008-3.jpg)
**图2** 隐藏Marker文字之后
![](assets/标记/file-20260514132013008-4.jpg)
...
![](assets/标记/file-20260514132013008-5.gif)
...
通过如下步骤设置监听标记拖动事件： 将[Marker](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-marker)的拖拽属性设置为true。 调用[on(type: 'markerDragStart' , callback: Callback)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapeventmanager#onmarkerdragstart)方法监听标记是否开始拖拽。 调用[on(type: 'markerDrag' , callback: Callback)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapeventmanager#onmarkerdrag)，监听标记拖动过程。 调用[on(type: 'markerDragEnd' , callback: Callback)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-mapeventmanager#onmarkerdragend)，监听标记拖动结束事件。
```text
// 设置标记可拖拽
this.marker.setDraggable(true);
...
![](assets/标记/file-20260514132013008-6.jpg)
...
![](assets/标记/file-20260514132013008-7.jpg)
...
展示效果如图：
![](assets/标记/file-20260514132013008-8.gif)
...
展示效果如图：
![](assets/标记/file-20260514132013008-9.gif)
...
展示效果如图：
![](assets/标记/file-20260514132013008-10.jpg)
