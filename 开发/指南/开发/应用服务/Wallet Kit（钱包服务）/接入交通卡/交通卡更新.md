...
![](assets/交通卡更新/file-20260514132223111-0.png)
 ...
 - 开发者的app可调用[updateTransitCard](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/wallet-wallettransitcard#updatetransitcard)接口发起更新处理过程。如更新过程出现异常导致失败，开发者的app会收到相应的错误码，可参考[ArkTS API错误码](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-wallet)。
