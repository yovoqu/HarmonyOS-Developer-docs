...
调用[StorageBucket.getDownloadURL](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudstorage#getdownloadurl)接口获取云侧文件的下载地址。 完整示例代码如下：
```text
