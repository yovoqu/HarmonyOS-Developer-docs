...
![](assets/构建阅读器/file-20260514132136322-0.png)
...
| [init](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/reader-read-core#init)(context: common.UIAbilityContext): Promise | 初始化ReadPageComponent控制器。          初始化接口需要优先于ReaderComponentController的其他接口之前执行。 |
...
| [startPlay](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/reader-read-core#startplay)(spineIndex: number, domPos: string): Promise | 以指定阅读进度打开书籍，使用Promise异步回调。          需要在registerBookParser接口调用之后执行。 |
