...
![](assets/开发概述/file-20260514131802249-0.jpg)
业务流程中各任务描述如下：
| 序号 | 任务 | 详情 |
| --- | --- | --- |
...
应用需要在应用市场上架。 接入应用归因服务的所有开发者应严格遵循法律法规、已签署的协议条款和开发者文档的要求处理用户的个人信息。 禁止通过应用归因服务上报、透传个人信息。 应用归因服务接入调试功能接口当前支持ARM版本、X86版本的模拟器。 应用归因服务支持Phone、Tablet设备。并且从6.1.0(23)版本开始，新增支持PC/2in1、TV设备。
