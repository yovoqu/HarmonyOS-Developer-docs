...
> [!NOTE]
> 配置签名信息 时，请使用手动签名方式。 接入数字商品服务，需要 添加公钥指纹 。
...
> [!NOTE]
> 用户购买商品后，服务器会在订单/订阅场景的某些关键事件发生时通知您配置的事件通知地址，具体可参见 服务端关键事件通知 。 调试阶段必须 申请调试证书 、 注册设备 、开启和激活“应用内购买服务”后需要重新 申请调试Profile ，并完成 手动签名 。 发布阶段必须 申请发布证书 、开启和激活“应用内购买服务”后需要重新 申请发布Profile ，并完成 手动签名 。
