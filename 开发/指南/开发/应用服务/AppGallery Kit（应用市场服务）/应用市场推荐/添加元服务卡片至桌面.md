...
用户使用元服务卡片加桌功能。 应用调用AppGallery Kit的[loadService](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-productviewmanager#productviewmanagerloadservice)接口。 AppGallery Kit API获取应用传入的信息，生成展示页面。 展示生成的页面给用户，用户点击“添加至桌面”按钮，将元服务卡片添加至桌面。
