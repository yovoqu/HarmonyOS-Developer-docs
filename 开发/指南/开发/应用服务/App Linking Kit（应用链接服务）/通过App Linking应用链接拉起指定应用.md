...
> [!NOTE]
> 该能力目前仅适用于5.0.0(12)及以上版本的HarmonyOS应用，如果开发的是元服务，请参考 使用元服务链接跳转元服务 。
...
4. 方式二：[通过openLink接口拉起](#通过openlink接口拉起)。

5. 方式三：[通过系统浏览器或ArkWeb拉起](#通过系统浏览器或arkweb拉起)。

6. 方式四：[通过系统级扫码入口拉起](#通过系统级扫码入口拉起)。
