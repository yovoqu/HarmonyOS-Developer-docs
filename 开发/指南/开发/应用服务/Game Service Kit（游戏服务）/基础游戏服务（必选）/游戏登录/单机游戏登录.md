...
4. 游戏顶部弹出欢迎横幅，并向游戏返回accountName（选择华为账号登录返回值为hw_account）、accountIdentifier（选择华为账号登录返回值为hw_account）、gamePlayerId等信息。
...
![](assets/单机游戏登录/file-20260708103347d56b5a6c.png)
...
![](assets/单机游戏登录/file-202607081033470726041a.png)
...
![](assets/单机游戏登录/file-2026070810334796665582.png)
