...
![](assets/搜索关键字/file-20260514132111686-0.jpg)
...
| 接口名 | 描述 |
| --- | --- |
| [searchKey](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pdf-arkts-pdfviewmanage#searchkey)(text: string, listener: Callback): void | 搜索文本并返回匹配的总数。 |
