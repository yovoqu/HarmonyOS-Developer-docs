...
![](assets/添加、删除水印/file-20260514132109826-0.png)
...
![](assets/添加、删除水印/file-20260514132109826-1.png)
...
**添加文本水印** 调用loadDocument方法，加载PDF文档。 实例化文本水印TextWatermarkInfo类，并设置相关属性，包括字体、大小、旋转，位置等。 调用addWatermark，添加文本水印。 保存PDF文档到应用沙箱。 **删除文本水印** 调用loadDocument方法，加载PDF文档。 调用removeWatermark，删除文本水印。 保存PDF文档到应用沙箱。
```text
...
**添加图片水印** 调用loadDocument方法加载PDF文档。 实例化图片水印ImageWatermarkInfo类，并设置相关属性，包括缩放、旋转、透明度和位置等。 调用addWatermark添加图片水印。 保存PDF文档到应用沙箱。 **删除图片水印** 调用loadDocument方法加载PDF文档。 调用removeWatermark删除图片水印。 保存PDF文档到应用沙箱。
```text
import { pdfService } from '@kit.PDFKit';
import { hilog } from '@kit.PerformanceAnalysisKit';
