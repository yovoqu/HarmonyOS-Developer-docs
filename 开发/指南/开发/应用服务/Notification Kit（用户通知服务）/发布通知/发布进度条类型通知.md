...
目前系统模板仅支持进度条模板，通知模板[NotificationTemplate](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-notification-notificationtemplate)中的data参数为用户自定义数据，用于显示与模板相关的数据。


#### 接口说明

[isSupportTemplate()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-notificationmanager#notificationmanagerissupporttemplate)是查询是否支持对应的通知模板，目前仅支持进度条模板。
