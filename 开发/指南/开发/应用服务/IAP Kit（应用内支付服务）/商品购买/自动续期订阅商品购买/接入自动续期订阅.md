...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/aVXDtmpvS_iOJalSn3CYOQ/zh-cn_image_0000002611754963.png?HW-CC-KV=V1&HW-CC-Date=20260528T030058Z&HW-CC-Expire=86400&HW-CC-Sign=9738326EA5F0970EB6554D6602D49B12F60EF126ECE52DE589A8AC5A1278F4BC)
...
4. 应用服务器对[PurchaseData.jwsSubscriptionStatus](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-data-model#purchasedata)进行[解码验签](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-verifying-signature#jws解码和验签)，成功后可得到[SubGroupStatusPayload](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-data-model#subgroupstatuspayload)的JSON字符串。
...
> [!NOTE]
> 为了提高安全性，建议应用服务器接入 服务端关键事件通知 以接收购买成功结果并通过应用服务器来处理 解码验签 、完成购买等操作。 请务必确保发货成功后再执行完成购买步骤，本步骤可通过请求服务端 订阅确认发货 接口来确认发货，完成购买流程。
