...
| 接口名 | 描述 |
| --- | --- |
| [setWorkspaceProfilePhoto](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/enterprisespace-spacemanager#setworkspaceprofilephoto)(workspaceId: number, photo: string): Promise | 设置工作空间资料照片。使用Promise异步回调。 |
