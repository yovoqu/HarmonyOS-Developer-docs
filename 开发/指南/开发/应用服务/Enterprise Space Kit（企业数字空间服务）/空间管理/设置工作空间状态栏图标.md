...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/enterprisespace-set-workspace-status_bar_icon

## 场景介绍

从6.1.0(23)开始，支持设置工作空间图标的能力。 Enterprise Space Kit为应用提供设置工作空间图标。所有工作空间都可以设置图标，可以展示在状态栏中。
