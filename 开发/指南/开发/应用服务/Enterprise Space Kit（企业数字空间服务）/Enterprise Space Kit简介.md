...
提供企业安全管控类[MDM](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/mdm-kit)应用设置空间数据外发审批信息、获取审批内容的能力，便于企业根据自身安全管控要求管理并审批空间文件外发事件。其中审批信息可包含文件信息、文件状态、文件发送对象、文件发送时间等信息。  提供统一的空间管理能力、下发空间管理策略，包括创建工作空间、移除工作空间、订阅空间事件等能力，便于企业根据自身业务需求配置管理。
