...
3. 请求单广告位广告。
  ...
  需要先创建一个AdLoader对象，通过AdLoader的[loadAd](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/apis-ads-kit/js-apis-advertising#loadad)方法请求广告，最后通过[AdLoadListener](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/apis-ads-kit/js-apis-advertising#adloadlistener)，来监听广告的加载状态。
...
3. 使用reward_ad_data作为key值获取奖励信息，其中：
属性rewardType用来获取奖励物品的名称。

4. 属性rewardAmount用来获取奖励物品的数量。
...
2. 展示广告。
  ...
  开发者需要调用[showAd](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/apis-ads-kit/js-apis-advertising#advertisingshowad)方法来展示广告，ads为[请求广告](#请求广告)返回的广告信息，在每次展示广告前需要注册[事件订阅](#事件订阅)中定义的监听器。
...
![](assets/激励广告/file-20260514131749209-4.png)
...
![](assets/激励广告/file-20260708103408c00d005e.png)


  通过点击上图所示的“获取密钥”按钮弹出如下所示的弹框，获取“开发者ID”和“密钥”。

  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/4UDsghm_RgWG1p9zZKnJqA/zh-cn_image_0000002674633446.png?HW-CC-KV=V1&HW-CC-Date=20260813T095839Z&HW-CC-Expire=86400&HW-CC-Sign=35D44FB8E72F5F66EE390CD8E3DC6C3923F52D42FFE61665157B917B10311CA7)
