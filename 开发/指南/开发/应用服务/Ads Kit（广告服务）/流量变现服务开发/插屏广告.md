...
![](assets/插屏广告/file-20260514131749778-0.png)
...
事件订阅。 开发者需要在应用中订阅com.huawei.hms.pps.action.PPS_INTERSTITIAL_STATUS_CHANGED事件来监听插屏广告页面变化。 在订阅到公共事件后，可以从[CommonEventData](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-commonevent-commoneventdata)的parameters参数中使用interstitial_ad_status作为key值获取插屏广告页面变化状态。 涉及的页面变化状态如下所示：
| 页面变化状态 | 说明 |
| --- | --- |
| onAdOpen | 打开广告。 |
| onAdClick | 点击广告。 |
