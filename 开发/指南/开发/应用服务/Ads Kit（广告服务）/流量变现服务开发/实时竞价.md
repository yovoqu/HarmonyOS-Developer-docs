...
开发者需要在广告请求参数[AdRequestParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/apis-ads-kit/js-apis-advertising#adrequestparams)中添加实时竞价相关参数。
...
开发者需要在广告请求成功后的回调AdLoadListener.[onAdLoadSuccess](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/apis-ads-kit/js-apis-advertising#onadloadsuccess)或MultiSlotsAdLoadListener.[onAdLoadSuccess](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/apis-ads-kit/js-apis-advertising#onadloadsuccess)中，处理广告返回的实时竞价结果[Advertisement](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/apis-ads-kit/js-apis-advertisement#advertisement).biddingInfo。
