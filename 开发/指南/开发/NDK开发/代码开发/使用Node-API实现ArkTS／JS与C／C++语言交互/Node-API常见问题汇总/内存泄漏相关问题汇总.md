...
使用Node-API时导致内存泄漏的常见原因：
 1. napi_value不在napi_handle_scope管理中，导致napi_value持有的ArkTS对象无法释放，该问题常见于[直接使用uv_queue_work的场景](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/napi-guidelines#异步任务)中。解决方法是添加napi_open_handle_scope和napi_close_handle_scope接口。
