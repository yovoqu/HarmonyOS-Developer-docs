...
5. windows 系统环境下，cmake 安装路径为自己所配置的环境变量路径
...
![](assets/使用命令行CMake构建NDK工程/file-20260514132659219-2.png)
...
![](assets/使用命令行CMake构建NDK工程/file-20260514132659219-3.png)

 
这里使用的是cmake .. -G "Ninja" 引号里面跟的参数就是上图查看的环境所支持的生成器，这里ndk中自带的生成器是Ninja。
 

![](assets/使用命令行CMake构建NDK工程/file-20260514132659219-4.png)
...
![](assets/使用命令行CMake构建NDK工程/file-20260514132659219-5.png)
...
![](assets/使用命令行CMake构建NDK工程/file-20260514132659219-6.png)
...
![](assets/使用命令行CMake构建NDK工程/file-20260514132659219-7.png)

 
ninja -f build.ninja 或者用 cmake --build . 执行结果如下：
 

![](assets/使用命令行CMake构建NDK工程/file-20260514132659219-8.png)
