...
- [基于线程安全函数机制实现](#基于线程安全函数机制)
- [基于libuv异步库的uv_async_send()方法实现](#基于libuv异步库的uv_async_send方法)

 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4d/v3/0ADskVj4R7uro3V0jckbow/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025443Z&HW-CC-Expire=86400&HW-CC-Sign=793AEBA1B3A9F34341836CEFDAC5BA6F24E57BF424AB23111DE914F4E7E2EA18)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e9/v3/KJeLwoa3Ss68Ae1FQ0-eZA/zh-cn_image_0000002628702224.png?HW-CC-KV=V1&HW-CC-Date=20260701T025443Z&HW-CC-Expire=86400&HW-CC-Sign=C6E703EE55E3FA680CBB28CA9FFD2855933BFD7DCC963D6EE0699CD0E68C3831)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/69/v3/Y9mXQ1HURbadVEoncMV-RA/zh-cn_image_0000002659101453.png?HW-CC-KV=V1&HW-CC-Date=20260701T025443Z&HW-CC-Expire=86400&HW-CC-Sign=038F6C0741CEC6A931907E12A4171BF7532D1F66029E60244EBB8C1C26E28203)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/42/v3/ZdenNC5TR2C7FYbJXqT9sA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025443Z&HW-CC-Expire=86400&HW-CC-Sign=4EBEB9261CFEB7FB254653DF9C21EAE34BC501071A38ED27CACA53911BFBD60E)
...
- Native侧主线程中构建线程安全函数、保存上下文信息并拆分子线程
  threadSafeCase()接口接收到ArkTS传入的回调函数后通过napi_create_threadsafe_function()创建一个线程安全函数tsFn，tsFn会回调主线程中的ThreadSafeCallJs()方法，然后在ThreadSafeCallJs()方法中调用ArkTS侧传入的回调函数。
...
static void ThreadSafeCallJs(napi_env env, napi_value js_callBack, void *context, void *data) {
    CallbackContext *argContext = reinterpret_cast(data);
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/rOQJuPbRRcu4heii2DcJng/zh-cn_image_0000002628862104.png?HW-CC-KV=V1&HW-CC-Date=20260701T025443Z&HW-CC-Expire=86400&HW-CC-Sign=5EE4F2DB940AD0C1009745FC0CF00231204DBE9C6F812775ED2935DD9CF2407B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/lKTu6z34QwW6Q0o5dhqeXQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025443Z&HW-CC-Expire=86400&HW-CC-Sign=EC1C68B11828E2C7C118E9FB0AB615024A13B9E537C3BB0E19C1FD5AB705ED80)
...
- 在主线程中运行Loop执行async句柄绑定的函数，调用ArkTS侧传递的回调函数
...
void async_handler(uv_async_t *handle) {
    CallbackContext *context = static_cast(handle->data);
    ...
    if (scope == nullptr) {
        ...
        delete context;
        context = nullptr;
        uv_close(reinterpret_cast(handle), [](uv_handle_t *handle) { delete reinterpret_cast(handle); });
        return;
    }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/zyXx3F55QE2MWfJOkl-YOg/zh-cn_image_0000002659221415.png?HW-CC-KV=V1&HW-CC-Date=20260701T025443Z&HW-CC-Expire=86400&HW-CC-Sign=3C01FC5210D6F6DBB0E6AAFAD7695397FCE05C1F1D1D9991B5D16ACB6555A988)
