...
> [!NOTE]
> ArkTS的自定义绘制能力和示例请参考 自定义绘制修改器 (DrawModifier) 。
...
1. 通过[ArkUI_NativeNodeAPI_1](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1)的[createNode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#createnode)接口，传入[ArkUI_NodeType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h#arkui_nodecustomeventtype)中的ARKUI_NODE_CUSTOM枚举值创建自定义节点。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e2/v3/2cmsFVUmRACQ5JW0sSO0ZQ/zh-cn_image_0000002611754075.jpg?HW-CC-KV=V1&HW-CC-Date=20260528T030431Z&HW-CC-Expire=86400&HW-CC-Sign=266E84847E2083119470C0E9E13120143BDDE17EF94E36D6FD39D997D89BB51F)
