...
> [!NOTE]
> 需要执行的动画属性变化必须写在 ArkUI_ContextCallback 中的callback中。 需要执行的动画属性，必须在执行动画之前设置过。
...
2. 解析NodeContent，转换为C中的[ArkUI_NodeContentHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nodecontent8h)对象。
...
3. 获取[ArkUI_NativeAnimateAPI_1](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativeanimateapi-1)对象。
...
4. 设置[ArkUI_AnimateOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-animateoption)参数，通过提供的C方法设置对应的参数。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c8/v3/dko-4CyRQWiP9Tt2UR8h9A/zh-cn_image_0000002659219935.gif?HW-CC-KV=V1&HW-CC-Date=20260701T041457Z&HW-CC-Expire=86400&HW-CC-Sign=00F01806266B2037BDFE04D2C6604B0B47100B3CE6D843B09146A7E30FA5F359)
...
1. 创建可交互界面，界面中包含一个Button组件，点击可以控制转场节点的添加和移除。其中[ArkUI_NodeContentHandle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nodecontent8h)类型节点的获取与使用可参考[接入ArkTS页面](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ndk-access-the-arkts-page)。
...
2. 创建一个设置了[ArkUI_NodeAttributeType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h#arkui_nodeattributetype)中的NODE_ROTATE_TRANSITION，NODE_SCALE_TRANSITION属性的节点，当目标节点上下树时会播放转场动画。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/43/v3/tNRESePPQqO4Ydv9KewdWA/zh-cn_image_0000002628700740.gif?HW-CC-KV=V1&HW-CC-Date=20260701T041457Z&HW-CC-Expire=86400&HW-CC-Sign=DF3A747339680EA8AF35942ECB887D8DC5542AC85D5FCB9766CAACA9F0F35A34)
...
1. 创建一个设置了[ArkUI_NodeAttributeType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h#arkui_nodeattributetype)中的NODE_GEOMETRY_TRANSITION属性的image节点，同时设置该节点的宽度、高度和位置，用于区别于另一个image节点，然后将当前image节点挂载到一个父节点，当前示例中父节点为stack。
...
2. 再创建一个设置了[ArkUI_NodeAttributeType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h#arkui_nodeattributetype)中的NODE_GEOMETRY_TRANSITION属性的image节点，属性值与第一个image节点相同，同时为该节点设置不同的宽度、高度和位置。
...
3. 在stack的OnImageTransitionClicked监听回调函数中添加两个节点的上下树逻辑，控制节点的上下树，确保同时只有一个节点存在，同时，当其中一个节点挂载到父节点时需要重置[ArkUI_NodeAttributeType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h#arkui_nodeattributetype)中的NODE_GEOMETRY_TRANSITION属性的值，并重新设置为原来的值。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/aHHRCI9XSAy_Is2sxpAhZw/zh-cn_image_0000002659099969.gif?HW-CC-KV=V1&HW-CC-Date=20260701T041457Z&HW-CC-Expire=86400&HW-CC-Sign=EEE0571A344B99CC56BD5C4BF4390FC8A2A1DD881FC092EAB87A1B5BC676EE90)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/Y1FfvDFBThSZ8LcLybO59A/zh-cn_image_0000002628860620.gif?HW-CC-KV=V1&HW-CC-Date=20260701T041457Z&HW-CC-Expire=86400&HW-CC-Sign=0266461F96BB06D8AF230223ED08BF36E14D5ACA81811C42C21DC9304384CB57)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/81/v3/2cHRCZgfRvSUTAfps4eTdg/zh-cn_image_0000002659219937.gif?HW-CC-KV=V1&HW-CC-Date=20260701T041457Z&HW-CC-Expire=86400&HW-CC-Sign=96902F39BDDA44B83354AC69D69EBB7D943D5288B9B9B660CF22FD155077D625)
