...
| 需求场景 | 推荐方法 | 说明 |
| --- | --- | --- |
| 固定行列网格，部分项占多行多列 | [OH_ArkUI_GridLayoutOptions_RegisterGetRectByIndexCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-h#oh_arkui_gridlayoutoptions_registergetrectbyindexcallback) | 灵活控制每个项的位置和大小。 |
...
![](assets/使用网格/file-20260525091602609-001.png)
...
![](assets/使用网格/file-20260525091602610-002.gif)
