...
通过调用[createNode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#createnode)接口，并传入ArkUI_NodeType中的ARKUI_NODE_FLEX，创建Flex节点。如下示例将该节点封装为ArkUIFlexNode，并通过[setAttribute](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#setattribute)接口，使用NODE_FLEX_OPTION设置主轴方向、换行和对齐方式。ArkUI_NumberValue中的五个参数分别用于控制不同的弹性布局行为，具体可参考[FlexOptions对象说明](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-flex#flexoptions对象说明)。
...
如下示例为弹性容器添加了一组子组件。为展示换行和交叉轴对齐效果，为第三个子组件设置单独的高度和[alignSelf](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-flex-layout#alignself)。alignSelf是在弹性容器内生效的组件通用属性，将该属性设置封装到自定义接口SetAlignSelf中，通过NODE_ALIGN_SELF设置在指定组件上，可以控制单个子组件在父容器交叉轴的对齐格式，且优先级高于容器的[alignItems](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-flex#flexoptions对象说明)属性。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/02/v3/AMT1X0vHSQ6UOgk3p99SRA/zh-cn_image_0000002587108510.jpg?HW-CC-KV=V1&HW-CC-Date=20260604T013004Z&HW-CC-Expire=86400&HW-CC-Sign=CD9CBE1C2CF115B69480EA59DBAA5A08E0FBE768137CC2114881835A1159D6A5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/9JqCFXFuTGeP67LBiURquQ/zh-cn_image_0000002617668191.jpg?HW-CC-KV=V1&HW-CC-Date=20260604T013004Z&HW-CC-Expire=86400&HW-CC-Sign=1DC6C7F7B263A637115D335F234344BDAA750D5A0F861633A5963790DBC6E742)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/rNI-vLzXRAiYrwsDmYSy_Q/zh-cn_image_0000002587268416.jpg?HW-CC-KV=V1&HW-CC-Date=20260604T013004Z&HW-CC-Expire=86400&HW-CC-Sign=B06FB0A13F2FAF2EB37CE94262DDC44B30C9B9C0790BAC80FA4B50BEFDACD31F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/TcyxYpYDRyKfvBlAwUcsSw/zh-cn_image_0000002617708093.jpg?HW-CC-KV=V1&HW-CC-Date=20260604T013004Z&HW-CC-Expire=86400&HW-CC-Sign=E6BA6E7F39A09F33C33145DED638CA34C3AAE8D81836947D7EC5A6CFC1F9FB5F)
