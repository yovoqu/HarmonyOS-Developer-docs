...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ndk-build-form-components

ArkUI NDK提供了多种表单组件，包括[按钮（Button）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-common-components-button)、滑动条[Slider](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-slider)、[切换按钮（Toggle）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-common-components-switch)、多选框[Checkbox](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-checkbox)、多选框群组[CheckboxGroup](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-checkboxgroup)和[单选框（Radio）](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-common-components-radio-button)。这些组件是用户交互的基础元素，可以用于构建丰富的表单界面。

表单组件的相关接口定义在[native_node.h](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h)中。
...
使用[createNode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#createnode)接口创建Button组件，节点类型为ARKUI_NODE_BUTTON。
...
Button组件支持通过设置NODE_BUTTON_TYPE属性实现不同的按钮类型，包括普通按钮、胶囊按钮、圆形按钮和圆角矩形按钮。按钮类型对应枚举请参考[ArkUI_ButtonType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-h#arkui_buttontype)。
...
Button独有属性如下，具体说明请参考[ArkUI_NodeAttributeType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h#arkui_nodeattributetype)中的枚举定义。
...
使用[createNode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#createnode)接口创建Slider组件，节点类型为ARKUI_NODE_SLIDER。
...
Slider支持两种样式，通过[ARKUI_SliderStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-h#arkui_sliderstyle)枚举定义：
...
Slider独有属性如下，具体说明请参考[ArkUI_NodeAttributeType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h#arkui_nodeattributetype)中的枚举定义。
...
使用[createNode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#createnode)接口创建Toggle组件，节点类型为ARKUI_NODE_TOGGLE。
...
Toggle独有属性如下，具体说明请参考[ArkUI_NodeAttributeType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h#arkui_nodeattributetype)中的枚举定义。
...
使用[createNode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#createnode)接口创建Checkbox组件，节点类型为ARKUI_NODE_CHECKBOX。
...
Checkbox独有属性如下，具体说明请参考[ArkUI_NodeAttributeType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h#arkui_nodeattributetype)中的枚举定义。
...
CheckboxGroup独有属性如下，具体说明请参考[ArkUI_NodeAttributeType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h#arkui_nodeattributetype)中的枚举定义。
...
使用[createNode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-nativenodeapi-1#createnode)接口创建Radio组件，节点类型为ARKUI_NODE_RADIO。
...
Radio独有属性如下，具体说明请参考[ArkUI_NodeAttributeType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h#arkui_nodeattributetype)中的枚举定义。
