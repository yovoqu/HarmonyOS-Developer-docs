...
自行测算截断字符，并在行末添加...展开或者...图标作为组件内容。实现方式请参考[getParagraphs](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-uicontext-measureutils#getparagraphs20)的示例、[文本展开折叠](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-text-unfolding-and-folding)。
...
![](assets/使用文本常见问题/file-20260514130811927-3.png)
...
![](assets/使用文本常见问题/file-20260514130811927-5.png)
