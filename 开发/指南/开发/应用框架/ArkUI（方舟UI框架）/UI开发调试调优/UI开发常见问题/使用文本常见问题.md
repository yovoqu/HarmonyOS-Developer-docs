...
![](assets/使用文本常见问题/file-20260525091605842-001.gif)
**原因分析**
...
![](assets/使用文本常见问题/file-20260525091605842-002.gif)
...
![](assets/使用文本常见问题/file-20260525091605843-003.gif)
...
![](assets/使用文本常见问题/file-20260525091605843-004.png)
...
![](assets/使用文本常见问题/file-20260525091605843-005.png)
...
![](assets/使用文本常见问题/file-20260525091605843-006.png)
**解决措施二**
...
![](assets/使用文本常见问题/file-20260525091605843-007.gif)
...
![](assets/使用文本常见问题/file-20260525091605844-008.gif)
...
**解决措施**
1. 如果需要Text组件字重跟随系统设置变化，需要在configuration标签设置followSystem。
...
![](assets/使用文本常见问题/file-20260525091605844-009.gif)