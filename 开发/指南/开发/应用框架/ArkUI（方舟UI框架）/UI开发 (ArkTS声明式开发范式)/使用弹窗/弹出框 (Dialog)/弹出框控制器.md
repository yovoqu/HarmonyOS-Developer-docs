...
> [!NOTE]
> 一个弹出框控制器只能绑定一个弹出框，且操作只对该弹出框生效。 使用 getDialogController 获取弹出框控制器时，如果当前自定义组件不在弹出框中显示则获取为undefined。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/jxgN-Nq5T7uER51ZfUiY3Q/zh-cn_image_0000002581433974.gif?HW-CC-KV=V1&HW-CC-Date=20260528T014811Z&HW-CC-Expire=86400&HW-CC-Sign=AA7DFA56A820F5A84C48AEAAEBE72FD7C9AA3499177C7BB0342D85595EE62453)
