...
> [!NOTE]
> 由于每个页面的页面转场样式都可由开发者独立配置，而页面转场涉及到两个页面，开发者应考虑两个页面的页面转场效果的衔接，如时长尽量保持一致。 如果没有定义匹配的页面转场样式，则该页面使用系统默认的页面转场样式。
...
![](assets/页面转场动画%20(不推荐)/file-20260514130706952-1.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/xDASwKBYSpSWNbwH2pzSkA/zh-cn_image_0000002656006458.gif?HW-CC-KV=V1&HW-CC-Date=20260730T071850Z&HW-CC-Expire=86400&HW-CC-Sign=669D22839905C008FD406C25DAD71B72054531C934C56BA1EA35241CCE988DF2)
