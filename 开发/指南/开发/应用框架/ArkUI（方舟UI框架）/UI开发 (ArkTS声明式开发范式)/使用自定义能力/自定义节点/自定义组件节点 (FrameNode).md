...
![](assets/自定义组件节点%20(FrameNode)/file-20260514130714990-0.png)
...
![](assets/自定义组件节点%20(FrameNode)/file-20260514130714990-1.png)
...
> [!NOTE]
> 无法获取系统组件代理FrameNode的RenderNode对象。 BuilderNode中调用 getFrameNode 获取得到的FrameNode节点对象中，可以通过getRenderNode获取对应的根节点的RenderNode对象。
...
> [!NOTE]
> 当前FrameNode如果不可修改，抛出异常信息。 目标父节点为 typeNode 时会校验子组件类型或个数，不满足抛出异常信息，限制情况请查看 typeNode 描述。 当前不支持对无组件类型的命令式节点进行移动。 当前仅支持以下类型的 TypedFrameNode 进行移动操作： Stack 、 XComponent 。对于其他类型的节点，移动操作不会生效。 当前仅支持根节点为以下类型组件的 BuilderNode 进行移动操作： Stack 、 XComponent 、 EmbeddedComponent 。对于其他类型的组件，移动操作不会生效。
...
![](assets/自定义组件节点%20(FrameNode)/file-20260514130714990-6.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6c/v3/bVjAyGgYSu6b_4Nq4dKQrw/zh-cn_image_0000002581434072.png?HW-CC-KV=V1&HW-CC-Date=20260528T014812Z&HW-CC-Expire=86400&HW-CC-Sign=82545138F92402F76DFF72C15C2EF21272CA288F5EC84A66B1A9CFABC8995A4B)
...
> [!NOTE]
> 在调用dispose方法后，FrameNode对象不再对应任何实际的FrameNode节点。此时，若尝试调用以下查询接口： getMeasuredSize 、 getLayoutPosition 、 getUserConfigBorderWidth 、 getUserConfigPadding 、 getUserConfigMargin 、 getUserConfigSize ，将导致应用程序触发 jscrash 。 通过 getUniqueId 可以判断当前FrameNode是否对应一个实体FrameNode节点。当UniqueId大于0时表示该对象对应一个实体FrameNode节点。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/DizybXBQQsurkpygmEnDkg/zh-cn_image_0000002611833901.png?HW-CC-KV=V1&HW-CC-Date=20260528T014812Z&HW-CC-Expire=86400&HW-CC-Sign=AA1543FE5C2A4C7FDBFAE862A859803E3DE88CAAF7E5E2ED1E53DCEB7AEBE1AD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/74/v3/7RbU7430SQSXYdd0QmQUew/zh-cn_image_0000002581274154.png?HW-CC-KV=V1&HW-CC-Date=20260528T014812Z&HW-CC-Expire=86400&HW-CC-Sign=EF01BC223C0B045B7C811ADF13371AFCDE70DB670614BE314180D53B28A0CCD0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b4/v3/YocV-qwtQDGdfLuPgRqP8g/zh-cn_image_0000002611754009.png?HW-CC-KV=V1&HW-CC-Date=20260528T014812Z&HW-CC-Expire=86400&HW-CC-Sign=5042C7CFC804524D7C6A69B707F01AA07FFD927519D49A36579264357FE7BA0A)
