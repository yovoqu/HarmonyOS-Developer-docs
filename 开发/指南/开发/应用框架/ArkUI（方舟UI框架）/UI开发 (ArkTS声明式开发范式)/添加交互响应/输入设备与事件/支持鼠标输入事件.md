...
> [!NOTE]
> 所有单指可响应的触摸事件/手势事件，均可通过鼠标左键来操作和响应。 例如当我们需要开发单击 Button 跳转页面的功能、且需要支持手指点击和鼠标左键点击，那么只绑定一个点击事件（ onClick ）就可以实现该效果； 若需要针对手指和鼠标左键的点击实现不一样的效果，可以在onClick回调中，使用回调参数中的source字段判断当前触发事件的来源是手指还是鼠标。
...
![](assets/支持鼠标输入事件/file-20260708103944132c6aa9.gif)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3c/v3/OMW7FSciSLOF0o3Defk3oQ/zh-cn_image_0000002655846486.gif?HW-CC-KV=V1&HW-CC-Date=20260730T071848Z&HW-CC-Expire=86400&HW-CC-Sign=D65BA6BD49638C7B9E713C5101E812723C979795B053A560E21AD043CEDF2D44)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/12/v3/brQUjfkQS2e901tBjUm9dg/zh-cn_image_0000002686085915.png?HW-CC-KV=V1&HW-CC-Date=20260730T071848Z&HW-CC-Expire=86400&HW-CC-Sign=589A01E6FFF5CA136737D50F49B03C53BE0DA6D2B27C97FE680DC3F1E5973BAC)
