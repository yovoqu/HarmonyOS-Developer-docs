...
struct HtmlSpanStringDemo {
  @State html: string =
    "<p>This is <b>b</b> <strong>strong</strong> em <i>i</i> <u>u</u> <del>del</del> <s>s</s>  <a href='https://www.example.com'>www.example</a>  red span <sup>superscript</sup> and <sub>subscript</sub></p>";
