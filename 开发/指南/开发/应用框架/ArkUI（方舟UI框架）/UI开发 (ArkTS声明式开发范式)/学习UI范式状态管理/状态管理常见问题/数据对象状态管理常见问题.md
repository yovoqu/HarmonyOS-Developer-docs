...
当在构造函数中初始化修改isSuccess的[箭头函数](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/introduction-to-arkts#箭头函数又名lambda函数)时，TestModel实例尚未被代理封装，this指向TestModel实例本身。因此，后续触发query事件时，状态管理无法观测到变化。
...
![](assets/数据对象状态管理常见问题/file-20260708103953e0a20b60.gif)
