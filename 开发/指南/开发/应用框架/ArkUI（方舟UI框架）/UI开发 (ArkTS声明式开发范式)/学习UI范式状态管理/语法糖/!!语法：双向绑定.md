...
!!双向绑定语法，是一个语法糖方便开发者实现数据双向绑定，用于初始化子组件的[@Param](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-param)装饰的属性和[@Event](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-event)装饰的事件。其中@Event方法名需要声明为“$”+ @Param属性名，详见[使用场景](#使用场景)。
...
内部状态的含义由组件或属性决定。例如：[bindMenu](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-menu#bindmenu11)属性的isShow参数。
...
![](assets/!!语法：双向绑定/file-20260708103953174178ed.gif)
