...
> [!NOTE]
> ArcList 的子组件必须是 ArcListItem ， ArcListItem 必须配合 ArcList 来使用。
...
![](assets/弧形列表%20(ArcList)（圆形屏幕推荐使用）/file-20260514130610997-1.png)
...
![](assets/弧形列表%20(ArcList)（圆形屏幕推荐使用）/file-20260514130610997-2.png)
...
![](assets/弧形列表%20(ArcList)（圆形屏幕推荐使用）/file-20260514130610997-3.png)
...
![](assets/弧形列表%20(ArcList)（圆形屏幕推荐使用）/file-20260514130610997-4.png)
...
![](assets/弧形列表%20(ArcList)（圆形屏幕推荐使用）/file-20260514130610997-5.gif)
...
![](assets/弧形列表%20(ArcList)（圆形屏幕推荐使用）/file-20260514130610997-6.gif)
...
![](assets/弧形列表%20(ArcList)（圆形屏幕推荐使用）/file-20260514130610997-7.gif)


> [!NOTE]
> 弧形滚动条组件 ArcScrollBar ，还可配合其他可滚动组件使用，如 List 、 Grid 、 Scroll 、 WaterFlow 。
