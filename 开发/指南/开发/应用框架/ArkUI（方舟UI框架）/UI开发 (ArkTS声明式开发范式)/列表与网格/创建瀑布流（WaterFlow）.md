...
![](assets/创建瀑布流（WaterFlow）/file-20260525091540525-002.png)
...
![](assets/创建瀑布流（WaterFlow）/file-20260525091540525-003.gif)
...
![](assets/创建瀑布流（WaterFlow）/file-20260525091540525-004.gif)
...
![](assets/创建瀑布流（WaterFlow）/file-20260525091540526-005.gif)

#### 分组混合布局
许多应用界面在瀑布流上方包含其他内容，这类场景可通过在Scroll或List内部嵌套WaterFlow来实现。类似下图：

![](assets/创建瀑布流（WaterFlow）/file-20260525091540526-006.png)
