...
![](assets/创建列表%20(List)/file-20260514130608150-0.png)
...
![](assets/创建列表%20(List)/file-20260514130608150-10.png)
...
![](assets/创建列表%20(List)/file-20260514130608150-11.png)
...
![](assets/创建列表%20(List)/file-20260514130608150-12.png)
...
![](assets/创建列表%20(List)/file-20260514130608150-13.gif)
...
![](assets/创建列表%20(List)/file-20260514130608150-14.gif)
...
![](assets/创建列表%20(List)/file-20260514130608150-15.png)
...
![](assets/创建列表%20(List)/file-20260514130608150-16.gif)
...
![](assets/创建列表%20(List)/file-20260514130608150-17.gif)
...
![](assets/创建列表%20(List)/file-20260514130608150-18.gif)
...
![](assets/创建列表%20(List)/file-20260514130608150-19.gif)
...
![](assets/创建列表%20(List)/file-20260514130608150-2.png)
...
![](assets/创建列表%20(List)/file-20260514130608150-20.png)
...
![](assets/创建列表%20(List)/file-20260514130608150-22.gif)
...
![](assets/创建列表%20(List)/file-20260514130608150-23.gif)


> [!NOTE]
> 滚动条组件 ScrollBar ，还可配合其他可滚动组件使用，如 ArcList 、 Grid 、 Scroll 、 WaterFlow 。 在圆形屏幕设备上， List 可以与弧形滚动条组件 ArcScrollBar 配合使用为列表添加弧形外置滚动条，使用方式可参考 创建弧形列表 (ArcList) 的 添加外置滚动条ArcScrollBar 章节。
...
![](assets/创建列表%20(List)/file-20260514130608150-25.gif)
...
![](assets/创建列表%20(List)/file-20260514130608150-26.gif)
...
![](assets/创建列表%20(List)/file-20260514130608150-27.gif)
...
![](assets/创建列表%20(List)/file-20260514130608150-28.gif)
...
![](assets/创建列表%20(List)/file-20260514130608150-4.png)
...
![](assets/创建列表%20(List)/file-20260514130608150-5.png)
...
![](assets/创建列表%20(List)/file-20260514130608150-7.png)
...
![](assets/创建列表%20(List)/file-20260514130608150-8.png)
...
![](assets/创建列表%20(List)/file-20260525091540801-001.png)
...
![](assets/创建列表%20(List)/file-20260525091540801-002.png)
...
![](assets/创建列表%20(List)/file-20260525091540801-003.png)
...
4. 通过[getItemRect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#getitemrect11)接口方法获取当前项位置信息。
...
![](assets/创建列表%20(List)/file-20260525091540801-004.png)
...
![](assets/创建列表%20(List)/file-20260525091540801-005.png)
...
![](assets/创建列表%20(List)/file-20260525091540801-006.png)
