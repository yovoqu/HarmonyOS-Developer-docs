...
> [!NOTE]
> 在自定义节点 BuilderNode 中使用 WithTheme ，为了确保显示效果正确，需手动传递系统环境变化事件，触发节点的全量更新，详细请参考BuilderNode系统环境变化更新 updateConfiguration 。
...
![](assets/设置应用内主题换肤/file-202607081039187b303ef5.png)
...
![](assets/设置应用内主题换肤/file-2026070810391957f50920.png)
