...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-component_reuse
...
- [同一列表内的组件复用](#同一列表内的组件复用)
- [多个列表间的组件复用](#多个列表间的组件复用)

 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/80/v3/Yl_mmep8RK6_2h_zyeeOKA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025427Z&HW-CC-Expire=86400&HW-CC-Sign=9777AADA79E532336C9BFB8742BBFFA5330D600E85F071E807B1CDE711D9B507)
...
- [列表项结构类型相同](#列表项结构类型相同)
- [列表项结构类型不同](#列表项结构类型不同)
- [列表项内子组件可拆分组合](#列表项内子组件可拆分组合)

 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d7/v3/jxCPMvqrRLe4vs2Hjpws3g/zh-cn_image_0000002659099385.png?HW-CC-KV=V1&HW-CC-Date=20260701T025427Z&HW-CC-Expire=86400&HW-CC-Sign=F61AA4F055C303BB70EB31D1732649744AADA7D86CE6FE9D1DB56BD68699B1D0)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bc/v3/ZGGcjflAT-u6hitfC9HjZw/zh-cn_image_0000002628860036.png?HW-CC-KV=V1&HW-CC-Date=20260701T025427Z&HW-CC-Expire=86400&HW-CC-Sign=706B65E854290D31BFDCCE7E3C72B7C752DD7DA08D1E55B002C2BA21E863CE50)

 
- 标记了@Reusable的自定义组件listItem列表项，在滑动出屏幕一定范围后，从组件树上被移除，组件的对象实例被放入CustomNode虚拟结点（与自定义组件一一对应的自定义结点）。
- 在不断滑动过程中，列表的RecycleManager将这些CustomNode虚拟结点回收，根据[复用标识](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-reuse-id)分组，形成CachedRecycleNodes的集合，即视图对象的复用缓存池。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/6ETaK-MJT4Kl0jdfjdl3yg/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025427Z&HW-CC-Expire=86400&HW-CC-Sign=EF4948A8A0A041988580FA4209DA38ADFF854300993BC4CA3ABE6601961C820F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/rKh3z_UCSzS_L1qCSrloyA/zh-cn_image_0000002659219353.png?HW-CC-KV=V1&HW-CC-Date=20260701T025427Z&HW-CC-Expire=86400&HW-CC-Sign=BFB82E1020775AAB7FD5FA9927A487F1FCEF7DDC1B3EC8305A0603E9CFA04599)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2/v3/BhXd3tOOREShxU68GLsvqQ/zh-cn_image_0000002628700152.png?HW-CC-KV=V1&HW-CC-Date=20260701T025427Z&HW-CC-Expire=86400&HW-CC-Sign=D8849B9A32C4371643ED23BC050752F87B4C21331569F7B01063AB1CB7CBEAB4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/86/v3/rXrrcYKUQZykHNewnf-8gQ/zh-cn_image_0000002659099387.png?HW-CC-KV=V1&HW-CC-Date=20260701T025427Z&HW-CC-Expire=86400&HW-CC-Sign=A742199733CFD9484BE3544CD5F1524839F9118F79BE0861820DC59A624A7EFD)

 
因此，可以创建五种复用子组件，通过子组件的选择组合，实现不同类型的列表项。
 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4f/v3/EOQfYQUrQUitAq8Mu2yCQQ/zh-cn_image_0000002628860038.png?HW-CC-KV=V1&HW-CC-Date=20260701T025427Z&HW-CC-Expire=86400&HW-CC-Sign=0E0E78EA568E8FDDC0D9E7BBFAF9F4DF5428322CCE9CD3BC10348706EA74EC6F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/Kq-HoBLaSSudFrslEbSqWA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025427Z&HW-CC-Expire=86400&HW-CC-Sign=43680DD9F9EE644559DFA50FA750A8D97D91D2AA7E59E214BA6D073B24F8315B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f6/v3/qbDiKZEvTyiW4KwKNQh_Ow/zh-cn_image_0000002659219355.png?HW-CC-KV=V1&HW-CC-Date=20260701T025427Z&HW-CC-Expire=86400&HW-CC-Sign=75A5106FC80582A3B3CEDDBE16D79995D2A5565265055F149C9814D4CF059734)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/52/v3/empd7-sHRJSM8_0VcC37_g/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025427Z&HW-CC-Expire=86400&HW-CC-Sign=0FBF698F592D380A2088799BF9D7D40656515B1D9CD3668931F0345478B9E58E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ad/v3/LWhrgUiVTgqCage5ZfuoKg/zh-cn_image_0000002628700154.png?HW-CC-KV=V1&HW-CC-Date=20260701T025427Z&HW-CC-Expire=86400&HW-CC-Sign=9E734E33FBC91F74FFB9DFC488F23480E3BB9C432D89FEFB4D660CF6F30508D6)
...
export class NodeItem extends NodeController {
  public builder: WrappedBuilder | null = null;
  public node: BuilderNode | null = null;
...
export class NodePool {
  ...
  public getNode(type: string, item: ESObject,
    builder: WrappedBuilder): NodeItem | undefined {
    let nodeItem: NodeItem | undefined = undefined;
    try {
      if (this.nodePool.get(type)) {
        for (let i = 0; i  = this.nodePool.get(type);
      if (!nodeArray) {
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/46/v3/RyLV2xdgRmeddIO6KAtRUg/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025427Z&HW-CC-Expire=86400&HW-CC-Sign=02173962017153937F8868A553DB2251C2A50526DB24C9A14048915C74C32B3C)
...
export struct DiffListItemNode {
  ...
  @State builder: WrappedBuilder | null = null;
...
```text
export const listItemWrapper: WrappedBuilder = wrapBuilder(listItemBuilder);
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c8/v3/jQzizKaGSnWyUm7zX5XLoA/zh-cn_image_0000002659099389.png?HW-CC-KV=V1&HW-CC-Date=20260701T025427Z&HW-CC-Expire=86400&HW-CC-Sign=579F0CE4903C38008F0AE35889B17404D26EEC8C93CC94E8CE9BCA0F7A668BBD)

 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7c/v3/7LIaIuT2TM-Zc3BRNgA1aw/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025427Z&HW-CC-Expire=86400&HW-CC-Sign=DBB9C87116FB03D35D1084890C1722E35921A641C7B2688EF3E9F752D3197E0A)
...
export class NodePool {
  ...
  public preBuild(type: string, item: ESObject, builder: WrappedBuilder, uiContext: UIContext) {
    if (type) {
...
export class IdleCallback extends FrameCallback {
  ...
  onIdle(idleTimeInNano: number): void {
    ...
    while (timeLeft >= 1000000) {
      ...
      if (this.todoCount - 在进入Swiper+List的页面之前，选择合适的时机执行context.postFrameCallback()，开启IdleCallback帧回调逻辑。
