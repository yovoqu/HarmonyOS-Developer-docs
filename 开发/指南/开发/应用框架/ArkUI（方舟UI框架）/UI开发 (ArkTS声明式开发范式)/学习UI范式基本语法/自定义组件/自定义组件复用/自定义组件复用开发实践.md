...
> [!NOTE]
> 本文以列表相关场景为例介绍，但实际只要发生了自定义组件的销毁和再创建，都可以考虑使用组件复用。包括以下情形： 滑动场景下对子组件进行频繁创建和销毁。例如List、Grid、WaterFlow、Swiper等布局容器中的滑动。 界面中反复切换条件渲染的控制分支，且控制分支中的子组件树结构比较复杂。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d7/v3/jxCPMvqrRLe4vs2Hjpws3g/zh-cn_image_0000002659099385.png?HW-CC-KV=V1&HW-CC-Date=20260701T041456Z&HW-CC-Expire=86400&HW-CC-Sign=3841D47876A46CC61C40FBE2E633BF936B5643D8F1E961022FCF06C9FA65597C)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bc/v3/ZGGcjflAT-u6hitfC9HjZw/zh-cn_image_0000002628860036.png?HW-CC-KV=V1&HW-CC-Date=20260701T041456Z&HW-CC-Expire=86400&HW-CC-Sign=C3844229729A25F69AA929E236D8687BCE19F386E9D99797BA3586A90E22A1F9)

 1. 标记了@Reusable的自定义组件listItem列表项，在滑动出屏幕一定范围后，从组件树上被移除，组件的对象实例被放入CustomNode虚拟结点（与自定义组件一一对应的自定义结点）。
2. 在不断滑动过程中，列表的RecycleManager将这些CustomNode虚拟结点回收，根据[复用标识](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-reuse-id)分组，形成CachedRecycleNodes的集合，即视图对象的复用缓存池。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/6ETaK-MJT4Kl0jdfjdl3yg/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T041456Z&HW-CC-Expire=86400&HW-CC-Sign=7648DF21D63F9FC9861F4EE8A6579AB5D9246B0E02DF478EA1E9C13749210A84)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/rKh3z_UCSzS_L1qCSrloyA/zh-cn_image_0000002659219353.png?HW-CC-KV=V1&HW-CC-Date=20260701T041456Z&HW-CC-Expire=86400&HW-CC-Sign=416FC7ABFDF6CF9169DEB67B6FDF1E331B23EE19B3B529CAACEC0873C263CC2B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2/v3/BhXd3tOOREShxU68GLsvqQ/zh-cn_image_0000002628700152.png?HW-CC-KV=V1&HW-CC-Date=20260701T041456Z&HW-CC-Expire=86400&HW-CC-Sign=4BC3C636605B91FBBE88AAA2BCD3F303E93F9A3D4B07C2A472D1CCA2298B3456)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/86/v3/rXrrcYKUQZykHNewnf-8gQ/zh-cn_image_0000002659099387.png?HW-CC-KV=V1&HW-CC-Date=20260701T041456Z&HW-CC-Expire=86400&HW-CC-Sign=92A57543A221896091A2D2CCE4A0D089F6027E670C8184ADB4A4C0C9E7233754)

 
因此，可以创建五种复用子组件，通过子组件的选择组合，实现不同类型的列表项。
 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4f/v3/EOQfYQUrQUitAq8Mu2yCQQ/zh-cn_image_0000002628860038.png?HW-CC-KV=V1&HW-CC-Date=20260701T041456Z&HW-CC-Expire=86400&HW-CC-Sign=F04934F4CB2E712765C178E1C1320B539EA35FF9A9ACC5122D10975C868BF51C)
...
> [!NOTE]
> 使用 @Builder 而非直接嵌套子组件的原因如下: 由于缓存池位于自定义组件上，嵌套子组件后会将缓存池分割，导致复用不生效。而使用@Builder可以使内部的自定义组件依然汇聚在同一个缓存池里，从而实现相互复用。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f6/v3/qbDiKZEvTyiW4KwKNQh_Ow/zh-cn_image_0000002659219355.png?HW-CC-KV=V1&HW-CC-Date=20260701T041456Z&HW-CC-Expire=86400&HW-CC-Sign=6B01495D4F870D96EBF0128F44A963C0C90B417FFAD4FB9DC9EA6F994FFBBA48)
...
> [!NOTE]
> 为什么不使用Tabs+List，而是用Swiper+List组件实现？ 当前Tabs内容页不支持使用LazyForEach()，只能使用ForEach+TabContent。如果使用ForEach()，Tabs页面显示时会一次性将所有的TabContent创建，TabContent子页面切换时也不会执行aboutToDisappear()，无法回收组件，进而不存在复用优化的可能。

 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ad/v3/LWhrgUiVTgqCage5ZfuoKg/zh-cn_image_0000002628700154.png?HW-CC-KV=V1&HW-CC-Date=20260701T041456Z&HW-CC-Expire=86400&HW-CC-Sign=F3E9F3A501B97D8C7F41676116C58BDB40065856D2AD5D505780E5E87CA0E817)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/46/v3/RyLV2xdgRmeddIO6KAtRUg/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T041456Z&HW-CC-Expire=86400&HW-CC-Sign=E35801039C80A35C8769C553F4D350DB6F7A9D169818FE567B2A7C3596A31310)
 

  
- getNode()方法中，如果找到的NodeItem父结点不为空（说明未完全下树），需要继续遍历查找下一个有效的NodeItem对象。

3. recycleNode()方法中，需要对NodeItem对象属性重置，使节点内容还原，避免复用显示异常情况。

4. 将步骤1中的列表项占位结点包装成组件，在对应的生命周期中分别取缓存、回收、复用。
...
5. 封装列表项的界面视图组件，使用listItemBuilder函数对外export该组件。
...
6. 在列表的LazyForEach()中，将步骤4的实际列表项视图wrapBuilder后作为参数传递给步骤3封装的占位组件，实现复用组件的布局。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c8/v3/jQzizKaGSnWyUm7zX5XLoA/zh-cn_image_0000002659099389.png?HW-CC-KV=V1&HW-CC-Date=20260701T041456Z&HW-CC-Expire=86400&HW-CC-Sign=0EFD1F139025864F03893162EEB2D6F4595D3A7534BFB0EF23A1EA44436F79B5)


  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7c/v3/7LIaIuT2TM-Zc3BRNgA1aw/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T041456Z&HW-CC-Expire=86400&HW-CC-Sign=6982BCE138BD3CD16ACEADBD3F5C9F40BBE97621E62762494F63EB2F2DFC732F)
