...
> [!WARNING]
> ArkUI框架会对重复的键值发出运行时警告。在UI更新时，如果出现重复的键值，框架可能无法正常工作，具体请参见 渲染结果非预期 。 不建议在键值中包含数据项索引index，这可能会导致 渲染结果非预期 和 渲染性能降低 。 如果开发者在itemGenerator函数中声明了index参数，但未在keyGenerator函数中声明index参数，框架会在keyGenerator函数返回值的基础上拼接index，作为最终的键值，这将会引发上述第二点中的问题。为避免此现象，请在keyGenerator函数中声明index参数。
...
![](assets/ForEach：循环渲染/file-20260514130539374-11.png)
...
![](assets/ForEach：循环渲染/file-20260514130539374-12.png)
...
![](assets/ForEach：循环渲染/file-20260514130539374-13.png)
...
![](assets/ForEach：循环渲染/file-20260514130539374-14.png)
...
![](assets/ForEach：循环渲染/file-20260514130539374-15.png)
...
![](assets/ForEach：循环渲染/file-20260514130539374-7.gif)
...
![](assets/ForEach：循环渲染/file-20260514130539374-8.png)
...
![](assets/ForEach：循环渲染/file-20260514130539374-9.gif)


**图15** 自定义键值生成函数下的内存占用


![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/K8sxJuGaSgWrkD5UnCODvQ/zh-cn_image_0000002611833537.png?HW-CC-KV=V1&HW-CC-Date=20260528T030455Z&HW-CC-Expire=86400&HW-CC-Sign=0D7D6DCBEE969AC54CA5D91363775A1D8F4AF5C650D66A1E6293CF9E4CD51299)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/de/v3/NSXMc7cDSXCGkWIBsSO_0A/zh-cn_image_0000002581273790.png?HW-CC-KV=V1&HW-CC-Date=20260528T030455Z&HW-CC-Expire=86400&HW-CC-Sign=AEF893693D2D5544C6AA59C5049E0C9F143FC793EA8504F6EA4219DCDDD22117)
