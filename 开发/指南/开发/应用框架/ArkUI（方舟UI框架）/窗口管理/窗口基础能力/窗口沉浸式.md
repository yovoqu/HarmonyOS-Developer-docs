...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e4/v3/t7OYEV6fRXGYhF4a1_v3YA/zh-cn_image_0000002659100107.png?HW-CC-KV=V1&HW-CC-Date=20260701T041458Z&HW-CC-Expire=86400&HW-CC-Sign=D8CD9A7AA1839D90972E35F418D3851843AB5958F79B193FF4E77209CC72F6A5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/qaRJf1FCRNGNVECAv7X_oQ/zh-cn_image_0000002628860762.png?HW-CC-KV=V1&HW-CC-Date=20260701T041458Z&HW-CC-Expire=86400&HW-CC-Sign=8E06CC1038AE0EE7EF273007DFF33F204A870643FAB53D6EB6B7E42E53777C42)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/66/v3/Ad3G5w6LRFSDV2rsJs6TcQ/zh-cn_image_0000002659220077.png?HW-CC-KV=V1&HW-CC-Date=20260701T041458Z&HW-CC-Expire=86400&HW-CC-Sign=72F4D9B441D01B4BC672F0F64499188AD054F0B18C94E6A6960BB618983FE76C)
...
> [!NOTE]
> setSpecificSystemBarEnabled() 、 setWindowSystemBarEnable() 等控制系统界面元素显示的接口仅非 自由窗口 状态下的主窗口支持调用，在 辅助窗口 中调用或 自由窗口 状态下调用不生效。在主窗口非全屏/非最大化模式时调用不会立即生效，应用在进入全屏/最大化模式后配置生效。



![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dd/v3/yNxTL94GT7-jAH6TR4R8xw/zh-cn_image_0000002628700882.png?HW-CC-KV=V1&HW-CC-Date=20260701T041458Z&HW-CC-Expire=86400&HW-CC-Sign=DC65E89353205AB3C4AE406741BEC5180A92D8C28B8E1EEFEBAF8618373CA958)

1. 调用[setWindowLayoutFullScreen()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-window#setwindowlayoutfullscreen9)接口设置窗口进入沉浸式布局。
2. 调用[setSpecificSystemBarEnabled()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-window#setspecificsystembarenabled11)隐藏状态栏。
...
> [!NOTE]
> 全局悬浮窗、模态窗口和系统窗口本身不具备获取避让区域的能力，如果需要在这些窗口中适配布局避让，需要使用 setSystemAvoidAreaEnabled() 接口使能避让区域能力后再进行布局避让。
...
3. 还可以使用响应式环境变量装饰器[@Env](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-env-system-property)来实现避让区域的获取和监听。
...
5. 避让使用@Env(SystemProperties.WINDOW_AVOID_AREA)获取到的避让区域的示例代码如下：
...
6. 根据实际的UI界面显示或相关UI元素背景颜色等，还可以按需设置状态栏的文字颜色、背景色或设置导航区域的显示或隐藏，以使UI界面效果呈现和谐。状态栏和导航区域默认是透明的，透传的是应用界面的背景色。
