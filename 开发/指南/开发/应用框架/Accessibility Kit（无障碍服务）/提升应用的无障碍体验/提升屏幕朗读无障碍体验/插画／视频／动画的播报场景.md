...
![](assets/插画／视频／动画的播报场景/file-20260514130406763-0.png)
...
以下[List](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list)的每个[Item](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem)，应该进行组合标注，从而给用户一个完整的提示信息：
...
![](assets/插画／视频／动画的播报场景/file-20260514130406763-1.png)
