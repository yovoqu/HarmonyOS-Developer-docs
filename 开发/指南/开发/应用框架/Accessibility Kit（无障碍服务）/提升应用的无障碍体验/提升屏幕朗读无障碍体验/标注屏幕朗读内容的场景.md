...
以accessibilityText()设置无障碍文本为例，[accessibilityText](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-accessibility#accessibilitytext)设置无障碍文本。聚焦[Button](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-button)时朗读效果为："Accessibility text，按钮"。
