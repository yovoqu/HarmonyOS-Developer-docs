...
在下面的代码片段中，您可以看到[Image](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-image)组件（它实际上是一个播放/暂停按钮），通过设置[accessibilityText](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-accessibility#accessibilitytext12)属性提供标注信息：
