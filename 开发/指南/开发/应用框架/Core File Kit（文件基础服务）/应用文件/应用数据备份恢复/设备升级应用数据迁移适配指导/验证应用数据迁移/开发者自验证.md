...
![](assets/开发者自验证/file-20260514130909693-10.png)


  
![](assets/开发者自验证/file-20260514130909693-11.png)

3. 单击“复制”按钮，将数据复制到文件管理器的“下载”目录下，作为后续自验证的测试数据源。

  
![](assets/开发者自验证/file-20260514130909693-12.png)
 
![](assets/开发者自验证/file-20260514130909693-13.png)
...
![](assets/开发者自验证/file-20260514130909693-14.png)
...
![](assets/开发者自验证/file-20260514130909693-15.png)

3. 在“迁移工具”应用的首页，开发者通过单击“选择”按钮进入设备文件管理界面。

  
![](assets/开发者自验证/file-20260514130909693-16.png)

4. 在设备文件管理界面，单击“浏览”按钮，进入浏览手机内部存储界面。单击“我的手机”，根据之前导入数据的路径，进入手机存储的相应路径，选择需要导入的APK应用数据zip包。

  
![](assets/开发者自验证/file-20260514130909693-17.png)
 
![](assets/开发者自验证/file-20260514130909693-18.png)

5. 单击需要导入的APK应用数据zip包后，会返回“迁移调试”工具首页，已选择的需要导入的APK应用数据会显示在第一栏中。选择好需要导入的APK应用数据后，单击“请输入应用包名”。

  
![](assets/开发者自验证/file-20260514130909693-2.png)

6. 输入需要验证的目标HarmonyOS应用包名，目标HarmonyOS应用会显示在“迁移调试”工具首页的第二栏中。

  
![](assets/开发者自验证/file-20260514130909693-3.png)


  
![](assets/开发者自验证/file-20260514130909693-4.png)

7. 选择需要导入的APK数据和目标HarmonyOS应用后，单击“启动迁移”按钮，开始模拟数据迁移，页面切换为数据优化界面，应用数据迁移的进度在数据迁移进度条中显示。

  
![](assets/开发者自验证/file-20260514130909693-5.png)
 
![](assets/开发者自验证/file-20260514130909693-6.png)
...
![](assets/开发者自验证/file-20260514130909693-7.png)
...
![](assets/开发者自验证/file-20260514130909693-8.png)
 
![](assets/开发者自验证/file-20260514130909693-9.png)

9. 数据迁移失败的情况下，应用图标上方的状态显示“优化失败”。单击“完成”按钮，切换回“迁移工具”应用首页，在下方的“迁移日志”版块中显示详细迁移信息。result字段表示数据迁移结果，costTime字段表示数据迁移时长（单位ms）。

  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/FJM2IApDSv2WDcyoYmOfYQ/zh-cn_image_0000002581274428.png?HW-CC-KV=V1&HW-CC-Date=20260528T014738Z&HW-CC-Expire=86400&HW-CC-Sign=EE39FFFCC66E8289599CB402746EF4FC6D6AC856D69D3FA7954603A740B022A7)
 
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9c/v3/dAg87exaTXyfxCxLaRrP_w/zh-cn_image_0000002611754281.png?HW-CC-KV=V1&HW-CC-Date=20260528T014738Z&HW-CC-Expire=86400&HW-CC-Sign=183FACAD683F23CA963A04272D53DE8A13F832E72A843DCEFB038B7AE410ECD3)
