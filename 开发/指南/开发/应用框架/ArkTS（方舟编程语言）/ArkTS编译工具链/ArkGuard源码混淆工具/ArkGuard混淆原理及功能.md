...
| 不保留未参与编译模块名称 | -extra-options strip-not-compiled-module-name |
| 保留声明文件参数 | -keep-parameter-names |
| 合并依赖模块选项 | -enable-lib-obfuscation-options |
| 通过注释在源码中标记白名单 | -use-keep-in-source |
| 保留对象字面量属性名称 | -keep-object-props |
| 删除指定的方法调用语句 | -remove-nosideeffects-calls |
...
![](assets/ArkGuard混淆原理及功能/file-20260514130454855-10.png)
