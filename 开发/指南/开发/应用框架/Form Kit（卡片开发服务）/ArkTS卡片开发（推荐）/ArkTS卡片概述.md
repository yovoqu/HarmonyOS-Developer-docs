...
3. 新增了自定义绘制的能力：ArkTS卡片开放了[Canvas](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-components-canvas-canvas)画布组件的能力，卡片可以使用自定义绘制的能力构建更多样的显示和交互效果。

4. 允许卡片中运行逻辑代码：开放逻辑代码运行能力后，部分业务逻辑可以在卡片内部实现，拓宽了业务适用场景。
