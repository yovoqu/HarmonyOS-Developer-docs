...
- ArkWeb内核版本：ArkWeb基于谷歌Chromium内核开发，系统版本与Chromium版本的对应关系如表格所示。 系统版本 Chromium版本 HarmonyOS 4.0及之前 M99   HarmonyOS 4.1-5.1 M114   HarmonyOS 6.0  M132（默认，推荐使用） M114（可选，若应用需切换为此内核，请参考M114内核在HarmonyOS6.0系统上的适配指导）   HarmonyOS 6.1 M132
