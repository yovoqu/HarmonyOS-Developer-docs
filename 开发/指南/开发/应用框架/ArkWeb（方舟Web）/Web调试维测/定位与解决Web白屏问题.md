...
4. 应用资源目录通过[Context.resourceDir](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-context#属性)获取，其子目录示例如下：

  
/data/storage/el1/bundle/entry/resources/resfile

5. /data/storage/el1/bundle/entry/resources/resfile/example

6. 从API version 21开始，还包括了应用缓存目录通过[Context.cacheDir](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-context#属性)获取，其子目录示例如下：

  
/data/storage/el2/base/cache

7. /data/storage/el2/base/haps/entry/cache/example

8. 设置的目录路径中，不允许包含cache/web，否则会抛出异常码401。如果设置目录路径是cache，cache/web也不允许访问。

9. 从API version 21开始，还包括了应用临时目录通过[Context.tempDir](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-context#属性)获取，其子目录示例如下：

  
/data/storage/el2/base/temp

10. /data/storage/el2/base/haps/entry/temp/example
