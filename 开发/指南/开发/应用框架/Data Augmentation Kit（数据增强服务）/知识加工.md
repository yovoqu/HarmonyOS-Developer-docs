...
6. 建表语句中的表名需要与schema文件中"tableName"字段保持一致，列名与"columnName"字段保持一致。
...
12. properties配置：根据业务需求设置相关参数，详见[KnowledgeProcessorConfig](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/dataaugmentation-knowledgeprocessor-api#knowledgeprocessorconfig)。
