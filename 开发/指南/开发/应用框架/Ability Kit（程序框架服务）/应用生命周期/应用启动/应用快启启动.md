...
#### 约束限制
 ...
 - 系统侧对快启启动功能做了权限保护处理，线上使能特性需要开发者先提交“快启启动”申请。       1. 登录[AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)，选择“开发与服务”。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4c/v3/qlpTJHvLTl-i_JuxB82hLw/zh-cn_image_0000002659219273.png?HW-CC-KV=V1&HW-CC-Date=20260701T041454Z&HW-CC-Expire=86400&HW-CC-Sign=B02C779A5174A1CF6BC815A70D8DB2A0728E634CD2B91D6D1ED51443E2D8206D)
...
3. AbilityStage.onCreate()是首个包含较多业务逻辑的生命周期回调。若该回调中的业务不易拆分，建议开发者在首次适配时，将AbilityStage.onCreate()的内容整体移至[onAboutToCreateAbility()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-abilitystage#onabouttocreateability24)。后续可通过业务前移扩大收益。
