...
**图标批量处理接口：** 最大并发数为 10，单次最大处理量 500 个。  **Symbol资源注册接口：** 仅支持注册 1 组图标资源与动效参数资源，最大支持 10 个自定义图标与动效参数资源注册。

## 模拟器支持情况

本Kit支持模拟器开发，但与真机存在部分能力差异，具体差异如下： 通用差异：请参见“[模拟器与真机的差异](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-emulator-specification#section1227613205203)”。不支持HDS沉浸视效，包括点光源效果、按压阴影、双边边缘流光、背景流光、自带背景的双边流光和沉浸光感材质。
