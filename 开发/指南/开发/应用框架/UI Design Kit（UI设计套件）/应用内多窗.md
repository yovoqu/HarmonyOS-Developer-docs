...
2. 使用MultiWindowEntryInAPP组件，并且设置组件参数，详细请参考[应用内多窗多股比价最佳实践](https://developer.huawei.com/consumer/cn/doc/best-practices/multi-ticket-class#section12800182173311)。
