...
![](assets/使用MindSpore%20Lite实现图像分类（ArkTS）/file-20260514132650285-0.png)
 
![](assets/使用MindSpore%20Lite实现图像分类（ArkTS）/file-20260514132650285-1.png)



![](assets/使用MindSpore%20Lite实现图像分类（ArkTS）/file-20260514132650285-2.png)
 
![](assets/使用MindSpore%20Lite实现图像分类（ArkTS）/file-20260514132650285-3.png)
