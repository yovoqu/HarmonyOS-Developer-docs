...
- [图像超分](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/core-vision-image-super-resolution)：图像超分一项基于人工智能算法的图像处理功能，可将低分辨率、模糊或细节不足的图片智能放大并增强清晰度。在放大图像尺寸的同时，系统能够自动补全纹理细节、优化边缘轮廓、降低噪点干扰，使图片呈现出更清晰、更自然、更高质量的视觉效果。
- [通过文本搜索图片](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/core-vision-text-search-image)：基于自然语言理解与图像跨模态检索技术，支持用户输入任意描述性文本（如“海边的落日”、“证件”），从应用沙箱中精准匹配并提取符合描述的图片。该功能极大地提升了用户的搜图效率，让无标签、未分类的图像资产变得可检索、易触达，广泛应用于智慧相册、聊天对话（如即时通讯、社交互动）以及电商以文搜图等场景。
