...
![](assets/接入方案/file-20260525091723597-001.png)
...
![](assets/接入方案/file-20260525091723597-002.png)
...
4. 在对应的方法中传递意图参数（param），并拉起对应落地页（如还款页面）。 import { insightIntent, InsightIntentExecutor } from '@kit.AbilityKit';
