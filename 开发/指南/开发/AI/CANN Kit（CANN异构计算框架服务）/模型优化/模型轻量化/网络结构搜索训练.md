...
3. 如果是评估模式，则dataset_dir传入scen.yaml中配置的val_dir目录。

4. 解析对应的数据并返回处理后的数据（具体接口定义参见[TensorFlow开发者自定义接口](#tensorflow开发者自定义接口)、[PyTorch开发者自定义接口](#pytorch开发者自定义接口)）。
...
> [!NOTE]
> [1] 优化器类型支持SGD，Momentum和Adam三种优化器类型。 SGD优化器，支持learning_rate参数。 Momentum优化器，支持momentum、learning_rate参数。PyTorch版本目前不支持该优化器。 Adam优化器，支持betas、learning_rate参数，betas的形式为list，list中索引为0的元素为beta1，索引为1的元素为beta2。 [2] 当没有预训练的ckpt文件时，其取值为预训练数据集的目录路径；当有预训练的ckpt文件时，其取值为ckpt所在的目录路径。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/a3DMywyeQO2HVTTzD9z5cA/zh-cn_image_0000002611835137.png?HW-CC-KV=V1&HW-CC-Date=20260528T014408Z&HW-CC-Expire=86400&HW-CC-Sign=FE7AB418BABAA7041C98ACF53A44C6AF45C61708DDD0514DDBDE9B97989DDC5F)

- lr-学习率变化曲线

  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/0iB3w_IeT1eVlizvH4qvOQ/zh-cn_image_0000002581275390.png?HW-CC-KV=V1&HW-CC-Date=20260528T014408Z&HW-CC-Expire=86400&HW-CC-Sign=F5B36FC7D8C99E9593F7BC9A84B6E9245102FFC2444EF834EAB8C841897ED686)

- pareto-帕累托前沿图

  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/5aeKZTpyThq8Pg4cM8Rsjg/zh-cn_image_0000002611755247.png?HW-CC-KV=V1&HW-CC-Date=20260528T014408Z&HW-CC-Expire=86400&HW-CC-Sign=3960E58FC794B88A9BB8CAD9B84AF542ED1D90BC852FE688C69D957DA160DA37)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/85/v3/FjKTfdPTRf-GI8g1u_uHew/zh-cn_image_0000002581435308.png?HW-CC-KV=V1&HW-CC-Date=20260528T014408Z&HW-CC-Expire=86400&HW-CC-Sign=47616581182E5F8437CCEEAAEE67CD6D16ED9E8F3350424C44A4C70DB68DDFA1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/7LGdQlv-SemDQIR0ikkeHw/zh-cn_image_0000002611835139.png?HW-CC-KV=V1&HW-CC-Date=20260528T014408Z&HW-CC-Expire=86400&HW-CC-Sign=BEEAAEB8955E7ACC8911A970AA15ED17367141DC33C76264C24A7D28D007A5F1)
