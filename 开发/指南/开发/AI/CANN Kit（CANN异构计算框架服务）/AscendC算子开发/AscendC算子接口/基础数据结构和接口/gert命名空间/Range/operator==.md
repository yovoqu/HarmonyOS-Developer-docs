...
```text
bool operator==(const Range&rht) const
```
...
int max = 1024;
int max2 = 1024;
Range range1(&min, &max); // 上界为1024Bytes，下界为0
Range range2(&min, &max); // 上界为1024Bytes，下界为0
Range range3(&min, &max2); // 上界为1024Bytes，下界为0
