...
graphStatus GetInputAttr(const int32_t index, const char_t *name, std::vector &attr_value) const;
graphStatus GetInputAttr(const char_t *dst_name, const char_t *name, std::vector &attr_value) const;
graphStatus GetInputAttr(const int32_t index, const char_t *name, std::vector &attr_value) const;
graphStatus GetInputAttr(const char_t *dst_name, const char_t *name, std::vector &attr_value) const;
graphStatus GetInputAttr(const int32_t index, const char_t *name, std::vector &attr_value) const;
graphStatus GetInputAttr(const char_t *dst_name, const char_t *name, std::vector &attr_value) const;
