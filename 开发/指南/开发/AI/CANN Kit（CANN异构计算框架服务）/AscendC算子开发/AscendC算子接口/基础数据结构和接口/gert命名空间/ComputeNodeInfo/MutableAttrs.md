...
获取算子的属性值，仅在算子IR原型定义和调用IMPL_OP宏注册的属性值会被返回，其他属性值被丢弃。 本方法与[GetAttrs](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-computenodeinfo-getattrs)的区别在于可以返回非const的属性对象。
...
auto compute_node_info = reinterpret_cast(ret.get());
