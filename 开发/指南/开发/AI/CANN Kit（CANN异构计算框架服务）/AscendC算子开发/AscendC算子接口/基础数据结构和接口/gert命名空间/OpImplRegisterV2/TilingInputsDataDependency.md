...
```text
OpImplRegisterV2 &TilingInputsDataDependency(std::initializer_list inputs);
OpImplRegisterV2 &TilingInputsDataDependency(std::initializer_list inputs, std::initializer_list placements);
```
