...
```text
__aicore__ inline void SetTensorB(const GlobalTensor& gm, bool isTransposeB = false)
__aicore__ inline void SetTensorB(const LocalTensor& rightMatrix, bool isTransposeB = false)
