...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-tque-vacantinque
...
true：表示Queue未满，可以继续EnQue操作。  false：表示Queue已满，不可以继续入队。
...
AscendC::LocalTensor tensor5 = que.AllocTensor();
