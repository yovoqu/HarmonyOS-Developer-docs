...
```text
__aicore__ inline void SetTensorA(const GlobalTensor& gm, bool isTransposeA = false)
__aicore__ inline void SetTensorA(const LocalTensor& leftMatrix, bool isTransposeA = false)
