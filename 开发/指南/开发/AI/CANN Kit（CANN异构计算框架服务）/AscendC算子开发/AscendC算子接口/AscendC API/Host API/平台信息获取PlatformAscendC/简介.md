...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-platformascendc-introduction
...
| 参数 | 输入/输出 | 说明 |
| --- | --- | --- |
| platformInfo | 输入 | platformInfo结构体，通过GetPlatformInfo接口可以获取。 |
