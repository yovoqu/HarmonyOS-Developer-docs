...
![](assets/AscendC简介/file-20260514132240150-0.png)
使用AscendC进行自定义算子开发的突出优势有： 遵循C/C++编程规范，匹配开发者开发习惯  自动并行调度，获得最优执行性能  结构化核函数编程，简化算子开发逻辑  CPU/NPU孪生调试，提升算子调试效率   开发者可以通过[AscendC主页](https://www.hiascend.com/zh/ascend-c)了解更详细的内容。
