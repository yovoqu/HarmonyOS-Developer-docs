...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/78/v3/eWAqIFEESjOoWhF0mNzgNg/zh-cn_image_0000002628861410.jpg?HW-CC-KV=V1&HW-CC-Date=20260701T041444Z&HW-CC-Expire=86400&HW-CC-Sign=4F019675FCA92E6414C1F7B44A828105FDA083245E81352E27C736C40F693393)
...
7. 游戏分辨率修正：当用户配置开关（isFeatureOn）为true、场景配置开关（isActive）为true并且设备状态（status）为AVALIABLE时，控显分离特性使能，游戏应用将游戏分辨率的高度修改为原来的一半，否则游戏分辨率的高度和折叠屏展开态的高度保持一致。
...
9. 用户退出控显示分离适用的游戏场景，则调用[HMS_XEG_RemoveControlDisplaySeparationStatusListener](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/xengine-kit-xengine#hms_xeg_removecontroldisplayseparationstatuslistener)，取消控显分离注册监听。       
```text
if(exit) {
