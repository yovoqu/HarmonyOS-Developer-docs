...
**图1** 主题字体的切换和使用
![](assets/使用主题字体（ArkTS）/file-20260514131642085-0.jpg)
...
请确保在设备系统**主题应用**中，能成功应用一项主题字体。 导入依赖的相关模块。
```text
...
> [!NOTE]
> 在生成段落对象设置段落样式入参时，不能指定fontFamilies属性，否则会变为优先使用指定字体而非主题字体。 若未在系统主题应用中设置一项主题字体，则将使用系统默认字体进行绘制。
...
![](assets/使用主题字体（ArkTS）/file-20260514131642085-1.png)
**图3** 主题字体2的效果
![](assets/使用主题字体（ArkTS）/file-20260514131642085-2.png)
