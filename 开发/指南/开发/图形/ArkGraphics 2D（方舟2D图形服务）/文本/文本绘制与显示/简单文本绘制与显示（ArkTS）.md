...
#### 开发步骤
1. 通过context获取到Canvas画布对象。 let canvas = context.canvas;
2. 初始化文本样式，此处设置字体颜色为红色，字体大小为100px。 // 获取文本样式
...
3. 初始化段落样式。 let myParagraphStyle: text.ParagraphStyle = {
  textStyle: myTextStyle,
};
4. 初始化段落对象，并添加文本。 let fontCollection = text.FontCollection.getGlobalInstance();
...
![](assets/简单文本绘制与显示（ArkTS）/file-20260525091645645-001.png)