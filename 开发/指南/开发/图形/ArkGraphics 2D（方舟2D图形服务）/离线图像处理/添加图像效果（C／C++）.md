...
6. 可使用OH_Filter_Brighten()接口在滤镜中添加提亮效果。
...
7. 可使用OH_Filter_GrayScale()接口在滤镜中添加灰度效果。
...
8. 可使用OH_Filter_Invert()接口在滤镜中添加反色效果。
...
9. 获取经过滤镜处理后的OH_PixelmapNative像素图对象。
...
10. 当不再需要滤镜生成图像效果后，请及时使用OH_Filter_Release()销毁OH_Filter对象。
