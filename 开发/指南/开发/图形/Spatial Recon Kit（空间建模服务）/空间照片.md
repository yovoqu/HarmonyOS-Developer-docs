...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/hJwPeYePTpmkOy1mjn7Flw/zh-cn_image_0000002659220715.png?HW-CC-KV=V1&HW-CC-Date=20260701T025440Z&HW-CC-Expire=86400&HW-CC-Sign=BCC3585FCE3A0F8DBC681DBE202CBA581ED97DD8B907BB3EC53040CD6DE30AB0)
...
```text
async function initSpatialImage(): Promise {
...
```text
async function generate3DModel(pixelMap: image.PixelMap, uri: string): Promise {
...
```text
private currentGeneratePromise: Promise | null = null;
