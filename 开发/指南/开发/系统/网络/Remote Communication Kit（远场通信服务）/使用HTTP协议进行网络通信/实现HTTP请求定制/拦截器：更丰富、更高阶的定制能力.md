...
![](assets/拦截器：更丰富、更高阶的定制能力/file-20260514131257936-0.png)
> [!NOTE]
...
export class RequestUrlChangeInterceptor implements rcp.Interceptor {
  ...
  // 自定义请求处理逻辑
  async intercept(context: rcp.RequestContext, next: rcp.RequestHandler): Promise {
