...
| [on](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/nearlink-manager#on-statechange)(type: 'stateChange', callback: Callback): void | 订阅星闪开关状态变化事件。 |
| [off](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/nearlink-manager#off-statechange)(type: 'stateChange', callback?: Callback): void | 取消订阅星闪开关状态变化事件。 |
