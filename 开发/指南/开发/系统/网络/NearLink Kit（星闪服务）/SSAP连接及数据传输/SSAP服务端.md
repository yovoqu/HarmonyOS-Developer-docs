...
| [on](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/nearlink-ssap#onconnectionstatechange)(type: 'connectionStateChange', callback: Callback): void | 订阅连接状态变化事件。 |
| [on](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/nearlink-ssap#on-propertyread)(type: 'propertyRead', callback: Callback): void | 订阅客户端的读请求事件。 |
...
| [notifyPropertyChanged](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/nearlink-ssap#notifypropertychanged)(address: string, property: Property): Promise | 通知客户端property值更新。 |
