...
以下是示例中使用的主要接口，更多接口及使用方式请见[@ohos.zlib (Zip模块)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-zlib)。
...
1. 17800005 传入的数据错误
  ...
  可能原因和处理步骤，请参见错误码[17800005](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-zlib#section17800005-传入的数据错误)。
2. 17800007 传入的缓冲区错误

  可能原因和处理步骤，请参见错误码[17800007](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-zlib#section17800007-传入的缓冲区错误)。
