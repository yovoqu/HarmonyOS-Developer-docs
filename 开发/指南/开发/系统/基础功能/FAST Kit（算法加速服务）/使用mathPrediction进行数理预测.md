...
##### 开发步骤
 ...
 - 导入[mathPrediction](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/fast-kit-fast-math-prediction)模块。
 - 构造[IndexSample](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/fast-kit-fast-math-prediction#indexsample)接口数组，添加至少2个采样点。
 - 调用[predictIndex](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/fast-kit-fast-math-prediction#predictindex)函数进行预测。
 - 获取返回的预测结果。
