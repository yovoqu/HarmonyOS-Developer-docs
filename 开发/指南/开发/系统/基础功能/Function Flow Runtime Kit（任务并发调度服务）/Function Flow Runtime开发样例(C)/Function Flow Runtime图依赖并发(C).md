...
![](assets/Function%20Flow%20Runtime图依赖并发(C)/file-20260514131322409-2.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f0/v3/qymVohR3QaKOPUPhvm8Xjg/zh-cn_image_0000002611754483.png?HW-CC-KV=V1&HW-CC-Date=20260528T014550Z&HW-CC-Expire=86400&HW-CC-Sign=4C7D92DA03978F0F10687A151199AA911DDCE18A0855E87CDCE807CCDE3E5CBA)
...
> [!NOTE]
> ffrt_submit_h_f和ffrt_submit_f接口可以接收裸函数指针任务作为参数，如果任务存在前后处理可以参见 ffrt_alloc_auto_managed_function_storage_base 函数查看如何构造任务结构体。
...
> [!NOTE]
> ffrt_submit_f接口可以接收裸函数指针任务作为参数，如果任务存在前后处理可以参见 ffrt_alloc_auto_managed_function_storage_base 函数查看如何构造任务结构体。

 
各个任务在FFRT内部形成了一棵调用树：
 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/Kaen8BBWTQGJrfJMVINhsg/zh-cn_image_0000002581434548.png?HW-CC-KV=V1&HW-CC-Date=20260528T014550Z&HW-CC-Expire=86400&HW-CC-Sign=F3EBCDA6B321AD1B7F08611876D8DB38800C6CE493A5FEAC1B0E03D47C87C014)
...
| 名称 | 描述 |
| --- | --- |
| ffrt_submit_f | 提交任务调度执行。 说明：从API version 20开始，支持该接口。 |
| ffrt_submit_h_f | 提交任务调度执行并返回任务句柄。 说明：从API version 20开始，支持该接口。 |
