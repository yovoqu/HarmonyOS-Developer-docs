...
当应用需要获取当前设备状态时，可以调用Stationary模块，例如：需要判断当前设备处于绝对静止状态或者相对静止状态。 详细的接口介绍请参考[@ohos.stationary (设备状态感知框架)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-stationary)。
...
if ((algoPara_.resultantAcc > RESULTANT_ACC_LOW_THRHD) && (algoPara_.resultantAcc
