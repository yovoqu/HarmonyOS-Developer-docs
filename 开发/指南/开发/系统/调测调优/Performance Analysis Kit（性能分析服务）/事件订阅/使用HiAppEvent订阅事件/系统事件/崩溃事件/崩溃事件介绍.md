...
| OH_APP_CRASH_PARAM_COLLECT_MINIDUMP collect_minidump | const char* | 否 | 是否启动minidump。 "true"：在Native Crash场景同时生成minidump。 "false"：在Native Crash场景不生成minidump。 生成minidump日志文件以.dmp结尾，跟随APP_CRASH事件一起返回，保存在external_log字段中。 |
