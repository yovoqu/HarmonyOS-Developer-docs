...
> [!NOTE]
> 从API版本26.0.0开始，如果已经通过errorManager接口监听了可捕获异常，则HiAppEvent将无法订阅 JsError崩溃 问题。
...
| setDefaultFreezeObserver(defaultObserver?: FreezeObserver) : FreezeObserver | 仅允许在主线程调用，发生APP_FREEZE异常时，支持链式回调，返回值为上一次注册的处理器。 说明：从API版本26.0.0开始，支持该接口。 模型约束： 此接口仅可在Stage模型下使用。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/a2Q_L9GlTNeHEUcwuPOSjw/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260624T020859Z&HW-CC-Expire=86400&HW-CC-Sign=E2A19601E8D0658C5C264B2303497298F86A740A59C0B53A08A63F273632A3C9)
