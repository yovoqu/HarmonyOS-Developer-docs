...
> [!NOTE]
> module.json文件为DevEco Studio编译构建产物，其中的字段与配置文件的对应关系，请参考 表1 module.json与配置文件属性的对照表 。
...
**APPQF打包合法性校验**
 ...
 - 所有HQF不得重复。HQF重复是指同时满足以下两个条件：       1. 两个HQF的patch.json文件中module下的name字段相同。
...
2. 如果是独立skill模块，确保[app.json5](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-configuration-file)中bundleType和[module.json5](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-configuration-file)中type均配置为skill。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/05/v3/mfMgd91bQqutuqU55PYbdQ/zh-cn_image_0000002686086623.png?HW-CC-KV=V1&HW-CC-Date=20260730T071933Z&HW-CC-Expire=86400&HW-CC-Sign=FDB9E3A05622F1DF2685A35085000E8C081A8AF9B57A023FAA15F09397893FFC)
...
3. 检查[module.json5](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-configuration-file)，确保type配置为shared或skill。
...
5. --json-path指定的module.json文件中bundleType是appPlugin时，module.json文件不包含[ohos.permission.kernel.SUPPORT_PLUGIN](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/restricted-permissions#ohospermissionkernelsupport_plugin)权限。
