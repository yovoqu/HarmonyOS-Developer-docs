...
**流程说明：**
1. 开发者应用调用[on](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/devicesecurity-superprivacymode-api#onsuperprivacymodechange)接口订阅超级隐私模式状态改变事件。
...
2. 调用[on](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/devicesecurity-superprivacymode-api#onsuperprivacymodechange)接口订阅超级隐私模式状态改变事件。
...
3. 调用[off](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/devicesecurity-superprivacymode-api#offsuperprivacymodechange)接口取消订阅超级隐私模式状态改变事件。
