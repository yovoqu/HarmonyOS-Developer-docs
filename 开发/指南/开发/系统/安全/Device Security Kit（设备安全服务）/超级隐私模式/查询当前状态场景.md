...
**流程说明：**
1. 开发者应用调用[getSuperPrivacyMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/devicesecurity-superprivacymode-api#getsuperprivacymode)接口查询当前超级隐私模式状态。
...
2. 调用[getSuperPrivacyMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/devicesecurity-superprivacymode-api#getsuperprivacymode)接口查询超级隐私模式的状态。
