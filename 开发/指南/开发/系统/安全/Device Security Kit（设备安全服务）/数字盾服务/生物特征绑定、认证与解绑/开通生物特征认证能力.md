...
4. 调用数字盾密码认证接口[trustedAuthentication](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/devicesecurity-trusted-auth-api#trustedauthenticationtrustedauthentication)发起生物特征认证前的密码认证申请。
