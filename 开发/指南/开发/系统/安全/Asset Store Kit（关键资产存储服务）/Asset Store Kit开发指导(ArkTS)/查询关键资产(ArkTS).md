...
开发者可以查阅API文档，获取关键资产查询接口的详细说明：异步接口[query(query: AssetMap)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-asset#assetquery)、同步接口[querySync(query: AssetMap)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-asset#assetquerysync12)。

在查询关键资产时，关键资产属性的内容（AssetMap）参数如下表所示：


![](assets/查询关键资产(ArkTS)/file-20260514131036964-0.png)
