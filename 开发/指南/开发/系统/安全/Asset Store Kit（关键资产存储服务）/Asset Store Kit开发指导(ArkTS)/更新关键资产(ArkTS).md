...
开发者可以查阅API文档，获取关键资产更新接口的详细说明：异步接口[update(query: AssetMap, attributesToUpdate: AssetMap)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-asset#assetupdate)、同步接口[updateSync(query: AssetMap, attributesToUpdate: AssetMap)](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-asset#assetupdatesync12)。

在更新关键资产时，关键资产属性的内容（AssetMap）参数如下表所示：


![](assets/更新关键资产(ArkTS)/file-20260514131036601-0.png)
