...
开发者可以查阅API文档，获取关键资产更新接口的详细说明：[OH_Asset_Update](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-asset-api-h#oh_asset_update)。 在更新关键资产时，关键资产属性的内容参数如下表所示：
![](assets/更新关键资产(C／C++)
/file-20260514131039066-0.png) 下表中“ASSET_TAG_ALIAS”和名称包含“ASSET_TAG_DATA_LABEL”的关键资产属性，用于存储业务自定义信息，其内容不会被加密，请勿存放敏感个人数据。 **query的参数列表：**
...
更新别名是demo_alias的关键资产，将关键资产明文更新为demo_pwd_new，附属信息更新成demo_label_new。 在指定群组中更新一条关键资产的示例代码详见[更新群组关键资产](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/asset-native-group-access-control#更新群组关键资产)。 在CMake脚本中链接相关动态库。
```text
