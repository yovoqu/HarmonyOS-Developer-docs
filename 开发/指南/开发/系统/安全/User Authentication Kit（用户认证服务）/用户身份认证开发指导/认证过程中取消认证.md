...
具体参数、返回值、错误码等描述，请参考对应的[cancel](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-useriam-userauth#cancel10)。 此处仅展示了取消认证操作的接口，在取消认证前，需要先发起认证，发起认证的接口列表、详细说明可参考[发起认证](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/start-authentication)章节和API文档。
| 接口名称 | 功能描述 |
| --- | --- |
