...
2. 通过调用接口[isolateThreatFile](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/erprisethreatprotection-virusremediation-interface#isolatethreatfile)，实现对恶意文件的安全隔离。path参数为目标文件的绝对路径。
