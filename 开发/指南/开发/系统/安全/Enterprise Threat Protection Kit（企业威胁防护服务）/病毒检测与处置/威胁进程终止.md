...
```
 ...
 - 调用接口[terminateProcess](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/enterprisethreatprotection-virusremediation-interface#terminateprocess)，实现终止指定PID的威胁进程。
