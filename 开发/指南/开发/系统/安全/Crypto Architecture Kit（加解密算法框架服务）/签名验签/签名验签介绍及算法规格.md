...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c8/v3/fOlZ5As6StibMM12khPcjA/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260730T071913Z&HW-CC-Expire=86400&HW-CC-Sign=67C303E366B6D44A31DF6D5D0C70BC6761CD1116E90A4C34DE4001750304DAB9)
...
> [!NOTE]
> 从API版本26.0.0开始，支持PSS模式的OnlySign/OnlyVerify。 使用的非对称密钥类型、摘要与掩码摘要取值范围、以及长度限制要求与上文PSS模式签名验签规格保持一致。
...
> [!NOTE]
> 从API版本26.0.0开始，支持ECC的OnlySign/OnlyVerify。 不支持空消息的验签。
