...
##### 摘要算法（一次性传入）
1. 调用[OH_CryptoDigest_Create](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-crypto-digest-h#oh_cryptodigest_create)，指定摘要算法MD5，生成摘要实例（OH_CryptoDigest）。
