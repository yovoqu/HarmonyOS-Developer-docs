...
从API版本26.0.0开始，支持分组密码算法[RC2](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-sym-key-generation-conversion-spec#rc2)，分组长度为64位，密钥长度支持8位～1024位。
...
从API版本26.0.0开始，支持流密码算法[RC4](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-sym-key-generation-conversion-spec#rc4)，无需分组与填充。密钥长度支持8位～4096位。
...
从API版本26.0.0开始，支持密码算法[Blowfish](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-sym-key-generation-conversion-spec#blowfishbf)，是一种分组密码算法，分组长度为64位，密钥长度支持32位～448位。
...
从API版本26.0.0开始，支持分组密码算法[CAST](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-sym-key-generation-conversion-spec#cast)，分组长度为64位，密钥长度支持40位～128位。

[CAST](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-sym-key-generation-conversion-spec#cast)为分组密码算法，分组长度为64位，密钥长度支持40位～128位。
