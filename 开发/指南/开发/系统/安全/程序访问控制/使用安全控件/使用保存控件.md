...
#### 约束与限制
 ...
 - 保存控件仅支持在[WindowType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-e#windowtype7)中定义的应用主窗口和子窗口中使用，且不支持在[UIExtension](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-uiextension)中使用。
 - 用户点击一次控件，仅获取一次授权调用。
