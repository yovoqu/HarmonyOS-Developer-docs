...
> [!NOTE]
> 请参考 sample-FIDOclientdemo （见 网站链接免责声明 ）。
...
> [!NOTE]
> 请参考 sample-IFAAclientdemo （见 网站链接免责声明 ）。
...
> [!NOTE]
> 请参考 samplecode-SOTERclientdemo （见 网站链接免责声明 ）。
...
> [!NOTE]
> 请参考 samplecode-FIDO2clientdemo-arkts 以及 samplecode-FIDO2clientdemo-cpp （见 网站链接免责声明 ）。
