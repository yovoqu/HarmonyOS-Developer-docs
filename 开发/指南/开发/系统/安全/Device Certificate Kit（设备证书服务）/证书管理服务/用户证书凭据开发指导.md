...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/certmanager-user-credential-guidelines
...
用户证书凭据功能提供了用户级别的证书凭据（包含证书链和私钥）的安全存储、授权管理和签名能力。用户证书凭据的公私钥对存储在[Universal Keystore Kit](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/huks-overview)。
 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/03/v3/hNmTYq9OQt68rlrAZasxCQ/zh-cn_image_0000002659100315.png?HW-CC-KV=V1&HW-CC-Date=20260701T025432Z&HW-CC-Expire=86400&HW-CC-Sign=2E2826B30EEF58281C7022C09BD84E88DE77B6CF854586B53CE1D6C1E8CA78B3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/qvKaFiyASYKAzMeyFsc14w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025432Z&HW-CC-Expire=86400&HW-CC-Sign=B022CF0CD5AD7EB4B3859857B64163624D47DEEC9F2CD37FD2FB2C426A590DCF)
 
 
本开发指导需使用API版本23及以上版本SDK。
  
用户证书凭据在用户授权后，可以被其他应用访问和使用，如您的应用安装的证书凭据不希望其他应用访问，请使用“[应用证书凭据](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/certmanager-private-credential-guidelines)”功能。
...
用户证书凭据的安装和签名、验签操作，依赖[密钥管理服务](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/huks-overview)（HUKS）能力。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/ldC8DMm7Qhqa5cGUed8bEA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025432Z&HW-CC-Expire=86400&HW-CC-Sign=3495A6BA9530892A1641638F3D442150F084C42560E9D2AC0A3579F5EEF79D4D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/18/v3/Nn3YO9PCQeGU6pNYQusGqg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025432Z&HW-CC-Expire=86400&HW-CC-Sign=077646BD549188908BEDB500B44AD6C326B012889AA0290287555B912387CAC9)
...
调用init接口初始化签名会话，传入安装接口返回的KeyUri和签名算法参数（如：填充方式和摘要算法），并返回签名会话的句柄handle。
- 调用update接口传入签名会话的句柄handle和待签名的数据。如果待签名的数据量比较大，可以调用多次update接口，每次传入部分数据。
- 调用finish接口结束签名会话并获取签名数据。

  

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/20/v3/OrAgdke8Q22mjoImoUVxAQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025432Z&HW-CC-Expire=86400&HW-CC-Sign=CF15F06A83EFB5C163535EE93162C238266615403B14B6652016609A3CD1366F)
 
 
签名、验签操作支持的参数组合，详见HUKS声明的[签名/验签介绍及算法规格](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/huks-signing-signature-verification-overview)中RSA、ECC及SM2的描述。
...
async function signAndVerify(keyUri: string): Promise {
  try {
