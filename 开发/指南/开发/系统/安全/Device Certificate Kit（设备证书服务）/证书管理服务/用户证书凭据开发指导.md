...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/03/v3/hNmTYq9OQt68rlrAZasxCQ/zh-cn_image_0000002659100315.png?HW-CC-KV=V1&HW-CC-Date=20260701T041504Z&HW-CC-Expire=86400&HW-CC-Sign=2DBA9256958AA969BBDC645C22537CDB796A555C5AE8A1A0A612A1EEF41B91AA)
...
> [!NOTE]
> 本开发指导需使用API版本23及以上版本SDK。 用户证书凭据在用户授权后，可以被其他应用访问和使用，如您的应用安装的证书凭据不希望其他应用访问，请使用“ 应用证书凭据 ”功能。
...
> [!NOTE]
> 用户证书凭据功能当前仅支持RSA、ECC及SM2算法类型的证书和私钥。 openInstallCertificateDialog接口当前只支持P12格式的密钥库文件。
