...
调用[证书CMS封装](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/create-cms-enveloped-object)进行CMS数据封装。 调用[cert.createCmsParser](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#certcreatecmsparser22)创建CmsParser对象。 调用[cmsParser.setRawData](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#setrawdata22)设置CMS数据。 调用[cmsParser.decryptEnvelopedData](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#decryptenvelopeddata22)解密封装数据。 解封装示例：
```text
import { cert } from '@kit.DeviceCertificateKit';
