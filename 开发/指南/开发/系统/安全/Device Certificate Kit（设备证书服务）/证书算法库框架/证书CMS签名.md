...
调用[cert.createCmsGenerator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#certcreatecmsgenerator18)创建cmsGenerator对象。 调用[cmsGenerator.addSigner](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#addsigner18)添加签名者信息。 调用[cmsGenerator.addCert](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#addcert18)添加证书。 调用[cmsGenerator.doFinal](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#dofinal18)获取Cms最终签名数据。 异步方法示例：
```text
import { cert } from '@kit.DeviceCertificateKit';
