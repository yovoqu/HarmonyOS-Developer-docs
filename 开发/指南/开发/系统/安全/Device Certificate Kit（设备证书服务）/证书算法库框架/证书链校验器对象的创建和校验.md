...
2. 调用[cert.createCertChainValidator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#certcreatecertchainvalidator)创建证书链校验器对象。
