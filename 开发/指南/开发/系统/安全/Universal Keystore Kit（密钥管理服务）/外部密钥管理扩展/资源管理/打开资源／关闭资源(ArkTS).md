...
const openResourceParams: Array = [];

async function openResource(): Promise {
  try {
...
const closeResourceParams: Array = [];

async function closeResource(): Promise {
  try {
