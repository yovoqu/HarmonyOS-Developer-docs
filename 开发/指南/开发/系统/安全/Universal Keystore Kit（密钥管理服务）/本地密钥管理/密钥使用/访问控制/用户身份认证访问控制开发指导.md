...
/* 生成SM4密钥 */
async function step1GenerateKey(): Promise {
...
function initSession(keyAlias: string, huksOptions: huks.HuksOptions,
  throwObject: ThrowObject): Promise {
  return new Promise((resolve, reject) => {
    try {
...
/* 初始化会话并获取挑战值 */
async function step2InitSession(): Promise {
...
/* 使用认证令牌进行加密 */
async function step4EncryptWithToken(): Promise {
