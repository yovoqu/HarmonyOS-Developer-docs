...
#### 生效方式
 ...
 - 播放对端声音时，AudioRendererInfo中的usage需设置为[STREAM_USAGE_VOICE_COMMUNICATION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-e#streamusage)或者[STREAM_USAGE_VIDEO_COMMUNICATION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-e#streamusage)，用于标识VoIP语音通话播放流。该类型的播放流起播时，会触发开启3A算法。
 - 录制本端声音时，AudioCapturerInfo中的source需设置为[SOURCE_TYPE_VOICE_COMMUNICATION](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-audio-e#sourcetype8)，用于标识语音通话采集流。
 - 播放和录制具体开发流程见下文[音频通话功能](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/audio-call-development#音频通话功能)。
