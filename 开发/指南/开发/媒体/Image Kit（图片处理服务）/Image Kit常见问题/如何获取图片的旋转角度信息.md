...
ArkTS场景下读取和编辑图片的旋转角度信息，可参考：[读取和编辑图片Exif信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-tool)，对应的propertyKey需要设置为：ORIENTATION。

C/C++场景下读取和编辑图片的旋转角度信息，可参考：[使用Image_NativeModule读取和编辑图片Exif信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-tool-c)，对应的key需要设置为：OHOS_IMAGE_PROPERTY_ORIENTATION。
