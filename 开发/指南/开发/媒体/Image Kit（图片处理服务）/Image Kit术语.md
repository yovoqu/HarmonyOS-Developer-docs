...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-glossary
...
##### [h2]Animated Image；动图

由多帧图像按时间顺序播放形成的图片资源。
 
  

##### [h2]Auxiliary Picture；辅助图
...
##### [h2]Color Space Conversion；色彩空间转换
...
##### [h2]Exchangeable image file format (Exif)；可交换图像文件格式

记录照片属性和拍摄信息的图像元数据格式，可包含拍摄时间、方向、焦距、地理位置等字段。
 
  

##### [h2]Extensible Metadata Platform (XMP)；可扩展元数据平台
...
##### [h2]Standard Dynamic Range (SDR)；标准动态范围
