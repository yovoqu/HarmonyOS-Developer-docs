...
```ArkTS
async createXMPMetadata(): Promise {
...
```ArkTS
async readXMPMetadataFromImage(imageSource: image.ImageSource): Promise {
...
```ArkTS
async operateXMPMetadata(xmpMetadata: image.XMPMetadata): Promise {
  try {
    // 设置xmp:title标签的值。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2b/v3/_CzWDZAbSeaoS4thAsT9jQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025438Z&HW-CC-Expire=86400&HW-CC-Sign=A3AC562C026D4FE49EBD96F3C0ADEBF3151821B5A7C85BFDB2F623AF650F3532)
...
```ArkTS
async writeXMPMetadataToImage(imageSource: image.ImageSource, xmpMetadata: image.XMPMetadata): Promise {
  try {
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/K6GoLqoSSNKPC1ZZKXQOEA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025438Z&HW-CC-Expire=86400&HW-CC-Sign=1886E8828565640598415DC1DD6C7CB26740DDC5C69A5A8115F9373FD1BAA130)
       
       
 - 使用标准命名空间（如xmp、dc、exif等）时，无需额外注册。Image Kit支持但不限于[常量](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-c#常量)中定义的标准命名空间。
 - 使用自定义命名空间时，需要先通过[registerXMPNamespace](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-xmpmetadata#registerxmpnamespace)完成注册。
...
```ArkTS
async setAndGetBasicTag(xmpMetadata: image.XMPMetadata): Promise {
  try {
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/jQUGGuFXS2-NBBqh125pyw/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025438Z&HW-CC-Expire=86400&HW-CC-Sign=678312A510E97FE576F4BB01D5D646CD66D607E16CEC394564AE4A14AF43D214)
...
```ArkTS
async createArrayAndAddElements(xmpMetadata: image.XMPMetadata): Promise {
  try {
    // 创建无序数组容器。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/45nZokUjSoem2O2f0l0b0A/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025438Z&HW-CC-Expire=86400&HW-CC-Sign=34827D5C1EB327F8EB8859844423D8606D0DC9F775470C2886A50AFFF7F0149E)
...
```ArkTS
async createStructAndOperateMembers(xmpMetadata: image.XMPMetadata): Promise {
  try {
    // 创建结构体父节点。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/iSD8iUd0QeCw_NLK3vc7_Q/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025438Z&HW-CC-Expire=86400&HW-CC-Sign=087CF63ED6492DD2FB9923C983AA3632DD5677EFF6726CDBE3DA63B9D9E963B7)
...
```ArkTS
async setAndGetQualifierValue(xmpMetadata: image.XMPMetadata): Promise {
  try {
...
```ArkTS
async setLanguageQualifier(xmpMetadata: image.XMPMetadata): Promise {
  try {
    // 创建语言替代数组容器。
...
##### [h2]命名空间前缀（仅rootPath支持）
     
仅指定命名空间前缀，遍历该命名空间下所有标签。
     
      
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/01/v3/rkIZwLi_SYm-TVhmuwWcFw/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025438Z&HW-CC-Expire=86400&HW-CC-Sign=CFBFD742691E7ADAD1D035E34D5E165BE486D65386261AE1A6F20AA2B299AD18)
...
```ArkTS
async enumerateNamespaceTags(xmpMetadata: image.XMPMetadata): Promise {
  try {
