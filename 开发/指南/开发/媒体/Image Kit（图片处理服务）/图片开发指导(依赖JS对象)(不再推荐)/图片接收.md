...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-receiver-native
...
struct Index {
  ...
  func (){
     ...
     abilityAccessCtrl.createAtManager().requestPermissionsFromUser(context,['ohos.permission.CAMERA']).then(async () => {
        ...
        if (cameraDevices.length  = profiles.previewProfiles;
...
static napi_value createFromReceiver(napi_env env, napi_callback_info info)
{
   ...
   char * surfaceId = static_cast(malloc(sizeof(char)));
