...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9c/v3/JL0L9RzRR_6MuavaWhitkA/zh-cn_image_0000002686086679.png?HW-CC-KV=V1&HW-CC-Date=20260730T072205Z&HW-CC-Expire=86400&HW-CC-Sign=761F1AA81327C964E4797BDB96B158B38B0D56A3BCD46996A27A46AFA87E4068)

 
在视频文件编码（以MP4文件编码为例）时，首先会通过视频编码器对YUV数据进行编码，将未压缩的视频数据YUV压缩成视频码流H.264，然后，将编码后的媒体数据按一定的格式封装存储到MP4文件里，流程如下所示。
 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4b/v3/h6SMPsWGS7e-OtTN_V_RvQ/zh-cn_image_0000002685926851.png?HW-CC-KV=V1&HW-CC-Date=20260730T072205Z&HW-CC-Expire=86400&HW-CC-Sign=3FCEFE95C9E9A28D4F466EA21242772A8E8557FD67CFF61E934669859DD1352A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f0/v3/_tmIuyQvSnyxiLmNZflybA/zh-cn_image_0000002656007172.png?HW-CC-KV=V1&HW-CC-Date=20260730T072205Z&HW-CC-Expire=86400&HW-CC-Sign=CB7F9BD8D1397EF158D0AF0C114A9003DF4F388583E161492D15EEA1E095E8DE)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/YjdOe9ZbT8aYvt4ZDNPkfg/zh-cn_image_0000002655847252.png?HW-CC-KV=V1&HW-CC-Date=20260730T072205Z&HW-CC-Expire=86400&HW-CC-Sign=63DADE198A779C45EC481FB16E89DBF011F4ECA8F2C0B0BD950DAAFFEFF0C795)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/a-rtMg-JSeCYreDzqtDG7Q/zh-cn_image_0000002686086681.png?HW-CC-KV=V1&HW-CC-Date=20260730T072205Z&HW-CC-Expire=86400&HW-CC-Sign=EC53DC7BE0BDE7F317E0945523729BE3D2FCD992224B0909D82DA9705100D343)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/r6Wodge3S8KQOigM-7EnWw/zh-cn_image_0000002685926853.png?HW-CC-KV=V1&HW-CC-Date=20260730T072205Z&HW-CC-Expire=86400&HW-CC-Sign=A7A54E919C0CD61143BCDFF0E5E6FC985C7B8268381832E640E3D8E97B43891D)

 
**视频文件解码**开发步骤如下所示。
 1. 通过inputBufferInfoQueue获取视频缓存空地址。
2. 通过Demuxer读取媒体数据，即视频码流数据及其格式。
3. 在OH_VideoDecoder_PushInputBuffer()中设置对应的视频缓存数据。
4. 在解码完成后，通过outputBufferInfoQueue获取视频缓存数据。
5. 处理缓存数据，最后通过OH_VideoDecoder_FreeOutputBuffer()刷新缓存，将缓存资源返回给解码器。
...
3. 通过OH_VideoEncoder_PushInputBuffer()将已填充的输入缓存提交给编码器。
...
> [!NOTE]
> 系统支持的封装格式有限，支持的格式列表请参考 AVCodec支持的格式 。 常规视频转码、录制、播放场景均包含音、视频双路流。本示例仅聚焦视频流处理，相关能力请参考 音视频编解码 。
...
> 在处理跨距时，需要注意size属性的计算与设置，如果size的大小和设置buffer的大小不一致，视频编解码时会出现buffer数据丢失。
  ...
  视频编解码包含两种方式，分别是Surface模式和Buffer模式。在Surface模式下，会通过window对象对接其他模块，如相机、屏幕录制等模块。相对于Surface模式，Buffer模式对于视频数据处理更加灵活，也更为复杂。关于Surface模式和Buffer模式的区别可以参考[视频编码](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/video-encoding)。
