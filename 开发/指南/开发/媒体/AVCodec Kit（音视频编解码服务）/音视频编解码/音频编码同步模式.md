...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/46/v3/Ti2bfhCpTQa_B0AEF5woIg/zh-cn_image_0000002656007146.png?HW-CC-KV=V1&HW-CC-Date=20260730T071938Z&HW-CC-Expire=86400&HW-CC-Sign=B6D68C6649B6B5ADAA520072A590779B17CD1B416A554650D064CD36B4065C5C)


  各音频编码类型参数范围说明：

  
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/15/v3/OrHHkj5kQIS4ZXRU_7K-8A/zh-cn_image_0000002655847226.png?HW-CC-KV=V1&HW-CC-Date=20260730T071938Z&HW-CC-Expire=86400&HW-CC-Sign=E3BA3C8D31557B41FA7A47C52858719BFE8F5F48EA390018ADD04527554319B1)
...
4. （可选）调用OH_AudioCodec_Reset()重置编码器。
...
5. （可选）调用OH_AudioCodec_Stop()停止编码器。
...
6. 调用OH_AudioCodec_Destroy()销毁编码器实例，释放资源。
