...
function getWhiteBalanceRange(session: camera.PhotoSession | camera.VideoSession): Array {
   ...
   try {
      ...
      if(whiteBalance >= range[0] && whiteBalance
