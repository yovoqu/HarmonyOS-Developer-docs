...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/49/v3/Y52-wTy_RIGbYvZ8bCE6wg/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260528T014719Z&HW-CC-Expire=86400&HW-CC-Sign=F60E0EE96F480820C741D997CC443F1429E2430B90411E794F5BF0AE6A97708F)
...
| 类型 | 形式 | 举例 | 说明 |
| --- | --- | --- | --- |
| URI | file://media/Photo/&lt;ID&gt;/<真实文件名(无后缀)>/&lt;displayName&gt; | 图片： file://media/Photo/111/IMG_1234567890_123/A.jpg 视频： file://media/Photo/222/VID_1234567890_321/B.mp4 | 字段定义与使用方式详见媒体文件URI。 |
...
2. 删除真实文件名 + displayName部分：/data/storage/el2/media/Photo/111/
3. 删除路径尾部的更多层级。
4. 删除真实文件名部分：/data/storage/el2/media/Photo/111/A.jpg
5. 删除ID部分：/data/storage/el2/media/Photo/IMG_1234567890_123/A.jpg
6. 删除其他目录层级。
7. 修改生成的媒体路径。
