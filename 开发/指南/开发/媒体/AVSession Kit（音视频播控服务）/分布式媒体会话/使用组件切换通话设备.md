...
3. 创建VOICE_COMMUNICATION类型的AudioRenderer，并开始播放。具体通话音频播放等实现，请参考[开发音频通话功能](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/audio-call-development)。
...
系统不再提供音频输入设备切换的API，如果需要在应用内切换音频输入设备，可通过接入AVInputCastPicker组件来完成。相关参数可参考[@ohos.multimedia.avInputCastPicker](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ohos-multimedia-avinputcastpicker)和[@ohos.multimedia.avCastPickerParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-avcastpickerparam)。
