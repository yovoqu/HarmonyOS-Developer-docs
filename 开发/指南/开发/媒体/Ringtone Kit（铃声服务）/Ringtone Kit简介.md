...
Ringtone Kit支持将音频文件设置成多种铃声类型，满足各类铃声需求场景。 多种铃声类型：可设置来电铃声、通知铃声、信息铃声、闹钟铃声。  支持双卡铃声：可对双卡分别设置不同来电铃声和信息铃声。  铃声快捷管理：点击我的铃声按钮快速跳转“设置-声音与振动”管理铃声。   铃声设置组件效果图：
![](assets/Ringtone%20Kit简介/file-20260514131604122-0.jpg)
...
当不满足所需条件时，部分功能不可使用： 当HarmonyOS设备无SIM卡槽时，来电铃声和信息铃声设置功能将不可用。  设置的铃声最大时长为5分钟。
