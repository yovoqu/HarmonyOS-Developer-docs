...
- 场景一：**问题现象** 当前使用的DevEco Studio版本与SDK版本不配套，导致DevEco Studio抛出异常：“TypeError: Cannot read properties of undefined (reading 'split')”。
![](assets/编译报错“Cannot%20read%20properties%20of%20undefined%20reading%20'split'”/file-20260515130216575-0.png)
 **解决措施** 访问华为[开发者官网](https://developer.huawei.com/consumer/cn/download/deveco-studio)下载最新版DevEco Studio。
- 使用新版本DevEco Studio打开待迁移项目。
- 根据DevEco Studio自动弹出的迁移提示进行操作。点击“Migrate Assistant”功能。


![](assets/编译报错“Cannot%20read%20properties%20of%20undefined%20reading%20'split'”/file-20260515130216575-1.png)


- 从版本列表中选择目标迁移版本。


![](assets/编译报错“Cannot%20read%20properties%20of%20undefined%20reading%20'split'”/file-20260515130216575-2.png)
