...
- 使用USB方式，将Phone或Tablet与PC进行连接。
- 在设置>系统>开发者选项中，打开“USB调试”开关（确保设备已连接USB）。
- 在Phone或Tablet中会弹出“允许USB调试”的弹框如下图，单击允许。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a9/v3/_SFdtMcpTNmQPwrcEKwG2w/zh-cn_image_0000002628564958.png?HW-CC-KV=V1&HW-CC-Date=20260701T025909Z&HW-CC-Expire=86400&HW-CC-Sign=6D9938CED22623C7B29FF7C5628E0F7164D504F12DBF99C823540655153D6075)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/JM8hoVC2SA2qqBqPdh4rbA/zh-cn_image_0000002628405052.png?HW-CC-KV=V1&HW-CC-Date=20260701T025909Z&HW-CC-Expire=86400&HW-CC-Sign=139A4FF5DF6C3BB5F9D0A7D1D8C8F9DFC1D49D79F9523F806BD337CD00304651)

- 在PC中执行hdc tconn设备IP地址:端口号命令连接设备。
...
- 检查设备系统与DevEco Studio版本、SDK版本是否配套，请参考[所有HarmonyOS版本](https://developer.huawei.com/consumer/cn/doc/harmonyos-releases/overview-allversion)。
- 根据电脑的操作系统，点击[下载地址](https://developer.huawei.com/consumer/cn/download/deveco-studio)选择对应的DevEco Studio版本。
- 判断hdc与设备的连接情况，判断命令：hdc list targets、hdc shell。
- 如果上述两个命令不正常，可参考[常见问题](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hdc#常见问题)处理解决。
...
- 请在cmd中执行hdc list targets命令查询能否识别到设备。
- 如提示“不是内部或外部命令”，请前往DevEco Testing安装路径，找到hdc.exe（Program Files\DevEco Testing\app\resources\bin），拖入cmd中再次执行hdc list targets命令。
- 若能识别到，请在任务管理器中，将hdc线程kill后，重新进入DevEco Testing创建任务页，查看设备列表是否显示。
- 检查当前DevEco Testing版本是否为最新，可以前往[下载中心](https://developer.huawei.com/consumer/cn/download/)更新到最新版本，重新尝试连接设备。
