...
- **场景一：内网环境，项目构建失败：**
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ad/v3/KbKaLJXeRv-_-J4MIcufig/zh-cn_image_0000002692927757.png?HW-CC-KV=V1&HW-CC-Date=20260811T005524Z&HW-CC-Expire=86400&HW-CC-Sign=96A6BD7A3B5D065B4C3E9424B7F53437EACAC576C861E0D9D7F40966E0011715)
...
- **场景一：**1. 需要配置npm代理，首先进入C:\Users\用户名目录，打开.npmrc文件。如果该目录下没有.npmrc文件，请新建一个。
...
- **场景二：**1、如果需要通过代理才能正常访问网络，可以参照文档[配置IDE的代理](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-environment-config#section10369436568)；
...
- **场景三：**
内网环境中要使用自动签名需放开下面三个域名：devecostudio-drcn.deveco.dbankcloud.com。

  connect-api.cloud.huawei.com。

  nsp-appgallery-agcfs-drcn.obs.cn-north-2.myhuaweicloud.cn。
- 若内网环境无法放开上述域名，可使用手动签名替代自动签名实现内网安装调试。在外网环境中申请好证书后，将证书文件导入内网环境即可进行调试。手动签名配置请参考[配置调试签名](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-signing)。
