...
- [创建HarmonyOS工程](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-create-new-project#section11644183711342)，在工程目录\entry\src\main\ets\pages\Index.ets中编写被测页面。
```text
@Entry
@Component
struct SliderDemo {
...
- 创建Instrument Test的[ArkTS测试用例](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-instrument-test#section36049271219)，在工程目录\entry\src\ohosTest\ets\test\uitest.test.ets中实现单元测试代码。
```text
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0f/v3/_nmGKaJYRkeCK8secwaUnQ/zh-cn_image_0000002658808909.png?HW-CC-KV=V1&HW-CC-Date=20260701T025923Z&HW-CC-Expire=86400&HW-CC-Sign=666AD25561FF910EBF3878320F638EFBBC85A47987689728472A4752B8C395A7)
