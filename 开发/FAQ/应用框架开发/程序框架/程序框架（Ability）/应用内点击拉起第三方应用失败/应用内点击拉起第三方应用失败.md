...
```text
let <span style="color: rgb(0,0,255);">link</span><span style="color: rgb(181,106,1);">: </span><span style="color: rgb(0,0,255);">string </span><span style="color: rgb(181,106,1);">= </span><span style="color: rgb(255,0,170);">"https://www.example.com/programs?action=showall"</span><span style="color: rgb(181,106,1);">;</span>
```
...
```text
let <span style="color: rgb(0,0,255);">want</span><span style="color: rgb(181,106,1);">: </span><span style="color: rgb(0,0,255);">Want </span><span style="color: rgb(181,106,1);">= </span><span style="color: rgb(255,0,170);">{ </span><span style="color: rgb(0,0,255);">uri</span><span style="color: rgb(181,106,1);">: </span><span style="color: rgb(255,0,170);">"link://www.example.com" </span><span style="color: rgb(255,0,170);">}</span><span style="color: rgb(181,106,1);">;</span>
```
