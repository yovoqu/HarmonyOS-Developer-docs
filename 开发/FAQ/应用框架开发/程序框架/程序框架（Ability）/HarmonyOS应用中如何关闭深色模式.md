...
- 应用主动设置深浅色模式的场景。如果应用调用[setColorMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-inner-application-uiabilitycontext#setcolormode18)接口主动设置了深浅色，则以接口效果优先。
