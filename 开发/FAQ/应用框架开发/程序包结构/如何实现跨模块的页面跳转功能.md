...
```text
<em>// Import a custom component of the Login module</em>
  ...
  build() {
    Navigation(this.pathStack) {
      Button('jump to login page')
        .onClick(() => {
          <em>// The second parameter of NavPathInfo is a custom parameter that can be used for message transfer</em>
