...
- 在资源文件中添加中/英文的value值。默认语言（base文件）以及中文语言（zh_CN文件）写的是中文，英文语言（en_US文件）写的是英文。因此在偏好语言为英文时，显示en_US文件的内容；偏好语言为中文时，显示zh_CN文件的内容；偏好语言为其他语言时，显示base文件的内容。
 
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/1XDrbTGBSay6W35vK47mPw/zh-cn_image_0000002628663108.png?HW-CC-KV=V1&HW-CC-Date=20260701T025736Z&HW-CC-Expire=86400&HW-CC-Sign=5EDDD870E232674C71F4B7C92CC4802854D1D376612CD145C65D68DBA4E3D2BE)
