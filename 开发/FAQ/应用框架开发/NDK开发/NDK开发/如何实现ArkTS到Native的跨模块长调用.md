...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dd/v3/FX_zAxBRSuWzsFhuc-a8tw/zh-cn_image_0000002659258289.png?HW-CC-KV=V1&HW-CC-Date=20260701T025531Z&HW-CC-Expire=86400&HW-CC-Sign=544707C8FE08101C646BAEC273A2A521FC021AC9565C2035D6D9240EEEEA8B1B)
...
- har是集成到hap中的，其入口模块是hap，即entry模块。所以napi_load_module_with_info中：
...
- module_info：bundleName/moduleName的路径拼接。此处的moduleName指的是被加载的模块（har）所在的hap下module.json5中module节点的name属性。
