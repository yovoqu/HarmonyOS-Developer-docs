...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/sJRhDfCXTK2TLG-O9V4Exw/zh-cn_image_0000002628899124.png?HW-CC-KV=V1&HW-CC-Date=20260701T025736Z&HW-CC-Expire=86400&HW-CC-Sign=AF59E1A3C66B1F546CCC2CC9067193547AE89B9B6724402D76D721E4B9CB7B80)
...
- 问题一：
日志过滤ARKWEB-CONSOLE，查看H5页面有没有报错日志输出，获得如下日志，可知UNIApp未被定义。
```text
...
- 检查是否将ArkTS对象注册到Web组件中，成功注册会有如下日志输出。
```text
