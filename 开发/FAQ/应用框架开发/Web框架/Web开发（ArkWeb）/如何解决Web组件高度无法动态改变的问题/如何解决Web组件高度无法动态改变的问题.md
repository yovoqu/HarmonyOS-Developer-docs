...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/16/v3/4FAD7T_uSwGfZg1OHm-fuw/zh-cn_image_0000002628899134.png?HW-CC-KV=V1&HW-CC-Date=20260811T005841Z&HW-CC-Expire=86400&HW-CC-Sign=BF936BE1D5A2F580B1838A14A9CB63DA47CDAF4A7A68CF16B3D92B1ADAB98ED3)
...
3. 组件延伸到安全区域下，在安全区域处的事件，如点击事件等可能会被系统拦截，优先给状态栏等系统组件响应。
4. 滚动类容器内的组件不建议设置expandSafeArea属性，如果设置，需要按照组件嵌套关系，将当前节点到滚动类容器间所有子节点设置expandSafeArea属性，否则expandSafeArea属性在滚动后可能会失效。
5. 除了组件扩展其安全区域外，和键盘相关比较常见的还有**setKeyboardAvoidMode（控制虚拟键盘抬起时页面的避让模式）**、**getKeyboardAvoidMode（返回虚拟键盘抬起时的页面避让模式）**。
