...
- [detectBarcode.decodeImage](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/scan-imagedecode#detectbarcodedecodeimage)：通过配置参数调用图像数据识码能力，使用Promise异步回调返回识码结果。
