...
当卡片需要将数据同步至主应用时，与方案一致，通过[postCardAction](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-postcardaction)的message事件触发卡片onFormEvent生命周期，然后发布公共事件。
