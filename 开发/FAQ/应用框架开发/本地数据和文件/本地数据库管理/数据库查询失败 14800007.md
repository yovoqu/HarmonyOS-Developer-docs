...
async query( ) {
  ...
  let uuid = this.getString(resultSet, columnUuid)  <em>// report errors</em>
}
<em>/**</em>
<em> * Retrieve the string column value of the current row in the result set.</em>
<em> * @param resultSet</em>
<em> * @param columnName</em>
<em> * @returns</em>
<em> */</em>
