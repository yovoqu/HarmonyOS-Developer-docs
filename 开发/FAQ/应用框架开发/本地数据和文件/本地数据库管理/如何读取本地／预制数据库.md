...
<em>// Obtaining the Context in EntryAbility, save it to AppStorage, then use AppStorage to retrieve it in the utility class.</em>
...
function initDatabase() {
 <em> // Create a database sandbox directory</em>
  try {
 ...
 <em> // Read the db file in the rawfile directory</em>
  try {
