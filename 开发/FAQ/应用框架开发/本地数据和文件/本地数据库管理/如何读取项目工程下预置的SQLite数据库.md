...
- 若数据库预置在rawfile目录下，可使用[resourceManager.getRawFdSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-resource-manager#getrawfdsync10)接口获取对应资源的文件描述符（fd），再使用[fs.readSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fsreadsync)接口读取文件内容，结合[fs.writeSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fswritesync)接口将读取的内容写入到沙箱指定文件中。（可参考下述示例的saveRawFileToSandbox代码）
- 若数据库预置在resfile目录下，可使用[fs.openSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fsopensync)接口获取对应资源的文件描述符（fd），再使用[fs.readSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fsreadsync)接口读取文件内容，结合[fs.writeSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs#fswritesync)接口将读取的内容写入到沙箱指定文件中。（可参考下述示例的saveResFileToSandbox代码）
- 将在项目rawfile或resfile目录下预置的SQLite数据库文件通过上述方案拷贝到应用沙箱[databaseDir目录](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-sandbox-directory#:~:text=database-,databaseDir,-数据库路径)下后，即可在应用中使用[relationalStore.getRdbStore](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-data-relationalstore-f#relationalstoregetrdbstore)接口获取数据库实例进行数据库相关操作。（可参考下述示例的initDataBaseDir代码）

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b3/v3/XwTilJ7aR7uXpd9bK_MQGA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025730Z&HW-CC-Expire=86400&HW-CC-Sign=5190BBDEF2082576700A20A7EC88A8BFF0B27B7BBCFB25A09B677CACC95D3975)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a3/v3/ocWLB8MjQMu3ZMd-woG9Pw/zh-cn_image_0000002629059004.png?HW-CC-KV=V1&HW-CC-Date=20260701T025730Z&HW-CC-Expire=86400&HW-CC-Sign=F629AE223C296EBB18CDE52E6879DD07DD632A6AA9C2E5C716E87E6C4E1FA376)
