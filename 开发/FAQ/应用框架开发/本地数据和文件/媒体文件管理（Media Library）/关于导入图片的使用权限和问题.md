...
async function savePictureToContext() {
  ...
  photoSelectOptions.MIMEType =
    photoAccessHelper.PhotoViewMIMETypes.IMAGE_TYPE; <em>// Filter and select media file type as IMAGE</em>
 ...
 <em> // After passing fd in, the C end can call it</em>
<em>  // ReadFile(file2.fd,file3.fd)</em>
}
```
