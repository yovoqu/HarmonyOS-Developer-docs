...
struct PickerDemo {
  ...
  selectedUris: Arraystring> = new Arraystring>();
  private videoMimeType: Arraystring> = ['video/mp4']; // 视频类型的mimetype，根据需要设置
  private imageMimeType: Arraystring> = ['image/jpeg', 'image/png']; // 图片类型的mimetype，根据需要设置
