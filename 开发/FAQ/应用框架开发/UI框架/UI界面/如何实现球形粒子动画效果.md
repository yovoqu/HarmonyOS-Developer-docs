...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0d/v3/o_c50AKBSIWxAg1gKJaezg/zh-cn_image_0000002628554402.gif?HW-CC-KV=V1&HW-CC-Date=20260701T025710Z&HW-CC-Expire=86400&HW-CC-Sign=500B3B35C2A049D69171E082F9DBECE4185561A84FE1B760D105A9172162FEAD)
...
- 通过Stack布局函数构建了一个包含粒子特效的界面。
- 创建了一个Particle粒子系统，配置了粒子的各种属性，例如粒子的发射率、生命周期、颜色、透明度、缩放、加速度等。
- 设置了一个扰动场（Disturbance Fields），用于影响粒子的行为。
