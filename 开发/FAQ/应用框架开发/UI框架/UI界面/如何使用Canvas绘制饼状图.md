...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/86/v3/9Hi6rLyPSoa4qhkEAdXibg/zh-cn_image_0000002628554406.png?HW-CC-KV=V1&HW-CC-Date=20260701T025710Z&HW-CC-Expire=86400&HW-CC-Sign=CE648F96DA5D9D24887FE5B1D7F17F1C26545B587C33F0BD62591084411216E5)
...
- 根据当前分类的数据和总数据占比，计算出扇形的起始角度和终点角度。
```text
drawChart() {
...
- 根据扇形的起始角度和终点角度，以及对应的数据信息绘制折线和文字。
```text
...
@Component
struct drawPieChart {
  @State sectorInfoArr: ArraySectorInfo> = [];
