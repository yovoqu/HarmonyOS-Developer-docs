...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/XXMdXGLxSpyXpdpGr_RXxw/zh-cn_image_0000002658913485.png?HW-CC-KV=V1&HW-CC-Date=20260701T025645Z&HW-CC-Expire=86400&HW-CC-Sign=51704FA31286550E5B9835E151FFCD23291312A09718A6F942FE876B8CE9D9D6)

- **方案二**：获取其他组件宽度并设置Text组件的缩进避让。
在通过RelativeContainer相对布局，实现标题Row组件和内容Text组件的相同位置显示，但此时两个组件内容会有重叠遮挡。
- 通过onAreaChange获取标题Row组件的宽度信息（this.titleWidth），转换为number类型。
```text
Row() {
  Text('短剧·中国版教父')
}
...
- 配置Text组件的首行缩进长度为第二步获取的Row组件的宽度（this.titleWidth），实现文字避让。
```text
Text(this.message)
  .key('text')
  .maxLines(this.lines)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/dLtkq2N1TuCblRA-N2Qsew/zh-cn_image_0000002658793535.png?HW-CC-KV=V1&HW-CC-Date=20260701T025645Z&HW-CC-Expire=86400&HW-CC-Sign=8B728460EEE4EEEC0ACCB74BD54987DFA8988F0F2C7AAF9CF0E3BCB7D6D6FCCA)
