...
@Component
struct MyComponent {
  private dataSource: BaseDataSourcestring> = StringListModel.instance().getDataSource();
...
```text
export class BaseDataSourceT> implements IDataSource {
  // 存储实际数据的数组。
  private datas: ArrayT> = [];
  // 存储所有已注册的数据变更监听器。
  private listeners: ArrayDataChangeListener> = [];
...
export class StringListModel {
  ...
  private stringDataSource: BaseDataSourcestring> = new BaseDataSource();
  ...
  private loadData(isFirstPage: boolean) {
    let loadCallback = (datas: Arraystring>) => {
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/JRY4Be2JQ6el1aQn5OSkyQ/zh-cn_image_0000002658794111.gif?HW-CC-KV=V1&HW-CC-Date=20260701T025710Z&HW-CC-Expire=86400&HW-CC-Sign=75D4675986ED707A5D2AC661C7E43935FCE049962FC2E2A5C7B074BFF9B788A2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/27/v3/mcqgmOQpSV2Vyl1mAJlJjg/zh-cn_image_0000002628554746.gif?HW-CC-KV=V1&HW-CC-Date=20260701T025710Z&HW-CC-Expire=86400&HW-CC-Sign=2EEA9877B615F150DF44AB553EA394269BCC2F19C99221E22916EE69FE6A2417)
