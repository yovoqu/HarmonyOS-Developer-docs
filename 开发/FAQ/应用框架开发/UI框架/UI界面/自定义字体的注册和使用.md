...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/gb6kUrDkRbKNnRYzxzeVpA/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025722Z&HW-CC-Expire=86400&HW-CC-Sign=B1CAA45E1157471D4A16549E4FAF6FC216847BFE306B045F3610C8D71BA69278)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/98/v3/N4UxJrCMSf2EaRx5q7RYEA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025722Z&HW-CC-Expire=86400&HW-CC-Sign=0CC18DFF2965FE15CD10E3423E3036B1E81AFE92D10067AC4B9CB20CB45FA1F0)
 
应用若需全局使用自定义字体，请在EntryAbility.ets文件的onWindowStageCreate生命周期中，通过windowStage.loadContent回调注册。参考：[自定义字体无法全局使用如何处理](https://developer.huawei.com/consumer/cn/doc/harmonyos-faqs/faqs-arkui-571)。
- 在文本组件中通过fontFamily属性使用自定义字体，关键代码如下：
```text
Text('青鸟华光简美黑')
 ...
 */
export async function writeFontFile(data: string): Promise { 
  let uri = ''; 
  try { 
