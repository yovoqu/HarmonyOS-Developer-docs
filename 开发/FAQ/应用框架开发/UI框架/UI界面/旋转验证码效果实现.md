...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d9/v3/wCpVyOGKStGlOzW7omy5uw/zh-cn_image_0000002658966207.png?HW-CC-KV=V1&HW-CC-Date=20260701T041221Z&HW-CC-Expire=86400&HW-CC-Sign=9F638F8CCDBB110509850D959893D087C6E65491AB2BB34E6D0BBF4A4954E65D)
...
2. 当TouchType为Move时，实时获取组件位置updatePosition，并通过calculateAngleBetweenPoints方法计算图片旋转的角度。
3. 定义变量rotateAngle表示图片旋转的角度值，该变量的值由上述方法获得，并将之赋值给Image的rotate属性即可。
