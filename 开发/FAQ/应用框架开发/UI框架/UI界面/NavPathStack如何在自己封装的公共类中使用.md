...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/bDEWbxwXT624J4Li6sTtOQ/zh-cn_image_0000002628395798.gif?HW-CC-KV=V1&HW-CC-Date=20260701T025704Z&HW-CC-Expire=86400&HW-CC-Sign=15086BB3320F8635563A567DB5FC5DB00462041440E11C2C39966DE8ECDAE021)
...
- 在src/main目录下的工程配置文件module.json5中的module字段里配置"routerMap": "$profile:router_map"，并在src/main/resources/base/profile目录下新增router_map.json。router_map.json示例参考如下：
```ArkTS
{
  "routerMap": [
    {
