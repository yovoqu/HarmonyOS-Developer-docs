...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/HPhFqtmrR3CB8opAy7n2Cw/zh-cn_image_0000002628395316.gif?HW-CC-KV=V1&HW-CC-Date=20260730T072444Z&HW-CC-Expire=86400&HW-CC-Sign=235A2C12609CDB7EB79D2B0C142333FDC8141E0F1B44BAF1B3C4DBC6656DF15C)
...
```text
<em>// contentItems</em><em>为页面数据，titles为导航栏数据</em>
...
<em>  // contentItems为页面数据，titles为导航栏数据</em>
  getDataByIdType(name: string, idType: string | null, idContent: string | null, index?: number) {
    let contentItems: ContentItem[] = [];
 <em>   // 获取页面初始数据</em>
    if (idType == null) {
