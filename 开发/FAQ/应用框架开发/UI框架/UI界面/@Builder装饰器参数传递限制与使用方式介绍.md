...
| 私有自定义构建函数 | 按值传递 | 不可以 |
| 私有自定义构建函数 | 按引用传递 | 可以 |
| 私有自定义构建函数 | 按回调传递参数 | 可以 |
| 全局自定义构建函数 | 按值传递 | 不可以 |
| 全局自定义构建函数 | 按引用传递 | 可以 |
| 全局自定义构建函数 | 按回调传递参数 | 可以 |
...
4. @Builder采用构造方法创建对象作为实参，UI刷新失败。
```text
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/YQnOxhbNRq2V0SoL_bmjAA/zh-cn_image_0000002658806605.png?HW-CC-KV=V1&HW-CC-Date=20260701T041136Z&HW-CC-Expire=86400&HW-CC-Sign=AD97CBB56D43F6A759D0A5BC090F0F3A5FE67575FBE40EF511590C48134028F1)
