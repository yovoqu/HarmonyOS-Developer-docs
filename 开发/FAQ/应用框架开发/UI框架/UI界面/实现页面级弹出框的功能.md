...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b7/v3/qpbST7qvQtWxkWMhF9QYng/zh-cn_image_0000002628557792.png?HW-CC-KV=V1&HW-CC-Date=20260701T041217Z&HW-CC-Expire=86400&HW-CC-Sign=0613135B6F7D5A75E24530808B00BABB5ED5109EF90D195BC37B5D8B5B8EAFEB)
...
struct IndexTwo {
  ...
  build() {
    ...
    .bindSheet($$this.isShow, this.myBuilder(), {
      height: 400,
      mode: SheetMode.EMBEDDED, <em>// 设置显示层级Navigation导航挂载在NavDestination节点上，若是Router路由挂载在Page节点上。</em>
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/tsCtHGhcSu2gdLTXGy3WHw/zh-cn_image_0000002658917109.png?HW-CC-KV=V1&HW-CC-Date=20260701T041217Z&HW-CC-Expire=86400&HW-CC-Sign=D26F51BE07EE36209EB6EBB804D391F5E10B6429393144A5D75BE2B0157BA49B)
  ...
  build() {
    NavDestination() {
      Stack({ alignContent: Alignment.Center }) {
        Text('') <em>// 弹窗遮罩</em>
          .onClick(() => {
            this.pathStack.pop(); <em>// 点击遮罩散出该页面，达到关闭弹窗效果</em>
          })
          .width('100%')
          .height('100%')
          .opacity(0) <em>// 遮罩透明度调节</em>
          .backgroundColor(0x000000);
        Column() {
          Text('我是弹窗');
          Button('jump')
            .onClick(() => {
              this.pathStack.pushPathByName('IndexThree', ''); /<em>/ 弹窗内推送IndexThree页面</em>
            });
        }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f4/v3/QV28axQjTHaQif4COPQp8A/zh-cn_image_0000002628397888.png?HW-CC-KV=V1&HW-CC-Date=20260701T041217Z&HW-CC-Expire=86400&HW-CC-Sign=7EFD90EF222C7CB1B990D1DFBF288D4C00DBFB34360B3925EA1A9A2FE8C97CC5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/8A0zh5KqR7yH4GKUtTELIg/zh-cn_image_0000002658797157.png?HW-CC-KV=V1&HW-CC-Date=20260701T041217Z&HW-CC-Expire=86400&HW-CC-Sign=B41265BB3F064032D4F7830AC13DC17634828E59B99315374BE14EBDAC3F30EB)

 - **方案四**：适用于@ohos.router（页面路由）导航方式。

  通过@ohos.window（窗口）创建子窗口的形式创建弹窗：1. 修改EntryAbility页面配置。
```json
...
export struct subWindow {
  ...
  onBackPress(): boolean | void {
    window.findWindow('mySubWindow').destroyWindow(); // <em>销毁子窗口</em>
  }
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ac/v3/cPEaIstGS8aKNcJGaRic7Q/zh-cn_image_0000002628557794.png?HW-CC-KV=V1&HW-CC-Date=20260701T041217Z&HW-CC-Expire=86400&HW-CC-Sign=37B9088B0742BE919D6BED912532CD469E6AFD94C62AB2175419A7DDE114AB97)
