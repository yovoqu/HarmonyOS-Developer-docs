...
export function watermarkBuilder(watermarkText = '', rotationAngle = -10,
  ...
  }.hitTestBehavior(HitTestMode.Transparent) <em>// 添加浮层并配置公共水印方法</em>
}
...
struct waterOver {
  ...
  build() {
    Column() {
      ...
      Button('显示隐藏')
        .onClick(() => {
        <em>  // 通过state状态变量控制水印的显示和隐藏</em>
          this.state = !this.state;
        });
    }
    .overlay(this.state ? watermarkBuilder(this.text) : undefined) <em>// 添加浮层并配置公共水印方法</em>
    .width('100%');
  }
}
```
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/63/v3/jIHqsPz6Q8K1efDl26hb9g/zh-cn_image_0000002628555692.png?HW-CC-KV=V1&HW-CC-Date=20260730T072454Z&HW-CC-Expire=86400&HW-CC-Sign=81D0DEF7AAC8FB3E1BB19DC8CE270480FCB5A16BA831CF7308741935DA22702D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/6ycKLXSaRmmCM9Te2Z4yzQ/zh-cn_image_0000002658915013.png?HW-CC-KV=V1&HW-CC-Date=20260730T072454Z&HW-CC-Expire=86400&HW-CC-Sign=058DE10A81683E14F6B5B38D3AFECD8F0627A7E3DDFFB31FBECF9391F4C755FE)
