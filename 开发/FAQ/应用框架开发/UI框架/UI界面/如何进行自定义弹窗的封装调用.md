...
- 多个页面就会出现多份重复的定义CustomDialogController代码。
- 一个页面需要定义多个自定义弹窗时，会出现多份重复的CustomDialogController定义代码。
- 相同的自定义弹窗在多个页面使用，每个页面都需要去定义CustomDialogController，造成大量代码的重复。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/W8apQcbaSXaY74qgCb7pSA/zh-cn_image_0000002628399752.png?HW-CC-KV=V1&HW-CC-Date=20260701T025650Z&HW-CC-Expire=86400&HW-CC-Sign=04058AEC47F55783C33A56B229C5523541F6116F8C51AEFA1AFFE637E8CC385A)

 综上，重复的定义CustomDialogController代码会影响开发者的开发效率以及代码的整洁。
 效果预览：
 
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/KN4lifa-QgyogXn4vhar4A/zh-cn_image_0000002658799019.png?HW-CC-KV=V1&HW-CC-Date=20260701T025650Z&HW-CC-Expire=86400&HW-CC-Sign=66F6E1B4D43834512383BD2BCA913F515EEA4703F374673D4BF76C9AAEBE3CF6)
...
- 新建DialogUtils.ets工具类，工具类中已封装了自定义弹窗，以及弹出自定义弹窗的方法。拉起弹窗通过this.getUIContext().getPromptAction().openCustomDialog来实现。
```text
