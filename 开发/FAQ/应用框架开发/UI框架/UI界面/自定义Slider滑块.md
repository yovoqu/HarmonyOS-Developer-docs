...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2a/v3/bJN22_adQu6b9gmp3_mCLw/zh-cn_image_0000002628609226.png?HW-CC-KV=V1&HW-CC-Date=20260701T025708Z&HW-CC-Expire=86400&HW-CC-Sign=7024D3A97E55CB45A404E85D210C04A8BBABFDE2194CEC82ACC13414645EBD05)
...
struct SliderDemo {
  ...
  iconList: Array = ['sys.media.AI_translate', 'sys.media.AI_circle_viewfinder', 'sys.media.AI_retouch',
  ...
  build() {
    Column() {
      Slider({ style: SliderStyle.NONE, value: 20 })
        ...
        .onChange(value => {
          if (value = 20 && value  30 && value  40 && value  50 && value  60 && value  // 显示提示框并计算偏移量
  private showTip(value: number) {
    this.isTipShow = true;
    let percent = Number((value / 100).toFixed(2));
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/Muo-vrXVR5G2j5bn98OmAQ/zh-cn_image_0000002658968443.png?HW-CC-KV=V1&HW-CC-Date=20260701T025708Z&HW-CC-Expire=86400&HW-CC-Sign=E96526E087E1C3A2DE9611D0E3BECCA43977B4E3C459037E17DADAA49155F555)
