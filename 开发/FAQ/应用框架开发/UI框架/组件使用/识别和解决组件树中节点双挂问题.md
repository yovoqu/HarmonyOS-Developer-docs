...
- ArkUI Inspector工具可视化确认：
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1d/v3/exIzPOOHROyHRapAPWUuiw/zh-cn_image_0000002658926429.png?HW-CC-KV=V1&HW-CC-Date=20260701T025558Z&HW-CC-Expire=86400&HW-CC-Sign=AFA5661390DAAB8B9B4CA7606435586C26E81C770C7D9437A8AC4911F86319F2)
...
- 创建共享的BuilderNode实例，为每个NodeContainer创建独立的NodeController，每个NodeController持有对共享BuilderNode的引用；
- 在挂载节点前，检查节点是否已有父节点，确保节点未被挂载到其他父节点；
- 通过detachContent/attachContent操作实现节点在不同容器间的迁移。
...
export class MyNodeController extends NodeController {
  ...
  constructor(builderNode: BuilderNode | undefined | null) {
    super();
...
let wrap = wrapBuilder(ContentBuilder);
```
...
struct Index {
  ...
  private builderNode: BuilderNode | null | undefined = new BuilderNode(this.getUIContext());
