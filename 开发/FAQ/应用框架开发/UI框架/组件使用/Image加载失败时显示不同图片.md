...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6e/v3/jvFeqMJUS2uAR-ISSEFdkg/zh-cn_image_0000002628603744.gif?HW-CC-KV=V1&HW-CC-Date=20260701T025615Z&HW-CC-Expire=86400&HW-CC-Sign=DDE72C517C06E6A34B305711EB255A678AAEB5E4C5F6B24188A46386A15F7C69)
...
- 引入状态变量status，并设置初始值“loading”。
- 通过alt设置图片加载时显示的占位图，并通过状态变量status控制图片变化。
- 在回调函数onError中设置状态变量status为“error”，实现图片切换功能。
