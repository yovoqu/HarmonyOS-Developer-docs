...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fe/v3/svo1muPZSBmARo1q0vm-0Q/zh-cn_image_0000002658976783.png?HW-CC-KV=V1&HW-CC-Date=20260730T072414Z&HW-CC-Expire=86400&HW-CC-Sign=8D141F7BA4EBF221366C5D66746FF9438D822C70857E03A2571216668A19008D)
    ...
    Column() {
      ...
      Row() {
        RichEditor({ controller: this.controller })
         ...
         <em>   // 初次渲染会调用onAreaChange方法，第一次不用移动RichEditor</em>
            if (this.isInit) {
              this.isInit = false;
            } else {
        ...
        Button('切换键盘')
         ...
         <em>   //切换键盘相当于关闭系统键盘，需要切换焦点，解决切换键盘后，输入框被遮挡问题</em>
