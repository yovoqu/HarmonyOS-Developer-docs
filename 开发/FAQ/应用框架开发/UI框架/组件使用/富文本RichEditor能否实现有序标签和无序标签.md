...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/9W7x_ecWTOub1elpy_-daA/zh-cn_image_0000002628400318.png?HW-CC-KV=V1&HW-CC-Date=20260701T025552Z&HW-CC-Expire=86400&HW-CC-Sign=E5DB6B15C068C1BAABAA077BC0151C89409426697A50540BE714C16835172A33)
...
- 使用@Builder装饰器自定义设置一个ListItemBuilder，在文本前面配置圆点大小，实现无序标签Row().width(6).height(6).backgroundColor(Color.Black).borderRadius(3).borderWidth(1)。
- 使用@Builder装饰器自定义设置一个ListNumBuilder，在文本前面配置数字，实现有序标签。
