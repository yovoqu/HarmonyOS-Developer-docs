...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8c/v3/tVLncV20RIK-IMHL6c_UTg/zh-cn_image_0000002658915019.png?HW-CC-KV=V1&HW-CC-Date=20260701T025546Z&HW-CC-Expire=86400&HW-CC-Sign=70FDC91F786D5C8836EF1E94F189D48CB995481E3866ABE7A17B0C3B0CBEB408)
...
- 设置defaultFocus属性为true来指定TextArea组件为当前页的默认焦点；
- 创建isFocus变量标识当前键盘是否拉起状态；
- 根据isFocus值响应对应的点击事件，使用clearFocus、requestFocus接口控制键盘拉起与关闭状态。
```text
