...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f8/v3/42lfjm7fSO6OqLJOos7qlg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025606Z&HW-CC-Expire=86400&HW-CC-Sign=744378173DCE3499594CAFE635CDB553E391FBA07000C17D463C381874A53CA7)
 
该属性识别的URL不支持跳转自定义WebView，但是可以跳转系统浏览器。
- **方案二**：实现思路如下：
创建URL字符串的正则表达式。
- 通过match方法匹配原文本中的URL。
- 通过split方法以URL分割字符串，生成数组。
- 最后Text组件内通过ForEach循环渲染Span组件，匹配文本内的超链接。
...
@Component
struct ExampleText {
  @State strArr: Arraystring> = [];
  @State urlArr: Arraystring> = [];
  // 示例字符串
  ...
  splitUrls(str: string) {
    ...
    let urlsArr = str.match(urlPattern) as Arraystring>;
  ...
  splitString(str: string, separators: Arraystring>) {
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/aa/v3/vfCNiHbeSfeSWbdizyGkxQ/zh-cn_image_0000002658833297.png?HW-CC-KV=V1&HW-CC-Date=20260701T025606Z&HW-CC-Expire=86400&HW-CC-Sign=5E7AEB2C8552C9663D80BFEE4369CFD35DA560B8F1F8673D33FF7BB049788236)
