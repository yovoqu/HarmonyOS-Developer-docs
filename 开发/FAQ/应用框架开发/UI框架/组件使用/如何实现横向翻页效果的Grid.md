...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/UjgbOPBzTo2BZeZP71nyZA/zh-cn_image_0000002658968433.gif?HW-CC-KV=V1&HW-CC-Date=20260701T025620Z&HW-CC-Expire=86400&HW-CC-Sign=783F88C4635CEFEBE369761942200B0029FFBA61BFB79D0A82FB932C75C2CA73)
...
- getGridData方法将mainArray分割成每页20个元素的子数组，形成二维数组，用于分页显示。
- 使用[RelativeContainer](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-relativecontainer)作为容器，设置全屏大小和背景颜色。内部嵌入Swiper组件，用于实现翻页效果，并绑定swiperController以控制滑动行为。
- Swiper内部使用ForEach循环遍历getGridData返回的二维数组，每个item对应一页数据。
- Grid组件设置为4列5行，消除列间和行间间隙，宽度占满容器，高度固定。
...
struct HorizontalGrid {
  @State mainArray: Arraystring> = ['待办', '人力服务', '薪资查询',
