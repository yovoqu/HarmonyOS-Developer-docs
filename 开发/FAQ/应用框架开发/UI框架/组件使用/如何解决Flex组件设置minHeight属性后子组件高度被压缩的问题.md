...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/xKBLiMSKQciAVx1LY3OF-w/zh-cn_image_0000002628397736.png?HW-CC-KV=V1&HW-CC-Date=20260701T025547Z&HW-CC-Expire=86400&HW-CC-Sign=BFB4D72D8EADB6536C6A8A0D8DF503030C844C04B8B557CEBF0A5FE44E31B85D)
...
- 当组件缺省设置height，且constraintSize缺省maxHeight时，组件的height = minHeight。
- Flex容器组件内的子组件会默认设置flexShrink为1。
