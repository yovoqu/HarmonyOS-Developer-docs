...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/84/v3/GMcxye4fQW6J3aoOozRiFg/zh-cn_image_0000002658848487.png?HW-CC-KV=V1&HW-CC-Date=20260701T025620Z&HW-CC-Expire=86400&HW-CC-Sign=D0935CA8323E247CE886FCE9DCE37F77F2C6F41EFEEF5E03DCCC17141D23D2AF)
...
struct Index {
  ...
  aboutToAppear(): void {
    // AppStorage获取对应值
    this.flag = AppStorage.get('customerFlag') ?? false;
    this.offsetX = AppStorage.get('offsetX') ?? 0;
    this.offsetY = AppStorage.get('offsetY') ?? 0;
    this.offset2X = AppStorage.get('offset2X') ?? 0;
    this.offset2Y = AppStorage.get('offset2Y') ?? 0;
  }
