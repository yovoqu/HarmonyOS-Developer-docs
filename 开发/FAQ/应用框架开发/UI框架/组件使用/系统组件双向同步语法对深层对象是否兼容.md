...
- 方案一：在状态管理V1中，推荐使用[$$](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-two-way-sync)实现系统组件的双向绑定。
...
```
 - 方案二：在状态管理V2中，推荐使用[!!](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-two-way-sync)语法糖统一处理双向绑定。
!!双向绑定语法不支持多层父子组件传递。
