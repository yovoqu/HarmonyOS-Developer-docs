...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1c/v3/cMFN3dHURAKRmDHth4EOjg/zh-cn_image_0000002658965767.png?HW-CC-KV=V1&HW-CC-Date=20260701T025618Z&HW-CC-Expire=86400&HW-CC-Sign=7AD8542286027CC56C6F4786A1A9CDBA1A01EF34C72E50C06EC9655B4FC0C4F6)
...
- 在主页面创建Refresh组件，并在该组件中使用LazyForEach对MomentListItem进行渲染，并按特定方式实现图片和视频组件的交替渲染，这是该demo的框架功能实现。
```text
...
- 在MomentListItem组件中，对用户昵称，头像，时间以及文案内容，评论，点赞进行展示，并根据data属性的不同，进行图片和视频的展示。具体代码展示如下，以下各代码文件均位于pages目录下：
 Moment.ets：
...
struct Moments {
  ...
  private listDataSource = new CommonDataSourceMomentItem>();
