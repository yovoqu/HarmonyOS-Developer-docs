...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7a/v3/HFwkJPWuRnao_cmaS8xMYA/zh-cn_image_0000002658794579.png?HW-CC-KV=V1&HW-CC-Date=20260701T025543Z&HW-CC-Expire=86400&HW-CC-Sign=670C7E9448DD642B4D1D9AACC31F2E34309C3B55F1F264224D92C8A931D1D979)
...
- 使用Image组件加载其他图片，检查是否为组件问题。由于“新闻”图片正常显示，确认非组件问题。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/57/v3/U_kXHGeWTlur-_aGlTThAg/zh-cn_image_0000002628555212.png?HW-CC-KV=V1&HW-CC-Date=20260701T025543Z&HW-CC-Expire=86400&HW-CC-Sign=FD6EE7EE006417F893CF218DE495D596CFB33A86C49DD9CF28803450E5310242)

- 检查原图片Exif信息，定位其orientation属性。通过在线网站查看图片信息得知该图片的拍摄方向为逆时针旋转90度。由此，定位到图片被旋转的原因。 
| 属性 | 说明 | 值 |
| --- | --- | --- |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/_HVbCujRRt2JFvpegdAB7A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025543Z&HW-CC-Expire=86400&HW-CC-Sign=1A0846F8319BF686F1406DFBEB1323F6958665B34CCCA8F8FAEA4AB73887F3B1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/tRmD8I5eQlmnXibaUyoRVw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025543Z&HW-CC-Expire=86400&HW-CC-Sign=5517EB08817DF8CCE5F3BE06D6A2CC910690FD263C2E96BD0819D780CEFC13A3)
 
这种方案不支持gif和svg类型的图片。
- **方案三：将图片转成ImageSource对象后读取旋转信息：****思路**：读取每张图片的方向orientation信息，根据其方向，设置图片的显示方向。
 
使用Image Kit的createImageSource接口，将图片转换成image.ImageSource对象。
- 使用ImageSource的getImageProperty接口获取图片的image.PropertyKey.ORIENTATION旋转信息。
- 根据图片的EXIF方向信息设置orientation属性值进行旋转，使图片正常显示。
