...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a7/v3/NwFGtrepS_m5jrgU3l2Ptg/zh-cn_image_0000002628604256.png?HW-CC-KV=V1&HW-CC-Date=20260701T025615Z&HW-CC-Expire=86400&HW-CC-Sign=FC4E1487E011ABBAE46FECDC58FD23C3B91E6FF5DF5D1461A976C2FC985A036A)
...
struct RichTextExample {
  value: string =
    'RichText用于解析并显示HTML格式文本。适用于不需要对显示效果进行较多自定义的应用场景，并且仅支持有限的通用属性和事件。';
  richStrHead: string = '';
