...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/53/v3/-oe0faEeTNqkWXreYGElIw/zh-cn_image_0000002628398640.gif?HW-CC-KV=V1&HW-CC-Date=20260701T025550Z&HW-CC-Expire=86400&HW-CC-Sign=AE3EFE583583F6B796EBF66EA8148E6F87B5533819D56619C6461B2361E25360)
...
- 使用Stack堆叠图像，并为Stack添加手势识别。
- 自定义getAngle和calculatePointsOnCircle方法分别计算图像的旋转角度和位置坐标。
...
struct RotatingArcDemo {
  ...
  // 自定义getScreenWidth方法获取屏幕宽度，用于手势识别的坐标计算。
  getScreenWidth() {
    display.getAllDisplays((err: BusinessError, data: Arraydisplay.Display>) => {
