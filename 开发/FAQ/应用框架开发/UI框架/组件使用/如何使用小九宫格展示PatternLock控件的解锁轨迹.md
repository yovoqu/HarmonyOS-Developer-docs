...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0/v3/SUbeyIf6TMmb_jAfXubHmg/zh-cn_image_0000002658953227.png?HW-CC-KV=V1&HW-CC-Date=20260701T025605Z&HW-CC-Expire=86400&HW-CC-Sign=A0427B2AC0E040040B0D2AE8122DBBD645864F2D6511E114CAA0552890EE23CB)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/M0K1DZHbQzmLMXYrvTv0pQ/zh-cn_image_0000002658833269.gif?HW-CC-KV=V1&HW-CC-Date=20260701T025605Z&HW-CC-Expire=86400&HW-CC-Sign=8B4429D09B0FB7C8FC5FE267CB8D085256FE0F4605473053C1195E783425B62B)
...
- 在PatternLock手势路径经过的地方使用current存储。
```text
// 最高层
...
- 定义小九宫格时，判断当前的位置是否在current中来确认展示对应的样式。
```text
// 手势路径：小九宫格
Grid() {
    ...
    Column() {
      ...
      Stack() {
        ...
        PatternLock(this.patternLockController)
          ...
          .onPatternComplete((input: Arraynumber>) => {
            // 输入的密码长度小于5时，提示重新输入
            if (input.length  5) {
              this.current = [];
