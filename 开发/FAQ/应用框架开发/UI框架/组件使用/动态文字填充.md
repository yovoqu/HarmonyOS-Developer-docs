...
export class DeviceScreen {
 <em> /**</em>
<em>   * Get the device size.</em>
<em>   *</em>
<em>   * @returns promise of window.</em>
<em>   */</em>
  ...
  <em>/**</em>
<em>   * Get the screen width.</em>
<em>   *</em>
<em>   * @returns screen width.</em>
<em>   */</em>
 ...
 <em> /**</em>
<em>   * Get the screen height.</em>
<em>   *</em>
<em>   * @returns screen height.</em>
<em>   */</em>
      ...
      Text() {
        ...
        if (this.inputText) {
          Span(this.inputText).decoration({
            type: TextDecorationType.Underline,<em> </em><em>// 设置下划线样式</em>
            color: Color.Black,
          })
        } else {
          Span('__________，')
