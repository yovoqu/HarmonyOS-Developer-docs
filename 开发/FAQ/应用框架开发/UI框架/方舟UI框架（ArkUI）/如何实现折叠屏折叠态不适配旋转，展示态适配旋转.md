...
<em>// module.json5</em>
{
  "module": {
    "abilities": [
      {
        "name": "EntryAbility",
        "orientation":"unspecified"  <em>// Unspecified orientation mode, determined by the system</em>
      }
    ]
  }
}
  ...
  onWindowStageCreate(windowStage: window.WindowStage): void {
   <em> // Main window is created, set main page for this ability</em>
    ...
    windowStage.getMainWindow().then((windowObj) => {
     <em> // Set orientation based on fold status: auto-rotation when expanded, portrait when folded</em>
    ...
    <em>  // Monitor the unfolded or folded state of the foldable screen</em>
