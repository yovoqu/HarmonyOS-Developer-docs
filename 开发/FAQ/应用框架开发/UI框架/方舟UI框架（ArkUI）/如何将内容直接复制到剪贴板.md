...
<em>/*</em>
<em> * Copy the text to the system clipboard</em>
<em> * @param text - text</em>
<em> * @returns void</em>
<em> */</em>
function copyText(text: string) {
  const uiContext: UIContext | undefined = AppStorage.get('context');
 <em> // Create clipboard content object</em>
  const pasteboardData = pasteboard.createData(pasteboard.MIMETYPE_TEXT_PLAIN, text);
  <em>// Get system clipboard object</em>
  const systemPasteboard = pasteboard.getSystemPasteboard();
  systemPasteboard.setData(pasteboardData); <em>// Put data into clipboard</em>
