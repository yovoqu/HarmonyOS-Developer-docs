...
scrollable：设置是否可以通过滑动页面进行Tab页面切换，默认支持向左向右两个方向滑动。

gesture：通用属性手势绑定，可绑定TapGesture、LongPressGesture、PanGesture、PinchGesture、RotationGesture、SwipeGesture等手势。
