...
struct ComponentHide {
  ...
  aboutToAppear(): void {
    let shouldShow: () => void = (): void => {
      ...
      let button2BottomRightX = button2TopLeftX + (button2Size?.width ?? 0);<strong> /</strong><strong>/ The x-coordinate at the lower right corner of button2, with the unit being px</strong>
