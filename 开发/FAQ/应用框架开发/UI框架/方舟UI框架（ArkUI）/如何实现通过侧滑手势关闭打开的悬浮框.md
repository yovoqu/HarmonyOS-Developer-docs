...
onWindowStageCreate(windowStage: window.WindowStage): void {
 <em> // Create application subwindow</em>
...
<em>    // After the child window is created successfully, set the position, size, and related properties of the child window.</em>
    windowClass.moveWindowTo(300, 300);
    windowClass.resize(200, 200);
    windowClass.setWindowTouchable(true);
   <em> // Load the corresponding target page for the child window.</em>
