...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/14/v3/yguKhBqNQaKtwp_OhcImYQ/zh-cn_image_0000002628559558.png?HW-CC-KV=V1&HW-CC-Date=20260701T025629Z&HW-CC-Expire=86400&HW-CC-Sign=B03919AECDB66C9A88A6346E574083EDADFAE0215DDCA7FDF1AA6453352706F3)


 
- 在FullScreen模式下，Navigation的TitleBar会被顶部状态栏遮挡，底部Tab组件会被系统导航条遮挡。可以通过设置padding来手动避让，设置padding后子页面也会受到影响，需要更新Navigation根页面中设置的padding才生效，使用AppStorage可以设置此padding值。**代码示例如下：**
 Index.ets页面。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/20/v3/BTdG20cgTb-tPES-cLq1Kg/zh-cn_image_0000002658918873.png?HW-CC-KV=V1&HW-CC-Date=20260701T025629Z&HW-CC-Expire=86400&HW-CC-Sign=45AE600D23EDC9D2CE95570C7E6C3024FA0B16CB52C75AA4E05F42068A57812E)


 - **不设置FullScreen**：当应用中大多数页面需要避让系统顶部状态栏和底部导航条时，可以不使用FullScreen模式，使用组件的扩展安全区域方式。当组件布局不需要避让时，可以通过expandSafeArea属性让组件渲染到非安全区。List组件还可以通过contentStartOffset和contentEndOffset设置内容顶部和底部的空余高度。
 **代码示例如下：**
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f4/v3/e5YwmImDRpeA2nCvXk5DyA/zh-cn_image_0000002628399654.png?HW-CC-KV=V1&HW-CC-Date=20260701T025629Z&HW-CC-Expire=86400&HW-CC-Sign=0E0DB098FAC9488A160B9FB15887F8E011E2928A5ECA1F5163EAA3F95BE41533)
