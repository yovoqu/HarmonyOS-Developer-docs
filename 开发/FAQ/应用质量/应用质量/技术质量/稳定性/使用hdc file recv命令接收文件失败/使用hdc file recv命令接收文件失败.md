...
- **场景二**：使用[mediatool工具](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/mediatool#mediatool工具)来进行文件导出。mediatool工具可以根据媒体文件在图库中的名字，对媒体文件进行导出。方法步骤如下：1. 查询目标文件。
```bash
