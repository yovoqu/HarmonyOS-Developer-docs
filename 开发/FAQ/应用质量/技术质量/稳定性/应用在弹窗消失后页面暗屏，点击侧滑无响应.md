...
- 查看hilog日志，检查到手势事件的触碰测试touch test hitted recognizer识别到的组件为Dialog。
```text
...
- 往前排查，日志中可以看到曾有自定义弹窗打开open custom dialog，并且焦点也移到了Dialog上focus on focusView: Dialog。
```text
...
- 查看closeCustomDialog接口，检查所有弹窗是否正确关闭。
