...
- [CppCrash](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-stability-fault-type#section169359583920)应用崩溃指的是C/C++运行时崩溃，CppCrash进程崩溃检测基于操作系统信号机制。CppCrash常见场景及关键字检索表：
