...
- 线程泄漏：60s一次遍历进程，获取进程的总线程数，超过阈值（700个）时抓取详细线程名信息，同步上报泄漏，参考文档[实现原理](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/resource-leak-guidelines#实现原理)。
- 线程泄漏日志规格可以参考[线程泄漏日志规格](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/resource-leak-guidelines#线程泄漏日志规格)说明。
