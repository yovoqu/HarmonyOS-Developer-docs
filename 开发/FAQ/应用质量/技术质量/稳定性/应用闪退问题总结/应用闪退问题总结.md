...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/PgxNRl2VQquPnmg_No1JbQ/zh-cn_image_0000002628395002.png?HW-CC-KV=V1&HW-CC-Date=20260811T005912Z&HW-CC-Expire=86400&HW-CC-Sign=CAC40181781F7219159255C396A5A34121AFABC9256596D3DB023D49E731F955)
...
2. **方向**：需排查具体的代码行号和变量状态。

3. **主线程阻塞类 (THREAD_BLOCK / APP_INPUT / LIFECYCLE)**：
**结论**：主线程负载过重或被阻塞，导致无法及时响应用户输入或系统回调。

4. **方向**：需排查主线程中的耗时操作、死锁或死循环。

5. **系统管控类 (LowMemory / CPU Highload / RSS)**：
**结论**：应用资源使用（内存、CPU）超标，或整机资源不足导致被动回收。

6. **方向**：需优化应用资源占用，治理内存泄漏和后台行为。
