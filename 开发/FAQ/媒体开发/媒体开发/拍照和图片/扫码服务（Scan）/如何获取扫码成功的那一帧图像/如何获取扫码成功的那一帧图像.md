...
当前[customScan.start](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/scan-customscan-api#customscanstart-1)支持获取扫码的图像流，但是不能保证获取到稳定清晰的码图图像，因此本文主要介绍的是如何使用双路预览+图像识码的方式来完成码图识别和码图保存。
...
Q：如何通过[customScan.start](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/scan-customscan-api#customscanstart-1)接口的frameCallback回调去获取扫码成功的那一帧图像？
