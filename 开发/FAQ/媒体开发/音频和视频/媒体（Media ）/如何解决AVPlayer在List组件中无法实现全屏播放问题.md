...
- List + LazyForEach组件渲染视频列表，以及添加全屏、退出全屏、横屏等按钮，示例代码如下：
```text
build() {
  ...
  .onVisibleAreaChange([0.2, 1.0], async (isVisible: boolean, currentRatio: number) => {
    if (!isVisible && currentRatio // 设置窗口方向
...
- 在module.json5配置文件中abilities标签下的preferMultiWindowOrientation属性增加“landscape_auto”，示例代码如下：
```ArkTS
{
  "module": {
    "name": "entry",
...
export struct VideoComponent {
  ...
  build() {
    ...
    .onVisibleAreaChange([0.2, 1.0], async (isVisible: boolean, currentRatio: number) => {
      if (!isVisible && currentRatio // surfaceID用于播放画面显示，具体的值需要通过Xcomponent接口获取，相关文档链接见上面Xcomponent创建方法。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/bkONVnRFQOW5QqduhLTW8A/zh-cn_image_0000002658911971.png?HW-CC-KV=V1&HW-CC-Date=20260701T025828Z&HW-CC-Expire=86400&HW-CC-Sign=D8F939AC037576318D934AD621C8659F9CA3EDF5E026231A724941AD5E1CEF6D)
 
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/FoM4TEczTlWZjIQC-PNKFw/zh-cn_image_0000002628392762.png?HW-CC-KV=V1&HW-CC-Date=20260701T025828Z&HW-CC-Expire=86400&HW-CC-Sign=79535D6E396E5E69C66ED4FF5C70BD52C1A7E7B02988DE3D6E757739359222F6)
 
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bb/v3/JfO-ou5WRFSCbuF-FaV7hg/zh-cn_image_0000002658792033.png?HW-CC-KV=V1&HW-CC-Date=20260701T025828Z&HW-CC-Expire=86400&HW-CC-Sign=D895DD3ECAFA2FB408DBBE00EC3CCFC64B769FA8FA10B9F9289B8FD2AC3A4380)
