        ...
        if (error) {
          ...
          if (responseCode.OK === code) {
            ...
            let options: Record<string, number | boolean | tmp> = {
              'alphaType': 0,<em> // Transparency</em>
              'editable': false,<em> // Is it editable</em>
              'pixelFormat': 3,<em> // Pixel Format</em>
              'scaleMode': 1,<em> // Abbreviation</em>
              'size': { height: 100, width: 100 }
            }; <em>// Create Image Size</em>
