...
```text
<em>/**</em>
<em> * 使用createPixelMap将ArrayBuffer类型的图片转换为PixelMap类型</em>
<em> * @param data：网络获取到的资源</em>
<em> */</em>
...
- H5侧：
```text
<em><!-- main/resources/resfile/index.html --></em>
<!DOCTYPE html>
<html lang="en">
