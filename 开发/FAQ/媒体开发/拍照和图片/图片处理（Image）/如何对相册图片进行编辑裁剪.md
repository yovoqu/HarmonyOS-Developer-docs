...
class RegionItem {
<em>  /**</em>
<em>   * width coordinate.</em>
<em>   */</em>
  x: number;

<em>  /**</em>
<em>   * height coordinate.</em>
<em>   */</em>
  y: number;
...
<em>// Pass in three parameters: image. PixelMap, image width, and image height. After obtaining the cropped image width and height,</em>
<em>// pass the parameters into the cropCommon method</em>
