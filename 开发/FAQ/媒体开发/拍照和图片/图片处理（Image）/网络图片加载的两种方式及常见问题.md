...
创建PixelMap状态变量。
- 引用网络权限与媒体库权限，并填写网络图片地址，获取图片的二进制数据，代码示例如下：
```text
...
- 将网络地址成功返回的数据，编码转码成PixelMap的图片格式，参考链接：[多媒体像素图](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-graphics-display#多媒体像素图)。代码示例如下：
```text
/**
