...
- 从上述日志可知preconfig接口抛出7400201错误码是因为指定的参数非法导致，于是检查相关代码逻辑，发现在调用preconfig接口前未曾调用[canPreconfig](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-camera-videosession#canpreconfig12)接口校验参数是否支持。
