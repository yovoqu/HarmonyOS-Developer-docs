...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/10/v3/GghghiX5SAC8VpRPpbyM_Q/zh-cn_image_0000002658791851.png?HW-CC-KV=V1&HW-CC-Date=20260730T072610Z&HW-CC-Expire=86400&HW-CC-Sign=25DC6125CC753FDBC251A5DD5D4EBFC8DF6305D935136BB29845DF9DB9C4D677)
...
- [ViewControl](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/scan-customscan-api#viewcontrol)相机控制参数。width和height需和XComponent的保持一致，start接口根据设置宽高值会匹配最接近相机分辨率。
...
通过相机预览回调的宽高设置createPixelMapFromSurface的image.Region。
 1. 获取自定义扫码界面回调的[相机预览流](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/scan-customscan-api#scanframe)。代码示例如下：
```text
