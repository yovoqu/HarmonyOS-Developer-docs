...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/Cw2hW7L9Q7uJccSJQAQQsQ/zh-cn_image_0000002628392570.png?HW-CC-KV=V1&HW-CC-Date=20260701T025814Z&HW-CC-Expire=86400&HW-CC-Sign=95BA504F27AED522D9E0D4BEE07B882DA857DCA398B68056AD6FCA732742AF27)
...
struct Index {
  ...
  checkPermissions(){
    ...
    atManager.requestPermissionsFromUser(this.context?.getHostContext(), permissions).then((data: PermissionRequestResult) => {
      ...
      for (let i = 0; i   // 用户拒绝授权，提示用户必须授权才能访问当前页面的功能，并引导用户到系统设置中打开相应的权限
          return;
        }
      }
      // 跳转拍照页
...
struct PhotoDemo {
  ...
  setPhotoOutputCb(photoOutput: camera.PhotoOutput) {
    ...
    photoOutput.on('photoAvailable', (errCode: BusinessError, photo: camera.Photo): void => {
      ...
      imageObj.getComponent(image.ComponentType.JPEG,
        async (errCode: BusinessError, component: image.Component): Promise => {
  ...
  setColorSpaceBeforeCommitConfig(session: camera.PhotoSession, isHdr: boolean): void {
    ...
    let colorSpaces: Array = this.getSupportedColorSpaces(session);
  ...
  getSupportedColorSpaces(session: camera.PhotoSession): Array {
