...
<em>/**</em>
<em> * 获取元数据输出流</em>
<em> * @param cameraManager 相机管理器实例</em>
<em> * @param cameraOutputCapability 相机支持的输出能力</em>
<em> * @return 元数据输出流</em>
<em> */</em>
...
```json
<em>/**</em>
<em> * 元数据流可用监听，获取人脸位置信息</em>
<em> * @param metadataOutput 元数据输出流</em>
<em> */</em>
  ...
  Column({ space: 20 }) {
    Stack({ alignContent: Alignment.TopStart }) {
      XComponent({
        ...
        .onLoad(async () => {
       <em>   // 动态计算XComponent的宽高，确保与相机预览比例一致</em>
          const displayWidth = display.getDefaultDisplaySync().width;
        <em>  // 更新XComponent的实际显示高度</em>
