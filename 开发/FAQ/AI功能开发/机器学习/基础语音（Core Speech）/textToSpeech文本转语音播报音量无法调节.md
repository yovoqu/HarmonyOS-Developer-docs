...
- 去设置里调整小艺音量：设置->声音和振动->小艺。
- 在语音播报过程中，通过音量上下键调节。
- 开发者使用textToSpeech接口时，主动把播放通道设置为媒体（没有音频播放的情况下音量上下键调整的是媒体音量）。设置方法：[SpeakParams->extraParams->soundChannel](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/hms-ai-texttospeech#section7843122735210)。
