...
参考文本转语音[SpeakParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/hms-ai-texttospeech#speakparams)合成播报音频流的extraParams参数，关于合成类型<'playType', number>的介绍如下：
