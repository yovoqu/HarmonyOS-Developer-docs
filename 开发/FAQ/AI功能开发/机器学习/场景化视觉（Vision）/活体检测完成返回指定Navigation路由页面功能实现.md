...
export class DetectionResult {
  // 自定义code和message
  finalResult: Recordstring, number | string>|undefined = undefined;
}
```
...
export struct Detection {
  ...
  @State failResult: Recordstring, number | string> = {
    'code': 1008302000,
    'message': ''
  };

  private array: ArrayPermissions> = ['ohos.permission.CAMERA'];
