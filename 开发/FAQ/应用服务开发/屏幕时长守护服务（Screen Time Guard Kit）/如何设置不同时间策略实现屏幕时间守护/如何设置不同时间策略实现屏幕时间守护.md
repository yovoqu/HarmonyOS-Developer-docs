...
- **步骤二：**[TimeStrategyType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/screentimeguard-guardservice#timestrategytype)时长策略类型有以下3种类型，按照不同的场景配置策略类型，具体配置如下：
