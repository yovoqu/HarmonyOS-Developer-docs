...
- HarmonyOS 4.3及以下版本和HarmonyOS 5及以上版本获取的OpenID确实不相同，首先用户OpenID的生成规则是：由用户账号和应用ID加密生成的；在这个基础上HarmonyOS 4.3及以下版本和HarmonyOS 5及以上版本的应用ID是不相同的，所以获取的OpenID是不同的。
