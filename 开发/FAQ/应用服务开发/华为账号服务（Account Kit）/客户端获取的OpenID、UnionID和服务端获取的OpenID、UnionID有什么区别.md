...
- 客户端通过executeRequest方法获取的UnionID、OpenID和服务端使用Access Token调用[解析凭证](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-get-token-info#section2520125725115)接口获取的UnionID、OpenID是分别相同的。
- 使用场景不同：
