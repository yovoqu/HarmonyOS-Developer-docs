...
const TIME = 10000; <em>// 倒计时实况窗计时器初始值</em>

export class LiveViewController {
 <em> // 获取实况窗请求体的倒计时时间</em>
 ...
 <em>   // 创建实况窗</em>
  ...
  private static async buildWantAgent(): Promise<Want> {
    const wantAgentInfo: wantAgent.WantAgentInfo = {
      wants: [
        {
          bundleName: 'com.example.liveview', <em>// 应用实际bundleName</em>
