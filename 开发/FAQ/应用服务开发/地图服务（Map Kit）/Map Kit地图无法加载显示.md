...
4. 如果是HarmonyOS 5.0.2(14)及以前版本，可能存在未正确配置module.json5文件中client_id和公钥指纹情况。
...
3. 如果是HarmonyOS 5.0.2(14)及以前版本，需正确配置module.json5文件中client_id（参见[配置Client ID](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/account-client-id#section159409567136)）和[配置公钥指纹](https://developer.huawei.com/consumer/cn/doc/app/agc-help-cert-fingerprint-0000002278002933)。开通地图服务后，需等待24小时后生效（HarmonyOS 5.0.2(14)及以前版本）。
4. 保证设备有网络并且网络稳定。
