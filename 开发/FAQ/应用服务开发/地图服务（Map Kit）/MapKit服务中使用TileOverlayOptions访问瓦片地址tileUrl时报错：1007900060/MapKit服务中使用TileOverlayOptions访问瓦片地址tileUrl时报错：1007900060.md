...
如果需要自行配置RCP策略，可以使用[本地加载](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/map-tile#本地加载)瓦片图层方法，需要您在指导中的tileProviderMethod方法中自行实现配置定制化RCP策略访问URL，下载瓦片并加载。
