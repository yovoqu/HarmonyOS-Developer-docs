...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4d/v3/PpcNO-hQS8mqb9VFLMEMOQ/zh-cn_image_0000002628771152.png?HW-CC-KV=V1&HW-CC-Date=20260701T025757Z&HW-CC-Expire=86400&HW-CC-Sign=4304A576F427E2C98B08A6BCDDE280469D7C234FBCD7656E43E905186277DF1E)
...
- **检查网络连通性**，通过浏览器访问域名或在终端执行hdc shell ping [域名]检查网络连接情况。在通畅的网络下，使用默认DNS服务器，终端返回域名解析结果，丢包率0%：
```text
...
- **查看hilog日志**，分析报错信息有1007900006、Couldn't resolve host name、ERR_NAME_NOT_RESOLVED报错。
RCP请求分析示例如下：
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/84/v3/d9wylOwWRESSBytFLE-5zg/zh-cn_image_0000002658970473.png?HW-CC-KV=V1&HW-CC-Date=20260701T025757Z&HW-CC-Expire=86400&HW-CC-Sign=E426BE510359262325178510141660860F617651F4A9D040FA26ABF0808CAF4F)

- 若请求时间点存在DNS query数据包，没有query response响应包，ICMP返回Destination unreachable，需要检查DNS服务器是否可达。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/fpdtZ840T9uC0GNMe6oRCg/zh-cn_image_0000002628611262.png?HW-CC-KV=V1&HW-CC-Date=20260701T025757Z&HW-CC-Expire=86400&HW-CC-Sign=07D5666FCC89AC26883BF33E03E622AB8635E4365D50E55F385EA2B6EFBEE675)

- 若请求时间点存在DNS query数据包，响应返回No such name [域名]，需要检查域名是否拼写正确，或更换DNS服务器。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/T_G9lWbNTgKDBMt6osj0Dw/zh-cn_image_0000002658850525.png?HW-CC-KV=V1&HW-CC-Date=20260701T025757Z&HW-CC-Expire=86400&HW-CC-Sign=2C262FF35F80AADD6AB6DCA0B28D2C86F6168B75AC006400EE0AE5B65A720774)


 - **检查是否存在连接复用**：对于HTTP/2版本，强制启用连接复用；HTTP/1.1版本中，header的Connection: keep-alive代表启用连接复用，默认开启，客户端可通过设置Connection: close显示关闭连接复用。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/Ecb5eo5hS_uKmRKIez0vbA/zh-cn_image_0000002628771154.png?HW-CC-KV=V1&HW-CC-Date=20260701T025757Z&HW-CC-Expire=86400&HW-CC-Sign=692B3548777E8F38CEBD5C7244C7C3A5E66E226A3C79F9C01C6EC0FC7D105EBF)
