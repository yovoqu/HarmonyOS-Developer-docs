...
@Component
struct BlePage {
  @StorageLink('availableDevices') availableDevices: Array = [];
...
function reqPermissionFromUser(permissions: Array, context: common.UIAbilityContext): void {
...
class BluetoothClientModel {
  ...
  private onBLEDeviceFind() {
    try {
      ble.on('BLEDeviceFind', (arr: Array) => {
