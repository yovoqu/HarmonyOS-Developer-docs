...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dd/v3/Yg6SVQyMRDeg2g5OpfHKPw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025801Z&HW-CC-Expire=86400&HW-CC-Sign=537745ECE62AD238EA833E34F46BFEE263A48BE08E7385273EAD1AA0369EBCC1)
 

使用蓝牙虚拟MAC地址固化API需要使用到[ohos.permission.PERSISTENT_BLUETOOTH_PEERS_MAC](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/restricted-permissions#ohospermissionpersistent_bluetooth_peers_mac)权限，且需要[ACL](https://developer.huawei.com/consumer/cn/doc/app/agc-help-apply-acl-0000002394212138)权限申请通过后方可使用。
- 使用该接口时，开发者应明确该虚拟随机地址对应的对端蓝牙设备真实地址是不变的，若对端设备地址发生变化，持久化保存的地址信息也会失效，无法继续使用。
...
struct Reconnect {
  ...
  onBLEDeviceFindOne() {
    ble.on('BLEDeviceFind', (data: Arrayble.ScanResult>) => {
      // 发现设备，创建实例进行连接
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/aa/v3/dii9-WVvSm-rCOnvvF7OAQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025801Z&HW-CC-Expire=86400&HW-CC-Sign=1E1DD751E0AA6D7FF146ACBE9185E3CA2A19E90DB74FF76146DCE05FD85C035D)
