...
- 权限检查。申请相关权限前应使用[checkAccessToken()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-abilityaccessctrl#checkaccesstoken9)检查是否有该权限，若无权限则进行如下操作。
...
- 二次向用户申请授权。用户已经拒绝过该权限则不会再次弹出，需要引导用户开启权限有以下两种方案。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e7/v3/sWMGzyDBRsWQSRISmRDUoA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260701T025746Z&HW-CC-Expire=86400&HW-CC-Sign=98DB634D53602A99783F268046453416DF1B099AFB70B5B9615858B80F714C36)
 
应适度使用requestPermissionOnSetting()方法进行权限请求。
- **方案二**：可以引导用户点击跳转到对应应用的权限页面，让用户手动授权。
