...
async function encryptionAndDecryption() {
  <em>// Generate public and private keys based on the key parameters</em>
...
<em>// Generate SM2 public key based on key parameters</em>
...
<em>// Generate SM2 private key based on key parameters</em> 
