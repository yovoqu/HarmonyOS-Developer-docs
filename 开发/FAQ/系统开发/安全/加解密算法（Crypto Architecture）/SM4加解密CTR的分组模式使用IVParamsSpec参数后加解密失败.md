...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2c/v3/SQJla1kLTHWX5zv_5E3hTg/zh-cn_image_0000002658968435.png?HW-CC-KV=V1&HW-CC-Date=20260701T025749Z&HW-CC-Expire=86400&HW-CC-Sign=1905D4530B3A35E47F91C2427FB9E5F1D3E19B4DC88499A11B7EB3B6165B4CC3)
...
- 检查创建加解密实例时传入的参数是否正确。
- 检查加解密实例init初始化执行时传入的参数是否正确。
- 检查传入的IVParamsSpec参数是否符合要求。
