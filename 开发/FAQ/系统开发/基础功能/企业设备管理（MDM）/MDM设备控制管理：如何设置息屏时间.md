...
> [!NOTE]
> MDM应用开发需要 申请资质 ，并使用对应的证书和Profile才可以使用接口。 该接口使用需要ohos.permission.ENTERPRISE_MANAGE_SETTINGS权限。 目前手机/平板可设置息屏时间范围与系统设置中的可选时间一致。可通过“设置”->“显示和亮度”->“休眠”，查看系统支持的休眠时间，当前手机系统最短休眠时间为15s。 当前永不息屏只在2in1设备上接通电源时才能生效。
