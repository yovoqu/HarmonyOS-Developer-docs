...
2. 响应式布局：通常使用窗口监听（[如何监听窗口大小的变化](https://developer.huawei.com/consumer/cn/doc/harmonyos-faqs/faqs-arkui-1040)）配合[断点](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-multi-device-responsive-layout#section1532120147301)动态调整字体与布局。
