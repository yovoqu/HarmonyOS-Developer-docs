...
- UIAbility实例通过WindowStage持有了一个主窗口，详见：[主窗口的生命周期](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/window-type-overview#主窗口)，该主窗口为ArkUI提供了绘制区域，可以加载不同的ArkUI页面。
