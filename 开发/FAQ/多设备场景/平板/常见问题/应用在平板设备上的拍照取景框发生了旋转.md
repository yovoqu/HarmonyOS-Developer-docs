...
- 检查代码中XComponent预览流组件是否设置[rotate](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-transformation#rotate)属性，针对不同设备主动旋转角度调整组件方向。
- 检查代码中是否使用[setXComponentSurfaceRotation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-xcomponent#setxcomponentsurfacerotation12)锁定Surface旋转方向，使其不跟随屏幕方向变化。
