...
Image('')
  ...
  .height(this.winWidth / this.winHeight == 9 / 16 ? 200 : 400) <em>// 悬浮窗竖向宽高比为9:16，横向为16:9根据是否处于悬浮窗来调整图片大小</em>
  .width('100%')
  .borderRadius(10)
Text('' + item)
  .width('100%')
  .height(this.winWidth / this.winHeight == 9 / 16 ? 50 : 100) <em>// 悬浮窗竖向宽高比为9:16，横向为16:9根据是否处于悬浮窗来调整Text组件大小</em>
  .fontSize(16)
            ...
            Column() {
              Text('' + item)
                ...
                .height(this.winWidth / this.winHeight == 9 / 16 ? 300 :
                  500)<em> // 悬浮窗竖向宽高比为9:16，横向为16:9根据是否处于悬浮窗来调整Text组件大小</em>
                .fontSize(25)
                .borderRadius(50)
