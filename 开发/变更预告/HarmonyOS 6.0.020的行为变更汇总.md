...
targetSdkVersion ≥ 6.0.0(20)变更生效
...
6.0.0(20) Beta1新增接口，仅对使用6.0.0(20) Beta1开发的应用生效
...
6.0.0(20) Beta2新增接口，仅对使用6.0.0(20) Beta2开发的应用生效
...
使用DevEco Studio 6.0.0 Beta1及以上版本时生效
...
使用DevEco Studio 6.0.0 Beta3及以上版本时生效
