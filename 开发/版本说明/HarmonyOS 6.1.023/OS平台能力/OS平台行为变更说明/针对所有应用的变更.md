...
- ArkGraphics 2D：ArkTS API：@ohos.graphics.text.d.ts文件interface ParagraphStyle中wordBreak属性对应属性值：WordBreak.BREAK_HYPHENC API：drawing_text_typography.h文件enum OH_Drawing_WordBreakType中类型：WORD_BREAK_TYPE_BREAK_HYPHEN
**适配指导**
