...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-releases/js-apidiff-performanceanalysiskit-6002

| 操作 | 旧版本 | 新版本 | d.ts文件 |
| --- | --- | --- | --- |
| 新增API | NA | 类名：event； API声明：const APP_KILLED: string; 差异内容：const APP_KILLED: string; | api/@ohos.hiviewdfx.hiAppEvent.d.ts |
