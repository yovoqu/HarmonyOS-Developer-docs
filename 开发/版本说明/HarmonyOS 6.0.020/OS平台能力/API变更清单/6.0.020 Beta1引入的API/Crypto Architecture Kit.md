...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-releases/js-apidiff-cryptoarchitecturekit-6001

| 操作 | 旧版本 | 新版本 | d.ts文件 |
| --- | --- | --- | --- |
| 新增API | NA | 类名：Result； API声明：ERR_PARAMETER_CHECK_FAILED = 17620003 差异内容：ERR_PARAMETER_CHECK_FAILED = 17620003 | api/@ohos.security.cryptoFramework.d.ts |
