...
| API废弃版本变更 | 类名：FilePreloadState； API声明：NOT_PRELOADED = 0 差异内容：NA | 类名：FilePreloadState； API声明：NOT_PRELOADED = 0 差异内容：26.0.0 | api/@hms.pcService.openFileBoost.d.ts |
