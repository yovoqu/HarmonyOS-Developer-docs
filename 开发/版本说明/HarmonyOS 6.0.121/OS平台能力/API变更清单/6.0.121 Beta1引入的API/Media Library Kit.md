...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-releases/js-apidiff-medialibrarykit-6011
...
| 新增API | NA | 类名：DataType； API声明：SET_SELECTED_INFO = 3 差异内容：SET_SELECTED_INFO = 3 | api/@ohos.file.PhotoPickerComponent.d.ets |
| 新增API | NA | 类名：DataType； API声明：SET_BADGE_CONFIGS = 4 差异内容：SET_BADGE_CONFIGS = 4 | api/@ohos.file.PhotoPickerComponent.d.ets |
...
| 新增API | NA | 类名：BadgeType； API声明：BADGE_UPLOADED = 0 差异内容：BADGE_UPLOADED = 0 | api/@ohos.file.PhotoPickerComponent.d.ets |
