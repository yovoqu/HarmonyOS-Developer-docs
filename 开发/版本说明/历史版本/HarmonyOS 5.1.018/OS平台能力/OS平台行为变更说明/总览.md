...
| ArkUI | ArkUI双指长按行为变更 | 5.1.0(18) Release | 小 | phone, tablet | 全部生效 |
...
| 变更描述 | 变更引入版本 | 变更影响 | 影响设备类型 | 变更生效规则 |
| --- | --- | --- | --- | --- |
| hiperf命令行调试工具使用权限缩小 | 5.1.0(18) Release | 小 | phone, tablet, 2in1 | 使用DevEco Studio 5.1.0 Release及以上版本时生效 |
