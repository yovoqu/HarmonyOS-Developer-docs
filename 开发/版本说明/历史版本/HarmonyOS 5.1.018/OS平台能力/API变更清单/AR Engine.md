...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-releases/js-apidiff-arengine-510
...
| 新增API | NA | 类名：ARAddAugmentedImageReason； API声明：SIZE_NOT_MATCH = 1 差异内容：SIZE_NOT_MATCH = 1 | api/@hms.core.ar.arengine.d.ts |
...
| 新增API | NA | 类名：ARPlaneFindingMode； API声明：HORIZONTAL_AND_VERTICAL = 3 差异内容：HORIZONTAL_AND_VERTICAL = 3 | api/@hms.core.ar.arengine.d.ts |
...
| 新增API | NA | 类名：ARPoseType； API声明：ROTATE_90 = 1 差异内容：ROTATE_90 = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPoseType； API声明：ROTATE_180 = 2 差异内容：ROTATE_180 = 2 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPoseType； API声明：ROTATE_270 = 3 差异内容：ROTATE_270 = 3 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine； API声明：enum ARPlaneType 差异内容：enum ARPlaneType | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPlaneType； API声明：FACING_HORIZONTAL_UPWARD = 0 差异内容：FACING_HORIZONTAL_UPWARD = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPlaneType； API声明：FACING_HORIZONTAL_DOWNWARD = 1 差异内容：FACING_HORIZONTAL_DOWNWARD = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPlaneType； API声明：FACING_VERTICAL = 2 差异内容：FACING_VERTICAL = 2 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPlaneType； API声明：FACING_INVALID = 3 差异内容：FACING_INVALID = 3 | api/@hms.core.ar.arengine.d.ts |
...
| 新增API | NA | 类名：ARImageFormat； API声明：YUV_420_888 = 2 差异内容：YUV_420_888 = 2 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARImageFormat； API声明：Y_8 = 3 差异内容：Y_8 = 3 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARImageFormat； API声明：Y_16 = 4 差异内容：Y_16 = 4 | api/@hms.core.ar.arengine.d.ts |
...
| 新增API | NA | 类名：ARTrackableType； API声明：AUGMENTED_IMAGE = 0x41520104 差异内容：AUGMENTED_IMAGE = 0x41520104 | api/@hms.core.ar.arengine.d.ts |
...
| 新增API | NA | 类名：ARTrackingStateReason； API声明：EXCESSIVE_MOTION = 1 差异内容：EXCESSIVE_MOTION = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARTrackingStateReason； API声明：INSUFFICIENT_FEATURES = 2 差异内容：INSUFFICIENT_FEATURES = 2 | api/@hms.core.ar.arengine.d.ts |
...
| 新增API | NA | 类名：ARPowerMode； API声明：POWER_SAVING = 1 差异内容：POWER_SAVING = 1 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPowerMode； API声明：PERFORMANCE_FIRST = 2 差异内容：PERFORMANCE_FIRST = 2 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPowerMode； API声明：BOOST = 3 差异内容：BOOST = 3 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPowerMode； API声明：ULTRA_POWER_SAVING = 11 差异内容：ULTRA_POWER_SAVING = 11 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：arEngine； API声明：enum ARPointOrientationMode 差异内容：enum ARPointOrientationMode | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPointOrientationMode； API声明：INITIALIZED_TO_IDENTITY = 0 差异内容：INITIALIZED_TO_IDENTITY = 0 | api/@hms.core.ar.arengine.d.ts |
| 新增API | NA | 类名：ARPointOrientationMode； API声明：ESTIMATED_SURFACE_NORMAL = 1 差异内容：ESTIMATED_SURFACE_NORMAL = 1 | api/@hms.core.ar.arengine.d.ts |
...
| 新增API | NA | 类名：ARPoseMode； API声明：GRAVITY_AND_HEADING = 1 差异内容：GRAVITY_AND_HEADING = 1 | api/@hms.core.ar.arengine.d.ts |
