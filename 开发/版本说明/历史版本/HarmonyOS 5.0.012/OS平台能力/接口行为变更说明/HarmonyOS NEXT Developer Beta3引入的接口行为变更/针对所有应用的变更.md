...
API version 12开始，元服务应用访问未配置域名，connect接口抛出该错误码，详情见接口文档。
...
开发者在进行元服务应用开发时，涉及webSocket.connect接口建立连接是，先到AppGallery Connect

完成服务器域名相关配置，可参考此指导文档

进行配置。

开发者在进行元服务应用开发时，若遇到webSocket.connect接口失败，请用catch捕获错误；若webSocket.connect接口失败错误码是2302998，可以到AppGallery Connect完成服务器域名相关配置，可参考此指导文档
