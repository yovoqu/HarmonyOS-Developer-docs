...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-releases/js-apidiff-arkts-hdc
...
| 新增API | NA | 类名：Type； API声明：BASIC_URL_SAFE 差异内容：BASIC_URL_SAFE | api/@ohos.util.d.ts |
| 新增API | NA | 类名：Type； API声明：MIME_URL_SAFE 差异内容：MIME_URL_SAFE | api/@ohos.util.d.ts |
...
| 新增API | NA | 类名：Int8Array； API声明：static readonly BYTES_PER_ELEMENT: number; 差异内容：static readonly BYTES_PER_ELEMENT: number; | arkts/@arkts.collections.d.ets |
...
| 新增API | NA | 类名：Decimal； API声明：static readonly ROUND_UP : 0; 差异内容：static readonly ROUND_UP : 0; | arkts/@arkts.math.Decimal.d.ets |
| 新增API | NA | 类名：Decimal； API声明：static readonly ROUND_DOWN : 1; 差异内容：static readonly ROUND_DOWN : 1; | arkts/@arkts.math.Decimal.d.ets |
| 新增API | NA | 类名：Decimal； API声明：static readonly ROUND_CEILING : 2; 差异内容：static readonly ROUND_CEILING : 2; | arkts/@arkts.math.Decimal.d.ets |
| 新增API | NA | 类名：Decimal； API声明：static readonly ROUND_FLOOR : 3; 差异内容：static readonly ROUND_FLOOR : 3; | arkts/@arkts.math.Decimal.d.ets |
| 新增API | NA | 类名：Decimal； API声明：static readonly ROUND_HALF_UP : 4; 差异内容：static readonly ROUND_HALF_UP : 4; | arkts/@arkts.math.Decimal.d.ets |
| 新增API | NA | 类名：Decimal； API声明：static readonly ROUND_HALF_DOWN : 5; 差异内容：static readonly ROUND_HALF_DOWN : 5; | arkts/@arkts.math.Decimal.d.ets |
| 新增API | NA | 类名：Decimal； API声明：static readonly ROUND_HALF_EVEN : 6; 差异内容：static readonly ROUND_HALF_EVEN : 6; | arkts/@arkts.math.Decimal.d.ets |
| 新增API | NA | 类名：Decimal； API声明：static readonly ROUND_HALF_CEILING : 7; 差异内容：static readonly ROUND_HALF_CEILING : 7; | arkts/@arkts.math.Decimal.d.ets |
| 新增API | NA | 类名：Decimal； API声明：static readonly ROUND_HALF_FLOOR : 8; 差异内容：static readonly ROUND_HALF_FLOOR : 8; | arkts/@arkts.math.Decimal.d.ets |
