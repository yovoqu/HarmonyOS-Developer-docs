...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-releases/js-apidiff-camerakit-b065

| 操作 | 旧版本 | 新版本 | d.ts文件 |
| --- | --- | --- | --- |
| API废弃版本变更 | 类名：CameraPosition； API声明：CAMERA_POSITION_FOLD_INNER = 3 差异内容：NA | 类名：CameraPosition； API声明：CAMERA_POSITION_FOLD_INNER = 3 差异内容：12 | api/@ohos.multimedia.camera.d.ts |
...
| 新增API | NA | 类名：FoldStatus； API声明：NON_FOLDABLE = 0 差异内容：NON_FOLDABLE = 0 | api/@ohos.multimedia.camera.d.ts |
...
| 新增API | NA | 类名：PreconfigType； API声明：PRECONFIG_720P = 0 差异内容：PRECONFIG_720P = 0 | api/@ohos.multimedia.camera.d.ts |
| 新增API | NA | 类名：PreconfigType； API声明：PRECONFIG_1080P = 1 差异内容：PRECONFIG_1080P = 1 | api/@ohos.multimedia.camera.d.ts |
| 新增API | NA | 类名：PreconfigType； API声明：PRECONFIG_4K = 2 差异内容：PRECONFIG_4K = 2 | api/@ohos.multimedia.camera.d.ts |
| 新增API | NA | 类名：PreconfigType； API声明：PRECONFIG_HIGH_QUALITY = 3 差异内容：PRECONFIG_HIGH_QUALITY = 3 | api/@ohos.multimedia.camera.d.ts |
| 新增API | NA | 类名：camera； API声明： enum PreconfigRatio 差异内容： enum PreconfigRatio | api/@ohos.multimedia.camera.d.ts |
| 新增API | NA | 类名：PreconfigRatio； API声明：PRECONFIG_RATIO_1_1 = 0 差异内容：PRECONFIG_RATIO_1_1 = 0 | api/@ohos.multimedia.camera.d.ts |
| 新增API | NA | 类名：PreconfigRatio； API声明：PRECONFIG_RATIO_4_3 = 1 差异内容：PRECONFIG_RATIO_4_3 = 1 | api/@ohos.multimedia.camera.d.ts |
| 新增API | NA | 类名：PreconfigRatio； API声明：PRECONFIG_RATIO_16_9 = 2 差异内容：PRECONFIG_RATIO_16_9 = 2 | api/@ohos.multimedia.camera.d.ts |
