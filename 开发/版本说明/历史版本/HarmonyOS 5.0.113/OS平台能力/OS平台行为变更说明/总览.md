...
| ArkUI | RichEditor（富文本）onDidChange接口变更 * 该变更在11月19日更新的ROM版本引入，ROM版本号为5.0.0.107。 | 5.0.1(13) Beta3 | 小 | phone, tablet, 2in1 | 全部生效 |
| ArkUI | RichEditor（富文本）删除完成后光标位置变更 * 该变更在11月19日更新的ROM版本引入，ROM版本号为5.0.0.107。 | 5.0.1(13) Beta3 | 小 | phone, tablet, 2in1 | 全部生效 |
| Localization Kit | 国家、地区本地化名称变更 | 5.0.1(13) Beta3 | 小 | phone, tablet, 2in1 | 全部生效 |
| Localization Kit | 时间日期格式“十一月”格式化结果错误问题修改 * 该变更在11月19日更新的ROM版本引入，ROM版本号为5.0.0.107。 | 5.0.1(13) Beta3 | 小 | phone, tablet, 2in1 | 全部生效 |
...
| Localization Kit | 系统支持国家地区列表变更 * 该变更在11月19日更新的ROM版本引入，ROM版本号为5.0.0.107。 | 5.0.1(13) Beta3 | 小 | phone, tablet, 2in1 | 全部生效 |
...
| ArkUI | Video组件不再默认解析并自动播放拖拽信息中的视频资源 * 该变更在2025年1月8日更新的ROM版本引入，ROM版本号为5.0.0.123。 | 5.0.1(13) Release | 小 | phone, tablet, 2in1 | 全部生效 |
| ArkWeb | onErrorReceive接口在首次加载woff等在线字体资源不再触发的行为变更 | 5.0.1(13) Release | 小 | phone, tablet, 2in1 | 全部生效 |
| Form Kit | PostCardAction的router事件允许拉起Ability类型范围变更 * 该变更在2025年1月8日更新的ROM版本引入，ROM版本号为5.0.0.123。 | 5.0.1(13) Release | 小 | phone, tablet, 2in1 | 全部生效 |
| 公共能力 | app.json中bundleName字段正则匹配规则修改 * 该变更在2024年12月8日发布的patch版本引入，对应开发工具DevEco Studio版本为5.0.5.306。 | 5.0.1(13) Release | 小 | phone, tablet, 2in1 | 使用DevEco Studio 5.0.1 Release及以上版本时生效 |
...
| --- | --- | --- | --- | --- | --- |
| 命令行工具 | 禁止bm命令进行跨用户操作 * 该变更在11月19日更新的ROM版本引入，ROM版本号为5.0.0.107。 | 5.0.1(13) Beta3 | 小 | phone, tablet, 2in1 | 使用DevEco Studio 5.0.1 Release及以上版本时生效 |
| 命令行工具 | 应用发生OOM时Heapdump产物文件格式变更 * 该变更在2024年12月8日发布的patch版本引入，对应开发工具DevEco Studio版本为5.0.5.306。 | 5.0.1(13) Release | 小 | phone, tablet, 2in1 | 使用DevEco Studio 5.0.1 Release及以上版本时生效 |
