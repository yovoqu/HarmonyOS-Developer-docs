...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-releases/js-apidiff-camerakit-b105

| 操作 | 旧版本 | 新版本 | d.ts文件 |
| --- | --- | --- | --- |
| 新增API | NA | 类名：CameraFormat； API声明：CAMERA_FORMAT_HEIC = 2003 差异内容：CAMERA_FORMAT_HEIC = 2003 | api/@ohos.multimedia.camera.d.ts |
