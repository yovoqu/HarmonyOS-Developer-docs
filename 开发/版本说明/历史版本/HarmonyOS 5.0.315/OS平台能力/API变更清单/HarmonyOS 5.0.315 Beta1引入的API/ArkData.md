...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-releases/js-apidiff-arkdata-5031
...
| 新增API | NA | 类名：UniformDataType； API声明：FILE_URI = 'general.file-uri' 差异内容：FILE_URI = 'general.file-uri' | api/@ohos.data.uniformTypeDescriptor.d.ts |
| 新增API | NA | 类名：UniformDataType； API声明：CONTENT_FORM = 'general.content-form' 差异内容：CONTENT_FORM = 'general.content-form' | api/@ohos.data.uniformTypeDescriptor.d.ts |
