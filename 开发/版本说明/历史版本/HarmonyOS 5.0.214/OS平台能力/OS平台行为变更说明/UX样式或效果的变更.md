...
默认效果变更，但开发者需审视此变更是否对自身相关业务代码逻辑产生影响，若有影响需根据自身业务代码进行对应适配。示例代码详情请看toDataURL接口示例。
...
![](assets/UX样式或效果的变更/file-20260515134933055-0.png)


变更后：设备宽度在600-840vp间时，SheetOptions中的preferType设置为SheetType.POPUP，实际显示跟手弹窗样式。


![](assets/UX样式或效果的变更/file-20260515134933055-1.png)
