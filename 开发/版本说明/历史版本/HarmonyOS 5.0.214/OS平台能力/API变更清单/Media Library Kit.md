...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-releases/js-apidiff-medialibrarykit-b123sp18
...
| 新增API | NA | 类名：VideoPlayerState； API声明：SEEK_START = 3 差异内容：SEEK_START = 3 | api/@ohos.file.PhotoPickerComponent.d.ets |
| 新增API | NA | 类名：VideoPlayerState； API声明：SEEK_FINISH = 4 差异内容：SEEK_FINISH = 4 | api/@ohos.file.PhotoPickerComponent.d.ets |
...
| 新增API | NA | 类名：PhotoSubtype； API声明：MOVING_PHOTO = 3 差异内容：MOVING_PHOTO = 3 | api/@ohos.file.sendablePhotoAccessHelper.d.ets |
