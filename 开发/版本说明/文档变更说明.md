...
新增应用生命周期章节。
 ...
 - [应用快启启动](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hyperstartup-application)：介绍应用快启机制，阐述了其如何通过优化应用启动流程以提升应用的冷启动性能与响应速度。
