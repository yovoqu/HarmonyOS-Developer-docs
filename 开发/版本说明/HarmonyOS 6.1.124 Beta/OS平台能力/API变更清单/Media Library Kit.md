...
| 新增API | NA | 类名：PickerOptions； API声明：backgroundOpacity?: number; 差异内容：backgroundOpacity?: number; | api/@ohos.file.PhotoPickerComponent.d.ets |
| 新增API | NA | 类名：UpdatablePickerConfigs； API声明：backgroundOpacity?: number; 差异内容：backgroundOpacity?: number; | api/@ohos.file.PhotoPickerComponent.d.ets |
