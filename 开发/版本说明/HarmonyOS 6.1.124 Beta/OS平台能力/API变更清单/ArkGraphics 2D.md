...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-releases/js-apidiff-arkgraphics2d-6111

| 操作 | 旧版本 | 新版本 | d.ts文件 |
| --- | --- | --- | --- |
| 新增API | NA | 类名：EllipsisMode； API声明：MULTILINE_START 差异内容：MULTILINE_START | api/@ohos.graphics.text.d.ts |
| 新增API | NA | 类名：EllipsisMode； API声明：MULTILINE_MIDDLE 差异内容：MULTILINE_MIDDLE | api/@ohos.graphics.text.d.ts |
...
| 新增API | NA | 类名：HDRFormat； API声明：VIDEO_AIHDR = 8 差异内容：VIDEO_AIHDR = 8 | api/@ohos.graphics.hdrCapability.d.ts |
