...
let formatter: intl.DateTimeFormat = new intl.DateTimeFormat('zh-CN', {
  dateStyle: 'full',
  timeStyle: 'medium',
});

// 使用区域ID列表创建DateTimeFormat对象，因为ban为非法区域ID，因此使用zh区域ID创建DateTimeFormat对象
formatter = new intl.DateTimeFormat(['ban', 'zh'], {
  dateStyle: 'full',
  timeStyle: 'medium',
});
```
...
let formatter: intl.NumberFormat = new intl.NumberFormat('en-GB', {
  style: 'decimal',
  notation: 'scientific',
});
```
...
let formatter: intl.NumberFormat = new intl.NumberFormat(['en-GB', 'zh'], {
  style: 'decimal',
  notation: 'scientific',
});
...
let pluralRules: intl.PluralRules = new intl.PluralRules('zh-CN', {
  localeMatcher: 'lookup',
  type: 'cardinal',
});
```
...
let formatter: intl.RelativeTimeFormat = new intl.RelativeTimeFormat('en', {
  numeric: 'auto',
});
...
let formatter: intl.RelativeTimeFormat = new intl.RelativeTimeFormat('en-GB', {
  style: 'short',
});
// 获取RelativeTimeFormat对象配置项
let options: intl.RelativeTimeFormatResolvedOptions =
