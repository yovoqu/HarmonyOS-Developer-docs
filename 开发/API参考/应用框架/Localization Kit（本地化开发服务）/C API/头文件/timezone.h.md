...
| 类型 | 说明 |
| --- | --- |
| [I18n_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-errorcode-h#i18n_errorcode) | 0 - 成功。  8900001 - ���入参数无效。  8900050 - 预期之外的错误，例如内存错误。 |
