...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-ets-loader

> [!TIP]
> 编译工具链错误码用于标识ArkTS编译过程中的各类错误，涵盖文件导入限制、模块解析、Kit配置与导入、编译执行及懒加载导入等场景，帮助开发者快速定位并解决编译相关问题。 以下仅介绍本模块特有错误码，通用错误码请参考 通用错误码说明文档 。
