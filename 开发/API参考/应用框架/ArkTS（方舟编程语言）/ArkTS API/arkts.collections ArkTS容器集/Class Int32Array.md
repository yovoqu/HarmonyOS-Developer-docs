...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-int32array
...
// int32Array2 [1, 3, 5]
let int32Array2: collections.Int32Array = new collections.Int32Array(
  int32Array1,
);
```
...
let int32Array1: collections.Int32Array = new collections.Int32Array(
  int32Array.buffer,
  4,
  5,
);
...
// Int32Array [0, 2, 4]
let filtered: collections.Int32Array = array.filter(
...
```ts
const array: collections.Int32Array = collections.Int32Array.from([
  1, 2, 3, 4, 5,
]);
...
int32Array.forEach(
  (value: number, index: number, array: collections.Int32Array) => {
...
以下错误码的详细介绍请��见[通用错误码](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-universal)和[语言基础类库错误码](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-utils)。
...
let reducedValue: string = array.reduce<string>(
  (accumulator: string, value: number) => accumulator + value,
  'initialValue',
);
```
