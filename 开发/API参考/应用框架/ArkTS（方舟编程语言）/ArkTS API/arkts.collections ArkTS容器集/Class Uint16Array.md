...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-uint16array
...
let arrayLike = [1, 3, 5];
// uint16Array1 [1, 3, 5]
let uint16Array1: collections.Uint16Array = new collections.Uint16Array(
  arrayLike,
);
// uint16Array2 [1, 3, 5]
let uint16Array2: collections.Uint16Array = new collections.Uint16Array(
  uint16Array1,
);
```
...
```ts
let uint16Array: collections.Uint16Array = collections.Uint16Array.from([
  1, 2, 3, 4, 5, 6,
]);
...
let filtered: collections.Uint16Array = array.filter(
...
```ts
const array: collections.Uint16Array = collections.Uint16Array.from([
  1, 2, 3, 4, 5,
]);
...
uint16Array.forEach(
  (value: number, index: number, array: collections.Uint16Array) => {
