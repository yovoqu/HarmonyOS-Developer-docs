...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-uint8clampedarray
...
let uint8ClampedArray: collections.Uint8ClampedArray =
  new collections.Uint8ClampedArray();
```
...
// 以长度参数构造对象
let uint8ClampedArray: collections.Uint8ClampedArray =
  new collections.Uint8ClampedArray(12);
```
...
let uint8ClampedArray1: collections.Uint8ClampedArray =
  new collections.Uint8ClampedArray(arrayLike);
// uint8ClampedArray2 [1, 3, 5]
let uint8ClampedArray2: collections.Uint8ClampedArray =
  new collections.Uint8ClampedArray(uint8ClampedArray1);
```
...
```ts
let arrayLike = [1, 3, 5];
let array: collections.Uint8ClampedArray =
  collections.Uint8ClampedArray.from(arrayLike); // array [1, 3, 5]
```
...
// 例1 从一个对象创建
let array: collections.Uint8ClampedArray =
  collections.Uint8ClampedArray.from<number>(
    { length: 5 },
    (v: Object, k: number) => k,
  );
...
// 例2 从一个字符数组创建
let array: collections.Uint8ClampedArray =
  collections.Uint8ClampedArray.from<string>(
    ['1', '3', '5'],
...
// 例3 从一个字符串创建
let array: collections.Uint8ClampedArray =
  collections.Uint8ClampedArray.from<string>('12345', (v: string, k: number) =>
    parseInt(v),
  );
...
let set: Set<number> = new Set<number>([1, 2, 3]);
let array: collections.Uint8ClampedArray =
  collections.Uint8ClampedArray.from(set);
// Uint8ClampedArray [1, 2, 3]
```
...
```ts
let arr: collections.Uint8ClampedArray = collections.Uint8ClampedArray.of(
  1,
  2,
  3,
  4,
...
let filtered: collections.Uint8ClampedArray = array.filter(
  (element: number) => element % 2 == 0,
);
...
let foundIndex: number = array.findIndex(
  (element: number) => element % 2 === 0,
); // 1
```
...
```ts
let uint8ClampedArray: collections.Uint8ClampedArray =
  collections.Uint8ClampedArray.from([1, 2, 3]);
uint8ClampedArray.forEach(
  (value: number, index: number, array: collections.Uint8ClampedArray) => {
...
let reducedValue: number = array.reduce(
...
let reducedValue: number = array.reduceRight(
  (accumulator: number, value: number) => accumulator + value,
);
