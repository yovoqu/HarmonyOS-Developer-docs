...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | TypedArrayMapCallback<number, Float32Array> | 是 | 回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback<number, number, Float32Array> | 是 | 归约函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | TypedArrayReduceCallback<U, number, Float32Array> | 是 | 归约函数。 |
