...
let arrayLike = [1, 3, 5];
// float32Array1 [1, 3, 5]
let float32Array1: collections.Float32Array = new collections.Float32Array(
  arrayLike,
);
// float32Array2 [1, 3, 5]
let float32Array2: collections.Float32Array = new collections.Float32Array(
  float32Array1,
);
```
...
```ts
let float32Array: collections.Float32Array = collections.Float32Array.from([
  1, 2, 3, 4, 5, 6,
]);
...
// Float32Array [0, 2, 4]
let filtered: collections.Float32Array = array.filter(
...
```ts
const array: collections.Float32Array = collections.Float32Array.from([
  1, 2, 3, 4, 5,
]);
...
float32Array.forEach(
  (value: number, index: number, array: collections.Float32Array) => {
