...
let arrayLike = [1, 3, 5];
// uint32Array1 [1, 3, 5]
let uint32Array1: collections.Uint32Array = new collections.Uint32Array(
  arrayLike,
);
// uint32Array2 [1, 3, 5]
let uint32Array2: collections.Uint32Array = new collections.Uint32Array(
  uint32Array1,
);
```
...
let filtered: collections.Uint32Array = array.filter(
...
uint32Array.forEach(
  (value: number, index: number, array: collections.Uint32Array) => {
