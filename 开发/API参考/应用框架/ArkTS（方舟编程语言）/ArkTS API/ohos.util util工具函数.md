...
let name = 'John';
let age = 20;
let formattedString = util.format(
...
util.ArkTSVM.getAllVMHeapMemoryInfo().then((result) => {
  result.forEach((info) => {
...
util.Aspect.addAfter(
  ...
  'foo',
  false,
  (instance: MyClass, ret: string, arg: string): string => {
    console.info('arg is ' + arg);
...
util.Aspect.replace(
  ...
  'foo',
  false,
  (instance: MyClass, arg: string): string => {
...
**���统能力：** SystemCapability.Utils.Lang
  ...
  afterRemoval(
    ...
    if (value.toString().indexOf('[object Map Iterator]') >= 0) {
      ...
      while (!keyEntry.done && !valueEntry.done) {
        console.info(
          `key = ${keyEntry.value}, valueStr = ${valueEntry.value.str}`,
        );
...
**元服���API：** 从API version 12开始，该接口支持在元服务中使用。
...
let array = new Uint8Array([
  77, 97, 110, 105, 115, 100, 105, 115, 116, 105, 110, 103, 117, 105, 115, 104,
  101, 100, 110, 111, 116, 111, 110, 108, 121, 98, 121, 104, 105, 115, 114, 101,
  97, 115, 111, 110, 98, 117, 116, 98, 121, 116, 104, 105, 115, 115, 105, 110,
  103, 117, 108, 97, 114, 112, 97, 115, 115, 105, 111, 110, 102, 114, 111, 109,
  111, 116, 104, 101, 114, 97, 110, 105, 109, 97, 108, 115, 119, 104, 105, 99,
  104, 105, 115, 97, 108, 117, 115, 116, 111, 102, 116, 104, 101, 109, 105, 110,
  100, 101, 120, 99, 101, 101, 100, 115, 116, 104, 101, 115, 104, 111, 114, 116,
  118, 101, 104, 101, 109, 101, 110, 99, 101, 111, 102, 97, 110, 121, 99, 97,
  114, 110, 97, 108, 112, 108, 101, 97, 115, 117, 114, 101,
]);
...
```ts
let pro: util.LruBuffer<number | string, number | string> =
  new util.LruBuffer();
pro.put(2, 10);
pro.put(2, 'anhu');
pro.put('afaf', 'grfb');
