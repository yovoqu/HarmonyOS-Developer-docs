...
> [!NOTE] 说明
> 本模块首批接口从API version 6开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。 本模块从API version 9开始废弃，建议使用@ohos.file.fs替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.stat替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.statSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.listFile替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.listFileSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.access替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.accessSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.close替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.closeSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.copyFile替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.copyFileSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.mkdir替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.mkdirSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.open替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.openSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.read替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.readSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.rmdir替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.rmdirSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.unlink替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.unlinkSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.write替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.writeSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用hash.hash替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.truncate替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.truncateSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.readText替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.readTextSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.lstat替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.lstatSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.rename替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.renameSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.fsync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.fsyncSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.fdatasync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.fdatasyncSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.symlink替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.symlinkSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.mkdtemp替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.mkdtempSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.createStream替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.createStreamSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.fdopenStream替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.fdopenStreamSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.Stat.isBlockDevice替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.Stat.isCharacterDevice替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.Stat.isDirectory替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.Stat.isFIFO替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.Stat.isFile替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.Stat.isSocket替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.Stat.isSymbolicLink替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.Stream替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.Stream.close替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.Stream.closeSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.Stream.flush替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.Stream.flushSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.Stream.write替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.Stream.writeSync替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.Stream.read替代。
...
> [!NOTE] 说明
> 从API version 9开始废弃，请使用fileIo.Stream.readSync替代。
