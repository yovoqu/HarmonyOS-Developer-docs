...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-clouddisk-clouddisk-filesyncstate
**支持设备：** PC/2in1 | Tablet
...
| 名称 | 描述 |
| --- | --- |
| CloudDisk_PathInfo filePathInfo | 文件的路径信息。 |
| CloudDisk_SyncState syncState | 文件的同步状态。 |
