...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-clouddisk-clouddisk-syncfolder
**支持设备：** PC/2in1 | Tablet
...
| CloudDisk_SyncFolderState state | 同步根路径状态。 |
| CloudDisk_DisplayNameInfo displayNameInfo | 同步根路径别名信息。 |
