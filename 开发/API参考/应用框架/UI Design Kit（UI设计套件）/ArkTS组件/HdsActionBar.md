...
| startSpace | LengthMetrics | 否 | 是 | @Trace | 主轴方向HdsActionBar的起始位置按钮到背板边框（水平排列时为左边框，竖直排列时为上边框）的距离。 |
| endSpace | LengthMetrics | 否 | 是 | @Trace | 主轴方向HdsActionBar的终止位置按钮到背板边框（水平排列时为右边框，竖直排列时为下边框）的距离。 |
...
| startSpace | LengthMetrics | 否 | 是 | 主轴方向HdsActionBar的起始位置按钮到背板边框（水平排列时为左边框，竖直排列时为上边框）的距离。 |
| endSpace | LengthMetrics | 否 | 是 | 主轴方向HdsActionBar的终止位置按钮到背板边框（水平排列时为右边框，竖直排列时为下边框）的距离。 |
...
![](assets/HdsActionBar/file-20260514164501549-0.gif)
