...
> [!NOTE]
> 该接口从API version 18开始支持，从API version 20开始废弃，建议使用 getPublishedRunningFormInfoById 替代。
...
> [!NOTE]
> 该接口从API version 18开始支持，从API version 20开始废弃，建议使用 getPublishedRunningFormInfos 替代。
