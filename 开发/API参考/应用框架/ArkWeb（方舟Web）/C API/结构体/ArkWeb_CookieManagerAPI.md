...
| 类型 | 说明 |
| --- | --- |
| ArkWeb_ErrorCode | 返回值错误码。 ARKWEB_SUCCESS 获取cookie成功。 ARKWEB_INVALID_URL 无效的URL。 ARKWEB_INVALID_PARAM cookieValue参数无效。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkWeb_ErrorCode | 返回值错误码。 ARKWEB_SUCCESS 设置cookie成功。 ARKWEB_INVALID_URL 无效的URL。 ARKWEB_INVALID_COOKIE_VALUE cookieValue参数无效。 |
