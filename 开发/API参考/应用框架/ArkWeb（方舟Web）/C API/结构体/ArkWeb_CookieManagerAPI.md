...
| 类型 | 说明 |
| --- | --- |
| [ArkWeb_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkweb-error-code-h#arkweb_errorcode) | 返回值错误码。 ARKWEB_SUCCESS 获取cookie成功。 ARKWEB_INVALID_URL 无效的URL。 ARKWEB_INVALID_PARAM cookieValue参数无效。 |
...
| 类型 | 说明 |
| --- | --- |
| [ArkWeb_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkweb-error-code-h#arkweb_errorcode) | 返回值错误码。 ARKWEB_SUCCESS 设置cookie成功。 ARKWEB_INVALID_URL 无效的URL。 ARKWEB_INVALID_COOKIE_VALUE cookieValue参数无效。 |
