...
| accessibilityLevel14+ | string | 否 | 是 | 后缀图标的无障碍重要性。用于控制后缀图标是否可被无障碍辅助服务识别。          支持的值为:          "auto"：当前组件存在action时转化���"yes"，不存在action时，转化为"no"。          "yes"：当前组件可被无障碍辅助服务所识别。          "no"：当前组件不可被无障碍辅助服务所识别。          "no-hide-descendants"：当前组件及其所有子组件不可被无障碍辅助服务所识别。          默认值："auto"。          值为undefined时，按默认值处理。          元服务API： 从API version 14开始，该接口支持在元服务中使用。 |
...
![](assets/Chip/file-20260514164153807-0.png)
...
![](assets/Chip/file-20260514164153807-1.png)
...
![](assets/Chip/file-20260514164153807-2.png)
...
![](assets/Chip/file-20260514164153807-3.gif)
