...
**设备行为差异：** 该接口在Wearable设备上使用时，应用程序运��异常，异常信息中提示接口未定义，在其他设备中可正常调用。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| normal | [SymbolGlyphModifier](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/universal-attributes-attribute-symbolglyphmodifier#symbolglyphmodifier) | 否 | 是 | 工具栏symbol图标普通态样式。 默认值：fontColor：\$r('sys.color.icon_primary')，fontSize：24vp。 |
...
![](assets/ToolBar/file-20260514164206927-0.png)
