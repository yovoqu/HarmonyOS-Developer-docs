...
> [!TIP]
> 本模块首批接口从API version 9开始支持，后续版本的新增接口，采用上角标单独标记接口的起始版本。 在自定义组件内实现onMeasureSize, onPlaceChildren任一方法即视为实现自定义布局，推荐同时实现两种方法，具体参数说明可见对应接口参数说明。 从API version 20开始，在自定义布局的自定义组件中，子组件若设置了 LayoutPolicy 对象的fixAtIdealSize属性，表示尺寸将不受父组件约束，完全按照开发者自定义的尺寸范围布局。 自定义布局内不支持使用懒加载(包含 Repeat 和 LazyForEach )。
...
> [!NOTE]
> 从API version 9开始支持，从API version 10开始废弃，推荐使用 onPlaceChildren 替代。
...
> [!NOTE]
> 从API version 9开始支持，从API version 10开始废弃，推荐使用 onMeasureSize 替代。
...
> [!NOTE]
> 从API version 9开始支持，从API version 10开始废弃。建议使用 getBorderWidth ， getMargin 和 getPadding 替代。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c7/v3/wT-EEqj5QZ6E-iizzvhezw/zh-cn_image_0000002611756167.png?HW-CC-KV=V1&HW-CC-Date=20260528T024222Z&HW-CC-Expire=86400&HW-CC-Sign=D0FFA4399FA01E5D6692D41CCB71CB4C1628E2555C24CDAD1E04F137B8332031)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e7/v3/okQmCtn6Qlm7WFbiNxaUzw/zh-cn_image_0000002581436228.png?HW-CC-KV=V1&HW-CC-Date=20260528T024222Z&HW-CC-Expire=86400&HW-CC-Sign=284809757200E0C0A2428FEE44CFC768C3B2A07AF62B74592C26D175301857E8)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bd/v3/tyMGJXNcRdW3ojClwxiyyQ/zh-cn_image_0000002611836059.jpg?HW-CC-KV=V1&HW-CC-Date=20260528T024222Z&HW-CC-Expire=86400&HW-CC-Sign=138ABA5840A4E918FD4A57D7C664F759B651600C38CC4A757A5733BA36A6EBB6)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5a/v3/Px6DfeSgRga5EtL2aiWcXw/zh-cn_image_0000002581276314.jpg?HW-CC-KV=V1&HW-CC-Date=20260528T024222Z&HW-CC-Expire=86400&HW-CC-Sign=ACBB592FA3C3955E486095627C3121DCE64000369DB01E9FC28334EC2CBFE9D6)
