...
| 类型 | 说明 |
| --- | --- |
| [MutableBuilder&lt;Args&gt;](#mutablebuilder-1) | MutableBuilder&lt;Args&gt;的实例，用于[全局@Builder](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-builder#全局自定义构建函数)进行赋值和传递的类，实现全局@Builder的动态更新。 |
