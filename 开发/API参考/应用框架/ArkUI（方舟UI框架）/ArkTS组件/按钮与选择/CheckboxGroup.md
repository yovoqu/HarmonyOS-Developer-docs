...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)&lt;[OnCheckboxGroupChangeCallback](#oncheckboxgroupchangecallback18)&gt; | 是 | 多选框群组的信息。          当callback的值为undefined时，不使用回调函数。 |
...
![](assets/CheckboxGroup/file-20260514164015387-0.gif)
...
![](assets/CheckboxGroup/file-20260514164015387-1.gif)
