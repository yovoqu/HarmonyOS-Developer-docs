...
| 类型 | 说明 |
| --- | --- |
| number | 如果栈中存在名为name的NavDestination页面，则返回由栈底开始第���个名为name的NavDestination页面的索引，否则返回-1。          取值范围：[-1, +∞) |
...
![](assets/MultiNavigation/file-20260514164008997-0.gif)

主页跳转详情页效果演示：

![](assets/MultiNavigation/file-20260514164008997-1.gif)

全屏类型页面效果演示：

![](assets/MultiNavigation/file-20260514164008997-2.gif)
