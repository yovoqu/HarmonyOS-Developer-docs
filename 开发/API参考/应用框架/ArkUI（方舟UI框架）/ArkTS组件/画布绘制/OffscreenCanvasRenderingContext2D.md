...
![](assets/OffscreenCanvasRenderingContext2D/file-20260514164111335-0.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260514164111335-1.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260514164111335-3.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260514164111335-7.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260514164111335-9.png)


### lineDashOffset
**支持设备：** Phone / PC/2in1 / Tablet / Wearable / TV

设置画布的虚线偏移量，精度为float，仅当设置setLineDash时属性才生效，此属性为只���属性，可通过赋值语句设置其值，但无法通过读取操作获取其当前值，若尝试读取将返回undefined。
...
用于指定绘制文本时字母之间的间距，此属性为只写属性，可通过赋值语句设置其值，但无法通过读取���作获取其当前值，若尝试读取将返回undefined。
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260514164111335-25.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260514164111335-27.jpg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260514164111335-41.jpeg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260514164111335-45.jpg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260514164111335-61.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260514164111335-63.png)
...
**元服务API：** 从API version 11开始，该接口��持在元服务中使用。
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260514164111335-68.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260514164111335-71.png)
