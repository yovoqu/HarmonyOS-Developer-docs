...
> [!NOTE] 说明
> 从 API version 8 开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。 OffscreenCanvasRenderingContext2D无法在ServiceExtensionAbility中使用，ServiceExtensionAbility中建议使用绘制模块进行离屏绘制。 beginPath、moveTo、lineTo、closePath、bezierCurveTo、quadraticCurveTo、arc、arcTo、ellipse、rect和roundRect接口只能对OffscreenCanvasRenderingContext2D中的路径生效，无法对CanvasRenderingContext2D和Path2D对象中设置的路径生效。
...
| settings | [RenderingContextSettings](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-canvasrenderingcontext2d#renderingcontextsettings) | 否 | 用来配置OffscreenCanvasRenderingContext2D对象的参数，见RenderingContextSettings接口描述。 异常值undefined按RenderingContextSettings的默认值处理。 默认值：null |
...
| height | number | 是 | 离屏画布的高度，默认单位：vp 异常值NaN和Infinity按无效值处理。 |
| settings | [RenderingContextSettings](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-canvasrenderingcontext2d#renderingcontextsettings) | 否 | 用来配置OffscreenCanvasRenderingContext2D对象的参数，见RenderingContextSettings接口描述。 异常值undefined按RenderingContextSettings的默认值处理。 默认值：null |
| unit | [LengthMetricsUnit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#lengthmetricsunit12) | 否 | 用来配置OffscreenCanvasRenderingContext2D对象的单位模式，配置后无法动态更改，配置方法同CanvasRenderingContext2D。 异常值undefined、NaN和Infinity按默认值处理。 默认值：DEFAULT |
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331621-001.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331622-002.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331622-003.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331622-004.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331622-005.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331623-006.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331623-007.jpeg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331623-008.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331623-009.jpg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331624-010.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331624-011.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331624-012.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331625-013.jpg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331625-014.jpg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331625-015.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331625-016.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331626-017.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331626-018.jpeg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331626-019.jpeg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331626-020.jpeg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331626-021.jpeg)
...
| 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- |
| boolean | 否 | 否 | 设置绘制图形和文本时是否开启抗锯齿。 true表示开启抗锯齿；false表示不开启抗锯齿。 值为undefined时，与RenderingContextSettings中的抗锯齿效果保持一致。 |
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331627-022.jpeg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331627-023.jpg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331627-024.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331628-025.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331628-026.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331628-027.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331628-028.jpg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331628-029.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331629-030.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331629-031.jpg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331629-032.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331629-033.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331629-034.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331630-035.jpg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331630-036.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331631-037.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331631-038.jpeg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331631-039.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331632-040.jpeg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331632-041.jpeg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331633-042.jpeg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331633-043.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331633-044.jpg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331634-045.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331634-046.jpg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331634-047.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331634-048.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331634-049.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331634-050.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331635-051.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331635-052.jpg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331635-053.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331636-054.jpeg)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331636-055.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331636-056.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331637-057.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331637-058.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331637-059.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331638-060.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331639-061.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331639-062.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331640-063.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331640-064.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331640-065.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331640-066.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331641-067.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331641-068.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331641-069.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331641-070.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331642-071.png)
...
![](assets/OffscreenCanvasRenderingContext2D/file-20260525091331642-072.png)