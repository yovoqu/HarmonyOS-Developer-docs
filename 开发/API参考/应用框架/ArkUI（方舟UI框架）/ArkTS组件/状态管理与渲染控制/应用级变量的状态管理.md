...
2. 通过link、prop、setAndLink、setAndProp接口返回的SubscribedAbstractProperty的实例。
...
> [!NOTE] 说明
> 从API version 7开始支持，从API version 10开始废弃，建议使用link替代。
...
> [!NOTE] 说明
> 从API version 7开始支持，从API version 10开始废弃，建议使用setAndLink替代。
...
> [!NOTE] 说明
> Prop仅支持简单类型。 从API version 7开始支持，从API version 10开始废弃，建议使用prop替代。
...
> [!NOTE] 说明
> 从API version 7开始支持，从API version 10开始废弃，建议使用setAndProp替代。
...
> [!NOTE] 说明
> 从API version 7开始支持，从API version 10开始废弃，建议使用has替代。
...
> [!NOTE] 说明
> 从API version 7开始支持，从API version 10开始废弃，建议使用get替代。
...
> [!NOTE] 说明
> 从API version 7开始支持，从API version 10开始废弃，建议使用set替代。
...
> [!NOTE] 说明
> 从API version 7开始支持，从API version 10开始废弃，建议使用setOrCreate替代。
...
> [!NOTE] 说明
> 从API version 7开始支持，从API version 10开始废弃，建议使用delete替代。
...
> [!NOTE] 说明
> 从API version 7开始支持，从API version 10开始废弃，建议使用keys替代。
...
> [!NOTE] 说明
> 从API version 7开始支持，从API version 9开始废弃，建议使用clear替代。
...
> [!NOTE] 说明
> 从API version 9开始支持，从API version 10开始废弃，建议使用clear替代。
...
> [!NOTE] 说明
> 从API version 7开始支持，从API version 10开始废弃，建议使用size替代。
...
> [!NOTE] 说明
> 从API version 10开始支持，从API version 18开始废弃，建议使用UIContext中的getSharedLocalStorage替代。 从API version 12开始，可以通过使用UIContext中的getSharedLocalStorage来明确UI的执行上下文。
...
> [!NOTE] 说明
> 从API version 7开始支持，从API version 10开始废弃，建议使用persistProp替代。
...
> [!NOTE] 说明
> 从API version 7开始支持，从API version 10开始废弃，建议使用deleteProp替代。
...
> [!NOTE] 说明
> 从API version 7开始支持，从API version 10开始废弃，建议使用persistProps替代。
...
> [!NOTE] 说明
> 从API version 7开始支持，从API version 10开始废弃，建议使用envProp替代。
...
> [!NOTE] 说明
> 从API version 7开始支持，从API version 10开始废弃，建议使用envProps替代。
