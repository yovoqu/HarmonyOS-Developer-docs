...
| 名称 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| Margin | Padding | 否 | 外边距类型，用于描述组件不同方向的外边距，其类型与内边距类型一致。 |
...
| 名称 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| LocalizedMargin | LocalizedPadding | 否 | 外边距类型，用于描述组件不同方向的外边距，其类型与内边距类型一致。 |
...
| 名称 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| EdgeWidth | EdgeWidths | 否 | 组件边框不同方向的宽度。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ab/v3/J_qU3H8_SM6YnV6JPuESmw/zh-cn_image_0000002677828107.png?HW-CC-KV=V1&HW-CC-Date=20260723T012000Z&HW-CC-Expire=86400&HW-CC-Sign=21DA9F7FD6AB1EAA9892CBA64F168AC68F38EE5AC4ECF0A4706356DED5BFCC84)


竖直方向同理，其值为组件到上锚点的距离Dtop与组件到竖直方向锚点间总距离Dtop + Dbottom的比值。下图中Dheight表示组件高度。


![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/07/v3/tOJQarMRSWGHxBqvhGdszg/zh-cn_image_0000002677668259.png?HW-CC-KV=V1&HW-CC-Date=20260723T012000Z&HW-CC-Expire=86400&HW-CC-Sign=624164BC87D7D5F583643245407056386312B73CFE990F998564D48F941AE7BE)
