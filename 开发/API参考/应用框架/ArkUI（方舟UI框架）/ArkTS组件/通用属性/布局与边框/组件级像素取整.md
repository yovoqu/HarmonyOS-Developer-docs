...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| start | [PixelRoundCalcPolicy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#pixelroundcalcpolicy11) | 否 | 是 | 组件前部边界取整对齐方式。 不设置[pixelRound](#pixelround)或者设置异常值时按四舍五入规则取整。 |
...
![](assets/组件级像素取整/file-20260514163911515-0.png)

**图2** 不使用pixelRound指导布局效果图

![](assets/组件级像素取整/file-20260514163911515-1.png)
