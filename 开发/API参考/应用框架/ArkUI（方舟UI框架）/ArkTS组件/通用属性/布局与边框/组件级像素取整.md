...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| start | PixelRoundCalcPolicy | 否 | 是 | 组件前部边界取整对齐方式。 不设置pixelRound或者设置异常值时按四舍五入规则取整。 |
| top | PixelRoundCalcPolicy | 否 | 是 | 组件上部边界取整对齐方式。 不设置pixelRound或者设置异常值时按四舍五入规则取整。 |
| end | PixelRoundCalcPolicy | 否 | 是 | 组件尾部边界取整对齐方式。 不设置pixelRound或者设置异常值时按四舍五入规则取整。 |
| bottom | PixelRoundCalcPolicy | 否 | 是 | 组件底部边界取整对齐方式。 不设置pixelRound或者设置异常值时按四舍五入规则取整。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/10/v3/ccA6O_MjRaKa8DPL2NMhMw/zh-cn_image_0000002581275712.png?HW-CC-KV=V1&HW-CC-Date=20260528T013915Z&HW-CC-Expire=86400&HW-CC-Sign=B6AD75241F0996C8C0F0134FAF646EFD34BDA0A5AF54C2D787E9C79B1AF148D1)

 
**图2** 不使用pixelRound指导布局效果图
 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/Guq4xWWqTvGgfBftwqU14w/zh-cn_image_0000002611755567.png?HW-CC-KV=V1&HW-CC-Date=20260528T013915Z&HW-CC-Expire=86400&HW-CC-Sign=25EDE5FB23544B06B360A2513FCC982309C16F9A93B447A8D42974715B3D6433)
