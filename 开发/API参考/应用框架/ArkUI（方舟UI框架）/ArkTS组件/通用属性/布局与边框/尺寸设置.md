...
> [!TIP]
> 从API version 7开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。 如果组件的尺寸通过百分比进行设置， 在计算组件尺寸的百分比大小时，参考最近设置了固定大小的祖先节点的尺寸。 从API version 10开始，尺寸设置内部分属性支持使用calc计算特性，具体支持属性请参考对应的属性说明。calc计算特性是一种动态计算长度值的函数，常用于灵活设置布局尺寸（如宽度、高度、边距等）。它允许通过数学表达式组合不同单位和数值，支持通过加减乘除括号运算符组成计算表达式，实现动态响应式设计。注意，在使用calc时，运算符与数值之间需要使用空格隔开。具体使用场景可见 示例1 。
...
> [!NOTE]
> 在 TextInput 组件中，width设置auto表示自适应文本宽度。 在 AlphabetIndexer 组件中，width设置auto表示自适应宽度最大索引项的宽度。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| widthValue | Length \| LayoutPolicy | 是 | 要设置的组件宽度或水平方向布局策略。 单位：vp |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| heightValue | Length \| LayoutPolicy | 是 | 要设置的组件高度或垂直方向布局策略。 单位：vp |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/tWBfR9BKR3CARQQt_75Tew/zh-cn_image_0000002628862216.png?HW-CC-KV=V1&HW-CC-Date=20260701T014324Z&HW-CC-Expire=86400&HW-CC-Sign=4E2431AEE2C1CBE2C23C1838993C7F8F6130AF98BBE693ACEA250A36A6BDA52A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5f/v3/zyvY-SypR4ejygGm0rYPuA/zh-cn_image_0000002659221527.png?HW-CC-KV=V1&HW-CC-Date=20260701T014324Z&HW-CC-Expire=86400&HW-CC-Sign=9732A3C380E243C77E17FC65FF7BFDB9AADCBA2F532A932867EED593A55F96E1)

 
从右至左显示语言示例图
 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/42/v3/XP3z917rQfGuTkkyzVv2aQ/zh-cn_image_0000002628702338.png?HW-CC-KV=V1&HW-CC-Date=20260701T014324Z&HW-CC-Expire=86400&HW-CC-Sign=3205EFF20C33E00D9F73CD42FE4D59DEE41EB3E1F79AD874CC1620E2F3FDAFFB)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/EpUd7vGgRnO1Sdb1DiCDFg/zh-cn_image_0000002659101567.png?HW-CC-KV=V1&HW-CC-Date=20260701T014324Z&HW-CC-Expire=86400&HW-CC-Sign=9D2CCAC517688A08A848997CB9466846E27E2DB7C79855FD539A8F494D40ED11)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/81/v3/7EgELUgHTiSNW_FoAt98og/zh-cn_image_0000002628862218.png?HW-CC-KV=V1&HW-CC-Date=20260701T014324Z&HW-CC-Expire=86400&HW-CC-Sign=52E71AC755331A1F96FC45C773704CAAED527E7F01BB573CB1C9C5C5794F6781)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a7/v3/Qh3xREMXS4Cj_HT0JD6H-A/zh-cn_image_0000002659221529.jpg?HW-CC-KV=V1&HW-CC-Date=20260701T014324Z&HW-CC-Expire=86400&HW-CC-Sign=680911C88EBD03506FD26613E156BA2BE559D1B6E21B5ABC2C32CDB5AE9134B7)
