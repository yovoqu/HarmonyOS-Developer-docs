...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| radius | number \| Resource | 否 | 否 | 阴影模糊半径。 取值范围：[0, +∞)，API版本26.0.0开始取值范围变更为(-∞, +∞) 单位：px 说明： API版本26.0.0之前，设置小于0的值时，按值为0处理。从API版本26.0.0开始，设置的值即为最终取值，当设置负数值时阴影消失。 如需使用vp单位的数值可用vp2px进行转换。 如果radius为Resource类型，则传入的值需为number类型。 元服务API： 从API version 11开始，该接口支持在元服务中使用。 卡片能力： 从API version 9开始，该接口支持在ArkTS卡片中使用。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bc/v3/vcbVHmHSR3qjyyVHbcmEKQ/zh-cn_image_0000002628702364.png?HW-CC-KV=V1&HW-CC-Date=20260701T014326Z&HW-CC-Expire=86400&HW-CC-Sign=E75C8964E99607896A9763003F86A1996E9167CD0EE12ACF4EADC0DFB8D704AC)

 
修改lightUpEffect参数值为0.2：
 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9a/v3/WExQsCTJRyy3LZI4szTPaQ/zh-cn_image_0000002659101593.png?HW-CC-KV=V1&HW-CC-Date=20260701T014326Z&HW-CC-Expire=86400&HW-CC-Sign=62D43EC25909FD1CAA601DD23BDD3E9156A5CC916D29158697A60A84B73DADE5)

 
去掉lightUpEffect的设置，效果如下：
 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fe/v3/knB9s1gZThGUbobWzDeSPg/zh-cn_image_0000002628862244.png?HW-CC-KV=V1&HW-CC-Date=20260701T014326Z&HW-CC-Expire=86400&HW-CC-Sign=DAB59E99160FA5341C390B9514C8ECD48966FB6ED1A0C9FE66D01B226C08BE40)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/VabSR9C6QaqxwgParoNYRA/zh-cn_image_0000002659221557.png?HW-CC-KV=V1&HW-CC-Date=20260701T014326Z&HW-CC-Expire=86400&HW-CC-Sign=9E9784E00D3F0468445FC5AFF7174E0DE4427BD0B4C99508712690BB8EA13B04)

 
去掉pixelStretchEffect的设置，原图效果如下：
 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a2/v3/DNaK-TFARB6_XiI5ia_N8g/zh-cn_image_0000002628702366.png?HW-CC-KV=V1&HW-CC-Date=20260701T014326Z&HW-CC-Expire=86400&HW-CC-Sign=F35BC3BF69F50E797A93C0EC20A5D5ED58D64BA6904C3D40F1F3E9D2522BF5D2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9b/v3/MHY3W4cgRuqHVlEDOckFPw/zh-cn_image_0000002659101595.png?HW-CC-KV=V1&HW-CC-Date=20260701T014326Z&HW-CC-Expire=86400&HW-CC-Sign=1C1CCF1E2602524284403853C940DB90A39E7AD0B430947D905CDE01E9F2EBCD)
