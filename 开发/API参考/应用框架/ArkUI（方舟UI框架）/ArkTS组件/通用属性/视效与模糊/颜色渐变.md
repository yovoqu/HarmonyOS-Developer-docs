...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)&lt;[LinearGradientOptions](#lineargradientoptions18对象说明)&gt; | 是 | 线性渐变。 当options的值为undefined时，恢复为无线性渐变的效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)&lt;[SweepGradientOptions](#sweepgradientoptions18对象说明)&gt; | 是 | 角度渐变。 当options的值为undefined时，恢复为无角度渐变的效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)&lt;[RadialGradientOptions](#radialgradientoptions18对象说明)&gt; | 是 | 径向渐变。 当options的值为undefined时，恢复为无径向渐变的效果。 |
...
![](assets/颜色渐变/file-20260514163915525-0.png)
...
![](assets/颜色渐变/file-20260514163915525-1.png)
...
![](assets/颜色渐变/file-20260514163915525-2.png)
