...
> [!NOTE]
> foregroundBlurStyle接口为实时模糊接口，每帧执行实时渲染，性能负载较大。当模糊内容与模糊半径均无需变动时，推荐采用静态模糊接口 blur 。最佳实践请参考： 图像模糊动效优化-使用场景 。
...
| --- | --- | --- | --- |
| style | Optional&lt;BlurStyle&gt; | 是 | 内容模糊样式。 当style的值为undefined时，恢复为无模糊的内容。 |
| options | ForegroundBlurStyleOptions | 否 | 可选参数，内容模糊选项。默认值请参考ForegroundBlurStyleOptions。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/YHItUKToRSOuCunn2q2VYg/zh-cn_image_0000002611755591.png?HW-CC-KV=V1&HW-CC-Date=20260528T025546Z&HW-CC-Expire=86400&HW-CC-Sign=9ED5E62B06F71AEC3D71181F649ED4C8F45CE4C54A86AD34CB4C53A7BE9AAE8E)
