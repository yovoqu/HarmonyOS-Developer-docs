...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-modal-transition
**支持设备：** Phone | PC/2in1 | Tablet | Wearable | TV

通过bindContentCover属性为组件绑定全屏模态页面，在组件插入和移除时可通过设置转场参数ModalTransition显示过渡动效。

> [!NOTE]
> 从API version 10开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。 本模块接口仅可在Stage模型下使用。 不支持横竖屏切换。 不支持路由跳转。
...
![](assets/全屏模态转场/file-20260514163930666-2.gif)
...
![](assets/全屏模态转场/file-20260514163930666-3.gif)
...
![](assets/全屏模态转场/file-20260514163930666-4.gif)
...
![](assets/全屏模态转场/file-20260514163930666-5.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/f4SiTXi3RRWLg-EjtL0LgQ/zh-cn_image_0000002628862296.gif?HW-CC-KV=V1&HW-CC-Date=20260701T014329Z&HW-CC-Expire=86400&HW-CC-Sign=4E67D91687653176BAAF692659E09A86CFF41C28B84E0A6775A0850175E45119)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f0/v3/KJ16j7OGTfiuTOAFI4ECGg/zh-cn_image_0000002659221609.png?HW-CC-KV=V1&HW-CC-Date=20260701T014329Z&HW-CC-Expire=86400&HW-CC-Sign=2033CE1F2A9FC93AE229FBD1182DFBDE72951501C9241476701D26D86C6B8876)
