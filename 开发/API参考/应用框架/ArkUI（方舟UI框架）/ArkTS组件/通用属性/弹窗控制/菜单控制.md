...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| content | Array&lt;[MenuElement](#menuelement)&gt; \| [CustomBuilder](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#custombuilder8) | 是 | 配置菜单项图标和文本的数组，或者自定义组件。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| title | [ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr) | 否 | 是 | 菜单标题。          说明：          仅在content设置为Array&lt;[MenuElement](#menuelement)&gt; 时生效。          元服务API： 从API version 11开始，该接口支持在元服务中使用。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| color | [ResourceColor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcecolor) | ��� | 是 | 设置蒙层颜色。          默认值：\$r('sys.color.ohos_id_color_mask_thin') |
...
![](assets/菜单控制/file-20260514163928127-0.gif)
...
![](assets/菜单控制/file-20260514163928127-1.gif)
...
![](assets/菜单控制/file-20260514163928127-10.png)


### 示例12（自定义背景效果参数）

该���例为bindMenu通过配置[ContextMenuOptions](#contextmenuoptions10)中的backgroundEffect属性，实现了自定义菜单背景效果。
...
![](assets/菜单控制/file-20260514163928127-11.png)
...
![](assets/菜单控制/file-20260514163928127-12.gif)
...
![](assets/菜单控制/file-20260514163928127-13.jpg)
...
![](assets/菜单控制/file-20260514163928127-14.gif)
