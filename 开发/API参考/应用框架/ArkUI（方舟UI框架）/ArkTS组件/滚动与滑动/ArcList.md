...
> [!NOTE]
> ArcListAttribute是用于配置ArcList组件属性的关键接口。API version 21及之前版本，导入ArcList组件后需要开发者手动导入ArcListAttribute，否则会编译报错。从API version 22开始，编译工具链识别到导入ArcList组件后，会自动导入ArcListAttribute，无需开发者手动导入ArcListAttribute。 如果开发者手动导入ArcListAttribute，DevEco Studio会显示置灰，API version 21及之前版本删除会编译报错，从API version 22开始，删除对功能无影响。
...
> [!NOTE]
> 调用 scrollEdge 和不带动画的 scrollToIndex 时，不触发onWillScroll。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/NNH7JSbjQF6wDOTafYs1AA/zh-cn_image_0000002581435750.png?HW-CC-KV=V1&HW-CC-Date=20260528T024215Z&HW-CC-Expire=86400&HW-CC-Sign=6B3B41EA0397C62D28C4598C3A1862E3987DFCE0D77DEE216D4C57DB75914D1B)
