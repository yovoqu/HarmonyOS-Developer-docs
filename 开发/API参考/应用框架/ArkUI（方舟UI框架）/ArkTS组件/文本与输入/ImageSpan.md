...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap) | 是 | 设置图片加载过程中显示的占位图，支持PixelMap类型。 默认值：null |
...
![](assets/ImageSpan/file-20260525091220515-001.png)
...
![](assets/ImageSpan/file-20260525091220515-002.png)
...
![](assets/ImageSpan/file-20260525091220515-003.png)
...
![](assets/ImageSpan/file-20260525091220516-004.gif)
...
![](assets/ImageSpan/file-20260525091220516-005.png)