...
| fontSize | number | 是 | 是 | 获取属性字符串的文本字体大小。          单位：[vp](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-pixel-units)          元服务API： 从API version 12开始，该接���支持在元服务中使用。 |
...
![](assets/属性字符串/file-20260514164045004-0.png)
...
![](assets/属性字符串/file-20260514164045004-1.png)
...
![](assets/属性字符串/file-20260514164045004-10.png)
...
![](assets/属性字符串/file-20260514164045004-11.gif)
...
![](assets/属性字符串/file-20260514164045004-12.png)
...
从API version 22开始，该示例通过给[ResourceImageAttachmentOptions](#resourceimageattachmentoptions15)设置supportSvg2属性，使[SVG标签解析能力增强功能](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-image-svg2-capabilities#svg易用性提升)的SVG易用性提升能力生效。
