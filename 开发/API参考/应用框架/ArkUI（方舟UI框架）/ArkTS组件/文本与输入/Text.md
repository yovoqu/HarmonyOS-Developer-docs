...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| spanType | [TextSpanType](#textspantype11��举说明) | 是 | 选择菜单的类型。          默认值：TextSpanType.TEXT |
...
![](assets/Text/file-20260514164026834-0.png)
...
- 从API version 11开始，建议优先组合[textOverflow](#textoverflow)和[wordBreak](#wordbreak11)属性来设置截断方式，具体详见[示例4设置文本断行及折行](#示例4设置文本断行及折行)、[如何解决Text组件文本为中文、数���、英文混合时显示省略号截断异常的问题](https://developer.huawei.com/consumer/cn/doc/harmonyos-faqs/faqs-arkui-347)。
...
| marqueeUpdatePolicy23+ | [MarqueeUpdatePolicy](#marqueeupdatepolicy23枚举说明) | 否 | 是 | 跑马灯组件属性更新后，跑马灯的滚动策略。          当跑马灯��播放状态，且文本内容宽度超过跑马灯组件宽度时，该属性生效。          默认值：MarqueeUpdatePolicy.DEFAULT          元服务API： 从API version 23开始，该接口支持在元服务中使用。 |
...
![](assets/Text/file-20260514164026834-1.gif)
...
![](assets/Text/file-20260514164026834-2.gif)


### 示例3（设置文本超长省略）

该示例通过[maxLines](#maxlines)、[textOverflow](#textoverflow)、[ellipsisMode](#ellipsismode11)属性展示了文本超长省略以及调整省略位置的效果，通过MULTILINE_START和MULTILINE_CENTER两种类型实现了单行文本和多行文本场景下的省略号在行首和行中的效果。同时，可以通过[marqueeOptions](#marqueeoptions18)配置跑马灯模式下的配置项以及跑马灯动画进行到特定的阶段时，触发的回��[onMarqueeStateChange](#onmarqueestatechange18)。
...
![](assets/Text/file-20260514164026834-10.gif)
...
![](assets/Text/file-20260514164026834-11.gif)
...
![](assets/Text/file-20260514164026834-12.gif)
...
![](assets/Text/file-20260514164026834-13.gif)
...
![](assets/Text/file-20260514164026834-14.png)
...
![](assets/Text/file-20260514164026834-15.png)
...
![](assets/Text/file-20260514164026834-16.png)
...
![](assets/Text/file-20260514164026834-18.gif)
...
![](assets/Text/file-20260514164026834-19.png)
...
![](assets/Text/file-20260514164026834-20.png)
...
![](assets/Text/file-20260514164026834-21.png)
...
![](assets/Text/file-20260514164026834-22.gif)
...
![](assets/Text/file-20260514164026834-23.gif)
...
![](assets/Text/file-20260514164026834-24.gif)
...
![](assets/Text/file-20260514164026834-25.png)
...
![](assets/Text/file-20260514164026834-26.png)
