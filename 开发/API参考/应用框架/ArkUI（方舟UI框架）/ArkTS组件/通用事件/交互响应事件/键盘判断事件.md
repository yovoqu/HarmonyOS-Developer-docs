...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-onneedsoftkeyboard
...
XComponent组件使用该方法时，如果返回值为true且XComponent组件使用[OH_NativeXComponent_SetNeedSoftKeyboard](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-interface-xcomponent-h#oh_arkui_xcomponent_setneedsoftkeyboard)设置了需要键盘，才会保留键盘，如果返回值为false，无论组件如何设置，键盘都不会保留。
...
![](assets/键盘判断事件/file-20260514163902405-0.gif)
