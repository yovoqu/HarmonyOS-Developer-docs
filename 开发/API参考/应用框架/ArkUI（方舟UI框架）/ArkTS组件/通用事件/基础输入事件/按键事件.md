...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#callback12)&lt;[KeyEvent](#keyevent对象说明), boolean&gt; | 是 | 按键事件的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#callback12)&lt;[KeyEvent](#keyevent对象说明), boolean&gt; | 是 | 处理按键事件的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#callback12)&lt;[KeyEvent](#keyevent对象说明), boolean&gt; | 是 | 处理按键事件分发的回调。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| type | [KeyType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#keytype) | 否 | 否 | 按键��类型。          元服务API： 从API version 11开始，该接口支持在元服务中使用。 |
...
| intentionCode10+ | [IntentionCode](#intentioncode10) | 否 | 否 | 按键对应的意图。          默认值：IntentionCode.INTENTION_UNKNOWN。          元服务API： 从API version 11开始，该接口支持在元服务中使用。 |
...
![](assets/按键事件/file-20260514163859272-0.gif)
