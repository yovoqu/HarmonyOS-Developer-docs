...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-events-focus_axis
...
> [!NOTE]
> 本模块首批接口从API version 15开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。 本模块接口仅可在Stage模型下使用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | Callback&lt;FocusAxisEvent&gt; | 是 | 焦点轴事件回调。绑定该方法的组件获焦后触发。 |
...
| stopPropagation | Callback&lt;void&gt; | 否 | 否 | 阻止事件冒泡传递，可用于当前组件处理焦点轴事件后，不希望父组件继续响应该事件的场景。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b4/v3/GEXpmAlkSZ6_BtHgMocBNw/zh-cn_image_0000002655848322.png?HW-CC-KV=V1&HW-CC-Date=20260730T071451Z&HW-CC-Expire=86400&HW-CC-Sign=566E3A117A8388A031C7A0DC46B430239AC5CE88896FFF5809CA2A735B7C1940)
