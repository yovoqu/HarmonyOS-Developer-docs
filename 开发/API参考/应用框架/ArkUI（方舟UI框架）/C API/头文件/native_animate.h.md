...
| int32_t OH_ArkUI_Animator_ResetAnimatorOption(ArkUI_AnimatorHandle animatorHandle, ArkUI_AnimatorOption* option) | 重置animator动画。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_AnimateOption* option | 设置动画效果相关参数。 option为NULL时，操作无效。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_AnimateOption* option | 设置动画效果相关参数。 option为NULL时，返回NULL。 |
