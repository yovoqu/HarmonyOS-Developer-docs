...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-common-attributes-h
...
| 名称 | 描述 |
| --- | --- |
| ArkUI_SnapshotOptions* OH_ArkUI_CreateSnapshotOptions() | 创建一个截图选项，当返回值不再使用时必须通过OH_ArkUI_DestroySnapshotOptions释放。 |
...
| int32_t OH_ArkUI_VisibleAreaEventOptions_SetExpectedUpdateInterval(ArkUI_VisibleAreaEventOptions *option, int32_t value) | 设置开发者期望的计算间隔，用于控制可见区域比例的计算频率。 |
...
| UI_STATE_HOVERED = 1 << 4 | 悬浮状态。 起始版本： 26.0.0 |
