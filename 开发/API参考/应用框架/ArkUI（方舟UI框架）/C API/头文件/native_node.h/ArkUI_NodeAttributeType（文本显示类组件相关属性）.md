...
| 类型 | 说明 |
| --- | --- |
| .object | 文本布局管理器对象，参数类型为[ArkUI_LayoutManager](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-textlayoutmanager)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 自定义文本选择菜单配置数据，参数类型为[ArkUI_TextSelectionMenuOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/-arkui-nativemodule-arkui-textselectionmenuoptions)。 |
