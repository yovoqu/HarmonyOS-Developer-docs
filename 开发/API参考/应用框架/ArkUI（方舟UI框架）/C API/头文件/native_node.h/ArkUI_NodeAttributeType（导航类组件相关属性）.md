...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-node-h-nodeattributetype-navigationrelatedcomponents
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 返回当前设置的动画曲线类型，参数类型ArkUI_AnimationCurve。 |
...
| .value[1]?.i32 | 跳转动画模式，参数类型ArkUI_SwiperAnimationMode，默认值为ARKUI_SWIPER_ANIMATION_MODE_NONE。仅本次设置有效。 该参数从API version 15开始支持。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 设置是否显示导航箭头，参数类型ArkUI_SwiperArrow，默认值为ARKUI_SWIPER_ARROW_HIDE。 |
| ?.object | 显示导航箭头时设置箭头样式，参数类型为ArkUI_SwiperArrowStyle。不设置该参数时使用系统默认箭头样式。 该参数从API version 19开始支持。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 返回当前导航箭头的显示状态，参数类型ArkUI_SwiperArrow。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 返回当前设置的边缘滑动效果类型，参数类型ArkUI_EdgeEffect。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 使用ArkUI_NodeAdapter对象。建议配合NODE_SWIPER_CACHED_COUNT使用以提升性能。 |
...
| 类型 | 说明 |
| --- | --- |
| .object | 返回当前设置的适配器对象，参数类型为ArkUI_NodeAdapter，用于动态加载或复用Swiper子组件。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 设置导航指示器的类型，参数类型ArkUI_SwiperIndicatorType，默认值为ARKUI_SWIPER_INDICATOR_TYPE_DOT。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 返回当前设置的导航指示器类型，参数类型ArkUI_SwiperIndicatorType。 |
| .object | 导航指示器的类型为ARKUI_SWIPER_INDICATOR_TYPE_DOT时参数类型为ArkUI_SwiperIndicator。 导航指示器的类型为ARKUI_SWIPER_INDICATOR_TYPE_DIGIT时参数类型为ArkUI_SwiperDigitIndicator。 ArkUI_SwiperDigitIndicator类型从API version 19开始支持。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | Swiper组件和父组件的嵌套滚动模式，参数类型ArkUI_SwiperNestedScrollMode，仅在Swiper嵌套在可滚动容器中时生效。默认值为：ARKUI_SWIPER_NESTED_SCROLL_SELF_ONLY。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 返回当前设置的嵌套滚动模式，参数类型ArkUI_SwiperNestedScrollMode。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 设置组件鼠标滚轮翻页模式，参数类型ArkUI_PageFlipMode，默认值为ARKUI_PAGE_FLIP_MODE_CONTINUOUS。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 返回当前设置的鼠标滚轮翻页模式，参数类型ArkUI_PageFlipMode。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 返回当前设置的响应式布局策略，数据类型ArkUI_ItemFillPolicy。 |
