...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 文本区域的滚动条显示模式，参数类型[ArkUI_BarState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-h#arkui_barstate)，默认值为ARKUI_BAR_STATE_AUTO。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 文本区域的滚动条显示模式，参数类型[ArkUI_BarState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-type-h#arkui_barstate)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 识别配置，参数类型[ArkUI_TextDataDetectorConfig](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkui-nativemodule-oh-arkui-textdatadetectorconfig)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 无输入时的提示文本选项，参数类型[ArkUI_TextEditorPlaceholderOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/nativemodule-oh-arkui-texteditorplaceholderoptions)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 属性字符串控制器，参数类型[ArkUI_TextEditorStyledStringController](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/vemodule-oh-arkui-texteditorstyledstringcontroller)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 文本选择菜单，参数类型[ArkUI_TextEditorSelectionMenuOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/tivemodule-oh-arkui-texteditorselectionmenuoptions)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 选中拖拽预览样式配置，参数类型[ArkUI_SelectedDragPreviewStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-nativemodule-arkui-textselecteddragpreviewstyle)。 |
