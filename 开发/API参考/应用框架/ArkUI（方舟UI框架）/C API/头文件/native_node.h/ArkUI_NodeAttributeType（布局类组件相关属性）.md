...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 对齐方式，数据类型ArkUI_Alignment，默认值ARKUI_ALIGNMENT_CENTER。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 对齐方式，数据类型ArkUI_Alignment。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 子组件在水平方向上的对齐格式，数据类型ArkUI_HorizontalAlignment，默认值ARKUI_HORIZONTAL_ALIGNMENT_CENTER。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 子组件在水平方向上的对齐格式，数据类型ArkUI_HorizontalAlignment。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 子组件在垂直方向上的对齐格式，数据类型ArkUI_FlexAlignment，默认值ARKUI_FLEX_ALIGNMENT_START。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 子组件在垂直方向上的对齐格式，数据类型ArkUI_FlexAlignment。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 子组件在垂直方向上的对齐格式，数据类型ArkUI_VerticalAlignment，默认值ARKUI_VERTICAL_ALIGNMENT_CENTER。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 子组件在垂直方向上的对齐格式，数据类型ArkUI_VerticalAlignment。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 子组件在水平方向上的对齐格式，数据类型ArkUI_FlexAlignment，默认值ARKUI_FLEX_ALIGNMENT_START。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 子组件在水平方向上的对齐格式，数据类型ArkUI_FlexAlignment。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0]?.i32 | 子组件在Flex容器上排列的方向ArkUI_FlexDirection，默认值为ARKUI_FLEX_DIRECTION_ROW。 |
| .value[1]?.i32 | 排列规则ArkUI_FlexWrap，默认值为ARKUI_FLEX_WRAP_NO_WRAP。 |
| .value[2]?.i32 | 主轴上的对齐格式ArkUI_FlexAlignment，默认值为ARKUI_FLEX_ALIGNMENT_START。 |
| .value[3]?.i32 | 交叉轴上的对齐格式ArkUI_ItemAlignment，默认值为ARKUI_ITEM_ALIGNMENT_START。 |
| .value[4]?.i32 | 交叉轴中有额外的空间时，多行内容的对齐方式ArkUI_FlexAlignment，默认值为ARKUI_FLEX_ALIGNMENT_START。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | RelativeContainer容器内的辅助线，参数类型为ArkUI_GuidelineOption。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | RelativeContainer容器内的屏障，参数类型为ArkUI_BarrierOption。 |
