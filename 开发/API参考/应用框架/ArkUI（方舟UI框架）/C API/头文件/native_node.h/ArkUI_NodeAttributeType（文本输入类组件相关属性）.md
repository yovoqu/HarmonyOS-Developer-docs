...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 回车键类型枚举ArkUI_EnterKeyType，默认值为ARKUI_ENTER_KEY_TYPE_DONE。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 回车键类型枚举ArkUI_EnterKeyType。 |
...
| .value[1]?.i32 | 可选字体样式ArkUI_FontStyle，默认值为ARKUI_FONT_STYLE_NORMAL。 |
| .value[2]?.i32 | 可选字体粗细样式ArkUI_FontWeight，默认值为ARKUI_FONT_WEIGHT_NORMAL。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 输入框类型枚举ArkUI_TextInputType，默认值为ARKUI_TEXTINPUT_TYPE_NORMAL。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 输入框类型枚举ArkUI_TextInputType。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 按钮样式ArkUI_CancelButtonStyle，默认值为ARKUI_CANCELBUTTON_STYLE_INPUT。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 参数类型ArkUI_TextInputContentType。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 参数类型ArkUI_TextInputStyle。默认值为ARKUI_TEXTINPUT_STYLE_DEFAULT。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 参数类型ArkUI_TextInputStyle。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 参数类型ArkUI_WordBreak。默认值ARKUI_WORD_BREAK_BREAK_WORD。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 键盘样式，参数类型ArkUI_KeyboardAppearance。默认值ARKUI_KEYBOARD_APPEARANCE_NONE_IMMERSIVE。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 是否启用自动填充动效。启用之后，仅输入框类型的枚举ArkUI_TextInputType设置为ARKUI_TEXTINPUT_TYPE_PASSWORD、ARKUI_TEXTINPUT_TYPE_NUMBER_PASSWORD或ARKUI_TEXTINPUT_TYPE_NEW_PASSWORD的输入框在进行自动填充时动效可生效。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 装饰样式配置项，为可选参数。参数类型为OH_ArkUI_DecorationStyleOptions。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 输入框类型枚举ArkUI_TextAreaType，默认值为ARKUI_TEXTAREA_TYPE_NORMAL。 |
...
| 类型 | 说明 |
| --- | --- |
| .value[0].i32 | 输入框类型枚举ArkUI_TextAreaType。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 文本控制滚动条状态。参数类型为ArkUI_BarState。默认值为ARKUI_BAR_STATE_AUTO。 |
