...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | false表示退出编辑态，true表示维持现状。 属性获取方法参数[ArkUI_AttributeItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-attributeitem)格式： |
...
作为属性设置方法参数、属性获取方法返回���[ArkUI_AttributeItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-attributeitem)格式如下。
...
| .object | 计数器配置，配置属性为文本输入框未达到最大字符数时计数器的颜色以及超出最大字符数时计数器的颜色。参数类型为 [ArkUI_ShowCounterConfig](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/api-arkui-nativemodule-arkui-textshowcounterconfig)。 |
...
| .object | 计数器配置，配置属性为文本���入框未达到最大字符数时计数器的颜色以及超出最大字符数时计数器的颜色。参数类型为[ArkUI_ShowCounterConfig](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/api-arkui-nativemodule-arkui-textshowcounterconfig)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 文本内容基础控制器。参数类型为[ArkUI_TextContentBaseController](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkui-nativemodule-arkui-textcontentbasecontroller)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 文本选中状态下的拖拽预览样式。参数类型为[ArkUI_SelectedDragPreviewStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-nativemodule-arkui-textselecteddragpreviewstyle)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 装饰样式配置项，为可选参数。参数类型为[OH_ArkUI_DecorationStyleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkui-nativemodule-oh-arkui-decorationstyleoptions)。 |
...
| 类型 | 说明 |
| --- | --- |
| .object | 装饰样式配置项。参数类型为[OH_ArkUI_DecorationStyleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkui-nativemodule-oh-arkui-decorationstyleoptions)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | false表示退��编辑态，true表示维持现状。 属性获取方法参数[ArkUI_AttributeItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-arkui-nativemodule-arkui-attributeitem)格式： |
| .value[0].i32 | false表示退出编辑态，true表示维持现状。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 设置输入框内���字是否在首行和尾行增加间距以避免文字截断。true表示开启增加间距，false表示关闭增加间距。默认值：false。 |
