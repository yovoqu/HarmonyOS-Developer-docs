...
| 参数项 | 描述 |
| --- | --- |
| .object | 使用[ArkUI_ListItemSwipeActionOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkui-nativemodule-arkui-listitemswipeactionoption)对象构造。 |
...
| .value[2].f32 | 分割线距离列表侧边起始端的距离，单位vp。 |
| .value[3].f32 | 分割线距离列表侧边结束��的距离，单位vp。 |
...
| .object | 参数格式为[ArkUI_WaterFlowSectionOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pi-arkui-nativemodule-arkui-waterflowsectionoption)。 |
...
| 类型 | 说明 |
| --- | --- |
| .object | 返回值格式为[ArkUI_WaterFlowSectionOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/pi-arkui-nativemodule-arkui-waterflowsectionoption)。 |
...
| 参数项 | 描述 |
| --- | --- |
| .value[0].i32 | 配合waterFlow组件Adapter使���，设置adapter中的缓存数量。 |
