...
| .value[1].f32 | 浮层基于���身左上角的偏移量X，单位为vp。 |
...
| .?object | 参数类型为[ArkUI_VisibleAreaEventOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/i-arkui-nativemodule-arkui-visibleareaeventoptions)。 |
...
| --- | --- |
| .value[...].f32 | 占比数值。 |
| .object | 返回类型为[ArkUI_VisibleAreaEventOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/i-arkui-nativemodule-arkui-visibleareaeventoptions)。 |
