...
| 参数项 | 描述 |
| --- | --- |
| .value[0].f32 | 线性渐变的起始角度，当ArkUI_LinearGradientDirection为ARKUI_LINEAR_GRADIENT_DIRECTION_CUSTOM时，angle属性生效，否则按direction为主要布局方式。0点方向顺时针旋转为正向角度，默认值：180。 |
| .value[1].i32 | 线性渐变的方向，设置除ARKUI_LINEAR_GRADIENT_DIRECTION_CUSTOM的线性渐变方向后，angle不生效。数据类型ArkUI_LinearGradientDirection。 |
...
| 参数项 | 描述 |
| --- | --- |
| .object | 参数类型为ArkUI_TransitionEffect。 |
