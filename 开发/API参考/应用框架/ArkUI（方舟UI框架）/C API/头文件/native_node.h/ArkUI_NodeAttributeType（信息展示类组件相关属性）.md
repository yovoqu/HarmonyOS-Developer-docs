...
| 参数项 | 描述 |
| --- | --- |
| .object | 使用[ArkUI_ProgressLinearStyleOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkui-nativemodule-arkui-progresslinearstyleoption)对象设置组件样式。 |
...
| 类型 | 说明 |
| --- | --- |
| .object | 使用[ArkUI_ProgressLinearStyleOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkui-nativemodule-arkui-progresslinearstyleoption)对象获取组件样式。 |
