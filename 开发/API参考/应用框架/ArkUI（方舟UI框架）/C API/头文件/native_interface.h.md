...
| const char* OH_ArkUI_NativeModule_GetErrorMessage() | 获取最新一次的报错信息，包括错误码、方法名称和错误原因。 |
...
| 名称 | 描述 |
| --- | --- |
| OH_ArkUI_GetModuleInterface(nativeAPIVariantKind, structType, structPtr) | 初始化C-API环境，并基于结构体类型获取对应结构体指针。 |
...
| const char* structName | Native接口结构体的名称，可通过查询对应头文件内的结构体定义获取，例如位于native_node.h中的"ArkUI_NativeNodeAPI_1"。 |
