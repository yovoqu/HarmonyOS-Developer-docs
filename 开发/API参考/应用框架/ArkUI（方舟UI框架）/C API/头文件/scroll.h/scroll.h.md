...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-scroll-h
...
| ArkUI_BarState | ArkUI_BarState | 定义TextArea和TextEditor组件的滚动条状态枚举值。 |
...
| ArkUI_ScrollSnapAnimationSpeed | ArkUI_ScrollSnapAnimationSpeed | 列表限位滚动动画速度。 |
