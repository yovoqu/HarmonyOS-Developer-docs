...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-image-h
...
| ARKUI_OBJECT_FIT_NONE_MATRIX = 15 | 不改变图像原始大小，在Image组件中需要配合ArkUI_NodeAttributeType中的NODE_IMAGE_IMAGE_MATRIX使用，通过矩阵变换控制图像的显示效果（如缩放、旋转、平移等）。若不配合NODE_IMAGE_IMAGE_MATRIX使用，该枚举值将无法生效。 起始版本： 21 |
