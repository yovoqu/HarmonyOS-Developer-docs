...
| ArkUI_Matrix4 | ArkUI_Matrix4 | 定义四阶矩阵对象。 |
| ArkUI_Matrix4RotationOptions | ArkUI_Matrix4RotationOptions | 定义矩阵旋转的旋转对象。 |
| ArkUI_Matrix4ScaleOptions | ArkUI_Matrix4ScaleOptions | 定义矩阵缩放的缩放对象。 |
| ArkUI_Matrix4TranslationOptions | ArkUI_Matrix4TranslationOptions | 定义矩阵平移的平移对象。 |
| ArkUI_PointF | ArkUI_PointF | 定义一个二维坐标点结构体，坐标以浮点类型存储。 |
| OH_ArkUI_DecorationStyleOptions | OH_ArkUI_DecorationStyleOptions | 定义装饰线样式。 |
| OH_ArkUI_TextDataDetectorConfig | OH_ArkUI_TextDataDetectorConfig | 定义文本实体识别的配置。 |
...
| OH_ArkUI_ShadowOptions | OH_ArkUI_ShadowOptions | 定义阴影选项。 |
...
| OH_ArkUI_TextController | OH_ArkUI_TextController | 定义文本组件的控制器。可以通过OH_ArkUI_TextController_Create创建文本组件控制器对象，通过OH_ArkUI_TextController_Destroy接口销毁文本组件控制器对象。控制器创建后通过OH_ArkUI_TextController_SetStyledString 接口设置文本组件的属性字符串。 |
...
| ArkUI_ObjectFit | ArkUI_ObjectFit | 定义Image组件的图片填充效果。 |
| ArkUI_ImageInterpolation | ArkUI_ImageInterpolation | 定义图片插值效果。用于优化图片缩放时的锯齿问题。SVG类型图源不支持该属性。 |
...
| ArkUI_FinishCallbackType | ArkUI_FinishCallbackType | 在动画中定义OH_ArkUI_AnimatorOption_RegisterOnFinishCallback回调的类型。 |
...
| ArkUI_AnimationDirection | ArkUI_AnimationDirection | 动画播放方向。 |
...
| void OH_ArkUI_WaterFlowSectionOption_RegisterGetItemMainSizeCallbackByIndex (ArkUI_WaterFlowSectionOption* option, int32_t index, float(*callback)(int32_t itemIndex)) | - | 通过FlowItem分组配置信息根据itemIndex获取指定FlowItem的主轴大小。如需在回调中使用自定义数据，可使用OH_ArkUI_WaterFlowSectionOption_RegisterGetItemMainSizeCallbackByIndexWithUserData。 |
| void OH_ArkUI_WaterFlowSectionOption_RegisterGetItemMainSizeCallbackByIndexWithUserData (ArkUI_WaterFlowSectionOption* option, int32_t index, void* userData, float (*callback)(int32_t itemIndex, void* userData)) | - | 通过FlowItem分组配置信息根据itemIndex获取指定Item的主轴大小。与OH_ArkUI_WaterFlowSectionOption_RegisterGetItemMainSizeCallbackByIndex的区别在于，该接口支持传入自定义数据userData，并在回调函数中接收该数据。 |
...
| void OH_ArkUI_ListChildrenMainSizeOption_Resize(ArkUI_ListChildrenMainSize* option, int32_t totalSize) | - | 调整List组件子项主轴尺寸数组的容量大小。 |
| int32_t OH_ArkUI_ListChildrenMainSizeOption_Splice(ArkUI_ListChildrenMainSize* option, int32_t index, int32_t deleteCount, int32_t addCount) | - | 对List组件子项主轴尺寸数组进行大小调整。 |
...
| void OH_ArkUI_TextPickerRangeContentArray_SetIconAtIndex(ArkUI_TextPickerRangeContentArray* handle, char* icon, int32_t index) | - | 设置TextPickerRangeContent数组指定位置的icon数据。 |
| void OH_ArkUI_TextPickerRangeContentArray_SetTextAtIndex(ArkUI_TextPickerRangeContentArray* handle, char* text, int32_t index) | - | 设置TextPickerRangeContent数组指定位置的text数据。 |
...
| void OH_ArkUI_TextCascadePickerRangeContentArray_SetTextAtIndex (ArkUI_TextCascadePickerRangeContentArray* handle, char* text, int32_t index) | - | 设置TextCascadePickerRangeContent数组指定位置的text数据。 |
| void OH_ArkUI_TextCascadePickerRangeContentArray_SetChildAtIndex (ArkUI_TextCascadePickerRangeContentArray* handle, ArkUI_TextCascadePickerRangeContentArray* child, int32_t index) | - | 设置TextCascadePickerRangeContent数组指定位置的child数据。 |
...
| ArkUI_Matrix4ScaleOptions* OH_ArkUI_Matrix4ScaleOptions_Create() | - | 创建指向矩阵运算的缩放参数对象的指针。在新创建的对象中，x、y和z方向的缩放系数默认值，为1。变换中心点的x轴坐标centerX、变换中心点的y轴坐标centerY取默认值，为0。 |
| void OH_ArkUI_Matrix4ScaleOptions_Dispose(ArkUI_Matrix4ScaleOptions* options) | - | 销毁指向矩阵运算的缩放参数对象的指针。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4ScaleOptions_SetX(ArkUI_Matrix4ScaleOptions* options, const float scaleX) | - | 设置矩阵运算的缩放参数对象x方向的缩放因子。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4ScaleOptions_GetX(const ArkUI_Matrix4ScaleOptions* options, float* scaleX) | - | 获取矩阵运算的缩放参数对象x方向的缩放因子。如果从未设置x的值，则x方向的缩放因子默认值为1。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4ScaleOptions_SetY(ArkUI_Matrix4ScaleOptions* options, const float scaleY) | - | 设置矩阵运算的缩放参数对象y方向的缩放因子。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4ScaleOptions_GetY(const ArkUI_Matrix4ScaleOptions* options, float* scaleY) | - | 获取矩阵运算的缩放参数对象y方向的缩放因子。如果从未设置y的值，则y方向的缩放因子默认值为1。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4ScaleOptions_SetZ(ArkUI_Matrix4ScaleOptions* options, const float scaleZ) | - | 设置矩阵运算的缩放参数对象z方向的缩放因子。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4ScaleOptions_GetZ(const ArkUI_Matrix4ScaleOptions* options, float* scaleZ) | - | 获取矩阵运算的缩放参数对象z方向的缩放因子。如果从未设置z的值，则z方向的缩放因子默认值为1。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4ScaleOptions_SetCenterX(ArkUI_Matrix4ScaleOptions* options, const float centerX) | - | 设置矩阵运算的缩放参数对象变换中心点的x轴坐标。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4ScaleOptions_GetCenterX(const ArkUI_Matrix4ScaleOptions* options, float* centerX) | - | 获取矩阵运算的缩放参数对象变换中心点的x轴坐标。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4ScaleOptions_SetCenterY(ArkUI_Matrix4ScaleOptions* options, const float centerY) | - | 设置矩阵运算的缩放参数对象变换中心点的y轴坐标。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4ScaleOptions_GetCenterY(const ArkUI_Matrix4ScaleOptions* options, float* centerY) | - | 获取矩阵运算的缩放参数对象变换中心点的y轴坐标。 |
| ArkUI_Matrix4RotationOptions* OH_ArkUI_Matrix4RotationOptions_Create() | - | 创建矩阵运算的旋转参数对象的指针。在新创建的对象中，单次矩阵变换中心点相对于组件变换中心点的x轴偏移值centerX、单次矩阵变换中心点相对于组件变换中心点的y轴偏移值centerY、旋转角度angle的默认值，为0。如果未指定x、y、z方向的方向向量中的任何一个，则等同于x=0、y=0、z=1，表示绕z轴旋转。一旦指定了x、y、z方向的方向向量中的任意一个，其余未指定的值等同于0。 |
| void OH_ArkUI_Matrix4RotationOptions_Dispose(ArkUI_Matrix4RotationOptions* options) | - | 销毁指向矩阵运算的旋转参数对象的指针。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4RotationOptions_SetX(ArkUI_Matrix4RotationOptions* options, const float x) | - | 设置矩阵运算的旋转参数对象x方向的方向向量。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4RotationOptions_GetX(const ArkUI_Matrix4RotationOptions* options, float* x) | - | 获取矩阵运算的旋转参数对象x方向的方向向量。如果从未设置过x值，其值将处于未定义状态，此时函数将返回ARKUI_ERROR_CODE_PARAM_INVALID。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4RotationOptions_SetY(ArkUI_Matrix4RotationOptions* options, const float y) | - | 设置矩阵运算的旋转参数对象y方向的方向向量。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4RotationOptions_GetY(const ArkUI_Matrix4RotationOptions* options, float* y) | - | 获取矩阵运算的旋转参数对象y方向的方向向量。如果从未设置过y值，其值将处于未定义状态，此时函数将返回ARKUI_ERROR_CODE_PARAM_INVALID。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4RotationOptions_SetZ(ArkUI_Matrix4RotationOptions* options, const float z) | - | 设置矩阵运算的旋转参数对象z方向的方向向量。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4RotationOptions_GetZ(const ArkUI_Matrix4RotationOptions* options, float* z) | - | 获取矩阵运算的旋转参数对象z方向的方向向量。如果从未设置过z值，其值将处于未定义状态，此时函数将返回ARKUI_ERROR_CODE_PARAM_INVALID。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4RotationOptions_SetAngle(ArkUI_Matrix4RotationOptions* options, const float angle) | - | 设置矩阵运算的旋转参数对象中旋转角度的值。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4RotationOptions_GetAngle(const ArkUI_Matrix4RotationOptions* options, float* angle) | - | 获取矩阵运算的旋转参数对象中旋转角度的值。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4RotationOptions_SetCenterX(ArkUI_Matrix4RotationOptions* options, const float centerX) | - | 设置单次矩阵变换中心点相对于组件变换中心点的x轴偏移值。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4RotationOptions_GetCenterX(const ArkUI_Matrix4RotationOptions* options, float* centerX) | - | 获取单次矩阵变换中心点相对于组件变换中心点的x轴偏移值。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4RotationOptions_SetCenterY(ArkUI_Matrix4RotationOptions* options, const float centerY) | - | 设置单次矩阵变换中心点相对于组件变换中心点的y轴偏移值。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4RotationOptions_GetCenterY(const ArkUI_Matrix4RotationOptions* options, float* centerY) | - | 获取单次矩阵变换中心点相对于组件变换中心点的y轴偏移值。 |
| ArkUI_Matrix4TranslationOptions* OH_ArkUI_Matrix4TranslationOptions_Create() | - | 创建指向矩阵运算的平移对象的指针。在新创建的对象中，x轴的平移距离x、y轴的平移距离y和z轴的平移距离z的默认值为0。 |
| void OH_ArkUI_Matrix4TranslationOptions_Dispose(ArkUI_Matrix4TranslationOptions* options) | - | 销毁指向矩阵运算的平移对象的指针。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4TranslationOptions_SetX(ArkUI_Matrix4TranslationOptions* options, const float x) | - | 设置矩阵运算的平移对象x轴方向的平移值。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4TranslationOptions_GetX(const ArkUI_Matrix4TranslationOptions* options, float* x) | - | 获取矩阵运算的平移对象x轴方向的平移值。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4TranslationOptions_SetY(ArkUI_Matrix4TranslationOptions* options, const float y) | - | 设置矩阵运算的平移对象y轴方向的平移值。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4TranslationOptions_GetY(const ArkUI_Matrix4TranslationOptions* options, float* y) | - | 获取矩阵运算的平移对象y轴方向的平移值。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4TranslationOptions_SetZ(ArkUI_Matrix4TranslationOptions* options, const float z) | - | 设置矩阵运算的平移对象z轴方向的平移值。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4TranslationOptions_GetZ(const ArkUI_Matrix4TranslationOptions* options, float* z) | - | 获取矩阵运算的平移对象z轴方向的平移值。 |
| ArkUI_Matrix4* OH_ArkUI_Matrix4_CreateIdentity() | - | 创建一个单位四阶矩阵对象。 |
| ArkUI_Matrix4* OH_ArkUI_Matrix4_CreateByElements(const float* elements) | - | 通过指定矩阵的每个元素来创建一个四阶矩阵对象。 |
| void OH_ArkUI_Matrix4_Dispose(ArkUI_Matrix4* matrix) | - | 销毁矩阵对象的指针。 |
| ArkUI_Matrix4* OH_ArkUI_Matrix4_Copy(const ArkUI_Matrix4* matrix) | - | 创建四阶矩阵对象的副本。用于对同一个矩阵进行操作以此获取不同矩阵对象。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4_Invert(ArkUI_Matrix4* matrix) | - | 对输入矩阵执行逆矩阵变换。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4_Combine(ArkUI_Matrix4* oriMatrix, const ArkUI_Matrix4* anotherMatrix) | - | 将另一个矩阵与原始矩阵合并，并将结果矩阵存储在oriMatrix中。结果矩阵相当于先应用oriMatrix的变换，然后再应用anotherMatrix的变换。此函数将修改oriMatrix对象。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4_Translate(ArkUI_Matrix4* matrix, const ArkUI_Matrix4TranslationOptions* translate)(capi-arkui-nativemodule-arkui-matrix4translationoptions) | - | 对原始矩阵应用平移变换以获取平移后的矩阵。每次平移变换都是在先前的矩阵上累积的。变换后将修改输入的矩阵对象。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4_Scale(ArkUI_Matrix4* matrix, const ArkUI_Matrix4ScaleOptions* scale) | - | 对原始矩阵应用缩放变换以获取缩放后的矩阵。每次缩放变换都是在先前的矩阵上累积的。此函数将修改输入的矩阵对象。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4_Rotate(ArkUI_Matrix4* matrix, const ArkUI_Matrix4RotationOptions* rotate) | - | 对原始矩阵应用旋转变换以获取旋转后的矩阵。每次旋转变换都是在先前的矩阵上累积的。此函数将修改输入的矩阵对象。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4_Skew(ArkUI_Matrix4* matrix, const float skewX, const float skewY) | - | 对原始矩阵应用倾斜变换以获取倾斜后的矩阵。每次倾斜变换都是在先前的矩阵上累积的。变换后将修改输入的矩阵对象。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4_TransformPoint(const ArkUI_Matrix4* matrix, const ArkUI_PointF* oriPoint, ArkUI_PointF* result) | - | 计算一个点经过矩阵变换后的新坐标位置。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4_SetPolyToPoly(ArkUI_Matrix4* matrix, const ArkUI_PointF* src, const ArkUI_PointF* dst, const uint32_t pointCount) | - | 将一个多边形的顶点坐标映射到另一个多边形的顶点坐标，并计算所需的矩阵。 |
| ArkUI_ErrorCode OH_ArkUI_Matrix4_GetElements(const ArkUI_Matrix4* matrix, float* result) | - | 获取四阶矩阵的16个元素。 |
| OH_ArkUI_DecorationStyleOptions* OH_ArkUI_DecorationStyleOptions_Create() | - | 创建一个装饰线样式对象。当该对象不再使用时，请调用OH_ArkUI_DecorationStyleOptions_Destroy销毁。 |
| void OH_ArkUI_DecorationStyleOptions_Destroy(OH_ArkUI_DecorationStyleOptions* options) | - | 销毁装饰线样式对象。 |
...
| OH_ArkUI_ShadowOptions* OH_ArkUI_ShadowOptions_Create() | - | 创建一个阴影选项对象。当该对象不再使用时，请调用OH_ArkUI_ShadowOptions_Destroy销毁。 |
| void OH_ArkUI_ShadowOptions_Destroy(OH_ArkUI_ShadowOptions* options) | - | 销毁阴影选项对象。 |
| ArkUI_ErrorCode OH_ArkUI_ShadowOptions_SetRadius(OH_ArkUI_ShadowOptions* options, float radius) | - | 设置阴影选项的模糊半径。 |
| ArkUI_ErrorCode OH_ArkUI_ShadowOptions_GetRadius(OH_ArkUI_ShadowOptions* options, float* radius) | - | 获取阴影选项的模糊半径。 |
| ArkUI_ErrorCode OH_ArkUI_ShadowOptions_SetType(OH_ArkUI_ShadowOptions* options, ArkUI_ShadowType type) | - | 设置阴影选项的阴影类型。 |
| ArkUI_ErrorCode OH_ArkUI_ShadowOptions_GetType(OH_ArkUI_ShadowOptions* options, ArkUI_ShadowType* type) | - | 获取阴影选项的阴影类型。 |
| ArkUI_ErrorCode OH_ArkUI_ShadowOptions_SetColor(OH_ArkUI_ShadowOptions* options, uint32_t color) | - | 设置阴影选项的阴影颜色。 |
| ArkUI_ErrorCode OH_ArkUI_ShadowOptions_GetColor(OH_ArkUI_ShadowOptions* options, uint32_t* color) | - | 获取阴影选项的阴影颜色。 |
| ArkUI_ErrorCode OH_ArkUI_ShadowOptions_SetOffsetX(OH_ArkUI_ShadowOptions* options, float offsetX) | - | 设置阴影在x轴上的偏移量。 |
| ArkUI_ErrorCode OH_ArkUI_ShadowOptions_GetOffsetX(OH_ArkUI_ShadowOptions* options, float* offsetX) | - | 获取阴影在x轴上的偏移量。 |
| ArkUI_ErrorCode OH_ArkUI_ShadowOptions_SetOffsetY(OH_ArkUI_ShadowOptions* options, float offsetY) | - | 设置阴影在y轴上的偏移量。 |
| ArkUI_ErrorCode OH_ArkUI_ShadowOptions_GetOffsetY(OH_ArkUI_ShadowOptions* options, float* offsetY) | - | 获取阴影在y轴上的偏移量。 |
| ArkUI_ErrorCode OH_ArkUI_ShadowOptions_SetFill(OH_ArkUI_ShadowOptions* options, bool isFill) | - | 设置是否用阴影填充组件内部。 |
| ArkUI_ErrorCode OH_ArkUI_ShadowOptions_GetFill(OH_ArkUI_ShadowOptions* options, bool* isFill) | - | 获取是否用阴影填充组件内部。 |
...
| void OH_ArkUI_FontWeightConfigs_SetEnableVariableFontWeight(OH_ArkUI_FontWeightConfigs* option, bool enable) | - | 设置是否启用可变字体粗细调节。 |
| bool OH_ArkUI_FontWeightConfigs_GetEnableVariableFontWeight(OH_ArkUI_FontWeightConfigs* option) | - | 获取文本字体粗细配置对象是否启用了可变字体粗细调节。 |
...
| ARKUI_CONTENT_CLIP_MODE_SAFE_AREA = 2 | 按组件配置的安全区域裁剪。 |
...
| ARKUI_OBJECT_FIT_NONE_MATRIX = 15 | 不改变图像原始大小，需要配合ArkUI_NodeAttributeType中的NODE_IMAGE_IMAGE_MATRIX使用。 起始版本： 21 |
...
| ARKUI_ANIMATION_FILL_MODE_BOTH = 3 | 动画将遵循ARKUI_ANIMATION_FILL_MODE_FORWARDS和ARKUI_ANIMATION_FILL_MODE_BACKWARDS的规则，从而在两个方向上扩展动画属性。 |
...
| ARKUI_ERROR_CODE_PARAM_ERROR = 100023 | 参数错误。错误码的详细介绍请参见100023 参数错误。 起始版本： 21 |
...
| ARKUI_ERROR_CODE_ARKTS_NODE_NOT_SUPPORTED = 106103 | 不支持对ArkTS创建的节点执行对应的操作。错误码的详细介绍请参见106103 对应的操作不支持ArkTS创建的节点。 |
| ARKUI_ERROR_CODE_ADAPTER_NOT_BOUND = 106104 | 懒加载适配器未绑定到组件上。错误码的详细介绍请参见106104 适配器未绑定。 |
| ARKUI_ERROR_CODE_ADAPTER_EXIST = 106105 | 适配器已存在。错误码的详细介绍请参见106105 适配器已存在。 |
...
| ARKUI_ERROR_CODE_NODE_CAN_NOT_ADOPT_TO = 106209 | 节点无法接纳其他节点。错误码的详细介绍请参见106209 节点无法接纳其他节点。 起始版本： 22 |
...
| ARKUI_ERROR_CODE_RENDER_HAS_INVALID_FRAME_NODE = 106407 | 当前渲染节点从FrameNode中获取且该FrameNode已被取消接纳为附属节点或销毁。错误码的详细介绍请参见106407 当前渲染节点从FrameNode中获取且该FrameNode已被取消接纳为附属节点或销毁。 起始版本： 22 |
| ARKUI_ERROR_CODE_RENDER_NOT_ADOPTED_NODE = 106408 | 当前节点不处于被接纳状态。错误码的详细介绍请参见106408 当前节点不处于被接纳状态。 起始版本： 22 |
| ARKUI_ERROR_CODE_FOCUS_NON_FOCUSABLE = 150001 | 当前节点无法获得焦点。错误码的详细介绍请参见150001 节点无法获得焦点。 起始版本： 15 |
| ARKUI_ERROR_CODE_FOCUS_NON_FOCUSABLE_ANCESTOR = 150002 | 当前节点对应的祖先节点中存在无法获焦节点。错误码的详细介绍请参见150002 祖先节点无法获得焦点。 起始版本： 15 |
| ARKUI_ERROR_CODE_FOCUS_NON_EXISTENT = 150003 | 当前节点不存在。错误码的详细介绍请参见150003 节点不存在。 起始版本： 15 |
...
| callback | 根据index获取指定Item的主轴大小。itemIndex：FlowItem索引值；userData：用户自定义数据。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_DrawableDescriptor* drawable | 使用PixelMap创建的ArkUI_DrawableDescriptor对象指针。 |
...
| 类型 | 说明 |
| --- | --- |
| OH_ArkUI_DecorationStyleOptions* | 指向OH_ArkUI_DecorationStyleOptions对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| OH_ArkUI_DecorationStyleOptions* options | 指向待销毁的选项对象的指针。 |
...
| --- | --- |
| OH_ArkUI_TextDataDetectorConfig* config | 指向OH_ArkUI_TextDataDetectorConfig对象的指针。 |
| OH_ArkUI_DecorationStyleOptions* decoration | 识别内容的装饰样式，取值为OH_ArkUI_DecorationStyleOptions中的枚举。 |
...
| 类型 | 说明 |
| --- | --- |
| OH_ArkUI_ShadowOptions* | 指向OH_ArkUI_ShadowOptions对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| OH_ArkUI_ShadowOptions* options | 指向OH_ArkUI_ShadowOptions对象的指针。 |
...
| --- | --- |
| OH_ArkUI_ShadowOptions* options | 指向OH_ArkUI_ShadowOptions对象的指针。 |
| ArkUI_ShadowType type | 阴影类型ArkUI_ShadowType。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkUI_Matrix4ScaleOptions* | 返回指向新创建的ArkUI_Matrix4ScaleOptions的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_Matrix4ScaleOptions* options | 指向要销毁的ArkUI_Matrix4ScaleOptions对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_Matrix4ScaleOptions* options | 指向矩阵运算的缩放参数对象的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkUI_ErrorCode | 错误码。 如果操作成功，返回ARKUI_ERROR_CODE_NO_ERROR。 如果发生参数异常，返回ARKUI_ERROR_CODE_PARAM_INVALID。 |
...
| 参数项 | 描述 |
| --- | --- |
| const ArkUI_Matrix4ScaleOptions* options | 指向矩阵运算的缩放参数对象的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkUI_Matrix4RotationOptions* | 返回指向新创建的ArkUI_Matrix4RotationOptions的指针 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_Matrix4RotationOptions* options | 指向矩阵运算的旋转参数对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| const ArkUI_Matrix4RotationOptions* options | 指向矩阵运算的旋转参数对象的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkUI_Matrix4TranslationOptions* | 返回指向新创建的ArkUI_Matrix4TranslationOptions的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_Matrix4TranslationOptions* options | 指向要销毁的ArkUI_Matrix4TranslationOptions对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_Matrix4TranslationOptions* options | 指向矩阵运算的平移参数对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| const ArkUI_Matrix4TranslationOptions* options | 指向矩阵运算的平移参数对象的指针。 |
| float* x | x轴方向的平移值。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkUI_Matrix4* | 返回指向创建的单位四阶矩阵对象的指针。 |
...
| 类型 | 说明 |
| --- | --- |
| ArkUI_Matrix4* | 返回新创建的四阶矩阵对象。如果elements指针为空，函数将返回空值。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_Matrix4* matrix | 指向要销毁的四阶矩阵对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| const ArkUI_Matrix4* matrix | 指向原始四阶矩阵对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_Matrix4* matrix | 指向要逆矩阵变换的四阶矩阵对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_Matrix4* oriMatrix | 指向原始四阶矩阵对象的指针。 |
| const ArkUI_Matrix4* anotherMatrix | 指向要合并的另一个矩阵对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_Matrix4* matrix | 指向待平移四阶矩阵对象的指针。 |
| const ArkUI_Matrix4TranslationOptions* translate | 指向平移对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_Matrix4* matrix | 指向待缩放四阶矩阵对象的指针。 |
| const ArkUI_Matrix4ScaleOptions* scale | 指向缩放对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_Matrix4* matrix | 指向待旋转四阶矩阵对象的指针。 |
| const ArkUI_Matrix4RotationOptions* rotate | 指向旋转对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_Matrix4* matrix | 指向待倾斜四阶矩阵对象的指针。 |
...
| 参数项 | 描述 |
| --- | --- |
| const ArkUI_Matrix4* matrix | 指向四阶矩阵对象的指针。 |
| const ArkUI_PointF* oriPoint | 指向原始坐标点的指针。 |
| ArkUI_PointF* result | 指向结果点的指针。不能为空。 |
...
| 参数项 | 描述 |
| --- | --- |
| ArkUI_Matrix4* matrix | 指向四阶矩阵对象的指针，用于存放结果矩阵。 |
| const ArkUI_PointF* src | 指向原始多边形坐标点数组的指针。数组长度应至少为pointCount。 |
| const ArkUI_PointF* dst | 指向映射后多边形坐标点数组的指针。数组长度应至少为pointCount。 |
...
| OH_ArkUI_FontWeightConfigs* fontWeightConfigs | 文本字体粗细配置。 |
