...
2. 共享元素的exchange效果类似下图。  **图1** 共享元素转场默认效果 ![](assets/转场样式/file-20260514164216688-0.png)
...
3. transition-enter/transition-exit说明如下：  a. push场景下：进入页面栈的Page2.js应用transition-enter描述的动画配置；进入页面栈第二位置的Page1.js应用transition-exit描述的动画配置。  ![](assets/转场样式/file-20260514164216688-2.png)  b. back场景下：退出页面栈的Page2.js应用transition-enter描述的动画配置，并进行倒播；从页面栈第二位置进入栈顶位置的Page1.js应用transition-exit描述的动画配置，并进行倒播。  ![](assets/转场样式/file-20260514164216688-3.png)
...
1. Page1  __PREBLOCK_11__  __PREBLOCK_12__  __PREBLOCK_13__
2. Page2  __PREBLOCK_14__  __PREBLOCK_15__  __PREBLOCK_16__  ![](assets/转场样式/file-20260514164216688-4.gif)
