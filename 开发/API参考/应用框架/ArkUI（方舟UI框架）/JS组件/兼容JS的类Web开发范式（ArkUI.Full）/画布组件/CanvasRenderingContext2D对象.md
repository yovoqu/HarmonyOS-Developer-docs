...
- 示意图（关闭抗锯齿）      ![](assets/CanvasRenderingContext2D对象/file-20260514164231742-0.png)
- 示意图（开启抗锯齿）      ![](assets/CanvasRenderingContext2D对象/file-20260514164231742-1.png)
...
| [lineCap](#linecap) | string | 指定线端点的样式，可选值为：          - butt：线端点以方形结束。          - round：线端点以圆形结束。          - square：线端点以方形结束，该样式下会增加一个长度和线段厚度相同，宽度是线段厚度一半的矩形。          默���值：butt |
...
| sHeight | number | 是 | 裁切源图像时��要裁切的高度。          单位：vp |
...
![](assets/CanvasRenderingContext2D对象/file-20260514164231742-47.png)
