...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-service-widget-common-styles
...
| background | &lt;linear-gradient&gt; | - | 仅支持设置[渐变样式](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-service-widget-common-gradient)，与background-color、background-image不兼容。 |
