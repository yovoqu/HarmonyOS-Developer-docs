...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-lite-components-common-mediaquery
**支持设备：** Phone | PC/2in1 | Tablet | Wearable | lite_wearable | TV

> [!NOTE]
> 从API version 8 开始支持。后续版本如有新增内容，则采用上角标单独标记该内容的起始版本。 media属性值默认为设备的真实尺寸大小、物理像素和真实的屏幕分辨率。
...
> [!NOTE]
> 不支持<=，>=，<，>操作符; 从API version 9开始，支持多重()嵌套使用； media语句整体长度不能超过 512 个字符； 单个media条件长度不能超过32个字符；
