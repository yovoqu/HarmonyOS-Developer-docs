...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/errorcode-internal
**支持设备：** Phone | PC/2in1 | Tablet | Wearable | TV | lite_wearable

> [!NOTE]
> 以下仅介绍本模块特有错误码。开发者在使用ArkUI相关接口时如遇到接口调用异常，可参考本文档中的错误码信息定位问题原因并采取相应处理步骤。通用错误码请参考 通用错误码 。
