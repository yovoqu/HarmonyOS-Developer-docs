...
router
  ...
  .catch((err: ESObject) => {
    console.error(
      `pushUrl failed, code is ${(err as BusinessError).code}, message is ${(err as BusinessError).message}`,
    );
  });
```
...
router.pushUrl(
  ...
  (err) => {
    if (err) {
      console.error(
        `pushUrl failed, code is ${err.code}, message is ${err.message}`,
      );
      return;
    }
...
router
  ...
  .catch((err: ESObject) => {
    console.error(
      `replaceUrl failed, code is ${(err as BusinessError).code}, message is ${(err as BusinessError).message}`,
    );
  });
```
...
router.replaceUrl(
  ...
  (err) => {
    if (err) {
      console.error(
        `replaceUrl failed, code is ${err.code}, message is ${err.message}`,
      );
      return;
    }
...
router
  ...
  .catch((err: ESObject) => {
    console.error(
      `pushNamedRoute failed, code is ${(err as BusinessError).code}, message is ${(err as BusinessError).message}`,
    );
  });
```
...
router.pushNamedRoute(
  ...
  (err) => {
    if (err) {
      console.error(
        `pushNamedRoute failed, code is ${err.code}, message is ${err.message}`,
      );
      return;
    }
...
router
  ...
  .catch((err: ESObject) => {
    console.error(
      `replaceNamedRoute failed, code is ${(err as BusinessError).code}, message is ${(err as BusinessError).message}`,
    );
  });
```
...
router.replaceNamedRoute(
  ...
  (err) => {
    if (err) {
      console.error(
        `replaceNamedRoute failed, code is ${err.code}, message is ${err.message}`,
      );
      return;
    }
...
try {
  ...
  console.error(
    `showAlertBeforeBackPage failed, code is ${(err as BusinessError).code}, message is ${(err as BusinessError).message}`,
  );
}
```
