...
![](assets/ComponentContent/file-20260514163846202-0.gif)
...
![](assets/ComponentContent/file-20260514163846202-2.gif)
...
![](assets/ComponentContent/file-20260514163846202-5.gif)
...
![](assets/ComponentContent/file-20260514163846202-9.gif)
      ...
      Scroll() {
        Column({ space: 12 }) {
          ...
          Button('change age - V2可自动更新').onClick(() => {
            this.params.age += 1; // V2装饰���会自动检测变化并更新UI
          })
...
![](assets/ComponentContent/file-20260514163846202-12.gif)
