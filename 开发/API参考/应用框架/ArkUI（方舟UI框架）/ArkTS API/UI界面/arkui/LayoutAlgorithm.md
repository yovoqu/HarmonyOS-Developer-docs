...
> [!NOTE]
> CustomLayoutAlgorithm类对象可以作为 DynamicLayout 组件的入参指定布局算法。
...
> [!NOTE]
> RowLayoutAlgorithm类对象可以作为 DynamicLayout 组件的入参指定布局算法。
...
> [!NOTE]
> ColumnLayoutAlgorithm类对象可以作为 DynamicLayout 组件的入参指定布局算法。
...
> [!NOTE]
> StackLayoutAlgorithm类对象可以作为 DynamicLayout 组件的入参指定布局算法。
...
> [!NOTE]
> GridLayoutAlgorithm类对象可以作为 DynamicLayout 组件的入参指定布局算法。
