...
> [!NOTE]
> 该类型变量可以赋值具体的布局算法类对象，如 CustomLayoutAlgorithm 类对象、 RowLayoutAlgorithm 类对象等。
...
> [!NOTE]
> CustomLayoutAlgorithm类对象可以赋值给LayoutAlgorithm类型变量，作为 DynamicLayout 组件的入参指定布局算法。
...
> [!NOTE]
> RowLayoutAlgorithm类对象可以赋值给LayoutAlgorithm类型变量，作为 DynamicLayout 组件的入参指定布局算法。
...
> [!NOTE]
> ColumnLayoutAlgorithm类对象可以赋值给LayoutAlgorithm类型变量，作为 DynamicLayout 组件的入参指定布局算法。
...
> [!NOTE]
> StackLayoutAlgorithm类对象可以赋值给LayoutAlgorithm类型变量，作为 DynamicLayout 组件的入参指定布局算法。
...
> [!NOTE]
> GridLayoutAlgorithm类对象可以赋值给LayoutAlgorithm类型变量，作为 DynamicLayout 组件的入参指定布局算法。
