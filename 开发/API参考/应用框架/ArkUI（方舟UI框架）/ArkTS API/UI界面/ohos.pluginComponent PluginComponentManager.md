  ...
  (err, data) => {
    console.info(
      'request_callback: componentTemplate.ability=' +
        data.componentTemplate.ability,
    );
    console.info(
    ...
    console.info(
      'request_callback: extraData=' + JSON.stringify(data.extraData),
    );
  },
);
```
