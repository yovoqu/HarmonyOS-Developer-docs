...
> [!NOTE] 说明
> 从API version 18开始废弃，建议使用UIContext中的getUIInspector方法获取UIInspector实例，再通过此实例调用替代方法createComponentObserver。 从API version 10开始，可以通过使用UIContext中的getUIInspector方法获取当前UI上下文关联的UIInspector对象。
