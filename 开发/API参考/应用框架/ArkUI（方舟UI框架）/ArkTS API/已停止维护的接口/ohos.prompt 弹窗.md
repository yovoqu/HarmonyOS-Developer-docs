...
> [!NOTE]
> 从API version 9 开始，该接口不再维护，推荐使用新接口 @ohos.promptAction (弹窗) 。 本模块首批接口从API version 8开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。
...
![](assets/ohos.prompt%20弹窗/file-20260514163855683-1.gif)
...
![](assets/ohos.prompt%20弹窗/file-20260514163855683-2.gif)
...
![](assets/ohos.prompt%20弹窗/file-20260514163855683-3.gif)
...
![](assets/ohos.prompt%20弹窗/file-20260514163855683-4.gif)
