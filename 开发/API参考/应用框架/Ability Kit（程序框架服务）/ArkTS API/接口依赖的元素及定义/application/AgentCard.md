...
| deviceTypes | Array&lt;string&gt; | 否 | 是 | Agent支持的设备类型列表。取值范围参考[deviceTypes](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/module-configuration-file#devicetypes标签)。 |
