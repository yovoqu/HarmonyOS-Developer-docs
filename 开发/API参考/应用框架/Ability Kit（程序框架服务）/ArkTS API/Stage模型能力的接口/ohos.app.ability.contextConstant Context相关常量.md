...
| SCENARIO_SHOW_ABILITY | 0x00000002 | showAbility接口触发的UIAbility到前台场景。 |
| SCENARIO_BACK_TO_CALLER_ABILITY_WITH_RESULT | 0x00000004 | backToCallerAbilityWithResult接口触发的UIAbility到前台场景。 |
