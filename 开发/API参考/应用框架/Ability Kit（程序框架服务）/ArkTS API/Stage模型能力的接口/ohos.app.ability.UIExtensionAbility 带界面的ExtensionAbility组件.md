...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-uiextensionability
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| context | UIExtensionContext | 否 | 否 | UIExtensionAbility组件的上下文。 |
