...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-atomicserviceoptions
    ...
    let completionHandler: CompletionHandlerForAtomicService = {
      ...
      onAtomicServiceRequestFailure(
        ...
        hilog.info(
          0x0000,
          'testTag',
          `appId:${appId}, failureCode:${failureCode}, failureMessage:${failureMessage}`,
        );
      },
    };
