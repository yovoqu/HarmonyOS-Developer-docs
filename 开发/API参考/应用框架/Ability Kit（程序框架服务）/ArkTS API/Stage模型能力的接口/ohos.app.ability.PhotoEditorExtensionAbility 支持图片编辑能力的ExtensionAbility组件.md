...
![](assets/ohos.app.ability.PhotoEditorExtensionAbility%20支持图片编辑能力的ExtensionAbility组件/file-20260514163706065-0.png)
...
export default class ExamplePhotoEditorAbility extends PhotoEditorExtensionAbility {
  onStartContentEditing(
    ...
    console.info(
      TAG,
      `onStartContentEditing want: ${JSON.stringify(want)}, uri: ${uri}`,
    );
  }
}
```
...
- 同步回调示例如下：  __PREBLOCK_5__
- Promise异步回调示例如下：  __PREBLOCK_6__
