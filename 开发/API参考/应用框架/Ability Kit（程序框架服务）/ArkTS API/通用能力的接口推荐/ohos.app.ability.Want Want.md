...
- 基础用法：在UIAbility对象中调用，示例中的context的获取方式请参见[获取UIAbility的上下文信息](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-usage#获取uiability的上下文信息)。       __PREBLOCK_1__
- ��前支持的数据类型有：字符串、数字、布尔、对象、数组和文件描述符等。                        字符串（String）         __PREBLOCK_2__
- 数字（Number）         __PREBLOCK_3__
- 布尔（Boolean）         __PREBLOCK_4__
- 对象（Object）         __PREBLOCK_5__
- 数组（Array）         __PREBLOCK_6__
- 文件描述符（FD）         __PREBLOCK_7__
- parameters参数用法：parameters携带开发者自定义参数，由UIAbilityA传递给UIAbilityB，并在UIAbilityB中进行获取。         __PREBLOCK_8__         __PREBLOCK_9__
- parameters参数中[wantConstant](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-wantconstant)的Key的使用方法。         __PREBLOCK_10__
