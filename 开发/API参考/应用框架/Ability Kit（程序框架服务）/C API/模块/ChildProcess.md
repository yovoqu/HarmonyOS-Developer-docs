...
| 名称 | 描述 |
| --- | --- |
| [native_child_process.h](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-native-child-process-h) | 支持创建Native子进程，并在父子进程间建立IPC通道。 引用文件：&lt;AbilityKit/native_child_process.h&gt; 库：libchild_process.so |
