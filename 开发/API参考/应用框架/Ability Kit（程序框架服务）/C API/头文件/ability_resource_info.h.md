...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [OH_NativeBundle_AbilityResourceInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/-native-bundle-oh-nativebundle-abilityresourceinfo) | OH_NativeBundle_AbilityResourceInfo | 表示组件资源信息。 |
...
| [int OH_NativeBundle_GetSize()](#oh_nativebundle_getsize) | 获取单个结构体[OH_NativeBundle_AbilityResourceInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/-native-bundle-oh-nativebundle-abilityresourceinfo)的大小。 |
...
| 类型 | 说明 |
| --- | --- |
| int | 返回单个结构体[OH_NativeBundle_AbilityResourceInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/-native-bundle-oh-nativebundle-abilityresourceinfo)的大小。 |
