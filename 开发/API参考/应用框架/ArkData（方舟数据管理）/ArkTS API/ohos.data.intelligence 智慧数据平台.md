...
intelligence
  .getTextEmbeddingModel(textConfig)
...
intelligence
  .getImageEmbeddingModel(imageConfig)
...
intelligence
  .splitText(splitText, splitConfig)
...
let image =
  'file://<packageName>/data/storage/el2/base/haps/entry/files/xxx.jpg';
imageEmbedding
  .getEmbedding(image)
  .then((data: Array<number>) => {
    console.info('Succeeded in getting Embedding');
