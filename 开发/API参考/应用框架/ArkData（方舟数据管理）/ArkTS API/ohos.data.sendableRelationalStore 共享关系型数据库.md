...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| values | collections.Array&lt;[ValueType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-data-relationalstore-t#valuetype)&gt; | 是 | 可跨线程传递的数组数据。 |
...
| 类型 | 说明 |
| --- | --- |
| collections.Array&lt;[ValueType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-data-relationalstore-t#valuetype)&gt; | 可跨线程传递的数组数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [collections.Array](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-array)&lt;[Asset](#asset)&gt; | 用于并发场景的Asset附件数据集合。 |
...
| 类型 | 说明 |
| --- | --- |
| [collections.Map](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-arkts-collections-map)&lt;string, [ValueType](#valuetype)&gt; | 并发场景的键值对数据存储，其中，键的类型为string，值的类型为ValueType。 |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[relationalStore.ValueType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-data-relationalstore-t#valuetype)&gt; | 非并发场景的数组数据存储，值的类型为ValueType。 |
