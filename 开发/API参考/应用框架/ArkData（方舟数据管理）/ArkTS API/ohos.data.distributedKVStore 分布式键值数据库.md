...
> [!NOTE]
> 使用equalTo时需要结合 Schema 使用。 使用Schema创建数据库请参见 通过键值型数据库实现数据持久化 中使用getKVStore()方法创建并获取键值数据库示例。
...
> [!NOTE]
> 使用notEqualTo时需要结合 Schema 使用。 使用Schema创建数据库请参见 通过键值型数据库实现数据持久化 中使用getKVStore()方法创建并获取键值数据库示例。
...
> [!NOTE]
> 使用greaterThan时需要结合 Schema 使用。 使用Schema创建数据库请参见 通过键值型数据库实现数据持久化 中使用getKVStore()方法创建并获取键值数据库示例。
...
> [!NOTE]
> 使用lessThan时需要结合 Schema 使用。 使用Schema创建数据库请参见 通过键值型数据库实现数据持久化 中使用getKVStore()方法创建并获取键值数据库示例。
...
> [!NOTE]
> 使用greaterThanOrEqualTo时需要结合 Schema 使用。 使用Schema创建数据库请参见 通过键值型数据库实现数据持久化 中使用getKVStore()方法创建并获取键值数据库示例。
...
> [!NOTE]
> 使用lessThanOrEqualTo时需要结合 Schema 使用。 使用Schema创建数据库请参见 通过键值型数据库实现数据持久化 中使用getKVStore()方法创建并获取键值数据库示例。
...
> [!NOTE]
> 使用isNull时需要结合 Schema 使用。 使用Schema创建数据库请参见 通过键值型数据库实现数据持久化 中使用getKVStore()方法创建并获取键值数据库示例。
...
> [!NOTE]
> 使用inNumber时需要结合 Schema 使用。 使用Schema创建数据库请参见 通过键值型数据库实现数据持久化 中使用getKVStore()方法创建并获取键值数据库示例。
...
> [!NOTE]
> 使用inString时需要结合 Schema 使用。 使用Schema创建数据库请参见 通过键值型数据库实现数据持久化 中使用getKVStore()方法创建并获取键值数据库示例。
...
> [!NOTE]
> 使用notInNumber时需要结合 Schema 使用。 使用Schema创建数据库请参见 通过键值型数据库实现数据持久化 中使用getKVStore()方法创建并获取键值数据库示例。
...
> [!NOTE]
> 使用notInString时需要结合 Schema 使用。 使用Schema创建数据库请参见 通过键值型数据库实现数据持久化 中使用getKVStore()方法创建并获取键值数据库示例。
...
> [!NOTE]
> 使用like时需要结合 Schema 使用。 使用Schema创建数据库请参见 通过键值型数据库实现数据持久化 中使用getKVStore()方法创建并获取键值数据库示例。
...
> [!NOTE]
> 使用unlike时需要结合 Schema 使用。 使用Schema创建数据库请参见 通过键值型数据库实现数据持久化 中使用getKVStore()方法创建并获取键值数据库示例。
...
> [!NOTE]
> 使用orderByAsc时需要结合 Schema 使用。 使用Schema创建数据库请参见 通过键值型数据库实现数据持久化 中使用getKVStore()方法创建并获取键值数据库示例。
...
> [!NOTE]
> 使用orderByDesc时需要结合 Schema 使用。 使用Schema创建数据库请参见 通过键值型数据库实现数据持久化 中使用getKVStore()方法创建并获取键值数据库示例。
...
> [!NOTE]
> 使用isNotNull时需要结合 Schema 使用。 使用Schema创建数据库请参见 通过键值型数据库实现数据持久化 中使用getKVStore()方法创建并获取键值数据库示例。
...
> [!NOTE]
> 设置默认延时后，调用 sync 接口不会立即触发端端同步，而是等待指定的延时时间后再执行。
