...
| 参数项 | 描述 |
| --- | --- |
| [OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences) *preference | 指向目标Preferences[OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences)实例对象的指针。 |
...
| --- | --- |
| [OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences) *preference | 指向目标[OH_Preferences](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferences)实例的指针。 |
| [OH_PreferencesPair](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-preferences-oh-preferencespair) **pairs | 指向要获取的KV数据的指针。当不再需要此KV数��时，用户需要调用[OH_Preferences_FreeString](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-oh-preferences-h#oh_preferences_freestring)释放内存。 |
