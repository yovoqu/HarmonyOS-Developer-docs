...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-trafficfilter-oh-trafficfilter-portmatch
**支持设备：** PC/2in1
...
| 名称 | 描述 |
| --- | --- |
| OH_TrafficFilter_PortMatchType type | 匹配类型。 起始版本： 26.0.0 |
