...
![](assets/系统能力SystemCapability使用指南/file-20260514163658228-0.png)
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/2XhYKYXPTPGvNU3Vsiah7A/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T083435Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=909A33FD254002CE132BEF73062C2B0F1F15FE3C070F04B4260E041C0C594D2A)
...
![](assets/系统能力SystemCapability使用指南/file-20260514163658228-2.png)
...
![](assets/系统能力SystemCapability使用指南/file-20260514163658228-3.png)
...
![](assets/系统能力SystemCapability使用指南/file-20260514163658228-4.png)

开发者在DevEco Studio创建工程时，需要选择应用的设备类型Device type：

![](assets/系统能力SystemCapability使用指南/file-20260514163658228-5.png)
...
![](assets/系统能力SystemCapability使用指南/file-20260514163658228-6.png)

DevEco Studio自动识别项目中的设备类型，定位SDK“device-define”下对应的SysCap集合，进而提取该设备支持的API，用于智能提示与自动联想，助力开发者精准、高效地调用所需接口。

![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/BcwgnDJ5TtGbG7SOCxTWPg/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T083435Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=2D1D5E818437CDA425971117E595F95344833315C2FD1C9FFACD54C0AADDA5AD)
...
1. 同步接口必须使用try...catch处理异常，避免应用功能崩溃。       __PREBLOCK_4__
2. 异步接口使用.catch的方式捕获异步的异常，开发者也可以不处理异常，应用不会崩溃。       __PREBLOCK_5__
...
![](assets/系统能力SystemCapability使用指南/file-20260514163658228-8.png)
...
![](assets/系统能力SystemCapability使用指南/file-20260514163658228-9.png)
