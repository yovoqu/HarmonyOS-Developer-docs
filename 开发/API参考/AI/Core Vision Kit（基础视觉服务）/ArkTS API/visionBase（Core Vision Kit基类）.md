...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[DownloadStartData](#downloadstartdata)&gt; | 是 | 回调函数，当模型开始下载时触发，返回开始下载的资源标识信息。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[DownloadCompleteData](#downloadcompletedata)&gt; | 是 | 回调函数，当模型下载完成时触发，返回完成下载的资源标识符及版本号。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[DownloadCancelData](#downloadcanceldata)&gt; | 是 | 回调函数，当模型下载被取消时触发，返回取消下载的资源标识信息。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[DownloadStatusData](#downloadstatusdata)&gt; | 是 | 回调函数，当模型下载状态发生变化时触发，返回当前下载状态信息。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[DownloadProgressData](#downloadprogressdata)&gt; | 是 | 回调函数，当模型下载进度更新时触发，返回当前下载进度信息。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[DownloadStartData](#downloadstartdata)&gt; | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[DownloadCompleteData](#downloadcompletedata)&gt; | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[DownloadCancelData](#downloadcanceldata)&gt; | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[DownloadStatusData](#downloadstatusdata)&gt; | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[DownloadProgressData](#downloadprogressdata)&gt; | 否 | 需要取消注册的回调函数，需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
