...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/intents-rest-api-revoke-event
...
#### 响应示例
- 调用成功，响应码为200，响应体为空。
- 调用失败，响应码为400，以未携带必填字段为例，响应体格式如下： HTTP/1.1 400 Bad Request
Content-Type: application/json
