...
| action | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;string \| [Subject](#subject)[]&gt; | 否 | 否 | 菜单结果回调，包含文字选中结果和抠图结果。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[AIButtonStatus](#aibuttonstatus)&gt; | 是 | 回调函数。返回AIButton展示状态。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[AIButtonStatus](#aibuttonstatus)&gt; | 否 | 回调函数，返回AIButton展示状态。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[ImageAnalyzerVisibility](#imageanalyzervisibility)&gt; | 是 | 回调函数。返回AI识图控件可见状态。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[ImageAnalyzerVisibility](#imageanalyzervisibility)&gt; | 否 | 回调函数。返回AI识图控件可见状态。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[Subject](#subject)[]&gt; | 是 | 回调函数。返回主体分析结果对象数组。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[Subject](#subject)[]&gt; | 否 | 回调函数。返回主体分析结果对象数组。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[Subject](#subject)[]&gt; | 是 | 回调函数。返回选中的主体信息对象数组。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[Subject](#subject)[]&gt; | 否 | 回调函数。返回选中的主体信息对象数组。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[ObjectSearchPanelVisibility](#objectsearchpanelvisibility)&gt; | 是 | 回调函数。返回图片搜索事件信息。 |
...
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-base#callback)&lt;[ObjectSearchPanelVisibility](#objectsearchpanelvisibility)&gt; | 否 | 回调函数。返回图片搜索事件信息。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
