...
| callback | Callback&lt;AIButtonStatus&gt; | 是 | 回调函数。返回AIButton展示状态。 |
...
| callback | Callback&lt;AIButtonStatus&gt; | 否 | 回调函数，返回AIButton展示状态。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | Callback&lt;ImageAnalyzerVisibility&gt; | 是 | 回调函数。返回AI识图控件可见状态。 |
...
| callback | Callback&lt;ImageAnalyzerVisibility&gt; | 否 | 回调函数。返回AI识图控件可见状态。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | Callback&lt;string&gt; | 是 | 回调函数。返回文字分析结果。 |
...
| callback | Callback&lt;string&gt; | 否 | 回调函数。返回文字分析结果。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | Callback&lt;string&gt; | 是 | 回调函数。返回文字选中结果。 |
...
| callback | Callback&lt;string&gt; | 否 | 回调函数。返回文字选中结果。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | Callback<Subject[]> | 是 | 回调函数。返回主体分析结果对象数组。 |
...
| callback | Callback<Subject[]> | 否 | 回调函数。返回主体分析结果对象数组。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | Callback<Subject[]> | 是 | 回调函数。返回选中的主体信息对象数组。 |
...
| callback | Callback<Subject[]> | 否 | 回调函数。返回选中的主体信息对象数组。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | Callback&lt;ObjectSearchPanelVisibility&gt; | 是 | 回调函数。返回图片搜索事件信息。 |
...
| callback | Callback&lt;ObjectSearchPanelVisibility&gt; | 否 | 回调函数。返回图片搜索事件信息。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | Callback&lt;void&gt; | 是 | 回调函数。返回为空，表示光标移入图片内文字区域。 |
...
| callback | Callback&lt;void&gt; | 否 | 回调函数。返回为空，表示光标移入图片内文字区域。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | Callback&lt;void&gt; | 是 | 回调函数。返回为空。表示光标移出图片内文字区域事件。 |
...
| callback | Callback&lt;void&gt; | 否 | 回调函数。返回为空。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
...
| callback | ErrorCallback | 是 | 回调函数。返回AI识图异常场景错误信息。 |
...
| callback | ErrorCallback | 否 | 回调函数。返回AI识图异常场景错误信息。需与订阅时传入的回调函数是同一个。若无此参数，则取消注册所有的回调函数。 |
