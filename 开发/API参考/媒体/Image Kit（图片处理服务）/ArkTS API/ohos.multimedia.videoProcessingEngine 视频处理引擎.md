...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-videoprocessingengine
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[image.PixelMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-image-pixelmap)&gt; | 异步方法返回PixelMap的Promise实例。 |
...
async function enhanceDetailSync(
  sourceImage: image.PixelMap,
  width: number,
  height: number,
) {
