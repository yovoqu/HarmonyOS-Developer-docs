...
> [!NOTE]
> 从API version 10开始支持，从API version 11开始废弃。建议使用 MediaAlbumChangeRequest.addAssets 替代。
...
> [!NOTE]
> 从API version 10开始支持，从API version 11开始废弃。建议使用 MediaAlbumChangeRequest.removeAssets 替代。
