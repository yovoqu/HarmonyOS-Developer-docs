...
| OH_MIDIDeviceType deviceType | 设备类型（USB、BLE等）。 起始版本： 24 |
| OH_MIDIProtocol nativeProtocol | 设备原生支持的MIDI协议。- OH_MIDI_PROTOCOL_1_0：设备是传统设备或当前配置为MIDI 1.0。 - OH_MIDI_PROTOCOL_2_0：设备支持MIDI 2.0功能。 起始版本： 24 |
