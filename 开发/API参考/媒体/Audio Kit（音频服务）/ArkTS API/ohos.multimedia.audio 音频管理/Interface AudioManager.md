...
audioManager.getAudioScene((err: BusinessError, value: audio.AudioScene) => {
  ...
  console.info(
    `Callback invoked to indicate that the audio scene mode is obtained ${value}.`,
  );
});
```
...
audioManager
  ...
  .then((value: audio.AudioScene) => {
    console.info(
      `Promise returned to indicate that the audio scene mode is obtained ${value}.`,
    );
  })
...
let audioRoutingManager: audio.AudioRoutingManager =
  audioManager.getRoutingManager();
```
...
let audioSessionManager: audio.AudioSessionManager =
  audioManager.getSessionManager();
```
...
let audioSpatializationManager: audio.AudioSpatializationManager =
  audioManager.getSpatializationManager();
```
...
audioManager.setAudioParameter(
  ...
  (err: BusinessError) => {
    ...
    console.info(
      'Callback invoked to indicate a successful setting of the audio parameter.',
    );
  },
);
```
...
audioManager.getAudioParameter(
  ...
  (err: BusinessError, value: string) => {
    if (err) {
      console.error(
        `Failed to obtain the value of the audio parameter. ${err}`,
      );
      return;
    }
    console.info(
      `Callback invoked to indicate that the value of the audio parameter is obtained ${value}.`,
    );
  },
);
```
...
audioManager.getAudioParameter('key_example').then((value: string) => {
  console.info(
    `Promise returned to indicate that the value of the audio parameter is obtained ${value}.`,
  );
});
```
...
audioManager.getVolume(audio.AudioVolumeType.MEDIA).then((value: number) => {
  console.info(
    `Promise returned to indicate that the volume is obtained ${value} .`,
  );
});
```
...
audioManager.getMinVolume(
  ...
  (err: BusinessError, value: number) => {
    ...
    console.info(
      `Callback invoked to indicate that the minimum volume is obtained. ${value}`,
    );
  },
);
```
...
audioManager.getMinVolume(audio.AudioVolumeType.MEDIA).then((value: number) => {
  console.info(
    `Promised returned to indicate that the minimum volume is obtained. ${value}`,
  );
});
```
...
audioManager.getMaxVolume(
  ...
  (err: BusinessError, value: number) => {
    ...
    console.info(
      `Callback invoked to indicate that the maximum volume is obtained. ${value}`,
    );
  },
);
```
...
audioManager.isMute(
  ...
  (err: BusinessError, value: boolean) => {
    ...
    console.info(
      `Callback invoked to indicate that the mute status of the stream is obtained. ${value}`,
    );
  },
);
```
...
audioManager.isMute(audio.AudioVolumeType.MEDIA).then((value: boolean) => {
  console.info(
    `Promise returned to indicate that the mute status of the stream is obtained ${value}.`,
  );
});
```
...
audioManager.setRingerMode(
  ...
  (err: BusinessError) => {
    ...
    console.info(
      'Callback invoked to indicate a successful setting of the ringer mode.',
    );
  },
);
```
...
audioManager.getRingerMode((err: BusinessError, value: audio.AudioRingMode) => {
  ...
  console.info(
    `Callback invoked to indicate that the ringer mode is obtained ${value}.`,
  );
});
```
...
audioManager.getRingerMode().then((value: audio.AudioRingMode) => {
  console.info(
    `Promise returned to indicate that the ringer mode is obtained ${value}.`,
  );
});
```
...
audioManager.getDevices(
  ...
  (err: BusinessError, value: audio.AudioDeviceDescriptors) => {
    if (err) {
...
audioManager
  ...
  .then((data: audio.AudioDeviceDescriptors) => {
    console.info(
...
audioManager.setDeviceActive(
  audio.ActiveDeviceType.SPEAKER,
  true,
  (err: BusinessError) => {
    if (err) {
...
```ts
audioManager
  .isDeviceActive(audio.ActiveDeviceType.SPEAKER)
  .then((value: boolean) => {
    console.info(
...
audioManager.isMicrophoneMute((err: BusinessError, value: boolean) => {
  ...
  console.info(
    `Callback invoked to indicate that the mute status of the microphone is obtained ${value}.`,
  );
});
```
...
audioManager.isMicrophoneMute().then((value: boolean) => {
  console.info(
    `Promise returned to indicate that the mute status of the microphone is obtained ${value}.`,
  );
});
```
...
audioManager.on('deviceChange', (deviceChanged: audio.DeviceChangeAction) => {
  ...
  console.info(
    `device change descriptor : ${deviceChanged.deviceDescriptors[0].deviceRole} `,
  );
  console.info(
    `device change descriptor : ${deviceChanged.deviceDescriptors[0].deviceType} `,
  );
});
```
...
audioManager.on(
  'interrupt',
  interAudioInterrupt,
  (interruptAction: audio.InterruptAction) => {
