...
| 名称 | 描述 |
| --- | --- |
| [OH_VideoCaptureInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-avscreencapture-oh-videocaptureinfo) videoCapInfo | 视频采集信息。 |
| [OH_VideoEncInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-avscreencapture-oh-videoencinfo) videoEncInfo | 视频编码参数。 |
