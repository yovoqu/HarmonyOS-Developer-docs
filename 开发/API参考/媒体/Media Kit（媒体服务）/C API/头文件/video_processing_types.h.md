...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| [VideoProcessing_ColorSpaceInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/api-videoprocessing-videoprocessing-colorspaceinfo) | VideoProcessing_ColorSpaceInfo | 视频颜色空间信息数据结构。 |
