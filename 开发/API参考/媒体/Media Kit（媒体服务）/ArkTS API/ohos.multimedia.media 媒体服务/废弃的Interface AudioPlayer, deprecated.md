...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃，建议使用 AVPlayer 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃，建议使用 AVPlayer.play 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃，建议使用 AVPlayer.pause 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃，建议使用 AVPlayer.stop 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃，建议使用 AVPlayer.reset 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃，建议使用 AVPlayer.seek 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃，建议使用 AVPlayer.setVolume 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃，建议使用 AVPlayer.release 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃，建议使用 AVPlayer.on('error') 替代。
