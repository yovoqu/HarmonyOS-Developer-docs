...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃，建议使用 AVRecorder 替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | AudioRecorderConfig | 是 | 配置录制的相关参数，包括音频输出URI、编码格式、采样率、声道数、输出格式等。 |
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃，建议使用 AVRecorder.start 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃，建议使用 AVRecorder.pause 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃，建议使用 AVRecorder.resume 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃，建议使用 AVRecorder.stop 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃，建议使用 AVRecorder.release 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃，建议使用 AVRecorder.reset 替代。
