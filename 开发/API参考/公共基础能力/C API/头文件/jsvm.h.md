...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_GENERIC_FAILURE 表示执行失败，说明当前进程已完成JSVM初始化，无需重复执行。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入的参数不合法。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 如果接口调用成功，返回 JSVM_OK。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入参数不合法。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入参数不合法。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码。  JSVM_OK 表示接口调用成功。  JSVM_OBJECT_EXPECTED 如果 target 或 handler 非 JS 对象。  JSVM_GENERIC_FAILURE 表示有未知的原因导致执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) JSVM_CDECL | 返回执行状态码。  JSVM_OK 表示接口调用成功。  JSVM_INVALID_ARG 表示传入参数不合法。 |
...
| 类型 | 说明 |
| --- | --- |
| [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) JSVM_CDECL | 返回执行状态码。  JSVM_OK 表示接口调用成功。  JSVM_INVALID_ARG 表示传入参数不合法。  JSVM_INVALID_TYPE 如果 value 非 Javascript Proxy。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_GENERIC_FAILURE 表示有未知的原因导致执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入的 data 是空指针。 JSVM_STRING_EXPECTED 表示传入的参数不是string类型。  JSVM_GENERIC_FAILURE 表示有未知的原因导致执行失败。  JSVM_CANNOT_RUN_JS 不能执行JS。  JSVM_PENDING_EXCEPTION 表示执行的过程中产生了JS异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入的 data 是空指针。 JSVM_STRING_EXPECTED 表示传入的参数不是string类型。  JSVM_GENERIC_FAILURE 表示执行失败。  JSVM_CANNOT_RUN_JS 不能执行JS。  JSVM_PENDING_EXCEPTION 表示执行的过程中产生了JS异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入的 data 是空指针。  JSVM_STRING_EXPECTED 表示传入的参数不是string类型。  JSVM_GENERIC_FAILURE 表示有未知的原因导致执行失败。  JSVM_PENDING_EXCEPTION 表示执行的过程中产生了JS异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_GENERIC_FAILURE 表示执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_GENERIC_FAILURE 表示执行失败。  JSVM_PENDING_EXCEPTION 表示执行的过程中产生了JS异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_STRING_EXPECTED 表示传入的参数不是string类型。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_HANDLE_SCOPE_MISMATCH 表示执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_ESCAPE_CALLED_TWICE 表示scope对象已被关闭。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_PENDING_EXCEPTION 表示执行的过程中产生了JS异常。 |
...
| 类型 | 说明 |
| --- | --- |
| [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) JSVM_CDECL | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入的 data 是空指针。  JSVM_GENERIC_FAILURE 表示内存申请失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) JSVM_CDECL | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入的 data 是空指针。 |
...
| 类型 | 说明 |
| --- | --- |
| [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) JSVM_CDECL | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示触发了下面描述的异常情况之一：  1. offset + arrayBufferSize > backingStoreSize。  2. backingStoreSize 或者 arrayBufferSize 为 0。  3. data 或者 result 为空。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入的参数不合法。  JSVM_PENDING_EXCEPTION 表示执行的过程中产生了JS异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入的参数不合法。  JSVM_GENERIC_FAILURE 表示有未知的原因导致执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_ARRAY_EXPECTED 表示传入的参数不是Array类型。  JSVM_PENDING_EXCEPTION 表示执行的过程中产生了JS异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入参数非外部的JSVM_Value。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_DATE_EXPECTED 表示传入参数不是Date类型。  JSVM_PENDING_EXCEPTION 表示执行的过程中产生了JS异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_BOOLEAN_EXPECTED 表示传入的参数不是boolean类型。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_NUMBER_EXPECTED 表示传入的参数不是number类型。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_BIGINT_EXPECTED 表示传入的参数不是BitInt类型。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_NUMBER_EXPECTED 如果传入的JavaScript值无法转换成Number。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_OBJECT_EXPECTED 如果传入的JavaScript值无法转换成Object。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_STRING_EXPECTED 如果传入的JavaScript值无法转换成String。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_FUNCTION_EXPECTED 表示传入的参数不是Function类型。  JSVM_GENERIC_FAILURE 表示有未知的原因导致执行失败。  JSVM_PENDING_EXCEPTION 表示执行的过程中产生了JS异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  如果JSVM_OK 表示执行成功。  JSVM_DETACHABLE_ARRAYBUFFER_EXPECTED 表示传入的参数不是可分析的ArrayBuffer。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_GENERIC_FAILURE 表示有未知的原因导致执行失败。  JSVM_PENDING_EXCEPTION 表示执行的过程中产生了JS异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_GENERIC_FAILURE 表示有未知的原因导致执行失败。  JSVM_NAME_EXPECTED 表示期望传入名字不合法。  JSVM_PENDING_EXCEPTION 表示执行的过程中产生了JS异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入的参数不合法。  JSVM_GENERIC_FAILURE 表示有未知的原因导致执行失败。  JSVM_PENDING_EXCEPTION 表示执行的过程中产生了JS异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_PENDING_EXCEPTION 表示执行的过程中产生了JS异常。  JSVM_GENERIC_FAILURE 表示有未知的原因导致执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 如果 env 或 promise 为空，或 onFulfilled 和 onRejected 同时为空。  JSVM_INVALID_TYPE 如果 promise 非 JS 的 Promise 类型，或 onFulfilled、onRejected 非 JS 的 Function 类型。  JSVM_PENDING_EXCEPTION 如果存在 JS 异常待处理。  JSVM_GENERIC_FAILURE 如果 API 执行错误。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_STRING_EXPECTED 表示传入的参数不是string类型。  JSVM_GENERIC_FAILURE 表示有未知的原因导致执行失败。  JSVM_PENDING_EXCEPTION 表示执行的过程中产生了JS异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码JSVM_Status。  JSVM_OK表示执行成功。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功，这个API不会触发任何异常。 |
...
| 类型 | 说明 |
| --- | --- |
| [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) JSVM_CDECL | 返回执行状态码JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示输入参数不合法。 |
...
| 类型 | 说明 |
| --- | --- |
| [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) JSVM_CDECL | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示输入参数不合法。 |
...
| 类型 | 说明 |
| --- | --- |
| [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) JSVM_CDECL | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示输入参数不合法。  JSVM_PENDING_EXCEPTION 表示API在运行时抛出异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示输入参数不合法。  JSVM_PENDING_EXCEPTION 表示API在运行时抛出异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示输入参数不合法。  JSVM_GENERIC_FAILURE 表示设置原型失败。如循环设置原型时，会触发该失败。  JSVM_PENDING_EXCEPTION 表示API在运行时抛出异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示输入参数不合法。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_BIGINT_EXPECTED 如果传入的JavaScript值无法转换成BitInt。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_GENERIC_FAILURE 表示输入的JavaScript无法编译成功。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回JSVM函数结果代码。  JSVM_OK 表示执行成功。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回JSVM函数结果代码。  JSVM_OK表示执行成功。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示脚本为空或已被保存过。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示脚本为空或未被保存过。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_PENDING_EXCEPTION 表示发生了异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示 env 或 wasmBytecode 参数为空，或传入的数据长度参数无效。  JSVM_GENERIC_FAILURE 表示编译失败。  JSVM_PENDING_EXCEPTION 表示发生了异常。  JSVM_JIT_MODE_EXPECTED 表示当前环境没有 JIT 权限支持。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示 env 或 wasmModule 参数为空，或 wasmModule 不是一个真正的 WebAssembly 模块。  JSVM_GENERIC_FAILURE 表示函数索引越界，或编译失败。  JSVM_PENDING_EXCEPTION 表示发生了异常。  JSVM_JIT_MODE_EXPECTED 表示当前环境没有 JIT 权限支持。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入了空指针参数。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入了空指针参数。  JSVM_GENERIC_FAILURE 表示缓存生成失败。  JSVM_JIT_MODE_EXPECTED 表示当前环境没有 JIT 权限支持。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入了空指针参数，或 cacheType 参数不合法。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG categories 或者 count 输入不合法。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。 。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG stream 或者 streamData 为空。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示函数执行成功。  JSVM_INVALID_ARG 表示传入的vm或者handler为空或者handler已经被添加过了。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示函数执行成功。  JSVM_INVALID_ARG 表示传入的vm或者handler为空或者handler已经被删除过了或者  这个handler从来没有被添加过。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示函数执行成功。  JSVM_INVALID_ARG 表示vm为空。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示函数执行成功。  JSVM_INVALID_ARG 如果传入的env为空指针，返回此错误码。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入的指针参数里面存在空指针。  JSVM_GENERIC_FAILURE 表示传入的utf8name \| constructor \| properties无效，导致执行失败。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入参数中 env, str 和 copied 中任一值为空。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示传入参数中 env 和 result 中任一值为空。  JSVM_STRING_EXPECTED 表示传入的 description 不是字符串。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示任一传入参数为空或者 key 不是一个 private key 对象。  JSVM_OBJECT_EXPECTED 表示传入的 object 不是一个真正的 JavaScript object。  JSVM_GENERIC_FAILURE 表示设置 private 属性失败，同时没有异常产生。  JSVM_PENDING_EXCEPTION 表示发生了异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示任一传入参数为空或者 key 不是一个 private key 对象。  JSVM_OBJECT_EXPECTED 表示传入的 object 不是一个真正的 JavaScript object。  JSVM_GENERIC_FAILURE 表示获取 private 属性失败，同时没有异常产生。  JSVM_PENDING_EXCEPTION 表示发生了异常。 |
...
| 类型 | 说明 |
| --- | --- |
| JSVM_EXTERN [JSVM_Status](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-types-h#jsvm_status) | 返回执行状态码 JSVM_Status。  JSVM_OK 表示执行成功。  JSVM_INVALID_ARG 表示任一传入参数为空或者 key 不是一个 private key 对象。  JSVM_OBJECT_EXPECTED 表示传入的 object 不是一个真正的 JavaScript object。  JSVM_GENERIC_FAILURE 表示删除 private 属性失败，同时没有异常产生。  JSVM_PENDING_EXCEPTION 表示发生了异常。 |
