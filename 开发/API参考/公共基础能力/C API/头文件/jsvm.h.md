...
| [JSVM_Script](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-value--8h)* result | 编译后的脚本。 |
...
| [JSVM_PropertyHandlerCfg](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-jsvm-jsvm-propertyhandlerconfigurationstruct) propertyHandlerCfg | 访问实例对象属性触发相应的回调函数。 |
