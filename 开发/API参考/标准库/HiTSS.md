...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/hitss-api-ref
...
2. 如果开发者需要使用HiTSS相关能力，首先请添加头文件。  __PREBLOCK_0__
3. 其次在CMakeLists.txt中添加以下动态链接库。  __PREBLOCK_1__
