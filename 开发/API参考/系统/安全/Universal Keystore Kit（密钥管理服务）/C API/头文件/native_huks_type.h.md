...
| OH_HUKS_PADDING_ISO_IEC_9797_1 = 7 | 使用ISO IEC 9797-1填充算���。 起始版本： 18 |
...
| OH_HUKS_TAG_TYPE_BYTES = 5 &lt;&lt; 28 | 该Tag的数据类型为[OH_Huks_Blob](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-hukstypeapi-oh-huks-blob)类型。 |
