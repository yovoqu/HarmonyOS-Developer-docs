...
let encodingBlob: cert.EncodingBlob = {
  ...
  // 根据encodingData的���式进行赋值，支持FORMAT_PEM和FORMAT_DER。
...
cert.createX509Cert(encodingBlob, (error, x509Cert) => {
  if (error) {
    console.error(
      `createX509Cert failed, errCode: ${error.code}, errMsg: ${error.message}`,
    );
  } else {
  ...
  if (error) {
    ...
    try {
      ...
      x509Cert.verify(pubKey, (err, data) => {
        if (err) {
          console.error(
            `verify failed, errCode: ${err.code}, errMsg: ${err.message}`,
          );
        } else {
      ...
      console.error(
        `getPublicKey failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
  ...
  .then((x509Cert) => {
    ...
    try {
      ...
      x509Cert
        ...
        .catch((error: BusinessError) => {
          console.error(
            `verify failed, errCode: ${error.code}, errMsg: ${error.message}`,
          );
        });
    } catch (error) {
      console.error(
        `getPublicKey failed: errCode: ${error.code}, errMsg: ${error.message}`,
      );
    }
  })
  .catch((error: BusinessError) => {
...
cert.createX509Cert(encodingBlob, (error, x509Cert) => {
  if (error) {
    ...
    x509Cert.getEncoded((error, data) => {
      if (error) {
        console.error(
          `getEncoded failed, errCode: ${error.code}, errMsg: ${error.message}`,
        );
      } else {
...
cert.createX509Cert(encodingBlob, (error, x509Cert) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = error as BusinessError;
      console.error(
        `checkValidityWithDate failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Cert(encodingBlob, (error, x509Cert) => {
  if (error) {
    ...
    try {
      ...
      console.error(
        `getCertSerialNumber failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Cert(encodingBlob, (error, x509Cert) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `getIssuerName failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Cert(encodingBlob, (error, x509Cert) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `getSubjectName failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
    try {
      let subjectNameutf8 = x509Cert.getSubjectName(
        cert.EncodingType.ENCODING_UTF8,
      );
    } catch (err) {
      let e: BusinessError = err as BusinessError;
      console.error(
        `getSubjectNameUtf8 failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Cert(encodingBlob, (error, x509Cert) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `getNotBeforeTime failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Cert(encodingBlob, (error, x509Cert) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `getNotAfterTime failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Cert(encodingBlob, (error, x509Cert) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `getSignature failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Cert(encodingBlob, (error, x509Cert) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `getSignatureAlgName failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Cert(encodingBlob, (error, x509Cert) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `getSignatureAlgOid failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Cert(encodingBlob, (error, x509Cert) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `getSignatureAlgParams failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Cert(encodingBlob, (error, x509Cert) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `getKeyUsage failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Cert(encodingBlob, (error, x509Cert) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `getExtKeyUsage failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Cert(encodingBlob, (error, x509Cert) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `getSubjectAltNames failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Cert(encodingBlob, (error, x509Cert) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `getIssuerAltNames failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
async function createX509Cert(): Promise<cert.X509Cert> {
  ...
  try {
    ...
    let e: BusinessError = err as BusinessError;
    console.error(
      `createX509Cert failed, errCode: ${e.code}, errMsg: ${e.message}`,
    );
  }
  return x509Cert;
}
...
async function matchX509Cert() {
  ...
  try {
    ...
    let e: BusinessError = err as BusinessError;
    console.error(
      `call x509Cert match failed, errCode: ${e.code}, errMsg: ${e.message}`,
    );
  }
}
```
...
async function certToString() {
  ...
  try {
    ...
    console.info('createX509Cert result: success.');
    console.info(
      'certToString success: ' +
        x509Cert.toString(cert.EncodingType.ENCODING_UTF8),
    );
  } catch (err) {
    let e: BusinessError = err as BusinessError;
    console.error(
...
cert.createCertExtension(encodingBlob, (error, certExt) => {
  if (error) {
    console.error(
      `createCertExtension failed, errCode: ${error.code}, errMsg: ${error.message}`,
    );
  } else {
...
cert.createCertExtension(encodingBlob, (error, certExt) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `ext getEncoded failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createCertExtension(encodingBlob, (error, certExt) => {
  if (error) {
    ...
    console.info('createCertExtension result: success.');
    try {
      let oidList = certExt.getOidList(
        cert.ExtensionOidType.EXTENSION_OID_TYPE_ALL,
      );
    } catch (err) {
      let e: BusinessError = err as BusinessError;
      console.error(
        `ext getOidList failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createCertExtension(encodingBlob, (error, certExt) => {
  if (error) {
    ...
    console.info('createCertExtension result: success.');
    let oid = new Uint8Array([
      0x32, 0x2e, 0x35, 0x2e, 0x32, 0x39, 0x2e, 0x31, 0x35,
    ]);
    let oidBlob: cert.DataBlob = {
      data: oid,
    };
    try {
      let entry = certExt.getEntry(
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `ext getEntry failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createCertExtension(encodingBlob, (error, certExt) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `ext checkCA failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert
  ...
  .catch((err: BusinessError) => {
    console.error(
      `createCertExtension failed, errCode: ${err.code}, errMsg: ${err.message}`,
    );
  });
```
...
cert.createX509Crl(encodingBlob, (error, x509Crl) => {
  if (error) {
    console.error(
      `createX509Crl failed, errCode: ${error.code}, errMsg: ${error.message}`,
    );
  } else {
    ...
    cert.createX509Cert(certEncodingBlob, (error, x509Cert) => {
      if (error) {
        ...
        try {
          ...
          let e: BusinessError = error as BusinessError;
          console.error(
            `isRevoked failed, errCode: ${e.code}, errMsg: ${e.message}`,
          );
        }
      }
    });
...
表示对X509证书吊销列表进行验签。使用callback异步回调。���签支持RSA算法。
...
let pubKeyData = new Uint8Array([
  ...
  ,
]);

let priKeyData = new Uint8Array([
  ,
...
cert.createX509Crl(encodingBlob, (error, x509Crl) => {
  if (error) {
    ...
    try {
      ...
      keyGenerator.convertKey(
        pubEncodingBlob,
        priEncodingBlob,
        (e, keyPair) => {
          if (e) {
            console.error(
              `convert key failed, errCode: ${e.code}, errMsg: ${e.message}`,
            );
          } else {
      ...
      let e: BusinessError = error as BusinessError;
      console.error(
        `get pubKey failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert
  ...
  .then((x509Crl) => {
    ...
    try {
      ...
      keyGenerator
        .convertKey(pubEncodingBlob, priEncodingBlob)
        .then((keyPair) => {
          console.info('convert key result: success.');
          x509Crl
            .verify(keyPair.pubKey)
            .then((result) => {
              console.info('verify result: success.');
            })
            .catch((error: BusinessError) => {
        ...
        .catch((error: BusinessError) => {
          console.error(
            `convert key failed, errCode: ${error.code}, errMsg: ${error.message}`,
          );
        });
    } catch (error) {
      let e: BusinessError = error as BusinessError;
...
cert.createX509Crl(encodingBlob, (error, x509Crl) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `getLastUpdate failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Crl(encodingBlob, (error, x509Crl) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `getNextUpdate failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Crl(encodingBlob, (error, x509Crl) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = error as BusinessError;
      console.error(
        `getRevokedCert failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Crl(encodingBlob, (error, x509Crl) => {
  if (error) {
    ...
    // 创建X509证书对象。
    cert
      .createX509Cert(certEncodingBlob)
      .then((x509Cert) => {
        try {
          ...
          let e: BusinessError = error as BusinessError;
          console.error(
            `getRevokedCertWithCert failed, errCode: ${e.code}, errMsg: ${e.message}`,
          );
        }
      })
      .catch((error: BusinessError) => {
...
cert.createX509Crl(encodingBlob, (error, x509Crl) => {
  if (error) {
    ...
    x509Crl.getRevokedCerts((error, array) => {
      if (error) {
        console.error(
          `getRevokedCerts failed, errCode: ${error.code}, errMsg: ${error.message}`,
        );
      } else {
...
cert.createX509Crl(encodingBlob, (error, x509Crl) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = error as BusinessError;
      console.error(
        `getTbsInfo failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
**元服务API：** 从API version 12开始，该接口���持在元服务中使用。
...
cert.createX509CRL(encodingBlob, (error, x509CRL) => {
  if (error) {
    ...
    try {
      ...
      let e: BusinessError = error as BusinessError;
      console.error(
        `getExtensions failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
  ...
  cert.createX509CRL(crlEncodingBlob, (error, x509CRL) => {
    if (error) {
      ...
      try {
        const param: cert.X509CRLMatchParameters = {
          issuer: [
            new Uint8Array([
              ...
              0x13, 0x02, 0x43, 0x4e, 0x31, 0x10, 0x30, 0x0e, 0x06, 0x03, 0x55,
              0x04, 0x08, 0x13, 0x07, 0x4a, 0x69, 0x61, 0x6e, 0x67, 0x73, 0x75,
              0x31, 0x10, 0x30, 0x0e, 0x06, 0x03, 0x55, 0x04, 0x07, 0x13, 0x07,
              0x4e, 0x61, 0x6e, 0x6a, 0x69, 0x6e, 0x67, 0x31, 0x0b, 0x30, 0x09,
              0x06, 0x03, 0x55, 0x04, 0x0a, 0x13, 0x02, 0x74, 0x73, 0x31, 0x0b,
              0x30, 0x09, 0x06, 0x03, 0x55, 0x04, 0x0b, 0x13, 0x02, 0x74, 0x73,
              0x31, 0x0b, 0x30, 0x09, 0x06, 0x03, 0x55, 0x04, 0x03, 0x13, 0x02,
              0x74, 0x73,
            ]),
          ],
          x509Cert: x509Cert,
        ...
        let e: BusinessError = error as BusinessError;
        console.error(
          `x509CRL match failed, errCode: ${e.code}, errMsg: ${e.message}`,
        );
      }
    }
  });
...
async function crlGetIssuerX500DistinguishedName() {
  ...
  try {
    ...
    let e: BusinessError = err as BusinessError;
    console.error(
      `createX509CRL failed, errCode: ${e.code}, errMsg: ${e.message}`,
    );
  }
}
```
...
async function crlToString() {
  ...
  try {
    ...
    console.info(
      'crlToString success: ' +
        x509Crl.toString(cert.EncodingType.ENCODING_UTF8),
    );
  } catch (err) {
    let e: BusinessError = err as BusinessError;
    console.error(
...
try {
  ...
  let e: BusinessError = error as BusinessError;
  console.error(
    `createCertChainValidator failed, errCode: ${e.code}, errMsg: ${e.message}`,
  );
}
```
...
let certPemDataLenData = new Uint8Array(
  new Uint16Array([certPemData.length]).buffer,
);
let caPemDataLenData = new Uint8Array(
  new Uint16Array([caPemData.length]).buffer,
);

let certChainBuff = new Uint8Array(
  certPemDataLenData.length +
    certPemData.length +
    caPemDataLenData.length +
    caPemData.length,
);
...
certChainBuff.set(
  caPemDataLenData,
  certPemDataLenData.length + certPemData.length,
);
certChainBuff.set(
  caPemData,
  certPemDataLenData.length + certPemData.length + caPemDataLenData.length,
);
...
try {
  ...
  validator.validate(certChainData, (error, data) => {
    if (error) {
      console.error(
        `validate failed, errCode: ${error.code}, errMsg: ${error.message}`,
      );
    } else {
...
cert.createX509Crl(encodingBlob, (err, x509Crl) => {
  if (err) {
    console.error(
      `createX509Crl failed, errCode: ${err.code}, errMsg: ${err.message}`,
    );
  } else {
...
cert.createX509Crl(encodingBlob, (err, x509Crl) => {
  if (err) {
    ...
    try {
      ...
      let e: BusinessError = error as BusinessError;
      console.error(
        `getRevokedCert or getSerialNumber failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Crl(encodingBlob, (err, x509Crl) => {
  if (err) {
    ...
    try {
      ...
      let e: BusinessError = error as BusinessError;
      console.error(
        `getRevokedCert or getCertIssuer failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509Crl(encodingBlob, (err, x509Crl) => {
  if (err) {
    ...
    try {
      ...
      let e: BusinessError = error as BusinessError;
      console.error(
        `getRevokedCert or getRevocationDate failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509CRL(encodingBlob, (err, x509CRL) => {
  if (err) {
    ...
    try {
      ...
      let e: BusinessError = error as BusinessError;
      console.error(
        `getRevokedCert or getExtensions failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
cert.createX509CRL(encodingBlob, (err, x509CRL) => {
  if (err) {
    ...
    try {
      ...
      let e: BusinessError = error as BusinessError;
      console.error(
        `getRevokedCert or hasExtensions failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
async function certToString() {
  ...
  try {
    ...
    console.info('createX509CRL result: success.');
    console.info(
      'toString success: ' + x509Crl.getRevokedCert(BigInt(1000)).toString(),
    );
  } catch (error) {
    let e: BusinessError = error as BusinessError;
    console.error(
...
async function certHashCode() {
  ...
  try {
    ...
    console.info('createX509CRL result: success.');
    console.info(
      'hashCode success: ' + x509Crl.getRevokedCert(BigInt(1000)).hashCode(),
    );
  } catch (error) {
    let e: BusinessError = error as BusinessError;
    console.error(
...
async function certGetExtensionsObject() {
  ...
  try {
    ...
    console.info('createX509CRL result: success.');
    let object = x509Crl
      .getRevokedCert(BigInt('14091103387070223745671018446433705560'))
      .getExtensionsObject();
  } catch (error) {
    let e: BusinessError = error as BusinessError;
    console.error(
...
async function createCollection() {
  ...
  try {
    const collection: cert.CertCRLCollection = cert.createCertCRLCollection(
      [x509Cert],
      [x509CRL],
    );
    ...
    let e: BusinessError = err as BusinessError;
    console.error(
      `createCertCRLCollection failed, errCode: ${e.code}, errMsg: ${e.message}`,
    );
  }
}
```
  ...
  try {
    const param: cert.X509CertMatchParameters = {
      ...
      issuer: new Uint8Array([
        ...
        0x0f, 0x45, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x20, 0x52, 0x6f, 0x6f,
        0x74, 0x20, 0x43, 0x41,
      ]),
    ...
    let e: BusinessError = err as BusinessError;
    console.error(
      `call selectCerts failed, errCode: ${e.code}, errMsg: ${e.message}`,
    );
  }
}
```
...
async function selectCerts() {
  ...
  collection.selectCerts(param, (err, certs) => {
    if (err) {
      console.error(
        `selectCerts failed, errCode: ${err.code}, errMsg: ${err.message}`,
      );
    } else {
...
async function selectCRLs() {
  ...
  const param: cert.X509CRLMatchParameters = {
    issuer: [
      new Uint8Array([
        ...
        0x13, 0x07, 0x4a, 0x69, 0x61, 0x6e, 0x67, 0x73, 0x75, 0x31, 0x10, 0x30,
        0x0e, 0x06, 0x03, 0x55, 0x04, 0x07, 0x13, 0x07, 0x4e, 0x61, 0x6e, 0x6a,
        0x69, 0x6e, 0x67, 0x31, 0x0b, 0x30, 0x09, 0x06, 0x03, 0x55, 0x04, 0x0a,
        0x13, 0x02, 0x74, 0x73, 0x31, 0x0b, 0x30, 0x09, 0x06, 0x03, 0x55, 0x04,
        0x0b, 0x13, 0x02, 0x74, 0x73, 0x31, 0x0b, 0x30, 0x09, 0x06, 0x03, 0x55,
        0x04, 0x03, 0x13, 0x02, 0x74, 0x73,
      ]),
    ],
    x509Cert: x509Cert,
  };
  try {
    ...
    let e: BusinessError = err as BusinessError;
    console.error(
      `selectCRLs failed, errCode: ${e.code}, errMsg: ${e.message}`,
    );
  }
}
```
...
查找证书和��书吊销列表集合中所有与参数匹配的证书吊销列表对象。使用callback异步回调。
...
async function selectCRLs() {
  ...
  collection.selectCRLs(param, (err, crls) => {
    if (err) {
      console.error(
        `selectCRLs failed, errCode: ${err.code}, errMsg: ${err.message}`,
      );
    } else {
      console.info('selectCRLs result: success.');
    }
...
async function createX509CertChain(): Promise<cert.X509CertChain> {
  ...
  try {
    ...
    let e: BusinessError = error as BusinessError;
    console.error(
      `createX509CertChain failed, errCode: ${e.code}, errMsg: ${e.message}`,
    );
  }
...
cert.createX509CertChain(encodingBlob, (err, certChain) => {
  if (err) {
    console.error(
      `createX509CertChain failed, errCode: ${err.code}, errMsg: ${err.message}`,
    );
  } else {
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | [CertChainBuildParameters](#certchainbuildparameters12) | 是 | 构建证书链的参��对象。          [CertChainBuildParameters](#certchainbuildparameters12)中的maxLength要小于证书集合中证书数量。 |
...
async function buildX509CertChain() {
  try {
    ...
    console.info(
      'cert issuer name: ' +
        certChainBuildResult.validationResult.entityCert.getIssuerName().data,
    );
    console.info(
      'ca subject name: ' +
        certChainBuildResult.validationResult.trustAnchor.CACert?.getSubjectName()
          .data,
    );
  } catch (error) {
    let e: BusinessError = error as BusinessError;
...
function doTestParsePkcs12() {
  try {
    let p12_cert = new Uint8Array([
      ,
      ...
      ,
    ]);
    ...
    console.error(
      `parsePKCS12 failed: errCode: ${error.code}, errMsg: ${error.message}`,
    );
  }
}
```
...
async function doTestParsePkcs12() {
  try {
    ...
    console.error(
      `parsePKCS12 failed: errCode: ${err.code}, errMsg: ${err.message}`,
    );
  }
}
```
...
async function createX509Cert(certData: string): Promise<cert.X509Cert> {
  ...
  try {
    ...
    console.error(
      `createX509Cert failed: errCode: ${err.code}, errMsg: ${err.message}`,
    );
  }
  return x509Cert;
}
...
async function doTestCreatePkcs12() {
  ...
  try {
    ...
    console.error(
      `createPkcs12 failed: errCode: ${err.code}, errMsg: ${err.message}`,
    );
  }
}
```
...
async function doTestCreatePkcs12Sync() {
  ...
  try {
    ...
    console.error(
      `createPkcs12Sync failed: errCode: ${err.code}, errMsg: ${err.message}`,
    );
  }
}
```
...
try {
  cert
    .createTrustAnchorsWithKeyStore(
      new Uint8Array([
        ,
      ]),
      '123456',
    )
    .then((data) => {
      console.info(
        'createTrustAnchorsWithKeyStore result: success, number of the result = ' +
          data.length,
      );
    })
    .catch((err: BusinessError) => {
      console.error(
        `createTrustAnchorsWithKeyStore failed: errCode: ${err.code}, errMsg: ${err.message}`,
      );
    });
} catch (error) {
  console.error(
    `createTrustAnchorsWithKeyStore failed: errCode: ${error.code}, errMsg: ${error.message}`,
  );
}
```
...
cert.createX509CertChain(encodingBlob, (err, certChain) => {
  if (err) {
    ...
    try {
      ...
      let e: BusinessError = err as BusinessError;
      console.error(
        `X509CertChain getCertList failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  }
});
...
async function validate() {
    ...
    trustAnchors: [
      {
        CAPubKey: new Uint8Array([
          ...
          0x00, 0xbb, 0x16, 0x9d, 0x8f, 0x5c, 0x30, 0xd0, 0xba, 0x8f, 0x37,
          0x6e, 0x33, 0xaf, 0x6f, 0x23, 0x71, 0x23, 0xa5, 0x49, 0x60, 0x1e,
          0xd1, 0x07, 0x4b, 0xc9, 0x11, 0x7e, 0x66, 0x01, 0xba, 0x92, 0x52,
        ]),
        CASubject: new Uint8Array([
          0x30, 0x5a, 0x31, 0x0b, 0x30, 0x09, 0x06, 0x03, 0x55, 0x04, 0x06,
          0x13, 0x02, 0x45, 0x4e, 0x31, 0x10, 0x30, 0x0e, 0x06, 0x03, 0x55,
          0x04, 0x08, 0x13, 0x07, 0x45, 0x6e, 0x67, 0x6c, 0x61, 0x6e, 0x64,
          0x31, 0x0f, 0x30, 0x0d, 0x06, 0x03, 0x55, 0x04, 0x07, 0x13, 0x06,
          0x4c, 0x6f, 0x6e, 0x64, 0x6f, 0x6e, 0x31, 0x0c, 0x30, 0x0a, 0x06,
          0x03, 0x55, 0x04, 0x0a, 0x13, 0x03, 0x74, 0x73, 0x31, 0x31, 0x0c,
          0x30, 0x0a, 0x06, 0x03, 0x55, 0x04, 0x0b, 0x13, 0x03, 0x74, 0x73,
          0x31, 0x31, 0x0c, 0x30, 0x0a, 0x06, 0x03, 0x55, 0x04, 0x03, 0x13,
          0x03, 0x74, 0x73, 0x31,
        ]),
      },
    ],
  ...
  try {
    ...
    let e: BusinessError = error as BusinessError;
    console.error(
      `X509CertChain validate failed, errCode: ${e.code}, errMsg: ${e.message}`,
    );
  }
}
  ...
  trustAnchors: [
    {
      CAPubKey: new Uint8Array([
        ...
        0xbb, 0x16, 0x9d, 0x8f, 0x5c, 0x30, 0xd0, 0xba, 0x8f, 0x37, 0x6e, 0x33,
        0xaf, 0x6f, 0x23, 0x71, 0x23, 0xa5, 0x49, 0x60, 0x1e, 0xd1, 0x07, 0x4b,
        0xc9, 0x11, 0x7e, 0x66, 0x01, 0xba, 0x92, 0x52,
      ]),
      CASubject: new Uint8Array([
        0x30, 0x5a, 0x31, 0x0b, 0x30, 0x09, 0x06, 0x03, 0x55, 0x04, 0x06, 0x13,
        0x02, 0x45, 0x4e, 0x31, 0x10, 0x30, 0x0e, 0x06, 0x03, 0x55, 0x04, 0x08,
        0x13, 0x07, 0x45, 0x6e, 0x67, 0x6c, 0x61, 0x6e, 0x64, 0x31, 0x0f, 0x30,
        0x0d, 0x06, 0x03, 0x55, 0x04, 0x07, 0x13, 0x06, 0x4c, 0x6f, 0x6e, 0x64,
        0x6f, 0x6e, 0x31, 0x0c, 0x30, 0x0a, 0x06, 0x03, 0x55, 0x04, 0x0a, 0x13,
        0x03, 0x74, 0x73, 0x31, 0x31, 0x0c, 0x30, 0x0a, 0x06, 0x03, 0x55, 0x04,
        0x0b, 0x13, 0x03, 0x74, 0x73, 0x31, 0x31, 0x0c, 0x30, 0x0a, 0x06, 0x03,
        0x55, 0x04, 0x03, 0x13, 0x03, 0x74, 0x73, 0x31,
      ]),
    },
  ],
};
...
cert.createX509CertChain(encodingBlob, (err, certChain) => {
  if (err) {
    ...
    certChain.validate(param, (error, validationRes) => {
      if (error) {
        console.error(
          `X509CertChain validate failed, errCode: ${error.code}, errMsg: ${error.message}`,
        );
      } else {
        console.info('X509CertChain validate result: success.');
      }
...
async function createCsrTest() {
  let nameStr =
    '/CN=John Doe/OU=IT Department/O=ACME Inc./L=San Francisco/ST=California/C=US/CN=ALN C/CN=XTS';
  ...
  let attribute: cert.CsrAttribute[] = [keyUsage, challengePassword];
  try {
    let data = await cert.createX500DistinguishedName(nameStr);
    console.info(
      'createX500DistinguishedName result: success. ' +
        data.getName('CN').toString(),
    );
    ...
    try {
      ...
      console.info(
        'generateCsr result: success, return str is ' + csrStr.toString(),
      );
    } catch (error) {
      let e: BusinessError = error as BusinessError;
      console.error(
        `generateCsr failed, errCode: ${e.code}, errMsg: ${e.message}`,
      );
    }
  } catch (error) {
    let e: BusinessError = error as BusinessError;
    console.error(
      `createX500DistinguishedName failed, errCode: ${e.code}, errMsg: ${e.message}`,
    );
  }
}
```
...
async function createX500DistinguishedName() {
  try {
    cert
      .createX500DistinguishedName(nameStr)
      .then((data) => {
        console.info('createX500DistinguishedName result: success.');
      })
      .catch((err: BusinessError) => {
        console.error(
          `createX500DistinguishedName failed, errCode: ${err.code}, errMsg: ${err.message}`,
        );
      });
  } catch (error) {
    let e: BusinessError = error as BusinessError;
...
let nameDer = new Uint8Array([
  48, 41, 49, 11, 48, 9, 6, 3, 85, 4, 3, 12, 2, 67, 65, 49, 13, 48, 11, 6, 3,
  85, 4, 10, 12, 4, 116, 101, 115, 116, 49, 11, 48, 9, 6, 3, 85, 4, 6, 19, 2,
  67, 78,
]);
...
async function createX500DistinguishedName() {
  try {
    cert
      .createX500DistinguishedName(nameDer)
      .then((data) => {
        console.info('createX500DistinguishedName result: success.');
      })
      .catch((err: BusinessError) => {
...
let nameStr =
  '/CN=Example CA/OU=test cert/O=test/L=XA/ST=SX/C=CN/CN=RSA CA/CN=XTS';
async function getName() {
  try {
    cert
      .createX500DistinguishedName(nameStr)
      .then((data) => {
        console.info('createX500DistinguishedName result: success.');
        console.info(
          'createX500DistinguishedName getName: ' + data.getName('CN'),
        );
      })
      .catch((err: BusinessError) => {
        console.error(
...
let nameStr =
  '/CN=陕西@西安/OU=IT Department/O=ACME Inc./L=San Francisco/ST=California/C=US/CN=ALN C/CN=XTS';
async function getName() {
  try {
    cert
      .createX500DistinguishedName(nameStr)
      .then((data) => {
        console.info('createX500DistinguishedName result: success.');
        console.info(
          'createX500DistinguishedName getName: ' +
            data.getName(cert.EncodingType.ENCODING_UTF8),
        );
      })
      .catch((err: BusinessError) => {
        console.error(
  ...
  cert.createX509Cert(certEncodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      try {
        ...
        console.info(
          'testcreateCmsGenerator createCmsGenerator result: success.',
        );
      } catch (err) {
        let e: BusinessError = err as BusinessError;
        console.error(
          `createCmsGenerator failed, errCode: ${e.code}, errMsg: ${e.message}`,
        );
      }
    }
  });
  ...
  cert.createX509Cert(certEncodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      try {
        ...
        let e: BusinessError = err as BusinessError;
        console.error(
          `testAddSigner failed, errCode: ${e.code}, errMsg: ${e.message}`,
        );
      }
    }
  });
  ...
  cert.createX509Cert(certEncodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      try {
        ...
        let e: BusinessError = err as BusinessError;
        console.error(
          `testAddCert failed, errCode: ${e.code}, errMsg: ${e.message}`,
        );
      }
    }
  });
...
function testSetRecipientEncryptionAlgorithm() {
  try {
    ...
    console.error(
      `testSetRecipientEncryptionAlgorithm failed: errCode: ${err.code}, errMsg: ${err.message}`,
    );
  }
}
```
...
async function testAddRecipientInfo() {
  ...
  try {
    ...
    console.error(
      `testAddRecipientInfo failed: errCode: ${err.code}, errMsg: ${err.message}`,
    );
  }
}
```
  ...
  cert.createX509Cert(certEncodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      try {
        ...
        let cmsGenerator = cert.createCmsGenerator(cmsContentType);
        console.info(
          'testDoFinalByPromise createCmsGenerator result: success.',
        );
        let privateKeyInfo: cert.PrivateKeyInfo = {
          key: rsaStr1024,
          password: '123456',
        ...
        cmsGenerator
          .doFinal(content, optionsFinal)
          .then((result) => {
            console.info(
              'testDoFinalByPromise doFinal result: success, result = %s',
              result,
            );
          })
          .catch((error: BusinessError) => {
            console.error(
              `testDoFinalByPromise failed, errCode: ${error.code}, errMsg: ${error.message}`,
            );
          });
      } catch (err) {
        let e: BusinessError = err as BusinessError;
        console.error(
          `testDoFinalByPromise failed, errCode: ${e.code}, errMsg: ${e.message}`,
        );
      }
    }
  });
  ...
  cert.createX509Cert(certEncodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      try {
        ...
        console.info(
          'testDoFinalSync doFinalSync result: success, output = %s.',
          output,
        );
      } catch (err) {
        let e: BusinessError = err as BusinessError;
        console.error(
          `testDoFinalSync failed, errCode: ${e.code}, errMsg: ${e.message}`,
        );
      }
    }
  });
...
async function testGetEncryptedContentData() {
  try {
    ...
    console.error(
      `testGetEncryptedContentData failed: errCode: ${err.code}, errMsg: ${err.message}`,
    );
  }
}
```
...
async function testCmsVerifyTest() {
  try {
    ...
    let x509CertEntry: cert.X509Cert = await createX509Cert(
      ECC_256_PUB_ENTRY_CERT,
    );
    let x509CertInter: cert.X509Cert = await createX509Cert(
      ECC_256_PUB_INTER_CERT,
    );
    let x509CertRoot: cert.X509Cert = await createX509Cert(
      ECC_256_PUB_ROOT_CERT,
    );
    let cms: cert.CmsGenerator = cert.createCmsGenerator(
      cert.CmsContentType.SIGNED_DATA,
    );
    ...
    console.error(
      `verifySignedData failed: errCode: ${error.code}, errMsg: ${error.message}`,
    );
  }
}
```
...
async function testCmsVerifyTest() {
  try {
    ...
    console.info(
      'getContentData result: success, contentData = ' + contentData,
    );
  } catch (error) {
    console.error(
      `verifySignedData failed: errCode: ${error.code}, errMsg: ${error.message}`,
...
async function testCmsVerifyTest() {
  try {
    ...
    await verify.verifySignedData(config);
    console.info('verifySignedData result: success.');
    let signerCerts: cert.X509Cert[] = await verify.getCerts(
      cert.CmsCertType.SIGNER_CERTS,
    );
    console.info(
      'getCerts result: success, signerCerts.length = ' + signerCerts.length,
    );
...
async function testCmsDecryptTest() {
  try {
    ...
    let cms: cert.CmsGenerator = cert.createCmsGenerator(
      cert.CmsContentType.ENVELOPED_DATA,
    );
    let option: cert.CmsGeneratorOptions = {
      outFormat: cert.CmsFormat.PEM,
    };
    cms.setRecipientEncryptionAlgorithm(
      cert.CmsRecipientEncryptionAlgorithm.AES_128_GCM,
    );
    let recipientInfo: cert.CmsRecipientInfo = {
      keyAgreeInfo: {
        cert: x509CertEc,
    ...
    console.info(
      'addRecipientInfo result: success, recipientInfo.keyAgreeInfo.digestAlgorithm = ' +
    ...
    console.info(
      'getEncryptedContentData result: success, cipherText = ' + cipherText,
    );
    ...
    let decPlainText: Uint8Array =
      await cmsDecrypt.decryptEnvelopedData(config);
    console.info(
      '[XTS] Decrypt result: success, decPlainText = ' + decPlainText,
    );
