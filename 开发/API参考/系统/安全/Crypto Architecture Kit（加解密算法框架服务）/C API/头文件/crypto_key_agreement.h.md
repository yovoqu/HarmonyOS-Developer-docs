...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| OH_CryptoKeyAgreement | OH_CryptoKeyAgreement | 密钥协商结构体，表示密钥协商上下文。 |
...
| 名称 | 描述 |
| --- | --- |
| OH_Crypto_ErrCode OH_CryptoKeyAgreement_Create(const char *algoName, OH_CryptoKeyAgreement **ctx) | 根据给定的算法名称创建密钥协商上下文。 注意：创建的资源必须通过OH_CryptoKeyAgreement_Destroy销毁。 |
| OH_Crypto_ErrCode OH_CryptoKeyAgreement_GenerateSecret(OH_CryptoKeyAgreement *ctx, OH_CryptoPrivKey *privkey, OH_CryptoPubKey *pubkey, Crypto_DataBlob *secret) | 生成共享秘密值。 注意：使用完成后必须通过OH_Crypto_FreeDataBlob释放secret内存。 |
| void OH_CryptoKeyAgreement_Destroy(OH_CryptoKeyAgreement *ctx) | 销毁密钥协商上下文。 |
...
| OH_CryptoKeyAgreement **ctx | [out] 指向密钥协商上下文指针的指针。ctx不能为NULL，*ctx必须为NULL。 |
...
| 参数项 | 描述 |
| --- | --- |
| OH_CryptoKeyAgreement *ctx | [in] 密钥协商上下文。不能为NULL。 |
...
| 参数项 | 描述 |
| --- | --- |
| OH_CryptoKeyAgreement *ctx | [in] 密钥协商上下文。 |
