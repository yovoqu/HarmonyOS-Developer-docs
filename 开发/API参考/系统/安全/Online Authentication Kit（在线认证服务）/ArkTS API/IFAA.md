...
getAnonIdPromise
  ...
  .catch((err: BusinessError) => {
    console.error(
      `Failed to call getAnonymousId. Code: ${err.code}, message: ${err.message}`,
    );
  });
```
...
// 开发者需要按照IIFAA的TLV格式构造入参，并转换为Uint8Array参数；此处arg需要开发者替换为真实入参。
let arg = new Uint8Array([0]);
ifaa.getAnonymousId(arg, (err: BusinessError, result: Uint8Array) => {
  if (err) {
    console.error(
      `Failed to call getAnonymousId. Code: ${err.code}, message: ${err.message}`,
    );
...
promise
  ...
  .catch((err: BusinessError) => {
    console.error(
      `Failed to call queryStatus. Code: ${err.code}, message: ${err.message}`,
    );
  });
```
...
// 开发者需要按照IIFAA的TLV格式构造入参，并转换为Uint8Array参数；此处arg需要开发者替换为真实入参。
let arg = new Uint8Array([0]);
ifaa.queryStatus(arg, (err: BusinessError, result: boolean) => {
  if (err) {
    console.error(
      `Failed to call queryStatus. Code: ${err.code}, message: ${err.message}`,
    );
...
registerPromise
  .then((registerResult) => {
    console.info(
      'Succeeded in doing register. registerResult:',
      registerResult,
    );
    // 开发者处理registerResult
  })
  .catch((err: BusinessError) => {
    console.error(
      `Failed to call register. Code: ${err.code}, message: ${err.message}`,
    );
  });
```
...
preAuthPromise
  ...
  .catch((err: BusinessError) => {
    console.error(
      `Failed to call preAuth. Code: ${err.code}, message: ${err.message}`,
    );
  });
```
...
ifaa.preAuth((err: BusinessError, preAuthResult: Uint8Array) => {
  if (err) {
    console.error(
      `Failed to call preAuth. Code: ${err.code}, message: ${err.message}`,
    );
...
authPromise
  ...
  .catch((err: BusinessError) => {
    console.error(
      `Failed to call auth. Code: ${err.code}, message: ${err.message}`,
    );
  });
```
...
// 开发者需要按照IIFAA的TLV格式构造入参，并转换为Uint8Array参数；arg需要开发者替换为真实入参。
let arg = new Uint8Array([0]);
ifaa.auth(token, arg, (err: BusinessError, authResult: Uint8Array) => {
  if (err) {
    console.error(
      `Failed to call auth. Code: ${err.code}, message: ${err.message}`,
    );
...
promise
  ...
  .catch((err: BusinessError) => {
    console.error(
      `Failed to call deregister. Code: ${err.code}, message: ${err.message}`,
    );
  });
```
...
// 开发者需要按照IIFAA的TLV格式构造入参，并转换为Uint8Array参数；此处arg需要开发者替换为真实入参。
let arg = new Uint8Array([0]);
ifaa.deregister(arg, (err: BusinessError) => {
  if (err) {
    console.error(
      `Failed to call deregister. Code: ${err.code}, message: ${err.message}`,
    );
...
promise
  .then((result) => {
    console.info(
      'Succeeded in doing getProtocolVersion. protocolVersion:',
      result,
    );
    // 开发者处理result
  })
  .catch((err: BusinessError) => {
    console.error(
      `Failed to call getProtocolVersion. Code: ${err.code}, message: ${err.message}`,
    );
  });
```
...
ifaa.getProtocolVersion((err: BusinessError, result: Uint8Array) => {
  if (err) {
    console.error(
      `Failed to call getProtocolVersion. Code: ${err.code}, message: ${err.message}`,
    );
...
console.info(
  'Succeeded in doing getSupportedCertTypesSync. supportedCertTypes:',
  result,
);
// 开发者处理result
```
...
promise
  .then((result) => {
    console.info(
      'Succeeded in doing getSupportedCertTypes. supportedCertTypes:',
      result,
    );
    // 开发者处理result
  })
  .catch((err: BusinessError) => {
    console.error(
      `Failed to call getSupportedCertTypes. Code: ${err.code}, message: ${err.message}`,
    );
  });
```
...
ifaa.getSupportedCertTypes((err: BusinessError, result: Uint8Array) => {
  if (err) {
    console.error(
      `Failed to call getSupportedCertTypes. Code: ${err.code}, message: ${err.message}`,
    );
