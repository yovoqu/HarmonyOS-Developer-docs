...
| typedef struct AuthenticationExtensionsClientOutputs AuthenticationExtensionsClientOutputs | 身份认证扩展输出。 |
...
| FIDO2_ErrorCode HMS_FIDO2_authenticate (const FIDO2_CredentialRequestOptions options, const FIDO2_TokenBinding tokenBinding, const char *origin, FIDO2_PublicKeyAssertionCredential **publicKeyAssertionCredential) | 通行密钥认证。 |
...
| 名称 | 描述 |
| --- | --- |
| publicKeyAssertionCredential | 要释放的FIDO2_PublicKeyAssertionCredential的结构体。 |
...
| 名称 | 描述 |
| --- | --- |
| publicKeyAttestationCredential | 要释放的FIDO2_PublicKeyAttestationCredential的结构体。 |
