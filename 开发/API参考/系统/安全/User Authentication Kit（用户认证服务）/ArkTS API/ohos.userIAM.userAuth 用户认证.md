...
| authTrustLevel | [AuthTrustLevel](#authtrustlevel8) | 否 | 否 | 期望达到的认证可信等级。典型操作需要的身份认证可信等级，以及身份认证可信等级的划分请参见认证可信等级划分原则。 元服务API： 从API version 12开始，该接口支持在元服务中使用。 |
| reuseUnlockResult^12+ | [ReuseUnlockResult](#reuseunlockresult12) | 否 | 是 | 表示可以复用解锁认证的结果。默认为不复用。 元服务API： 从API version 12开始，该接口支持在元服务中使用。 |
...
| uiContext^18+ | Context | 否 | 是 | 以模应用弹窗方式显示身份认证对话框，仅支持在2in1设备上使用，如果没有此参数或其他类型的设备，身份认证对话框将以模系统弹窗方式显示。 默认以模系统弹窗方式显示身份认证对话框。 元服务API： 从API version 18开始，该接口支持在元服务中使用。 |
...
| enrolledState^12+ | [EnrolledState](#enrolledstate12) | 否 | 是 | 认证成功时，返回注册凭据的状态。 |
...
> [!NOTE] 说明
> 从 API version 9 开始支持，从 API version 11 开始废弃，请使用UserAuthResult替代。
...
> [!NOTE] 说明
> 从 API version 9 开始支持，从 API version 11 开始废弃，请使用AuthTipInfo替代。
...
> [!NOTE] 说明
> 从 API version 9 开始支持，从 API version 11 开始废弃，请使用IAuthCallback替代。
...
> [!NOTE] 说明
> 从 API version 9 开始支持，从 API version 11 开始废弃，请使用onResult替代。
...
> [!NOTE] 说明
> 从 API version 9 开始支持，从 API version 10 开始废弃，请使用UserAuthInstance替代。
...
> [!NOTE] 说明
> 从 API version 9 开始支持，从 API version 10 开始废弃，请使用on('result')替代。 使用获取到的AuthInstance对象调用该接口进行订阅。
...
> [!NOTE] 说明
> 从 API version 9 开始支持，从 API version 10 开始废弃，请使用off('result')替代。 需要使用已经成功订阅事件的AuthInstance对象调用该接口进行取消订阅。
...
> [!NOTE] 说明
> 从 API version 9 开始支持，从 API version 10 开始废弃，请使用start替代。 使用获取到的AuthInstance对象调用该接口进行认证。
...
> [!NOTE] 说明
> 从 API version 9 开始支持，从 API version 10 开始废弃，请使用cancel替代。 使用获取到的AuthInstance对象调用该接口进行取消认证，此AuthInstance需要是正在进行认证的对象。
...
> [!NOTE] 说明
> 从 API version 9 开始支持，从 API version 10 开始废弃，请使用getUserAuthInstance替代。 每个AuthInstance只能进行一次认证，若需要再次进行认证则需重新获取AuthInstance。
...
![](assets/ohos.userIAM.userAuth%20用户认证/file-20260525092924703-001.png)
...
> [!NOTE] 说明
> 从 API version 8 开始支持，从 API version 9 开始废弃，请使用start代替。
...
> [!NOTE] 说明
> 从 API version 8 开始支持，从 API version 9 开始废弃，请使用cancel代替。
...
> [!NOTE] 说明
> 从 API version 8 开始支持，从 API version 9 开始废弃，请使用AuthEvent代替。
...
> [!NOTE] 说明
> 从 API version 8 开始支持，从 API version 9 开始废弃，请使用callback代替。
...
> [!NOTE] 说明
> 从 API version 8 开始支持，从 API version 9 开始废弃，请使用AuthResultInfo代替。
...
> [!NOTE] 说明
> 从 API version 8 开始支持，从 API version 9 开始废弃，请使用UserAuthResultCode代替。
...
> [!NOTE] 说明
> 从 API version 6 开始支持，从 API version 8 开始废弃，请使用AuthTrustLevel替代。
...
> [!NOTE] 说明
> 从 API version 6 开始支持，从 API version 8 开始废弃，请使用UserAuthType替代。
...
> [!NOTE] 说明
> 从 API version 6 开始支持，从 API version 8 开始废弃，请使用getAuthInstance替代。
...
> [!NOTE] 说明
> 从 API version 6 开始支持，从 API version 8 开始废弃，请使用AuthInstance替代。
...
> [!NOTE] 说明
> 从 API version 6 开始支持，从 API version 8 开始废弃，请使用start替代。
...
> [!NOTE] 说明
> 从 API version 6 开始支持，从 API version 8 开始废弃，请使用UserAuthResultCode代替。
