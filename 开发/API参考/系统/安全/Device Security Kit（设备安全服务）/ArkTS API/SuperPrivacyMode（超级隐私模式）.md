...
let mode: superPrivacyMode.SuperPrivacyMode =
  superPrivacyMode.SuperPrivacyMode.OFF;
try {
  ...
  hilog.error(
    DOMAIN,
    TAG,
    `call getSuperPrivacyMode interface failed, errCode:${err?.code}, errMessage:${err?.message}`,
  );
}
```
...
const superPrivacyChangedCallback = (
  superPrivacyMode: superPrivacyMode.SuperPrivacyMode,
): void => {
  hilog.info(
    DOMAIN,
    TAG,
    `super privacy mode changed, mode = ${superPrivacyMode}`,
  );
};
...
try {
  ...
  hilog.info(
    DOMAIN,
    TAG,
    'register super privacy mode change listener success',
  );
} catch (err) {
  hilog.error(
    DOMAIN,
    TAG,
    `register super privacy changed listener failed, errCode:${err?.code}, errMessage:${err?.message}`,
  );
}
```
...
try {
  ...
  hilog.error(
    DOMAIN,
    TAG,
    `unregister super privacy changed listener failed, errCode:${err?.code}, errMessage:${err?.message}`,
  );
}
```
