...
let callback: Callback<dataTransfer.ConnectionResult> = (
...
try {
  ...
  let state: dataTransfer.ConnectionState = dataTransfer.getConnectionState(
...
let callback: Callback<dataTransfer.DataParams> = (
