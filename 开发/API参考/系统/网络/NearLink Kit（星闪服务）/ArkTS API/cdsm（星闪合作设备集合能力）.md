...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[CdsmInfo](#cdsminfo)> | 是 | 表示远端设备合作设备集合信息变化回调函数的入参。回调函数由用户创建，通过该接口注册。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback<[CdsmInfo](#cdsminfo)> | 否 | 回调函数，返回合作设备集合信息。 填写该参数则取消当前callback订阅。不填写该参数则取消该type对应的所有回调。 |
