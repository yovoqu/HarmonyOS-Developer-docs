...
| 名称 | 描述 |
| --- | --- |
| [Rcp_OnStatusCodeReceiveCallbackFunc](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/remote-communication-overview#rcp_onstatuscodereceivecallbackfunc) | 请求过程中接收响应状态码的回调函数。 |
