...
> [!NOTE]
> 从API version 8开始支持，���API version 9开始废弃。建议使用[bluetoothManager.MajorMinorClass](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bluetoothmanager#majorminorclassdeprecated)替代。
