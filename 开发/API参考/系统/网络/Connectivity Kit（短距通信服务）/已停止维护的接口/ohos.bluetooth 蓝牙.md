...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-bluetooth
**支持设备：** Phone | PC/2in1 | Tablet | Wearable | TV

蓝牙模块提供了基础的传统蓝牙能力以及BLE的扫描、广播等功能。
 
> [!NOTE]
> 本模块首批接口从API version 7开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。 从API Version 9 开始，该接口不再维护，推荐使用 @ohos.bluetooth.ble (蓝牙ble模块) 等相关Profile接口。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.enableBluetooth 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.disableBluetooth 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.getLocalName 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.getState 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.getBtConnectionState 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.setLocalName 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.pairDevice 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.getProfileConnectionState 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.getRemoteDeviceName 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.getRemoteDeviceClass 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.getPairedDevices 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.setBluetoothScanMode 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.getBluetoothScanMode 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.startBluetoothDiscovery 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.stopBluetoothDiscovery 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.setDevicePairingConfirmation 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.on('bluetoothDeviceFind') 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.off('bluetoothDeviceFind') 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.on('pinRequired') 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.off('pinRequired') 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.on('bondStateChange') 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.off('bondStateChange') 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.on('stateChange') 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.off('stateChange') 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.sppListen 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.sppAccept 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.sppConnect 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.sppCloseServerSocket 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.sppCloseClientSocket 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.sppWrite 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.on('sppRead') 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.off('sppRead') 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.getProfileInstance 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.BLE.createGattServer 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.BLE.createGattClientDevice 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.BLE.getConnectedBLEDevices 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.BLE.startBLEScan 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.BLE.stopBLEScan 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.BLE.on('BLEDeviceFind') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.BLE.off('BLEDeviceFind') 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.BaseProfile.getConnectionDevices 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.BaseProfile.getDeviceState 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.A2dpSourceProfile.connect 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.A2dpSourceProfile.disconnect 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.A2dpSourceProfile.on('connectionStateChange') 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.A2dpSourceProfile.off('connectionStateChange') 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.A2dpSourceProfile.getPlayingState 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.HandsFreeAudioGatewayProfile.connect 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.HandsFreeAudioGatewayProfile.disconnect 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.HandsFreeAudioGatewayProfile.on('connectionStateChange') 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.HandsFreeAudioGatewayProfile.off('connectionStateChange') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattServer.startAdvertising 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattServer.stopAdvertising 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattServer.addService 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattServer.removeService 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattServer.close 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattServer.notifyCharacteristicChanged 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattServer.sendResponse 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattServer.on('characteristicRead') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattServer.off('characteristicRead') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattServer.on('characteristicWrite') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattServer.off('characteristicWrite') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattServer.on('descriptorRead') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattServer.off('descriptorRead') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattServer.on('descriptorWrite') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattServer.off('descriptorWrite') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattServer.on('connectStateChange') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattServer.off('connectStateChange') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattClientDevice.connect 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattClientDevice.disconnect 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattClientDevice.close 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattClientDevice.getServices 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattClientDevice.readCharacteristicValue 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattClientDevice.readDescriptorValue 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattClientDevice.writeCharacteristicValue 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattClientDevice.writeDescriptorValue 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattClientDevice.setBLEMtuSize 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattClientDevice.setNotifyCharacteristicChanged 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattClientDevice.on('BLECharacteristicChange') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattClientDevice.off('BLECharacteristicChange') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattClientDevice.on('BLEConnectionStateChange') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattClientDevice.off('BLEConnectionStateChange') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattClientDevice.getDeviceName 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattClientDevice.getRssiValue 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.ScanMode 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.BondState 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.SppOption 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.SppType 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.GattService 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.BLECharacteristic 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.BLEDescriptor 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.NotifyCharacteristic 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.CharacteristicReadRequest 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.CharacteristicWriteRequest 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.DescriptorReadRequest 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.DescriptorWriteRequest 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.ServerResponse 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.BLEConnectChangedState 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.ProfileConnectionState 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.ScanFilter 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.ScanOptions 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.ScanDuty 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.MatchMode 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.ScanResult 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.BluetoothState 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.AdvertiseSetting 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.AdvertiseData 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.ManufactureData 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 bluetoothManager.ServiceData 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.PinRequiredParam 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.BondStateParam 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.StateChangeParam 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.DeviceClass 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.MajorClass 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.MajorMinorClass 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.PlayingState 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 bluetoothManager.ProfileId 替代。
