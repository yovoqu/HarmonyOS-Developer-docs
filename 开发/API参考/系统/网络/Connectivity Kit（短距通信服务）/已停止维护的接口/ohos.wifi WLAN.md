...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-wifi
**支持设备：** Phone | PC/2in1 | Tablet | Wearable | TV

该模块主要提供WLAN基础功能、P2P（peer-to-peer）功能和WLAN消息通知的相应服务，让应用可以通过WLAN和其他设备互联互通。
 
> [!NOTE]
> 本模块首批接口从API version 6开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。 从API Version 9 开始，该接口不再维护，推荐使用 @ohos.wifiManager (WLAN) 等相关接口。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃。建议使用 wifiManager.isWifiActive 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃。建议使用 wifiManager.scan 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃。建议使用 wifiManager.getScanInfoList 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃。建议使用 WifiScanInfo 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃。建议使用 WifiSecurityType 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃。建议使用 WifiDeviceConfig 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 wifiManager.addCandidateConfig 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 wifiManager.removeCandidateConfig 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃。建议使用 wifiManager.getSignalLevel 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃。建议使用 wifiManager.getLinkedInfo 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃。建议使用 WifiLinkedInfo 替代。
...
> [!NOTE]
> 从API version 6开始支持，从API version 9开始废弃。建议使用 ConnState 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 wifiManager.isConnected 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 wifiManager.isFeatureSupported 替代。
...
> [!TIP]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 wifiManager.getIpInfo 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 wifiManager.getCountryCode 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 wifiManager.getP2pLinkedInfo 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 WifiP2pLinkedInfo 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 P2pConnectState 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 wifiManager.getCurrentGroup 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 wifiManager.getP2pPeerDevices 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 WifiP2pDevice 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 P2pDeviceStatus 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 wifiManager.createGroup 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 WifiP2PConfig 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 GroupOwnerBand 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 wifiManager.removeGroup 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 wifiManager.p2pConnect 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 wifiManager.p2pCancelConnect 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 wifiManager.startDiscoverDevices 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 wifiManager.stopDiscoverDevices 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 WifiP2pGroupInfo 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 wifiManager.on 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 wifiManager.off 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 wifiManager.on 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃。建议使用 wifiManager.off 替代。
