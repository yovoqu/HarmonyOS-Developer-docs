...
> [!NOTE]
> 从 API version 7 开始支持，从 API version 9 开始废弃，建议使用 tag.getNfcA 替代。
...
> [!NOTE]
> 从 API version 7 开始支持，从 API version 9 开始废弃，建议使用 tag.getNfcB 替代。
...
> [!NOTE]
> 从 API version 7 开始支持，从 API version 9 开始废弃，建议使用 tag.getNfcF 替代。
...
> [!NOTE]
> 从 API version 7 开始支持，从 API version 9 开始废弃，建议使用 tag.getNfcV 替代。
