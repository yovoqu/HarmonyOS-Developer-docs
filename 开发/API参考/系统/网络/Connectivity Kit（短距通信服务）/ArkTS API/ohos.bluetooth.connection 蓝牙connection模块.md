...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;AclStateResult&gt; | 是 | 回调函数，返回蓝牙外设连接状态 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;AclStateResult&gt; | 否 | 指定取消订阅的回调函数通知。 若传参，则需与connection.onAclStateChange中的回调函数一致；若无传参，则取消订阅所有蓝牙ACL连接状态变更的回调函数通知。 |
