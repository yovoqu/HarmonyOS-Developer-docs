...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-tagsession
**支持设备：** Phone | Wearable
...
> [!NOTE]
> 从 API version 7 开始支持，从 API version 9 开始废弃，建议使用 tag.getTagInfo 替代。
...
> [!NOTE]
> 从 API version 7 开始支持，从 API version 9 开始废弃，建议使用 tagSession.connect 替代。
...
> [!NOTE]
> 从 API version 7 开始支持，从 API version 9 开始废弃，建议使用 tagSession.resetConnection 替代。
...
> [!NOTE]
> 从 API version 7 开始支持，从 API version 9 开始废弃，建议使用 tagSession.isConnected 替代。
...
> [!NOTE]
> 从 API version 7 开始支持，从 API version 9 开始废弃，建议使用 tagSession.getMaxTransmitSize 替代。
...
> [!NOTE]
> 从 API version 7 开始支持，从 API version 9 开始废弃，建议使用 tagSession.getTimeout 替代。
...
> [!NOTE]
> 从 API version 7 开始支持，从 API version 9 开始废弃，建议使用 tagSession.setTimeout 替代。
...
> [!NOTE]
> 从 API version 7 开始支持，从 API version 9 开始废弃，建议使用 tagSession.transmit 替代。
