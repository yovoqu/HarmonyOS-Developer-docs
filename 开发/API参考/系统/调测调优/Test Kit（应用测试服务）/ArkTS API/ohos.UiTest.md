...
> [!NOTE]
> 本模块首批接口从API version 8开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。 本模块接口在 自动化测试脚本 中使用。 本模块接口不支持并发调用。
...
> [!NOTE]
> 如果控件的无障碍属性 accessibilityLevel 设置为'no'或'no-hide-descendants'，无法使用本接口指定目标控件的文本属性用于查找控件，可以使用 On.originalText() 接口实现。
...
> [!NOTE]
> 如果控件的无障碍属性 accessibilityLevel 设置为'no'或'no-hide-descendants'，可以使用本接口指定目标控件的文本属性用于查找控件，使用 On.text() 接口不生效。
...
> [!NOTE]
> 如果控件的无障碍属性 accessibilityLevel 设置为'no'或'no-hide-descendants'，无法使用本接口获取控件的文本信息，可以使用 Component.getOriginalText() 获取控件的文本信息。
...
> [!NOTE]
> 从API version 9开始支持，从API version 11开始废弃，建议使用 isActive 11+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 On 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 text 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 id 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 type 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 clickable 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 scrollable 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 enabled 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 focused 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 selected 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 isBefore 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 isAfter 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 click 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 doubleClick 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 getId 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 getText 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 getType 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 isClickable 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 isScrollable 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 isEnabled 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 isFocused 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 isSelected 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 scrollSearch 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 create 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 findComponent 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 findComponents 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 assertComponentExist 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 pressBack 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 swipe 9+ 替代。
...
> [!NOTE]
> 从API version 8开始支持，从API version 9开始废弃，建议使用 screenCap 9+ 替代。
