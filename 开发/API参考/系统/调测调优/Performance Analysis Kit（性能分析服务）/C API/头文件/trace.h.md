...
| HITRACE_FLAG_TP_INFO = 1 &lt;&lt; 2 | 埋点标志。  调试场景下设置该标志，调用信息埋点接口[OH_HiTrace_Tracepoint](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-trace-h#oh_hitrace_tracepoint)时，会打印埋点信息hilog日志；缺省不打印埋点信息hilog日志。 起始版本： 12 系统能力： SystemCapability.HiviewDFX.HiTrace |
| HITRACE_FLAG_NO_BE_INFO = 1 &lt;&lt; 3 | 无开始结束信息标志。  调试场景下设置该标志，调用开始跟踪接口[OH_HiTrace_BeginChain](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-trace-h#oh_hitrace_beginchain)和结束跟踪接口[OH_HiTrace_EndChain](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-trace-h#oh_hitrace_endchain)时，分别会打印开始、结束跟踪信息hilog日志；缺省不打印开始、结束跟踪信息hilog日志。 起始版本： 12 系统能力： SystemCapability.HiviewDFX.HiTrace |
...
| HITRACE_FLAG_D2D_TP_INFO = 1 &lt;&lt; 6 | 设备间埋点标志。[HITRACE_FLAG_TP_INFO](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-trace-h#hitrace_flag)的一个子集，调试场景下使用。  当已设置[HITRACE_FLAG_TP_INFO](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-trace-h#hitrace_flag)标志时，[HITRACE_FLAG_D2D_TP_INFO](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-trace-h#hitrace_flag)标志不生效；  当未设置[HITRACE_FLAG_TP_INFO](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-trace-h#hitrace_flag)标志时，设置[HITRACE_FLAG_D2D_TP_INFO](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-trace-h#hitrace_flag)标志，此时调用信息埋点接口[OH_HiTrace_Tracepoint](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-trace-h#oh_hitrace_tracepoint)，仅当mode参数为设备间通信[HITRACE_CM_DEVICE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-trace-h#hitrace_communication_mode)的情况下，会打印埋点信息hilog日志。 起始版本： 12 系统能力： SystemCapability.HiviewDFX.HiTrace |
