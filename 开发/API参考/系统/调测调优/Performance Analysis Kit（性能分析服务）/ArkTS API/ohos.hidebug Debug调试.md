...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/y-h9IlpZTNq7bkitthHSlQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=A5C2FD46035B7E17C71D562962C0EFAFFEB61627F474382D5F633B72AB1980E3)
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4b/v3/B4skGWFKQYm6d4ADDvzpgg/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=49B8337EF57059167222DFA13DBE9E99844896360E60F6B6529C93BEF4BDB313)
由于/proc/{pid}/smaps_rollup的读取耗时较长，建议不要在主线程中使用该接口，可通过[@ohos.taskpool](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-taskpool)或[@ohos.worker](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-worker)开启异步线程以避免应用出现卡顿。
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/OKNhVxjWSxeLd7Xu5HA_SA/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=17EA6015B401BEF1A1BA2EB94DFFF9B55F2B82952085E0C94F8AC1ED1E0CE5A4)
由于/proc/{pid}/smaps_rollup的读取耗时较长，建议不要在主线程中使用该接口，可通过[@ohos.taskpool](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-taskpool)或[@ohos.worker](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-worker)开启异步线程以避免应用出现卡顿。
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/vKqHtu_QQl6i3JEM7_yJ5Q/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=92119CA7F0B5AE877543AF6DBAE2F20D194C6025F1B64D9B6F921260C1B3B5F0)
...
try {
  ...
  let path: string =
    this.getUIContext().getHostContext()!.filesDir + '/serviceInfo.txt';
  console.info('output path: ' + path);
  fileFd = fileIo.openSync(
    path,
  ...
  console.error(
    `error code: ${(error as BusinessError).code}, error msg: ${(error as BusinessError).message}`,
  );
}
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ce/v3/hk5eA3FbSNKzhIM8lm4fCg/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=270A8B827430771A8907076A81C45ECBD2147C707CD6F910CCBD1B3949ECD0FF)
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0e/v3/GEtJQxMvQEuQ72vafiXgeg/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=4ABA6C2F9BB109BE48A1B37580EE87DB4D1F0BEA3E8F02D8C593E087D5AD6D36)
由于虚拟机堆导出极其耗时，且该接口为同步接口，建议不要在上架版本中调用该接口，以避免应用冻屏，影响用户体验。
...
console.info(
  `totalHeap = ${vmMemory.totalHeap}, heapUsed = ${vmMemory.heapUsed},` +
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/44/v3/lmm6iQ0aQbuDdZxmmW0uzA/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=3FA2FF92F762D78CDFB5B3E6B38C8471D53C50027C52FEA56EB13937F2A54678)
由于该接口涉及跨进程通信，耗时较长，为了避免引入性能问题，建议不要在主线程中直接调用该接口。
...
let appThreadCpuUsage: hidebug.ThreadCpuUsage[] =
  hidebug.getAppThreadCpuUsage();
for (let i = 0; i < appThreadCpuUsage.length; i++) {
  console.info(
    `threadId=${appThreadCpuUsage[i].threadId}, cpuUsage=${appThreadCpuUsage[i].cpuUsage}`,
  );
}
```
...
try {
  ...
  hilog.error(
    0x0000,
    'hidebug',
    `error code: ${(error as BusinessError).code}, message: ${(error as BusinessError).message}`,
  );
}
```
...
console.info(
  `rssLimit: ${appMemoryLimit.rssLimit}, vssLimit: ${appMemoryLimit.vssLimit},` +
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/12/v3/cAiNr74oShiYE_plgXkWZQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=B782681D90173A956D9A29143F10F0D8437F346B63442255416617BB47E288DF)
由于该接口涉及跨进程通信，耗时较长，为了避免引入性能问题，建议不要在主线程中直接调用该接口。
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5f/v3/4UoYEY2URCKLvhROy7diHA/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=14E4514C15197531487687E0794AA84BAED49956D23E6665C53F558DA55B580C)
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2d/v3/XrFy6wB6Q76qRqPS2t03dg/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=8232D24A8280F8E23679C7867E3E41A8E08299D49A4909A41A971F7CA13C14CD)
...
hidebug
  ...
  .then((nativeMemInfo: hidebug.NativeMemInfo) => {
    console.info(
      `pss: ${nativeMemInfo.pss}, vss: ${nativeMemInfo.vss}, rss: ${nativeMemInfo.rss}, ` +
        `sharedDirty: ${nativeMemInfo.sharedDirty}, privateDirty: ${nativeMemInfo.privateDirty}, ` +
        `sharedClean: ${nativeMemInfo.sharedClean}, privateClean: ${nativeMemInfo.privateClean}`,
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/50CllBOUQ0a3d9Jq0_mugg/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=6553C130C8DF579F4D7AAF2A9FA80728EB1666E21A88DF2D16855EE1B2B7DA11)
...
```ts
let nativeMemInfo: hidebug.NativeMemInfo =
...
console.info(
  `totalMem: ${systemMemInfo.totalMem}, freeMem: ${systemMemInfo.freeMem}, ` +
...
console.info(
  `gc-bytes-allocated: ${vMRuntimeStats['ark.gc.gc-bytes-allocated']}`,
);
console.info(`gc-bytes-freed: ${vMRuntimeStats['ark.gc.gc-bytes-freed']}`);
console.info(
  `fullgc-longtime-count: ${vMRuntimeStats['ark.gc.fullgc-longtime-count']}`,
);
```
...
try {
  ...
  console.info(
    `gc-bytes-allocated: ${hidebug.getVMRuntimeStat('ark.gc.gc-bytes-allocated')}`,
  );
  console.info(
    `gc-bytes-freed: ${hidebug.getVMRuntimeStat('ark.gc.gc-bytes-freed')}`,
  );
  console.info(
    `fullgc-longtime-count: ${hidebug.getVMRuntimeStat('ark.gc.fullgc-longtime-count')}`,
  );
} catch (error) {
  console.error(
    `error code: ${(error as BusinessError).code}, error msg: ${(error as BusinessError).message}`,
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/70/v3/Z8sAnbPpT7qJVtsP5mcLiA/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=A2F48D1014905224D18ACCB963769EC62D0BA4179F4890CA866C0204E6FC448F)
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/67/v3/saT6zmfmR0S_HX6kRnytpg/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=2A213B4011FCECC83E5CAEB94F36920E3E8552858953D31F699E59F5FE223E60)
...
hidebug
  ...
  .then((ret: hidebug.GraphicsMemorySummary) => {
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/81/v3/WW6RI9RHRSa1sPyD4AUFiQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=8671D480E4B0B0307DCF36D982E902F52109667D8374A9B65B59748938BB3F9E)
...
hidebug
  ...
  .then((filePath: string) => {
    console.info(
      `dumpJsRawHeapData success and generated file path is ${filePath}`,
    );
  })
  .catch((error: BusinessError) => {
    console.error(`error code: ${error.code}, error msg: ${error.message}`);
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/12/v3/gcZZV-zBTzK5XwHvykYk1g/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=30C28181519B80BCDF63629E1617BEE0F2E2FCD2958D9FC1A01C96062D33526C)
系统通过该接口转存快照会消耗大量资源，因此严格限制了调用频率和次数。处理完生成的文件后，请立即删除。
...
try {
  ...
  console.error(
    `Failed to enable GWP-ASan. Code: ${err.code}, message: ${err.message}`,
  );
}
```
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d1/v3/bJ1DUxxxTUqZvmnR_PoYDw/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=4A4AD7514950625A845E67A3B102B9A95555C0657D3F94FD0602DF2A9C578935)
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/qnl18rbHSrCc4VlQsqjVvw/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=FFB20A344E936DA0A7FC73D2D200B7E3EA16CE4654C138A6E11797556B29C0FE)
...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e/v3/0E2jiWEbReanDA_I2MTH7w/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T084739Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=5A13CD513433FE055D9994FB1B54E843548CC4D31844B79332F71CEA5B5DA655)
