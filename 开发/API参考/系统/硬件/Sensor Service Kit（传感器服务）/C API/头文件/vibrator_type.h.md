...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| Vibrator_Attribute | Vibrator_Attribute | 马达属性，参考 Vibrator_Attribute。 |
| Vibrator_FileDescription | Vibrator_FileDescription | 振动文件描述，参考 Vibrator_FileDescription。 |
...
| 名称 | typedef关键字 | 描述 |
| --- | --- | --- |
| Vibrator_ErrorCode | Vibrator_ErrorCode | 定义错误码。 |
| Vibrator_Usage | Vibrator_Usage | 振动优先级，用于定义不同场景下振动的优先级，高优先级振动会中断低优先级的振动。使用时建议根据应用场景选择合适的优先级。 |
