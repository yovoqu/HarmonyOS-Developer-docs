...
| [Vibrator_Attribute](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-vibrator-vibrator-attribute) attribute | - 振动属性，请参考VibrateAttribute。 |
...
| 类型 | 说明 |
| --- | --- |
| int32_t | 如果操作成功，则返回0；否则返回非零值。请参阅 [Vibrator_ErrorCode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-vibrator-type-h#vibrator_errorcode)。 |
