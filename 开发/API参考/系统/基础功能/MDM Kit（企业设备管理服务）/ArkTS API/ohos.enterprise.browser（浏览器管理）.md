...
let policyValue: string =
  '{"level":"mandatory","scope":"machine","source":"platform","value":true}';
...
try {
  ...
  console.error(
    `Failed to set browser policies. Code is ${err.code}, message is ${err.message}`,
  );
}
```
...
try {
  ...
  console.info(
    `Succeeded in getting browser policies, result : ${JSON.stringify(result)}`,
  );
} catch (err) {
  console.error(
    `Failed to get browser policies. Code is ${err.code}, message is ${err.message}`,
  );
}
```
...
try {
  ...
  console.error(
    `Failed to set managed browser policy. Code is ${err.code}, message is ${err.message}`,
  );
}
```
...
try {
  let buffer: ArrayBuffer = browser.getManagedBrowserPolicy(
    wantTemp,
    bundleName,
  );
  ...
  console.info(
    `Succeeded in getting managed browser policy, result : ${stringData}`,
  );
} catch (err) {
  console.error(
    `Failed to get managed browser policy. Code is ${err.code}, message is ${err.message}`,
  );
}
```
...
try {
  ...
  console.info(
    `Succeeded in getting self managed browser policy version, result : ${version}`,
  );
} catch (err) {
  console.error(
    `Failed to get self managed browser policy version. Code is ${err.code}, message is ${err.message}`,
  );
}
```
...
try {
  ...
  let stringData: string = decoder.decodeToString(intBuffer);
  console.info(
    `Succeeded in getting self managed browser policy, result : ${stringData}`,
  );
} catch (err) {
  console.error(
    `Failed to get self managed browser policy. Code is ${err.code}, message is ${err.message}`,
  );
}
```
