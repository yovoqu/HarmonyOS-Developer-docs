...
async function addToStatusBar(context: Context) {
  ...
  try {
    ...
    console.error(
      `addToStatusBar failed. error code: ${error.code}, error message: ${error.message}`,
    );
  }
}
```
...
function removeFromStatusBar(context: Context) {
  ...
  try {
    ...
    console.error(
      `removeFromStatusBar failed. error code: ${error.code}, error message: ${error.message}`,
    );
  }
}
```
...
function updateQuickOperationHeight(context: Context) {
  ...
  try {
    ...
    console.error(
      `updateQuickOperationHeight failed. error code: ${error.code}, error message: ${error.message}`,
    );
  }
}
```
...
function updateStatusBarMenu(context: Context) {
  ...
  try {
    ...
    console.error(
      `updateStatusBarMenu failed. error code: ${error.code}, error message: ${error.message}`,
    );
  }
}
```
...
async function updateStatusBarIcon(context: Context) {
  ...
  try {
    ...
    console.error(
      `updateStatusBarIcon failed. error code: ${error.code}, error message: ${error.message}`,
    );
  }
}
```
...
async function updateStatusBarHoverTips(context: Context) {
  ...
  try {
    ...
    console.error(
      `updateStatusBarHoverTips failed. error code: ${error.code}, error message: ${error.message}`,
    );
  }
}
```
...
async function updateStatusBarMenuItemTest(context: Context) {
  ...
  try {
    ...
    console.error(
      `updateStatusBarMenuItem failed. error code: ${e?.code}, error message: ${e?.message}`,
    );
  }
}
```
...
async function updateStatusBarSubMenuItemTest(context: Context) {
  ...
  try {
    ...
    console.error(
      `updateStatusBarSubMenuItem failed. error code: ${e?.code}, error message: ${e?.message}`,
    );
  }
}
```
