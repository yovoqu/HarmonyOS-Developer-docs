...
| --- | --- | --- | --- |
| context | common.Context | 是 | 上下文信息。 |
| combineIcon | image.PixelMap | 是 | 快捷栏图标信息，支持JPEG、PNG、GIF、WebP、BMP、SVG、ICO、DNG等图片类型。 说明： 建议使用512vp * 512vp大小的图片。 |
...
| --- | --- | --- | --- |
| context | common.Context | 是 | 上下文信息。 |
| foregroundIcon | image.PixelMap | 是 | 快捷栏前景图标信息，支持JPEG、PNG、GIF、WebP、BMP、SVG、ICO、DNG等图片类型。 说明： 建议使用512vp * 512vp大小的图片。 |
| backgroundIcon | image.PixelMap | 是 | 快捷栏背景图标信息，支持JPEG、PNG、GIF、WebP、BMP、SVG、ICO、DNG等图片类型。 说明： 建议使用512vp * 512vp大小的图片。 |
...
| --- | --- | --- | --- |
| context | common.Context | 是 | 上下文信息。 |
| state | ProgressState | 是 | 快捷栏图标上显示的进度状态。 取值范围如下： - NO_PROGRESS (0)：无进度状态。 - NORMAL (1)：正常状态。 - PAUSED (2)：暂停状态。 - ERROR (3)：错误状态。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;boolean&gt; | Promise对象，返回true表示支持快捷栏功能，返回false表示不支持。 |
