...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| portId | number | 是 | 端口号，来自getPortList返回的SerialPort对象，传入无效值时返回错误码31400003。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| portId | number | 是 | 端口号，来自getPortList返回的SerialPort对象，必须使用getPortList返回的有效端口号，传入无效值时返回错误码31400003。 |
