...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 zlib.compressFile 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃。建议使用 zlib.decompressFile 替代。 传入的压缩包内部文件或者文件夹名称不能包含“../”，否则会返回-1错误码。
