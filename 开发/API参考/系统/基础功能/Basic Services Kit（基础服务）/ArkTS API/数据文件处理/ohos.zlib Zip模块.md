...
zlib
  .zipFile(inFile, outFile, options)
  .then((data: void) => {
...
zlib
  .unzipFile(inFile, outFile, options)
  .then((data: void) => {
...
try {
  zlib.compressFile(inFile, outFile, options, (errData: BusinessError) => {
    if (errData !== null) {
      console.error(
        `compressFile errData is errCode:${errData.code}  message:${errData.message}`,
      );
    } else {
...
try {
  zlib
    ...
    .catch((errData: BusinessError) => {
      console.error(
        `errData is errCode:${errData.code}  message:${errData.message}`,
      );
    });
} catch (errData) {
  let code = (errData as BusinessError).code;
...
try {
  zlib.decompressFile(inFile, outFileDir, options, (errData: BusinessError) => {
    if (errData !== null) {
      console.error(
        `decompressFile errData is errCode:${errData.code}  message:${errData.message}`,
      );
    } else {
  ...
  let message = (errData as BusinessError).message;
  console.error(
    `decompressFile errData is errCode:${code}  message:${message}`,
  );
}
```
...
try {
  zlib
    .decompressFile(inFile, outFileDir, options)
    .then((data: void) => {
...
try {
  zlib
    .getOriginalSize(compressedFile)
    .then((data: number) => {
...
try {
  zlib
    .compressFiles([inFile, pathDir], outFile, options)
    .then((data: void) => {
...
async function demo() {
  ...
  await checksum
    .adler32Combine(adler1, adler2, 12)
    .then((data) => {
...
const arrayBufferIn = u8.buffer.slice(
  u8.byteOffset,
...
zip
  .compress(arrayBufferOut, arrayBufferIn, 20)
  .then((data) => {
...
zip
  .compress2(
    arrayBufferOut,
    arrayBufferIn,
    zlib.CompressLevel.COMPRESS_LEVEL_BEST_SPEED,
  )
  .then((data) => {
...
async function demo() {
  ...
  let zip = zlib.createZipSync();
  await zip
    .compress(arrayBufferOut, arrayBufferIn, 12)
    .then((data) => {
      console.info('compress success');
    })
    .catch((errData: BusinessError) => {
  ...
  await zip
    .uncompress(arrayBufferIn, arrayBufferOut, 20)
    .then((data) => {
...
async function demo() {
  ...
  await zip
    .uncompress2(arrayBufferIn, arrayBufferOut, 20)
    .then((data) => {
...
async function demo() {
  ...
  await zip
    .inflateValidate({ availableIn: 1 }, 1)
    .then((data) => {
...
async function demo() {
  ...
  await zip
    .inflateSyncPoint({ availableIn: 1 })
    .then((data) => {
...
async function demo() {
  ...
  let zip = zlib.createZipSync();
  await zip
    .deflateInit({}, zlib.CompressLevel.COMPRESS_LEVEL_DEFAULT_COMPRESSION)
    .then((data) => {
  ...
  await zip
    .deflate(
      ...
      zlib.CompressFlushMode.FULL_FLUSH,
    )
    .then((data) => {
  ...
  await zip
    .deflate({ availableIn: 11 }, zlib.CompressFlushMode.FINISH)
    .then((data) => {
      console.info('deflate success');
    })
    .catch((errData: BusinessError) => {
  ...
  try {
    await zip
      .inflateInit({ nextIn: arrayBufferOut, availableIn: 2 })
      .then((data) => {
  ...
  await zip
    .inflate(
      ...
      zlib.CompressFlushMode.NO_FLUSH,
    )
    .then((data) => {
  ...
  await zip
    .inflateEnd({ nextOut: arrayBufferOut })
    .then((data) => {
...
async function demo() {
  ...
  await zip
    .inflateResetKeep({ availableIn: 1 })
    .then((data) => {
...
async function demo() {
  ...
  await zip
    .deflateInit({}, zlib.CompressLevel.COMPRESS_LEVEL_BEST_COMPRESSION)
    .then((data) => {
      console.info('deflateInit success');
    })
    .catch((errData: BusinessError) => {
  ...
  await zip
    .deflateSetDictionary({}, dictionarybuf)
    .then((data) => {
  ...
  try {
    await zip
      .inflateInit({ nextIn: arrayBufferOut, availableIn: 100 })
      .then((data) => {
        console.info('inflateInit success');
      });
  } catch (errData) {
  ...
  await zip
    .inflateSetDictionary({}, dictionarybuf)
    .then((data) => {
...
async function demo() {
  ...
  await zip
    .inflateReset2({ availableOut: 8 }, 15)
    .then((data) => {
...
async function demo() {
  ...
  await zip
    .inflateReset({ availableIn: 1, availableOut: 8 })
    .then((data) => {
...
async function demo() {
  ...
  await zip
    .inflatePrime({ nextOut: arrayBufferOut }, 5, 2)
    .then((data) => {
...
async function demo() {
  ...
  await zip
    .inflateGetDictionary({ nextOut: arrayBufferOut }, arrayBufferOut)
    .then((data) => {
...
async function demo() {
  ...
  await zip
    .inflate({ availableIn: 8, availableOut: 8 }, 0)
    .then((data) => {
      console.info('inflate success');
    })
    .catch((errData: BusinessError) => {
...
async function demo() {
  let readIn: (inDesc: object) => ArrayBuffer = (
    inDesc: object,
  ): ArrayBuffer => {
    ...
    array.set([
      31, 139, 8, 0, 0, 0, 0, 0, 0, 10, 243, 72, 205, 201, 201, 231, 2, 0, 22,
      53, 150, 49, 6, 0, 0, 0,
    ]);
    return buffer;
  };
    ...
    try {
      ...
      for (;;) {
        ...
        if (last != 31 || NEXT2() != 139) {
          ret = first ? -3 : -1;
          console.info(
            'inflateBackTest Call result last != 31 || (NEXT2() != 139 && last != 157)',
          );
          break;
        }
        first = 0;
        ...
        await sr
          .inflateBack(zStream, readIn, { fileName: 'test.gz' }, writeOut, {
            fileName: 'test.gz',
          })
          .then((result) => {
            ret = result;
...
async function demo() {
  ...
  let zip = zlib.createZipSync();
  await zip
    .deflateInit(zStream, zlib.CompressLevel.COMPRESS_LEVEL_BEST_SPEED)
    .then((data) => {
      console.info('deflateInit success');
    })
    .catch((errData: BusinessError) => {
  ...
  await zip
    .deflate({ availableOut: 8 }, zlib.CompressFlushMode.FINISH)
    .then((data) => {
      console.info('deflate success');
    })
    .catch((errData: BusinessError) => {
  ...
  await zip
    .deflateEnd({ nextOut: arrayBufferOut })
    .then((data) => {
      console.info('deflateEnd success');
    })
    .catch((errData: BusinessError) => {
...
async function demo() {
  ...
  await zip
    .deflateBound({ nextOut: arrayBufferOut }, 12)
    .then((data) => {
...
async function demo() {
  ...
  await zip
    .deflateSetDictionary({ nextOut: arrayBufferOut }, arrayBufferOut)
    .then((data) => {
      console.info('deflateSetDictionary success');
    })
    .catch((errData: BusinessError) => {
...
async function demo() {
  ...
  await zip
    .deflateGetDictionary({ nextOut: arrayBufferOut }, arrayBufferOut)
    .then((data) => {
...
async function demo() {
  ...
  await zip
    .deflateTune({ nextOut: arrayBufferOut }, 2, 2, 2, 2)
    .then((data) => {
...
async function demo() {
  ...
  await zip
    .deflateReset({ nextOut: arrayBufferOut })
    .then((data) => {
...
async function demo() {
  ...
  await zip
    .deflateResetKeep({ nextOut: arrayBufferOut })
    .then((data) => {
...
async function demo() {
  ...
  await zip
    .deflatePending({ nextOut: arrayBufferOut })
    .then((data) => {
...
async function demo() {
  ...
  await zip
    .deflatePrime({ nextOut: arrayBufferOut }, 5, 2)
    .then((data) => {
