...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-input-input-customcursor
...
| 名称 | 描述 |
| --- | --- |
| OH_Input_CustomCursor_Create | 创建自定义鼠标光标资源对象。通过调用OH_Input_CustomCursor_Destroy销毁自定义鼠标光标资源对象。 |
