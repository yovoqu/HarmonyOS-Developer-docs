...
| uint8_t [frameIdx](#frameidx) | 当前帧序号，序号计数从0开始。该值必须小于[FG_ContextDescription_VK](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/_f_g___context_description___v_k)中的framesInFlight。 |
