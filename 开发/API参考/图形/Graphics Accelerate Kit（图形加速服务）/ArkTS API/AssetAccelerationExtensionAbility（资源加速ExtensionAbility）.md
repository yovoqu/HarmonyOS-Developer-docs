...
export default class AssetAccelExtAbility extends AssetAccelerationExtensionAbility {
  async onDownloadContentRequest(
    ...
    console.info(
      'AssetAccelDemo',
      `application file directory = ${context.filesDir}`,
    );
    console.info(
      'AssetAccelDemo',
      `onDownloadContentRequest enter, requestType: ${requestType}, manifestUrl: ${manifestUrl}.`,
    );
...
// 此处以AssetAccelExtAbility继承AssetAccelerationExtensionAbility为例
export default class AssetAccelExtAbility extends AssetAccelerationExtensionAbility {
  async onDownloadWithAppControl(
    requestType: ContentRequestType,
    manifestUrl: string,
    assetAccelerationExtensionInfo: AssetAccelerationExtensionInfo,
  ): Promise<boolean> {
    ...
    console.info(
      'AssetAccelDemo',
      `onDownloadWithAppControl enter, requestType: ${requestType}, manifestUrl: ${manifestUrl}.`,
    );
...
export default class AssetAccelExtAbility extends AssetAccelerationExtensionAbility {
  // 接收后台资源包下载成功消息的接口。
  async onBackgroundDownloadSucceeded(
    downloadTask: assetDownloadManager.AssetDownloadTask,
    filePath: string,
  ): Promise<void> {
    console.info(
      'AssetAccelDemo',
      `onBackgroundDownloadSucceeded enter, taskId is ${downloadTask.taskId}, filePath = ${filePath}`,
    );
    // 添加文件转移处理逻辑。
  }
}
...
export default class AssetAccelExtAbility extends AssetAccelerationExtensionAbility {
  // 接收后台资源包下载失败消息的接口。
  async onBackgroundDownloadFailed(
    downloadTask: assetDownloadManager.AssetDownloadTask,
    fault: assetDownloadManager.DownloadFault,
  ): Promise<void> {
    console.info(
      'AssetAccelDemo',
      `onBackgroundDownloadFailed enter, download url: ${downloadTask.config.url}, err: ${fault}`,
    );
    // 添加下载异常处理逻辑
  }
}
...
export default class AssetAccelExtAbility extends AssetAccelerationExtensionAbility {
  ...
  async onExtensionWillTerminate(error?: BusinessError<void>): Promise<void> {
    ...
    if (!error) {
      console.info(
        'AssetAccelDemo',
        `onExtensionWillTerminate enter, BusinessError is null;`,
      );
      return;
    }
    console.error(
      'AssetAccelDemo',
      `onExtensionWillTerminate enter, BusinessError: ${error?.code}, msg: ${error?.message}`,
    );
  }
}
```
