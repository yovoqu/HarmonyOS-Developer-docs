...
| OH_Drawing_Canvas* canvas | 指向画布对象的指针。 |
| const OH_Drawing_Rect* rect | 指向矩形对象的指针。 |
| OH_Drawing_CanvasClipOp clipOp | 裁剪方式。支持可选的具体裁剪方式可见OH_Drawing_CanvasClipOp枚举。 |
...
| OH_Drawing_CanvasClipOp clipOp | 表示裁剪类型。支持可选的具体裁剪方式可见OH_Drawing_CanvasClipOp枚举。 |
