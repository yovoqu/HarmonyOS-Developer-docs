...
let shader = drawing.ShaderEffect.createComposeShader(
  dstShader,
  srcShader,
...
class DrawingRenderNode extends RenderNode {
  draw(context: DrawContext) {
    ...
    if (pixelMap != null) {
      let imageShader = drawing.ShaderEffect.createImageShader(
        pixelMap,
...
![](assets/Class%20ShaderEffect/file-20260514165006366-0.png)
...
![](assets/Class%20ShaderEffect/file-20260514165006366-1.png)
...
![](assets/Class%20ShaderEffect/file-20260514165006366-2.png)
...
![](assets/Class%20ShaderEffect/file-20260514165006366-3.png)
