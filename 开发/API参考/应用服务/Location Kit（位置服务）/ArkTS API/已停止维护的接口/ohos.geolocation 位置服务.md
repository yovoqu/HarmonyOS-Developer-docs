...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-geolocation
**支持设备：** Phone | PC/2in1 | Tablet | Wearable | TV

位置服务提供GNSS定位、网络定位、地理编码、逆地理编码、国家码和地理围栏等基本功能。

> [!NOTE]
> 本模块首批接口从API version 7开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。 从API Version 9开始，该接口不再维护，推荐使用新接口 geoLocationManager 。 本模块能力仅支持WGS-84坐标系。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃，建议使用 geoLocationManager.on('locationChange') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃，建议使用 geoLocationManager.off('locationChange') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃，建议使用 geoLocationManager.on('locationEnabledChange') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃，建议使用 geoLocationManager.off('locationEnabledChange') 替代。
...
> [!NOTE]
> 从API version 8开始支持。 从API version 9开始废弃，建议使用 geoLocationManager.on('cachedGnssLocationsChange') 替代。
...
> [!NOTE]
> 从API version 8开始支持。 从API version 9开始废弃，建议使用 geoLocationManager.off('cachedGnssLocationsChange') 替代。
...
> [!NOTE]
> 从API version 8开始支持。 从API version 9开始废弃，建议使用 geoLocationManager.on('satelliteStatusChange') 替代。
...
> [!NOTE]
> 从API version 8开始支持。 从API version 9开始废弃，建议使用 geoLocationManager.off('satelliteStatusChange') 替代。
...
> [!NOTE]
> 从API version 8开始支持。 从API version 9开始废弃，建议使用 geoLocationManager.on('nmeaMessage') 替代。
...
> [!NOTE]
> 从API version 8开始支持。 从API version 9开始废弃，建议使用 geoLocationManager.off('nmeaMessage') 替代。
...
> [!NOTE]
> 从API version 8开始支持。 从API version 9开始废弃，建议使用 geoLocationManager.on('gnssFenceStatusChange') 替代。
...
> [!NOTE]
> 从API version 8开始支持。 从API version 9开始废弃，建议使用 geoLocationManager.off('gnssFenceStatusChange') 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃，建议使用 geoLocationManager.getCurrentLocation 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃，建议使用 geoLocationManager.getLastLocation 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃，建议使用 geoLocationManager.isLocationEnabled 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃，建议使用 geoLocationManager.isGeocoderAvailable 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃，建议使用 geoLocationManager.getAddressesFromLocation 替代。
...
> [!NOTE]
> 从API version 7开始支持，从API version 9开始废弃，建议使用 geoLocationManager.getAddressesFromLocationName 替代。
...
> [!NOTE]
> 从API version 8开始支持。 从API version 9开始废弃，建议使用 geoLocationManager.getCachedGnssLocationsSize 替代。
...
> [!NOTE]
> 从API version 8开始支持。 从API version 9开始废弃，建议使用 geoLocationManager.flushCachedGnssLocations 替代。
...
> [!NOTE]
> 从API version 8开始支持。 从API version 9开始废弃，建议使用 geoLocationManager.sendCommand 替代。
...
> [!NOTE]
> 从API version 9开始废弃，建议使用 geoLocationManager.ReverseGeoCodeRequest 替代。
...
> [!NOTE]
> 从API version 9开始废弃，建议使用 geoLocationManager.GeoCodeRequest 替代。
...
> [!NOTE]
> 从API version 9开始废弃，建议使用 geoLocationManager.GeoAddress 替代。
...
> [!NOTE]
> 从API version 9开始废弃，建议使用 geoLocationManager.LocationRequest 替代。
...
> [!NOTE]
> 从API version 9开始废弃，建议使用 geoLocationManager.CurrentLocationRequest 替代。
...
> [!NOTE]
> 从API version 8开始支持。 从API version 9开始废弃，建议使用 geoLocationManager.SatelliteStatusInfo 替代。
...
> [!NOTE]
> 从API version 8开始支持。 从API version 9开始废弃，建议使用 geoLocationManager.CachedGnssLocationsRequest 替代。
...
> [!NOTE]
> 从API version 8开始支持。 从API version 9开始废弃，建议使用 geoLocationManager.Geofence 替代。
...
> [!NOTE]
> 从API version 8开始支持。 从API version 9开始废弃，建议使用 geoLocationManager.GeofenceRequest 替代。
...
> [!NOTE]
> 从API version 8开始支持。 从API version 9开始废弃，建议使用 geoLocationManager.LocationCommand 替代。
...
> [!NOTE]
> 从API version 9开始废弃，建议使用 geoLocationManager.Location 替代。
...
> [!NOTE]
> 从API version 8开始支持。 从API version 9开始废弃，替代接口geoLocationManager.LocationPrivacyType仅供系统应用使用。
...
> [!NOTE]
> 从API version 9开始废弃，建议使用 geoLocationManager.LocationRequestPriority 替代。
...
> [!NOTE]
> 从API version 9开始废弃，建议使用 geoLocationManager.LocationRequestScenario 替代。
...
> [!NOTE]
> 从API version 9开始废弃，建议使用 位置服务错误码 替代。
