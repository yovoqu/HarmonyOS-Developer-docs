...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-system-location
**支持设备：** Wearable | lite_wearable

本模块仅提供GNSS定位、网络定位等基本功能。
 
> [!NOTE]
> 本模块首批接口从API version 3开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。 对于Lite Wearable设备类型，该模块长期维护，正常使用。 对于支持该模块的其他设备类型，该模块从API Version 9开始，该接口不再维护，推荐使用新接口 geoLocationManager 。
...
> [!NOTE]
> 除Lite Wearable外，从API version 9开始废弃，建议使用 geoLocationManager.getCurrentLocation 替代。
...
> [!NOTE]
> 除Lite Wearable外，从API version 9开始废弃，建议使用 geoLocationManager.on('locationChange') 替代。
...
> [!NOTE]
> 除Lite Wearable外，从API version 9开始废弃，建议使用 geoLocationManager.off('locationChange') 替代。
...
> [!NOTE]
> 除Lite Wearable外，从API version 9开始废弃，建议使用 geoLocationManager.CurrentLocationRequest 替代。
...
> [!NOTE]
> 除Lite Wearable外，从API version 9开始废弃，建议使用 geoLocationManager.Location 替代。
