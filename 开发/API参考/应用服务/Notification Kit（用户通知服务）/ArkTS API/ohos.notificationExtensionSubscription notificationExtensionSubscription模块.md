...
try {
  ...
  notificationExtensionSubscription
    .openSubscriptionSettings(context)
    .then(() => {
    ...
    .catch((e: Error) => {
      ...
      console.error(
        `failed to call openSubscriptionSettings ${JSON.stringify(error)}`,
      );
    });
} catch (error) {
  console.error(
...
notificationExtensionSubscription
  ...
  .then(
    (
      ...
      console.info(
        `getSubscribeInfo successfully. Data: ${JSON.stringify(data)}`,
      );
    },
  )
  .catch((err: BusinessError) => {
...
notificationExtensionSubscription
  ...
  .then((data: notificationExtensionSubscription.GrantedBundleInfo[]) => {
    console.info(
      `getUserGrantedEnabledBundles successfully. Data: ${JSON.stringify(data)}`,
    );
  })
  .catch((err: BusinessError) => {
