...
| teamPlayerId | 是 | String | HarmonyOS 5.0及以上游戏的玩家标识，通过调用unionLogin接口返回， 最大长度256个字符。 |
...
![](assets/解绑账号/file-20260514165124476-0.png)
...
> [!NOTE]
> 游戏私钥获取请参见 获取游戏密钥 。 签名字符串需要进行urlencode后再拼接到请求中。
