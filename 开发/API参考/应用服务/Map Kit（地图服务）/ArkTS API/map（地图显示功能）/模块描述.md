...
- [newLatLng](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-functions#newlatlng)：设置地图的中心点和缩放层级。
...
- [scrollBy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-functions#scrollby)：按像素移动地图中心点。
...
- [zoomIn](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-functions#zoomin)：放大地图缩放级别，在当前地图显示的级别基础上加1。
- [zoomOut](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-functions#zoomout)：缩小地图缩放级别，在当前地图显示的级别基础上减1。
- [zoomTo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-functions#zoomto)：设置地图缩放级别。

 
常用工具函数：
 
- [calculateDistance](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-functions#calculatedistance)：计算坐标点之间的距离。
- [convertCoordinate](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-functions#convertcoordinate)：坐标系转换，使用Promise异步回调。
- [convertCoordinateSync](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-functions#convertcoordinatesync)：坐标系转换。
- [rectifyCoordinate](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-map-functions#rectifycoordinate)：根据用户输入的坐标系和坐标以及获取当前的路由地，判断是否需要修正坐标。
