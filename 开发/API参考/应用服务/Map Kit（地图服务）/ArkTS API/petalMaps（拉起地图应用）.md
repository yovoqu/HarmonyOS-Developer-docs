...
| coordinateType | [mapCommon.CoordinateType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#coordinatetype) | 否 | 是 | 地图坐标系类型。默认值mapCommon.CoordinateType.GCJ02，异常值按照默认值处理。 起始版本： 6.0.1(21) |
...
| vehicleType | [VehicleType](#vehicletype) | 否 | 是 | 出行方式。 默认值为VehicleType.DRIVING，异常值按默认值处理。 |
| coordinateType | [mapCommon.CoordinateType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/map-common#coordinatetype) | 否 | 是 | 地图坐标系类型。默认值mapCommon.CoordinateType.GCJ02，异常值按照默认值处理。 起始版本： 6.0.1(21) |
