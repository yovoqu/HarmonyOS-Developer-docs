...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/64/v3/HPlqGM_bSty5EqEveCg4XA/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T085119Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=EDD7721148D3A29B6D5F394119CB4BE0711D9DBF1ACCBB151C469331C1B42864)
...
async function deleteFile() {
  ...
  try {
    ...
    console.error(
      'delete failed, errCode:' + error.code + ', errMessage:' + error.message,
    );
  }
}
```
