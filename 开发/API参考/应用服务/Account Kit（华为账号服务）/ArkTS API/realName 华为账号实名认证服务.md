...
| state | string | 否 | 是 | 请求体中的state参数，开发者可自定义，字符包含0-9、a-z、A-Z、英文点号、英文冒号、斜杠、下划线等，长度限制1-255，校验规则^[0-9a-zA-Z:/\.\-_]{1,255}\$。该参数与响应体中返回的state比较，校验是否是当前请求，可防止跨站攻击。 默认值：undefined。 推荐开发者用随机数并做一致性校验。建议生成方式：[util.generateRandomUUID()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-util#utilgeneraterandomuuid9)。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| NETWORK_ERROR | [1002500001](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1002500001-网络不可用) | 网络不可用。 |
| ACCOUNT_NOT_LOGGED_IN | [1002500002](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1002500002-账号未登录) | 用户未登录华为账号。 |
| PACKAGE_FINGERPRINT_CHECK_ERROR | [1002500003](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1002500003-应用指纹证书校验失败) | 应用指纹证书校验失败。 |
| PERMISSION_CHECK_ERROR | [1002500004](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1002500004-应用未申请对应permissions权限) | 应用程序未申请对应permissions权限。 |
| USER_CANCELED | [1002500005](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1002500005-用户取消验证) | 用户取消验证。 |
| INTERNAL_ERROR | [1002500006](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1002500006-内部错误) | 内部错误。 |
| REAL_NAME_UNSUPPORTED | [1002500008](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1002500008-该华为账号不支持实名验证) | 该华为账号不支持实名验证。 |
| REAL_NAME_VERIFICATION_ERROR | [1002500009](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1002500009-实名渠道验证失败) | 实名渠道验证错误。 |
| FACE_NOT_MATCH | [1002500011](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1002500011-您的面部与作为身份证明的面部图像不匹配) | 您的面部与作为身份证明的面部图像不匹配。 |
| REAL_NAME_NOT_EXIST | [1002500012](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1002500012-未查询到实名信息) | 未查询到该华为账号的实名信息。 |
| NAME_AND_ID_NUMBER_NOT_MATCH | [1002500013](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1002500013-姓名和身份证号码不匹配) | 姓名和身份证号码不匹配。 |
| TOO_MANY_ATTEMPTS | [1002500014](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1002500014-实名验证尝试次数过多) | 实名验证尝试次数过多。24小时后重试。 |
| VERIFICATION_TOKEN_INCORRECT | [1002500015](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1002500015-参数verificationtoken不合法) | 参数verificationToken不合法。 |
| DEVICE_NOT_SUPPORTED | [1002500016](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-error-code#section1002500016-此设备不支持此api) | 此设备不支持此API。 |
...
hilog.info(
  0x0000,
  'testTag',
  `verifyFacialRecognitionWithPromise params ${request}`,
);
