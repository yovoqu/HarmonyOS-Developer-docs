...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-verify-realname

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b5/v3/DGHly3vIRHG_858XJFUjBg/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260528T025116Z&HW-CC-Expire=86400&HW-CC-Sign=5447A92E203B70F4AADD8C83951ABE29BD4667A1DAA846DD312F50F6F20F3AA6)
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| access_token | 是 | String | 通过获取用户级凭证获取的Access Token。 说明： 本场景下Access Token只能使用一次，再次使用会报“access forbidden”错误。 |
