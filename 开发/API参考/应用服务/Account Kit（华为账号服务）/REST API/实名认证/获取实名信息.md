...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-get-realname

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/-DarH77fSLSYLFujdImOEA/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260730T071727Z&HW-CC-Expire=86400&HW-CC-Sign=0B45451579516103394B7D7DC5EB801F17D54F000F527FA8C5957DC3DC080516)
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| access_token | 是 | String | 通过获取用户级凭证获取的Access Token。 |
| queryRangeFlag | 是 | String | 实名信息查询范围标志： 固定传值："0001"。 |
| serviceAccountClientID | 是 | String | 服务账号。 登录华为开发者联盟API Console，在“凭证”菜单中，选择创建服务账号密钥时会生成密钥文件，打开密钥文件中有sub_account 信息，该参数为密钥文件中的sub_account 的值。 |
