...
![图片](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/tR9XM8sHR1-vuPkdyeeJFw/caution_3.0-zh-cn.png?HW-CC-KV=V1&amp;HW-CC-Date=20260514T085106Z&amp;HW-CC-Expire=86400&amp;HW-CC-Sign=0166F53E4F6D9E3578822829FE411E328D6EBFBAF6961F8C98124074BA8E7BED)
...
- **承载协议**：HTTPS POST
- **接口方向**：开发者服务器->华为账号服务器
- **接口URL**：https://account-api.cloud.huawei.com/openrealname/v6/realname-info/get
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| clientId | 是 | String | 在创建应用后，由AppGallery Connect（简称AGC）为应用分配的唯一标识。参数取值详见[查看应用基本信息](https://developer.huawei.com/consumer/cn/doc/app/agc-help-appinfo-0000001100014694)中的OAuth 2.0客户端ID(凭据)-Client ID参数。          说明：          该参数与获取Access Token时的Client ID必须一致，否则会报错（resultCode=61110003）。 |
...
public class GetDetailInfoDemo {
  public static void main(String[] args) throws IOException {
    ...
    // 获取实名信息的接口URL
    String url = "https://account-api.cloud.huawei.com/openrealname/v6/realname-info/get";
