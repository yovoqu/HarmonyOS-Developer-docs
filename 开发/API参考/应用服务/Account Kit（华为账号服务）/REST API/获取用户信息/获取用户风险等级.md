...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-getuserrisklevel

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c1/v3/I6BGkNT7Q_yiZOOtgwk3XQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260528T023743Z&HW-CC-Expire=86400&HW-CC-Sign=1DDCC8DD5F975421CDC43965DCFD7BAED1025AABC22E41F17AA64D0B7EFD1C16)
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| accessToken | 是 | String | 通过获取用户级凭证获取的Access Token。获取凭证时Authorization Code需包含riskLevel scope的授权。 |
