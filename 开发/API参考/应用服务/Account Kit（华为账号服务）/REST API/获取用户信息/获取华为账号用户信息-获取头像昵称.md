...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-get-user-info-get-nickname-and-avatar

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fa/v3/Q4P0eYdCSI-b39kEE62OfQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260624T020332Z&HW-CC-Expire=86400&HW-CC-Sign=57D2897F967EA3AF6D661E904001B5CC8B79CC62BA7CD6B2F31ADFA4DFE139B6)
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| access_token | 是 | String | 通过获取用户级凭证获取的Access Token。获取凭证时Authorization Code需包含profile scope的授权。 |
...
| headPictureURL | 否 | String | 用户头像，该字段返回场景详见获取头像昵称。用户未设置头像时不返回。 说明： 当用户更新头像后，原头像链接会立即失效。为确保头像正常显示，建议先将头像下载保存后再使用，避免因用户头像链接失效而影响业务流程。 |
