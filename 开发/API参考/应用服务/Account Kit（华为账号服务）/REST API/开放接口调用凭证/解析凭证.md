...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fb/v3/V2IFATUCROOkcU4ER_qemQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260528T013442Z&HW-CC-Expire=86400&HW-CC-Sign=F6F629D773BBB3081D3A3F669D2C8C3FE59B9428EEEFBF65892A05FF7F0A01D8)
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| access_token | 是 | String | 通过获取用户级凭证/刷新用户级凭证/获取应用级凭证获取到的access_token值。 |
...
| type | 是 | Integer | 凭证类型。 0：通过获取用户级凭证获取的Access Token。 1：通过获取应用级凭证获取的Access Token。 |
