...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/account-api-get-token-info

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f1/v3/j6njBQRyS4W4iJlEE8uBvQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260730T071726Z&HW-CC-Expire=86400&HW-CC-Sign=6340C88B47AE1BC106E8B78BDEF6C2E006524C3CA3D64B9D7B331196899EEFE1)
...
| 参数 | 是否必选 | 参数类型 | 描述 |
| --- | --- | --- | --- |
| access_token | 是 | String | 通过如下场景获取到的access_token值。 - 获取用户级凭证 - 刷新用户级凭证 - 获取应用级凭证 - 扫码授权登录-获取用户级凭证 |
...
| type | 是 | Integer | 凭证类型。 0：通过获取用户级凭证、刷新用户级凭证、扫码授权登录-获取用户级凭证获取到的Access Token。 1：通过获取应用级凭证获取的Access Token。 |
