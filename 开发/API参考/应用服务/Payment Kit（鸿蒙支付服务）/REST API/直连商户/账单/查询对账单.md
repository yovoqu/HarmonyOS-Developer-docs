...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-query-trade-bill
...
> [!NOTE]
> 无论是否产生交易，每日自动生成账单。如果查询日期超限或未生成，则不返回文件下载信息。其他情况会返回。 账单下载后，建议遍历附件目录以获取“.csv”后缀的文件进行解析。 解析表单内容时，需考虑表单更新，如新增列等场景。
