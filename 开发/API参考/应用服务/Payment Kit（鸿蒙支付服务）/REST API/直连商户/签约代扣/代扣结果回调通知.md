...
| promotionDetail | 否 | List&lt;[PromotionItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-model#promotionitem)&gt; | 营销活动信息。 说明： 当用户支付时参与过营销活动，此字段才会返回。 |
