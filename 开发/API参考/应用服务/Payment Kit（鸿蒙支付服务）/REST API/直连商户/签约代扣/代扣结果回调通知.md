...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-withhold-notify
...
> [!NOTE]
> 为保证回调请求的可靠性，系统具备重试机制，所以可能出现重发的通知。 订单状态需根据orderStatus字段判断。
...
| promotionDetail | 否 | List&lt;PromotionItem&gt; | 营销活动信息。 说明： 当用户支付时参与过营销活动，此字段才会返回。 |
