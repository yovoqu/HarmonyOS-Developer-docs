...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-api-common-promotion-service-merc-coup-coupbatch-upbudge
...
> [!NOTE]
> 以下几种情况会报错： currentMaxCoupons大于等于targetMaxCoupons。 currentMaxCoupons、targetMaxCoupons、currentMaxCouponsByDay、targetMaxCouponsByDay都不存在。 currentMaxCoupons、targetMaxCoupons一个为空，一个有值。 currentMaxCouponsByDay、targetMaxCouponsByDay一个为空，一个有值。
