...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ommon-promotion-service-merc-coup-ucoup-distribute
...
| coupons | 是 | List&lt;[SendCouponInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-model#sendcouponinfo)&gt; | 待发券的批次信息和券码。列表最小长度为1，最大长度为10。 |
...
| succResults | 否 | List&lt;[BatchCoupons](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-model#batchcoupons)&gt; | 成功发券的结果信息。 |
| failResults | 否 | List&lt;[FailResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/payment-model#failresult)&gt; | 失败发券的结果信息。 |
