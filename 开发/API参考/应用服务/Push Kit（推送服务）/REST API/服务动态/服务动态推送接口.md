...
| sceneId | 是 | String | 场景标识，详细参见服务动态发送场景说明。长度范围[1, 32]。 |
| subSceneId | 是 | String | 子场景标识，详细参见服务动态发送场景说明。长度范围[1, 32]。 |
...
| content | 是 | TimelineStatusContent Object | 服务动态指定状态参数。 若您是外卖自取场景，请参考外卖自取结构体说明。 若您是外卖配送场景，请参考外卖配送结构体说明。 |
