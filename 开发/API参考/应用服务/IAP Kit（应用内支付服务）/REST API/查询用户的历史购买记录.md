...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-order-info-query-by-order-history
...
| jwsPurchaseOrderList | 否 | List&lt;String&gt; | 已购订单相关状态信息的JWS格式数据的数组。 可参见[返回结果验签](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-verifying-signature)处理，验签通过后解码获取相关订单状态信息，具体请参见[PurchaseOrderPayload](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-server-data-model#purchaseorderpayload)说明。 |
