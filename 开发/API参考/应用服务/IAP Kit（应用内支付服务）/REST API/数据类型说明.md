...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-server-data-model
...
| applicationUserName | 否 | String | 用户账户相关联的混淆字符串，唯一标识用户，传递优惠ID场景，可以传递该字段，若传递了本字段则需在PurchaseParameter请求参数中传递一个相同的applicationUserName。 |
