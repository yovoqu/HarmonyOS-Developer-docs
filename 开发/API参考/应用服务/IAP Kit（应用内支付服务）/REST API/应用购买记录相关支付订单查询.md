...
来源：https://developer.huawei.com/consumer/cn/doc/harmonyos-references/iap-order-query
...
> [!NOTE]
> 由于当天的订单信息可能还会发生变动，因此不建议使用此接口查询当天的实时订单数据，建议延迟一天查询。 当前仅支持查询180天内的订单数据。 当前不支持查询沙盒订单和0元订单。
