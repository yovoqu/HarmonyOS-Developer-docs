...
**流水线场景**
1. 修改工程目录下的AppScope/app.json5文件，添加HWASan配置开关。"hwasanEnabled": true
2. 在hvigorw命令后加上**-p ****ohos-enable-hwasan=true**的选项，执行hvigorw命令，更多options参考[hvigorw文档](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-hvigor-commandline)。hvigorw [taskNames...] -p ohos-enable-hwasan=true  &lt;options&gt;

#### 方式二 配置文件方式使能
**DevEco Studio场景**
1. 修改工程目录下的AppScope/app.json5文件，添加HWASan配置开关。"hwasanEnabled": true
2. 在需要使能HWASan的模块中，通过添加构建参数开启HWASan检测插桩，在对应模块的模块级build-profile.json5中添加命令参数。"arguments": "-DOHOS_ENABLE_HWASAN=ON"
**流水线场景**
...
![](assets/使用HWASan检测内存错误/file-20260525085706144-002.png)
**优化建议**
...
![](assets/使用HWASan检测内存错误/file-20260525085706145-003.png)
**修改方法**
注意数组长度，不能越界
...
![](assets/使用HWASan检测内存错误/file-20260525085706145-004.png)
**修改方法**
