...
**【使用建议】**
- 应用确认调用的接口类型及设置的回调函数。
- 当前系统有两种设置回调的接口，分别设置两种回调函数：通过 OH_AudioStreamBuilder_SetRendererCallback 设置 OH_AudioRenderer_OnWriteData （不支持返回值）通过 OH_AudioStreamBuilder_SetRendererWriteDataCallback 设置 OH_AudioRenderer_OnWriteDataCallback（支持返回值）
...
A3：根据情况排查。
- 若使用OH_AudioStreamBuilder_SetRendererCallback回调：需要应用阻塞直到数据准备充足，确保buffer写满
- 若使用OH_AudioStreamBuilder_SetRendererWriteDataCallback，可以选择两种方案：数据不足时，返回AUDIO_DATA_CALLBACK_RESULT_INVALID，框架会在短时间内再次请求数据若需要写数据，确保buffer写满
...
![](assets/易错API的使用规范/file-20260525085713435-002.png)
字节不匹配，写入失败

![](assets/易错API的使用规范/file-20260525085713436-003.png)
7、onRemoteRequest函数报错，返回错误码4
**【问题描述】**
客户端发送信息给服务端，服务端处理时出现错误，错误日志为：OnJsRemoteRequest failed, ret:4, time:xxxxx。

![](assets/易错API的使用规范/file-20260525085713436-004.png)
**【使用错误影响】**
...
![](assets/易错API的使用规范/file-20260525085713436-005.png)
sendMessageRequest(code: number, data: MessageSequence, reply: MessageSequence, options: MessageOption, callback: AsyncCallback&lt;RequestResult&gt;): void
在使用此方法时，必须在AsyncCallback回调中获取业务数据后才能释放。

![](assets/易错API的使用规范/file-20260525085713436-006.png)
...
![](assets/易错API的使用规范/file-20260525085713436-007.png)
**【使用错误影响】**
...
![](assets/易错API的使用规范/file-20260525085713436-008.png)
**【使用错误影响】**
...
![](assets/易错API的使用规范/file-20260525085713436-009.png)
![](assets/易错API的使用规范/file-20260525085713436-010.png)
![](assets/易错API的使用规范/file-20260525085713436-011.png)
**【使用建议】**
...
![](assets/易错API的使用规范/file-20260525085713437-015.png)
【案例分析】
...
![](assets/易错API的使用规范/file-20260525085713437-016.png)
**【最佳实践】**
...
![](assets/易错API的使用规范/file-20260525085713437-017.png)
...
![](assets/易错API的使用规范/file-20260525085713438-018.png)
...
![](assets/易错API的使用规范/file-20260525085713438-019.png)
**【最佳实践】**
打开多线程检测开关后，hilog会打印注册失败的backtrace。

![](assets/易错API的使用规范/file-20260525085713438-020.png)
...
![](assets/易错API的使用规范/file-20260525085713438-021.png)
...
![](assets/易错API的使用规范/file-20260525085713438-022.png)
**原因分析：**
...
![](assets/易错API的使用规范/file-20260525085713438-023.png)
...
![](assets/易错API的使用规范/file-20260525085713438-024.png)
...
![](assets/易错API的使用规范/file-20260525085713438-025.png)
...
![](assets/易错API的使用规范/file-20260525085713438-026.png)
