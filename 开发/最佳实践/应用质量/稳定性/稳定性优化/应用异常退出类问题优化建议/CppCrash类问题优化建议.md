...
![](assets/CppCrash类问题优化建议/file-20260515115129081-0.png)
...
如果可以安全的调用该函数，并且在信号处理程序上文中可以安全的使用，则该函数是异步安全的或异步信号安全的。下表中所列的均为异步安全函数，来自POSIX标准。应用程序可以在信号处理程序中调用这些异步安全函数。
