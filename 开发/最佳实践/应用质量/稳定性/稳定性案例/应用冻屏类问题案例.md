...
![](assets/应用冻屏类问题案例/file-20260515115131989-0.png)
往前推6s左右，可以看到在14:40:53.498左右，有一个点击事件发给了scb。
 

![](assets/应用冻屏类问题案例/file-20260515115131989-1.png)
这之间的6s存在大量的scb日志，判断是在进行更新渲染。
 

![](assets/应用冻屏类问题案例/file-20260515115131989-2.png)

 
查看对应时间点的trace：
 

![](assets/应用冻屏类问题案例/file-20260515115131989-3.png)
...
![](assets/应用冻屏类问题案例/file-20260515115131989-4.png)
查看具体代码：
...
```text
MemoryCatcher --
some <span style="color: rgb(0,0,255);">avg10</span>=69.85 <span style="color: rgb(0,0,255);">avg60</span>=69.85 <span style="color: rgb(0,0,255);">avg300</span>=69.85 <span style="color: rgb(0,0,255);">total</span>=69
full <span style="color: rgb(0,0,255);">avg10</span>=69.85 <span style="color: rgb(0,0,255);">avg60</span>=69.85 <span style="color: rgb(0,0,255);">avg300</span>=69.85 <span style="color: rgb(0,0,255);">total</span>=69
//...
