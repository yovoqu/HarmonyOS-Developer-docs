...
具体内容见[精简节点数](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-layout-optimization-guidance#精简节点数)和[合理使用布局组件](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-layout-optimization-guidance#合理使用布局组件)。

**减少渲染时间**

if/else条件渲染是ArkUI开发框架提供的功能，可根据应用状态渲染相应UI。

具体内容见[合理使用渲染控制语法](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-layout-optimization-guidance#合理使用渲染控制语法)。
