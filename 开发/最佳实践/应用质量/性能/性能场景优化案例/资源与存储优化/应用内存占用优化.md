...
![](assets/应用内存占用优化/file-20260525085643702-002.png)
Purgeable内存回收流程图如下所示。当引用计数为0时，丢弃Purgeable内存中的数据，并标记为已回收。
**图3 **Purgeable内存回收流程图

![](assets/应用内存占用优化/file-20260525085643702-003.png)
...
![](assets/应用内存占用优化/file-20260525085643702-004.png)
...
![](assets/应用内存占用优化/file-20260525085643702-005.png)
