...
![](assets/省电和深色模式下低功耗设计/file-20260515115050794-2.png)
...
**图4 **创建深色模式资源文件夹
![](assets/省电和深色模式下低功耗设计/file-20260515115050794-3.png)
  ...
  onWindowStageCreate(windowStage: window.WindowStage): void {
    ...
    if (
      ...
      try {
        ...
        console.error(
          'Failed to set the brightness. Cause: ' + JSON.stringify(exception),
        );
      }
    }
  }
