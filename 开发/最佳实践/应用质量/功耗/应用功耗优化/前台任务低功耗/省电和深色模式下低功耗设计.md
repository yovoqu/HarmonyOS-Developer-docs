...
图1 **总耗电量对比（相对于正常模式）**
![](assets/省电和深色模式下低功耗设计/file-20260515115050794-0.png)
...
4. 连接设备：将设备通过USB连接到计算机上。

5. 选择应用程序：在Profiler中，选择要测试的应用程序并开启Realtime Monitor。

6. 进行应用程序操作：在设备上进行应用程序操作，如浏览网页、播放视频等。

7. 查看结果：右侧区域展示时间窗内Energy资源的实时使用情况。将鼠标悬浮在统计图的任意位置，打开时间标线，左右移动鼠标，结合时间轴查看不同时间点的实时信息。
...
![](assets/省电和深色模式下低功耗设计/file-20260515115050794-1.png)
...
![](assets/省电和深色模式下低功耗设计/file-20260515115050794-4.png)
...
在应用省电模式后，继续在“我的”界面下设置深色模式，可以在显示模块获得显著收益。应用深色模式的步骤如下：
  ...
  **图4 **创建深色模式资源文件夹**
![](assets/省电和深色模式下低功耗设计/file-20260515115050794-5.png)
...
![](assets/省电和深色模式下低功耗设计/file-20260515115050794-6.gif)
...
![](assets/省电和深色模式下低功耗设计/file-20260515115050794-7.png)
...
**图7 **省电和深色模式下停止冗余动效**
![](assets/省电和深色模式下低功耗设计/file-20260515115050794-8.png)
