...
![](assets/Buffer低功耗优化/file-20260515115101475-3.png)
...
![](assets/Buffer低功耗优化/file-20260515115101475-9.png)
...
>  使用opacity属性，给自绘制组件设置透明度使用foregroundEffect实现前景模糊，blur实现背景模糊使用grayscale，实现灰阶效果使用lightUpEffect，强行对图层进行压暗提亮特别地，对于Web、XComponent组件，建议设置背景色为黑色不透明，或不主动设置backgroundColor属性
