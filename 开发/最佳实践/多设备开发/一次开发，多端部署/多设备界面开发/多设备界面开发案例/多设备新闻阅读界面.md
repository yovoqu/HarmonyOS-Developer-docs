...
| 7 | 竖向视频卡片 | 采用重复布局，手机上的左图右文卡片，在折叠屏和PC/2in1上显示更多列该卡片内容。 |
| 8 | 大视频类新闻 | 采用重复布局，手机上单列展示，在折叠屏和PC/2in1上重复布局。 |
...
| 2 | 新闻标题及发布信息 | 使用占比能力保证多设备尺寸下的界面一致。 |
| 3 | 新闻内容 | 使用占比能力保证多设备尺寸下的界面一致。 |
| 4 | 评论区 | 采用挪移布局，当设备尺寸变宽时将新闻内容区域和评论区左右布局。 |
| 5 | 底部工具栏 | 使用自适应布局中的均分能力，实现设备尺寸变化时图标尺寸不变，图标间距及左右边缘间距均等改变。 |
