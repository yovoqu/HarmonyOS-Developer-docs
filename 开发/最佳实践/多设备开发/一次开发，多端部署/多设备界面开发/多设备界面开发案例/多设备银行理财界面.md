...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8d/v3/M8t_FPn-QliHXl8sYzLUFA/zh-cn_image_0000002610026103.png?HW-CC-KV=V1&HW-CC-Date=20260528T013054Z&HW-CC-Expire=86400&HW-CC-Sign=7C698E8D11E8116C8B448434F0BA6959DAC97B454F6671E167783A236C3166B8)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/94/v3/oAfG3muuS3S1hzTCEJt-GQ/zh-cn_image_0000002579426308.png?HW-CC-KV=V1&HW-CC-Date=20260528T013054Z&HW-CC-Expire=86400&HW-CC-Sign=3B5DACEB8A9D860E0C85D69A7DBBF26DED63BA93E0042F3534D5E4F05B993CC7)
...
| 3 | 产品推荐 | 复用移动端设备布局方案，同移动端账户总览页对应区域的布局实现方案。 |
| 4 | 活期存款 | 复用移动端设备布局方案，同移动端账户总览页对应区域的布局实现方案。 |
| 5 | 投资（理财卡片、基金卡片） | 复用移动端设备布局方案，同移动端账户总览页对应区域的布局实现方案。 |
| 6 | 负债信息 | 复用移动端设备布局方案，同移动端账户总览页对应区域的布局实现方案。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e0/v3/Bp8UP2uzSHKpKHb8huJV_g/zh-cn_image_0000002609946203.png?HW-CC-KV=V1&HW-CC-Date=20260528T013054Z&HW-CC-Expire=86400&HW-CC-Sign=BB9919F858DB96D084BBF0139AA822C1983F1318BE31A8B800B4FE506E2920C0)
...
| 3 | 时间轴卡片 | 复用移动端设备布局方案，同移动端理财详情页对应区域的布局实现方案。 |
| 4 | 产品亮点 | 复用移动端设备布局方案，同移动端理财详情页对应区域的布局实现方案。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ef/v3/0hQ8pGWxTg-n-lmw6DsQXg/zh-cn_image_0000002579586218.png?HW-CC-KV=V1&HW-CC-Date=20260528T013054Z&HW-CC-Expire=86400&HW-CC-Sign=EBF32419EC1B2F2F1136F3BCC2E40AB86AD0F4570BDEA2CDBB73B3E54EB3E772)
...
| 2 | 产品名称 | 复用移动端设备布局方案，同移动端购买页对应区域的布局实现方案。 |
| 3 | 购买金额卡片 | 复用移动端设备布局方案，同移动端购买页对应区域的布局实现方案。 |
| 4 | 支付方式卡片 | 复用移动端设备布局方案，同移动端购买页对应区域的布局实现方案。 |
| 5 | 产品摘要信息 | 复用移动端设备布局方案，同移动端购买页对应区域的布局实现方案。 |
| 6 | 底部确认按钮 | 复用移动端设备布局方案，同移动端购买页对应区域的布局实现方案。 |
