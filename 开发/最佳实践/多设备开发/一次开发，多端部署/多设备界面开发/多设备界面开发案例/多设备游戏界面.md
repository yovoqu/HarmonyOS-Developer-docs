...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5e/v3/dFYP6kS3TnCXppxqREYOXw/zh-cn_image_0000002276709524.png?HW-CC-KV=V1&HW-CC-Date=20260813T095913Z&HW-CC-Expire=86400&HW-CC-Sign=2F593BA67E10A97C8379ED6D3C5F6C299B23DC30423325A4B4196F7C406F76DC)
...
首先调用[setWindowLayoutFullScreen()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-window#setwindowlayoutfullscreen9)接口设置窗口布局为沉浸式布局，接着调用[setWindowSystemBarEnable()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-window#setwindowsystembarenable9)接口设置状态栏和导航条的具体显示/隐藏状态，此场景下将其设置为隐藏。
...
- Native侧避让定义数据传递函数，用于将避让区域从ArkTS侧传输到Native侧，后续可根据应用需求自定义实现区域避让。更多数据交互可参考[object类型数据交互](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cross-language-complex-param#object类型数据交互)。
