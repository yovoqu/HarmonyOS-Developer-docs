...
> [!NOTE]
> 只有当应用要求能力集是设备支持能力集的子集的时候，应用才可以在该设备上分发、安装和运行。 系统能力使用可参考 系统能力SystemCapability使用指南 。
...
- [canIUse()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-syscap#caniuse)接口帮助开发者来判断该设备是否支持某个特定的syscap。
