...
> [!NOTE]
> 布局适配优先基于响应式断点，而非折叠状态：应使用统一的横纵向 断点 判断页面布局，确保在不同屏幕状态上实现一致的响应式表现。避免直接依赖折叠状态作为布局依据，防止因设备差异导致显示异常（如Pura XFOLD_STATUS_EXPANDED状态对应的是展开态，为直板机布局；而三折叠FOLD_STATUS_EXPANDED状态对应的是双屏态，应为大方形屏布局）。 设备悬停态等特殊场景可针对性优化：其他特殊场景（例如折叠屏悬停态下特殊的布局设计），可使用折叠状态作为判断条件，效果可参考 悬停态适配案例 。
...
> [!NOTE]
> 页面布局应基于 断点 进行响应式设计，不建议依赖 deviceType 、 isFoldable 、 foldStatus 等设备状态接口作为布局决策条件，以防在多尺寸折叠屏设备上出现适配异常。
...
| 单屏态（F态） | 1:2 | 上下分屏（竖屏） | 351 * 245 | 横向断点sm，纵向断点sm |
| 单屏态（F态） | 2:1 | 上下分屏（竖屏） | 351 * 490 | 横向断点sm，纵向断点lg |
| 单屏态（F态） | 左右分屏（横屏） | 1:1 | 367 * 351 | 横向断点sm，纵向断点md |
| 双屏态（M态） | 上下分屏（竖屏） | 1:1 | 352 * 776 | 横向断点sm，纵向断点lg |
| 双屏态（M态） | 左右分屏（横屏） | 1:1 | 384 * 712 | 横向断点sm，纵向断点lg |
| 三屏态（G态） | 上下分屏（竖屏） | 1:1 | 776 * 533 | 横向断点md，纵向断点sm |
| 三屏态（G态） | 1:2 | 上下分屏（竖屏） | 776 * 355 | 横向断点md，纵向断点sm |
| 三屏态（G态） | 2:1 | 上下分屏（竖屏） | 776 * 710 | 横向断点md，纵向断点md |
| 三屏态（G态） | 左右分屏（横屏） | 1:1 | 550 * 776 | 横向断点sm，纵向断点lg |
| 左右分屏（横屏） | 1:2 | 367 * 776 | 横向断点sm，纵向断点lg |
| 左右分屏（横屏） | 2:1 | 733 * 776 | 横向断点md，纵向断点md |
 
 
 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/02/v3/zvVAZut_RauPSCsSbwGMaA/zh-cn_image_0000002458026077.png?HW-CC-KV=V1&HW-CC-Date=20260528T024739Z&HW-CC-Expire=86400&HW-CC-Sign=B43E371657C2B49A9EEFA7B022AA6BEF6BFAF8BEB0D8C58255C18294E044D3E2)

 
**自由悬浮窗****口**
 
> [!NOTE]
> 三折叠在单屏态、双屏态和三屏态均支持悬浮窗。 Mate XTs在三屏态下点击开启自由多窗按钮后，可以开启自由多窗模式，此时 FLOATING 代表自由窗口；关闭自由多窗模式， FLOATING 代表悬浮窗。
...
| 单屏态（F态） | 横向悬浮窗 | 776 * 437 | 横向断点md，纵向断点sm |
| 双屏态（M态） | 纵向悬浮窗 | 351 * 658 | 横向断点sm，纵向断点md |
| 双屏态（M态） | 横向悬浮窗 | 776 * 437 | 横向断点md，纵向断点sm |
| 三屏态（G态） | 纵向悬浮窗 | 351 * 658 | 横向断点sm，纵向断点md |
| 三屏态（G态） | 横向悬浮窗 | 776 * 437 | 横向断点md，纵向断点sm |
 
 
 

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b9/v3/XxZ8R2mKQ-6cBJKdgDsWUg/zh-cn_image_0000002424587346.png?HW-CC-KV=V1&HW-CC-Date=20260528T024739Z&HW-CC-Expire=86400&HW-CC-Sign=9F981FC670464369EDE504616DC7D0B99FF9C219E477A66F76616D39CFFD572D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/10/v3/UhwzuhhITPWIF44dQYTitQ/zh-cn_image_0000002462550117.png?HW-CC-KV=V1&HW-CC-Date=20260528T024739Z&HW-CC-Expire=86400&HW-CC-Sign=F50FB34B4C8BADACF7FE44D367975FDE7FAFF736D4F8A6FB418DD57C06F87B43)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2c/v3/Ht5T2jK6S5mfBf7pBKsDkw/zh-cn_image_0000002457946277.png?HW-CC-KV=V1&HW-CC-Date=20260528T024739Z&HW-CC-Expire=86400&HW-CC-Sign=782C9F82F5BB9153BE37935E4C0C90B8E7C11475A29661CB59348BDAC584DB08)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/11/v3/HctOFjKfRp67q92Q5ayhFA/zh-cn_image_0000002424427546.png?HW-CC-KV=V1&HW-CC-Date=20260528T024739Z&HW-CC-Expire=86400&HW-CC-Sign=4A3E72A79639C216BC45930649E2DA493B6672AF0CD524A1DCDF25256A52E422)
...
> [!NOTE]
> 三折叠在下面几种场景中避让区会发生变化： 窗口模式切换（全屏/悬浮窗/分屏）。 窗口方向变化（横竖屏切换）。 折叠屏状态切换（展开/折叠）。 适配方案可参考 窗口沉浸式 。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7e/v3/N8x1e05BTqavmlpugfumqg/zh-cn_image_0000002424427622.png?HW-CC-KV=V1&HW-CC-Date=20260528T024739Z&HW-CC-Expire=86400&HW-CC-Sign=FE074D364EB9083FA8E64E5BA11817239FC6BDE20B81711D49147D6C5AC100AD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/L5SOqKT4Rfax3csK7GGX2g/zh-cn_image_0000002458026225.png?HW-CC-KV=V1&HW-CC-Date=20260528T024739Z&HW-CC-Expire=86400&HW-CC-Sign=278A0C0C01625A1D8DE1C6FC2E016C4A85CFD67C1E7757AB22C3ABBB1511D816)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/22/v3/KWmheZRQT4iJ4GLEIYpH_Q/zh-cn_image_0000002424587482.png?HW-CC-KV=V1&HW-CC-Date=20260528T024739Z&HW-CC-Expire=86400&HW-CC-Sign=28591AC523F7E13D87A67E08611BB4CDE371F6A999BC5F019F0561ED96BB1E26)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/84/v3/kAo0fmqDT3uApBcaHj2mLg/zh-cn_image_0000002457946397.png?HW-CC-KV=V1&HW-CC-Date=20260528T024739Z&HW-CC-Expire=86400&HW-CC-Sign=6FDA925B41843AFC506301D798B7C3D725DD640EBD597C41E6921405FCEF9720)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ea/v3/iUt8oVT0TbyWmc8P6YGJJA/zh-cn_image_0000002467756733.png?HW-CC-KV=V1&HW-CC-Date=20260528T024739Z&HW-CC-Expire=86400&HW-CC-Sign=5B725CFED096A11716471F162E39E2D60A83FF2B0703D7315CD0528D26E76281)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f/v3/8lzxUSdVSeumSc0skt770w/zh-cn_image_0000002424587546.png?HW-CC-KV=V1&HW-CC-Date=20260528T024739Z&HW-CC-Expire=86400&HW-CC-Sign=1B904091F33BF4701521E7E1E29BBF7C3F9000BAE5EF46DD120B35E8533695E1)
