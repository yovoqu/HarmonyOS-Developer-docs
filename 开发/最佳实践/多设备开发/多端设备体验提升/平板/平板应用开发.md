...
| 效果图 |  |  |  |  |
| --- | --- | --- | --- | --- |
| 屏幕方向Orientation | 横屏LANDSCAPE | 竖屏PORTRAIT | 反向横屏LANDSCAPE_INVERTED | 反向竖屏PORTRAIT_INVERTED |
| --- | --- | --- | --- | --- |
| 屏幕ID | 0 | 0 | 0 | 0 |
| --- | --- | --- | --- | --- |
...
| --- | --- | --- | --- | --- |
| 效果图 |  |  |  |  |
| 屏幕方向Orientation | 竖屏PORTRAIT | 反向横屏LANDSCAPE_INVERTED | 反向竖屏PORTRAIT_INVERTED | 横屏LANDSCAPE |
| 屏幕ID | 0 | 0 | 0 | 0 |
...
| 左右分屏 | 1:2 | 847*1600 | 横屏 | 376*711 | 横向断点sm，纵向断点sm |
| 左右分屏 | 2:1 | 1695*1600 | 横屏 | 753*711 | 横向断点md，纵向断点md |
| 上下分屏 | 1:1(默认) | 竖屏 | 1600*1271 | 711*564 | 横向断点md，纵向断点lg |
| 上下分屏 | 1:2 | 1600*847 | 竖屏 | 711*376 | 横向断点md，纵向断点lg |
| 上下分屏 | 2:1 | 1600*1695 | 竖屏 | 711*753 | 横向断点md，纵向断点md |
...
> [!WARNING]
> 平板设备同时支持自由窗口和悬浮窗，开启自由多窗模式， FLOATING 代表自由窗口；关闭自由多窗模式， FLOATING 代表悬浮窗。 平板设备上，用户下拉控制中心，点击自由多窗按钮，切换至自由多窗模式，窗口默认以自由窗口层叠显示。 平板设备默认支持自由多窗模式，但需注意，MatePad Mini平板设备不支持该模式。
...
![](assets/平板应用开发/file-20260525090450801-004.png)
...
![](assets/平板应用开发/file-20260525090450801-005.png)
...
平板设备支持横竖屏切换功能。当不同页面需要采用不同显示方向时，需在应用逻辑中动态调整窗口方向以实现该效果。平板可以通过设置窗口旋转策略（[orientation](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-window-e#orientation9)）的方式控制应用的显示方向。窗口旋转策略（orientation）与屏幕旋转角度的关系请参考[window.orientation与display.rotation的关系](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-multi-device-window-direction#section20201743171811)。平板开发的横竖屏旋转策略以及适配方案可参考[窗口方向](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-multi-device-window-direction)。
...
平板应用推荐适配横竖屏切换功能，具体适配逻辑可参考[为多设备配置旋转策略](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-multi-device-window-direction#section12636154743220)。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0/v3/iU1rLxbhS96ls9VksOmkaQ/zh-cn_image_0000002396895258.png?HW-CC-KV=V1&HW-CC-Date=20260528T013056Z&HW-CC-Expire=86400&HW-CC-Sign=1B09E1CB2B9DFA53FD5616D71138768B381B8EF9F26BA08EC358CFCB676D1908)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/af/v3/2ggF9BvWTlSHvUwE6ydNMw/zh-cn_image_0000002430374909.png?HW-CC-KV=V1&HW-CC-Date=20260528T013056Z&HW-CC-Expire=86400&HW-CC-Sign=4B20ED37212C327F14D2B129AC892E19BD34FA0980A86C912F0957E681BD3353)
...
| 分栏布局 | 三分栏 | SideBarContainer组件+Navigation组件+断点 |  |
| 挪移布局 | 插图和文字组合布局 | GridRow/GridCol组件+断点+栅格 |  |
| 挪移布局 | 底部/侧边导航 | Tabs组件+断点 |  |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/yhjRntigTn6QNTlmsEv1VQ/zh-cn_image_0000002397057082.png?HW-CC-KV=V1&HW-CC-Date=20260528T013056Z&HW-CC-Expire=86400&HW-CC-Sign=06C6F3982950778881F62E7953D35342A375CC7660E508AB2D1A8B3A28F90D69)


2. 屏幕高度，窗口宽度与高度的比例为1:1。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c7/v3/axFLCYQQQMGHaEwbLCzkWw/zh-cn_image_0000002430496785.png?HW-CC-KV=V1&HW-CC-Date=20260528T013056Z&HW-CC-Expire=86400&HW-CC-Sign=DEE2B3EFCFF74F45C1EE1A545830BDA8FD5A8A965C87DD52495B27130A032BEF)
...
方向策略：1. module.json5中Ability的"orientation"配置（仅支持竖屏）应选择以下选项之一：{"portrait", "portrait_inverted", "auto_rotation_portrait", "auto_rotation_portrait_restricted"}。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3b/v3/99WylHiPQDCV_GQJPlRB4w/zh-cn_image_0000002396897210.png?HW-CC-KV=V1&HW-CC-Date=20260528T013056Z&HW-CC-Expire=86400&HW-CC-Sign=A62C7AAEC339E8B2E1420F4318F0650002A94FDFBCD080EA557911B35F1E28F9)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/22/v3/5yzL_2EhS_GfdIm4JByriw/zh-cn_image_0000002430376837.png?HW-CC-KV=V1&HW-CC-Date=20260528T013056Z&HW-CC-Expire=86400&HW-CC-Sign=9AF8ED5430AD2D1590C69CABAA70F600F206B9EA6204C543AF3CA5E82B03CA84)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f0/v3/l15ryXl0QROCQ8cMDle2AQ/zh-cn_image_0000002397057086.png?HW-CC-KV=V1&HW-CC-Date=20260528T013056Z&HW-CC-Expire=86400&HW-CC-Sign=9AFCAC4369C2C891CEFE350292A717F64D3F8F64216B315897517E13F7DC347A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/91-hP_W6QmiKPeVkKe-lJQ/zh-cn_image_0000002430496789.png?HW-CC-KV=V1&HW-CC-Date=20260528T013056Z&HW-CC-Expire=86400&HW-CC-Sign=3C4D62FF7E14CA72DD363E551A904F0E84F5650892FA5F1011720E368204108E)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/tSEzHujGRPOpxBCLb7mBUQ/zh-cn_image_0000002458144425.png?HW-CC-KV=V1&HW-CC-Date=20260528T013056Z&HW-CC-Expire=86400&HW-CC-Sign=B25E4317EBD05293B004D75EA28881FA133D403F9B1DBD7CA52A082EC50015C5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/sCswI94nSn68Lpx8sC-QtA/zh-cn_image_0000002396902526.png?HW-CC-KV=V1&HW-CC-Date=20260528T013056Z&HW-CC-Expire=86400&HW-CC-Sign=E5B4DAE6EFF0917C2228660FB21FA1258141556B29218D0B820FAE4FB9E5FDF3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/89/v3/edmx1Y_BQ2CQVeOxEtPKTw/zh-cn_image_0000002397144262.png?HW-CC-KV=V1&HW-CC-Date=20260528T013056Z&HW-CC-Expire=86400&HW-CC-Sign=BE71C17EE655BA26B428BE9C745FD9599B6E2BA1A28B6DF9888EF84000C849E6)
