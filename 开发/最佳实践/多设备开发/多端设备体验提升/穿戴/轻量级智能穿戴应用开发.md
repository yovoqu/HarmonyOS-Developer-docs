...
> [!NOTE]
> 本文档适用于轻量级智能穿戴应用开发，针对智能穿戴应用请参考 智能穿戴 。
...
> [!NOTE]
> 因Lite Wearable设备无法与DevEco Studio进行连接，因此在对Lite Wearable应用/服务签名时，不能采用自动化签名方案，只能使用 手动签名 ，然后再手动配置签名信息。
...
> [!NOTE]
> 如果Lite Wearable与华为手机未连接，请单击 应用调测助手 APP界面的 连接设备 按钮，手机会自动打开 运动健康 APP添加Lite Wearable。 申请调试Profile 时，需先 注册设备 ，再选择调试设备。
...
4. 在detail.js文件中实现clickAction()方法，调用router.replaceUrl()函数跳转到详情页。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4e/v3/P4K_GCoAQI200c7BmChM8Q/zh-cn_image_0000002231037836.png?HW-CC-KV=V1&HW-CC-Date=20260624T020957Z&HW-CC-Expire=86400&HW-CC-Sign=5C9D217D21CC3F34984A69E764E30DD50F30419E9F1AD55544EA46F6631FEFD4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/HT6Ur9ZCRhmRp0vSF2TcPg/zh-cn_image_0000002505798198.png?HW-CC-KV=V1&HW-CC-Date=20260624T020957Z&HW-CC-Expire=86400&HW-CC-Sign=E6D13A00D5B8DB6FEBB70C3152939E2E9D97BA0A1BD1E4179E03567DC0F33513)
...
```text
{
  <span style="color: rgb(255,0,170);">"strings"</span>: {
    <span style="color: rgb(255,0,170);">"hello"</span>: <span style="color: rgb(80,160,79);">"Hello"</span>,
    <span style="color: rgb(255,0,170);">"world"</span>: <span style="color: rgb(80,160,79);">"World"</span>
  }
}
```
...
| 对称算法 | ECB | AES | NoPadding | 密钥生成、加密、解密 | 128/192/256 |
| 对称算法 | GCM | AES | NoPadding | 密钥生成、加密、解密 | 128/192/256 |
| 对称算法 | DES | 密钥生成、加密、解密 | CBC | NoPadding | 64 |
| DES | ECB | 密钥生成、加密、解密 | NoPadding | 64 |
| 3DES | 密钥生成、加密、解密 | CBC | NoPadding | 128/192 |
| 3DES | ECB | 密钥生成、加密、解密 | NoPadding | 128/192 |
...
| 非对称算法 | ECB | RSA |    | 密钥生成、加密、解密 | PKCS#1 V1.5 | [1024,2048] | RFC | 开源 |
| 非对称算法 | ECB | RSA | SHA256 | 密钥生成、加密、解密 | OAEP | [1024,2048] | RFC | 开源 |
| 非对称算法 | 密钥生成、签名、验签 | RSA |    | SHA256 | PKCS#1 V1.5 | [1024,2048] | RFC | 开源 |
| 非对称算法 |    | RSA | SHA256 | PSS | [1024,2048] | RFC | 开源 |
| 非对称算法 |    | RSA | SHA1 | ISO/IEC 9796-2 | [1024,2048] | ISO-9796 | 闭源 |
...
| 消息认证码（MAC）算法 | HMAC | MAC |    |    | 按照现有密钥规格 | RFC | 开源 | SHA256 |    |
