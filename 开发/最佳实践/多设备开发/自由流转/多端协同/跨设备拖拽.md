...
![](assets/跨设备拖拽/file-20260525090252691-001.gif)

#### 运作机制

![](assets/跨设备拖拽/file-20260525090252692-002.png)
1. 用户使用鼠标点击组件，触发拖拽事件。
2. 应用设置拖拽数据。
...
- **使用限制**双端设备需要登录同一华为账号。双端设备需要打开Wi-Fi和蓝牙开关，并接入同一个局域网。打开键鼠穿越开关。应用本身预置的资源文件（即应用在安装前的HAP包中已经存在的资源文件）不支持跨设备拖拽。
