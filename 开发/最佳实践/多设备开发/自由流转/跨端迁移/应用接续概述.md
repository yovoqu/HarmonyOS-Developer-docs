...
> [!NOTE]
> 自API12起，无需申请ohos.permission.DISTRIBUTED_DATASYNC权限。 API11及以前版本，需要执行如下操作: 声明ohos.permission.DISTRIBUTED_DATASYNC权限，详见 声明权限 。 由于ohos.permission.DISTRIBUTED_DATASYNC权限需要用户授权，应用需在首次启动或进入接续页面时弹窗向用户申请授权，详见 向用户申请授权 。
...
| 工具 | 笔记 | 笔记编辑页，笔记浏览或编辑进度同步。 | 退出 |
| 工具 | 日历 | 任意页面，日期视图、日程浏览或日程编辑进度同步。 | 退出 |
| 工具 | 邮箱 | 邮件编辑页面，内容进度及附件同步。 | 退出 |
| 工具 | 浏览器 | 网页内容详情页，网页浏览进度同步。 | 退出 |
| 出行导航 | 地图服务 | 路线查询、导航界面，当前路线及导航同步。 | 退出 |
| 影音娱乐 | 视频/短视频/微短剧/直播 | 音视频播放、直播页，音视频、直播播放进度同步。 | 应用按需适配 |
| 影音娱乐 | 音乐/K歌/电台/乐器 | 音视频播放、直播页，音视频、直播播放进度同步。 | 应用按需适配 |
...
“接续应用AppID1”：填入“APP ID_B”

4. “接续应用AppID2”：填入“APP ID_A”。

5. 申请原因：按照模板填写。

6. 附件：可上传介绍应用的相关信息。

7. 进入互动中心页面，可看到申请已提交的消息。
![](assets/应用接续概述/file-20260525090230391-003.png)


8. 返回“开放能力接入”页面，原“申请”按钮变为“申请中”。
![](assets/应用接续概述/file-20260525090230392-004.png)


9. 申请审批通过后，互动中心会发送通知消息给您。“申请中”按钮会变为“申请”，同时对应的能力开关会为您自动开启。至此，您的应用已成功接入接续服务能力。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/92/v3/xwA7DdJpTZ6bDwk15_RY6Q/zh-cn_image_0000002579827482.png?HW-CC-KV=V1&HW-CC-Date=20260730T072036Z&HW-CC-Expire=86400&HW-CC-Sign=5E90D4B1C60A44E02F8DD7CF85DE220081C5DFD6123FB00DDA41DC14A8A2A8A2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/BSMYgzKkQXap9g1m40bnww/zh-cn_image_0000002610107363.png?HW-CC-KV=V1&HW-CC-Date=20260730T072036Z&HW-CC-Expire=86400&HW-CC-Sign=6FBC3548D53A0FD4910EF76B28DBB297DB803EF8CA61AD0F3018E4A97326A0A8)
...
- Router页面栈迁移
配置wantParam[wantConstant.Params.SUPPORT_CONTINUE_PAGE_STACK_KEY]
```ArkTS
onContinue(wantParam: Record<string, Object>) {
  // ...
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ee/v3/qd_N42sASy2UCdckxE8ZbA/zh-cn_image_0000002610187453.png?HW-CC-KV=V1&HW-CC-Date=20260730T072036Z&HW-CC-Expire=86400&HW-CC-Sign=F841209E035FB6DE7E34370A4B1312136475C3EDCE270FA84D2C812154D67CDB)
