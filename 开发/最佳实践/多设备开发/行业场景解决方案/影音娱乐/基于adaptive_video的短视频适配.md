...
| 8 | r >= 9:15.9 或 r < 9:16.1 (非9:16区间的视频) | 9:20 <= x < 9:18 | 窗口高度减去底部导航栏高度、后，视频自适应放大至撑满剩余区域 状态栏沉浸、底部tab不沉浸 | 320 <= w |
| 9 | r >= 9:15.9 或 r < 9:16.1 (非9:16区间的视频) | x > 9:18 | 视频自适应放大至撑满剩余区域 状态栏沉浸、底部tab根据视频区域大小决定是否沉浸 | 320 <= w |
