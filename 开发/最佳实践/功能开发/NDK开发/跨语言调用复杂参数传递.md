...
3. 在DevEco Studio[预生成的Init()函数](#li114851510132916)中设置写好的数据传递函数。与[arrayBuffer类型数据交互](#section9552193517193)类同，此处不再赘述。
...
- 需在DevEco Studio[预生成的Init()函数](#li114851510132916)中设置写好的数据传递函数。与[arrayBuffer类型数据交互](#section9552193517193)类同，此处不再赘述。
...
3. 需在DevEco Studio[预生成的Init()函数](#li114851510132916)中设置写好的数据传递函数。与[arrayBuffer类型数据交互](#section9552193517193)类同，此处不再赘述。
...
EXTERN_C_END
```
 需要先在DevEco Studio[预生成的Init()函数](#li114851510132916)中，定义一个classProp，并写入class对应的访问器与方法
