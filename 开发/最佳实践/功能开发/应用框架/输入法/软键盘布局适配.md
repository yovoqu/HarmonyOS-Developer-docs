...
![](assets/软键盘布局适配/file-20260515114612444-0.gif)
...
![](assets/软键盘布局适配/file-20260515114612444-1.gif)


示例如下：

```ts
TextInput({ placeholder: 'Please enter a contact name' }).id('input1');
...
![](assets/软键盘布局适配/file-20260515114612444-2.png)
...
![](assets/软键盘布局适配/file-20260515114612444-3.gif)
...
![](assets/软键盘布局适配/file-20260515114612444-4.png)
...
通过window模块的on('avoidAreaChange')方法开启当前窗口系统规避区变化的监听，获取内容可视区域大小，同时也可以监听软键盘的弹出收起。根据软键盘弹出后的可视区域大小，动态调整布局中组件的高度以适配界面。具体运用可以参考软键盘避让常见问题中通过监听软键盘弹出，实现软键盘避让示例。
...
![](assets/软键盘布局适配/file-20260515114612444-5.png)
...
![](assets/软键盘布局适配/file-20260515114612444-6.png)
...
![](assets/软键盘布局适配/file-20260515114612444-7.png)
...
![](assets/软键盘布局适配/file-20260515114612444-8.png)
...
前面介绍了避让模式，组件会为了避让软键盘而移动。有时希望组件不避让软键盘，例如在上抬模式下，希望顶部标题栏不移动。这种需求如何实现？这就需要了解安全区域和expandSafeArea属性了。
...
![](assets/软键盘布局适配/file-20260515114612444-9.png)
...
![](assets/软键盘布局适配/file-20260515114612444-10.png)
...
![](assets/软键盘布局适配/file-20260515114612444-11.png)
...
![](assets/软键盘布局适配/file-20260515114612444-12.png)


现在需求是希望顶部标题固定，点击底部输入框软键盘弹起的时候，标题不上抬，只有内容区域上抬。效果图如下：


![](assets/软键盘布局适配/file-20260515114612444-13.png)
...
![](assets/软键盘布局适配/file-20260515114612444-14.png)
...
![](assets/软键盘布局适配/file-20260515114612444-15.png)
