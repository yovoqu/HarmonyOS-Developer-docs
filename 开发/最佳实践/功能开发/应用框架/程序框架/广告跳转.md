...
5. 参考[Web页面开发与部署](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-social-share#section157709544229)完成部署与配置。
6. 配置直达应用市场能力（可选）       
...
10. 向广告载体方（如视频应用）提供标准App Linking跳转链接       将每一个商品的App Linking链接提供给广告载体（如视频应用），广告点击后调用openLink()接口进行跳转。
