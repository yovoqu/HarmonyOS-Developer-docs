...
面向互联网用户提供服务的应用，通常只需信任系统预置的CA证书。Network Kit（网络服务）和Remote Communication Kit（远场通信服务）的HTTPS连接已默认信任系统预置的CA证书。
...
```ts
certificatePinning: [
  //Optional, supports dynamic setting of certificate lock configuration information. This property is supported since API 12
  {
