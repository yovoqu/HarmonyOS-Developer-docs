...
```text
curl_easy_setopt(curl, CURLOPT_CAPATH, "/etc/security/certificates");
```
...
```text
curl_easy_setopt(curl, CURLOPT_CAPATH, "/data/storage/el1/bundle/entry/resources/resfile/domainCaCert");
```
