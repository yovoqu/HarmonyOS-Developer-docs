...
当分段按钮组件需要悬浮在页面之上时，建议适配[沉浸光感](https://developer.huawei.com/consumer/cn/doc/design-guides/immersivelight-0000002612101053)提高分段按钮的精致度和空间感，为界面带来更丰富的视觉体验。如采用沉浸光感样式，建议将沉浸光感设置在分段按钮整体容器背板上，选中态使用不透明度低于 20% 的背景色，选中态距离背板容器边距 4 vp，以增强组件的沉浸感体验和视觉舒适度。

采用沉浸光感样式，选中态支持拖拽切换，同时生效拖拽跟手动态效果，丰富组件的交互形式。
...
![](assets/分段按钮/file-20260515143708252-3.png)
...
![](assets/分段按钮/file-20260515143708252-4.png)
...
![](assets/分段按钮/file-20260515143708252-5.png)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/XeEOHLzgS72JxD3PX3fZNg/zh-cn_image_0000002355947717.png?HW-CC-KV=V1&HW-CC-Date=20260813T100446Z&HW-CC-Expire=86400&HW-CC-Sign=FE871D85CBFE57E87176FDF10DBE717DFEF1CB64F91572DFA7562B8914C4BEFC)
