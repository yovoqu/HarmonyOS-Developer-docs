...
| 标准编号 | 2.1.2.2 | 挖孔区适配 |
| --- | --- | --- |
| 标准描述 | 界面布局需要适配摄像头的挖孔区域，若重要信息或交互操作 (例如底部页签/顶部页签、工具栏、标题栏、搜索框、输入框、悬浮按钮、横幅通知等) 和挖孔区之间有遮挡，则需要局部避开挖孔区显示。         若重要信息或交互操作和挖孔区无遮挡，则无需避开挖孔区显示；悬浮类控件或功能 (例如弹出框、侧边栏等)，无需避开挖孔区显示；可以上下滚动的内容，例如列表、卡片等无需避开挖孔区显示。         若应用支持横竖屏旋转，则横竖屏的界面布局均需满足以上挖孔适配要求。         ![](assets/通用应用%20UX%20体验标准/file-20260515144601044-0.png)         输入框/按钮避让挖孔的示例         ![](assets/通用应用%20UX%20体验标准/file-20260515144601044-1.png)         挖孔区没有遮挡交互或核心信息，无需避让的示例 |  |
...
| 标准编号 | 2.1.4.3.1 | 应用图标 |
| --- | --- | --- |
| 标准描述 | 应用图标资源需分层，尺寸需满足规范要求：         应用图标资源必须分为前景图和背景图两层，尺寸要求必须为 1024 px * 1024 px，资源不允许自行裁切圆角，不允许在资源内添加内间距。         ![](assets/通用应用%20UX%20体验标准/file-20260515144601044-2.png)         上图为正确资源示例         ![](assets/通用应用%20UX%20体验标准/file-20260515144601044-3.png)         上图为错误资源示例 |  |
...
| ![](assets/通用应用%20UX%20体验标准/file-20260515144601044-4.png)![](assets/通用应用%20UX%20体验标准/file-20260515144601044-5.png)         Do | ![](assets/通用应用%20UX%20体验标准/file-20260515144601044-6.png)![](assets/通用应用%20UX%20体验标准/file-20260515144601044-7.png)         Don't |  |
| - 根据页面内状态栏区域的背景色选择合适的状态栏颜色 (黑/白)，保证状态栏信息的易读性。 |  |  |
| ![](assets/通用应用%20UX%20体验标准/file-20260515144601044-8.png)![](assets/通用应用%20UX%20体验标准/file-20260515144601044-9.png)         Do | ![](assets/通用应用%20UX%20体验标准/file-20260515144601044-10.png)![](assets/通用应用%20UX%20体验标准/file-20260515144601044-11.png)         Don't |  |
| - 避免在状态栏背景区域内采用左右半区对比差异过大的颜色，导致部分状态栏信息无法阅读。 |  |  |
| ![](assets/通用应用%20UX%20体验标准/file-20260515144601044-12.png)         ![](assets/通用应用%20UX%20体验标准/file-20260515144601044-13.png)         Do | ![](assets/通用应用%20UX%20体验标准/file-20260515144601044-14.png)         ![](assets/通用应用%20UX%20体验标准/file-20260515144601044-15.png)         Don't |  |
| 测试方法 | 检查应用内界面布局 |  |
